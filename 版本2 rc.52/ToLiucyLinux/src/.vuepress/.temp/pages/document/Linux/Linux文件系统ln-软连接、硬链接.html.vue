...
<h2 id="硬链接与软连接的区别" tabindex="-1"><a class="header-anchor" href="#硬链接与软连接的区别"><span>硬链接与软连接的区别：</span></a></h2>
<blockquote>
...
<h2 id="语法格式" tabindex="-1"><a class="header-anchor" href="#语法格式"><span><font color=teal>语法格式：</font></span></a></h2>
<blockquote>
<p>ln [参数] [源文件或目录] [目标文件或目录]</p>
</blockquote>
<h2 id="常用参数" tabindex="-1"><a class="header-anchor" href="#常用参数"><span><font color=teal>常用参数：</font></span></a></h2>
<table>
<thead>
<tr>
<th></th>
...
<h2 id="参考实例" tabindex="-1"><a class="header-anchor" href="#参考实例"><span><font color=teal>参考实例：</font></span></a></h2>
