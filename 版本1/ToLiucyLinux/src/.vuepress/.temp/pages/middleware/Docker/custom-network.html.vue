<template><div><h1 id="docker-自定义网络" tabindex="-1"><a class="header-anchor" href="#docker-自定义网络" aria-hidden="true">#</a> Docker | 自定义网络</h1>
<h2 id="_1-前言" tabindex="-1"><a class="header-anchor" href="#_1-前言" aria-hidden="true">#</a> 1.前言</h2>
<p>大家好，我是Leo哥🫣🫣🫣。前面我们创建了一个Java项目的容器，而Java项目往往需要访问其它各种中间件，例如MySQL、Redis等。现在，我们的容器之间能否互相访问呢？我们这篇文章主要讨论如何在Docker中使用网络。</p>
<h2 id="_2-测试访问" tabindex="-1"><a class="header-anchor" href="#_2-测试访问" aria-hidden="true">#</a> 2.测试访问</h2>
<p>首先，我们查看下MySQL容器的详细信息，重点关注其中的网络IP地址：</p>
<div class="language-Bash line-numbers-mode" data-ext="Bash"><pre v-pre class="language-Bash"><code># 1.用基本命令，寻找Networks.bridge.IPAddress属性
...
<p><a href="https://docs.docker.com/engine/reference/commandline/network/" target="_blank" rel="noopener noreferrer">https://docs.docker.com/engine/reference/commandline/network/<ExternalLinkIcon/></a></p>
<h2 id="_3-常见命令" tabindex="-1"><a class="header-anchor" href="#_3-常见命令" aria-hidden="true">#</a> 3.常见命令</h2>
<table>
<thead>
<tr>
...
<h2 id="_4-自定义网络" tabindex="-1"><a class="header-anchor" href="#_4-自定义网络" aria-hidden="true">#</a> 4.自定义网络</h2>
<div class="language-Bash line-numbers-mode" data-ext="Bash"><pre v-pre class="language-Bash"><code># 1.首先通过命令创建一个网络
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/LeoPic202312112042799.png" alt="image-20231211204208746" tabindex="0" loading="lazy"><figcaption>image-20231211204208746</figcaption></figure>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/LeoPic202312112042286.png" alt="image-20231211204233248" tabindex="0" loading="lazy"><figcaption>image-20231211204233248</figcaption></figure>
<p>OK，现在无需记住IP地址也可以实现容器互联了。</p>
<p><strong>注意：</strong></p>
<p>这里有些朋友可能会遇到ping common命令不可用的情况，这里给出解决方案。</p>
<p>解决：</p>
<p>1)这时候需要敲：apt-get update，这个命令的作用是：同步 /etc/apt/sources.list 和 /etc/apt/sources.list.d 中列出的源的索引，这样才能获取到最新的软件包。<br>
　　2)等更新完毕以后再敲命令：apt-get install iputils-ping命令即可。</p>
<p>同理，安装 vim也是：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">apt</span> <span class="token function">install</span> <span class="token function">vim</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>安装 net-tools:</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">apt</span> <span class="token function">install</span> net-tools
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><strong>总结</strong>：</p>
<ul>
...
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/LeoPic202312112044028.png" alt="公众号封面" tabindex="0" loading="lazy"><figcaption>公众号封面</figcaption></figure>
</div></template>
