...
<h2 id="一、环境准备" tabindex="-1"><a class="header-anchor" href="#一、环境准备" aria-hidden="true">#</a> 一、环境准备</h2>
<table>
<thead>
<tr>
<th>服务器类型</th>
...
<h2 id="二、部署-prometheus-普罗米修斯" tabindex="-1"><a class="header-anchor" href="#二、部署-prometheus-普罗米修斯" aria-hidden="true">#</a> 二、部署 Prometheus（普罗米修斯）</h2>
<h3 id="_1、prometheus-简介" tabindex="-1"><a class="header-anchor" href="#_1、prometheus-简介" aria-hidden="true">#</a> 1、Prometheus 简介</h3>
<blockquote>
...
<h3 id="_2、prometheus-部署" tabindex="-1"><a class="header-anchor" href="#_2、prometheus-部署" aria-hidden="true">#</a> 2、Prometheus 部署</h3>
...
<h4 id="_2-1-下载安装包-两种方式" tabindex="-1"><a class="header-anchor" href="#_2-1-下载安装包-两种方式" aria-hidden="true">#</a> 2.1 下载安装包（两种方式）</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412161105304.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>等待下载完成之后，</p>
<h4 id="_2-2-解压安装包并放到指定目录" tabindex="-1"><a class="header-anchor" href="#_2-2-解压安装包并放到指定目录" aria-hidden="true">#</a> 2.2 解压安装包并放到指定目录</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_2-3-修改-prometheus-配置文件" tabindex="-1"><a class="header-anchor" href="#_2-3-修改-prometheus-配置文件" aria-hidden="true">#</a> 2.3 修改 Prometheus 配置文件</h4>
...
<h4 id="_2-4-配置系统启动文件-设置开机自启-两种方式-推荐第一种" tabindex="-1"><a class="header-anchor" href="#_2-4-配置系统启动文件-设置开机自启-两种方式-推荐第一种" aria-hidden="true">#</a> 2.4 配置系统启动文件，设置开机自启 （两种方式：推荐第一种）</h4>
...
<h4 id="_2-5-页面访问" tabindex="-1"><a class="header-anchor" href="#_2-5-页面访问" aria-hidden="true">#</a> 2.5 页面访问</h4>
<blockquote>
<p>ip:port<br>
...
<h4 id="_2-6-服务端安装完成" tabindex="-1"><a class="header-anchor" href="#_2-6-服务端安装完成" aria-hidden="true">#</a> 2.6 服务端安装完成</h4>
<blockquote>
<p>至此，Prometheus 服务端安装完成。</p>
</blockquote>
<h2 id="三、部署-exporters-普罗米修斯客户端" tabindex="-1"><a class="header-anchor" href="#三、部署-exporters-普罗米修斯客户端" aria-hidden="true">#</a> 三、部署 Exporters（普罗米修斯客户端）</h2>
<blockquote>
<p>Exporters 远程监控linux主机，也就是普罗米修斯客户端</p>
</blockquote>
<h3 id="_1、exporters-部署" tabindex="-1"><a class="header-anchor" href="#_1、exporters-部署" aria-hidden="true">#</a> 1、Exporters 部署</h3>
...
<h4 id="_1-1-下载安装包-两种方式" tabindex="-1"><a class="header-anchor" href="#_1-1-下载安装包-两种方式" aria-hidden="true">#</a> 1.1 下载安装包（两种方式）</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412161104963.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>等待下载完成之后，</p>
<h4 id="_1-2-解压安装包并放到指定目录" tabindex="-1"><a class="header-anchor" href="#_1-2-解压安装包并放到指定目录" aria-hidden="true">#</a> 1.2 解压安装包并放到指定目录</h4>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment">#解压安装包</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_1-3-配置系统启动文件-设置开机自启-两种方式-推荐第一种" tabindex="-1"><a class="header-anchor" href="#_1-3-配置系统启动文件-设置开机自启-两种方式-推荐第一种" aria-hidden="true">#</a> 1.3 配置系统启动文件，设置开机自启 （两种方式：推荐第一种）</h4>
...
<h4 id="_1-4-页面访问" tabindex="-1"><a class="header-anchor" href="#_1-4-页面访问" aria-hidden="true">#</a> 1.4 页面访问</h4>
<blockquote>
<p>ip:port<br>
...
<h4 id="_1-5-客户端安装完成" tabindex="-1"><a class="header-anchor" href="#_1-5-客户端安装完成" aria-hidden="true">#</a> 1.5 客户端安装完成</h4>
<h3 id="_2、修改prometheus服务端的配置文件" tabindex="-1"><a class="header-anchor" href="#_2、修改prometheus服务端的配置文件" aria-hidden="true">#</a> 2、修改Prometheus服务端的配置文件</h3>
<blockquote>
<p>回到 Prometheus 服务端的配置文件里添加被监控机器的配置段</p>
</blockquote>
<h4 id="_2-1-添加客户端到服务端-分为添加单个客户端与多个客户端两部分" tabindex="-1"><a class="header-anchor" href="#_2-1-添加客户端到服务端-分为添加单个客户端与多个客户端两部分" aria-hidden="true">#</a> 2.1 添加客户端到服务端（分为添加单个客户端与多个客户端两部分）</h4>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>  - job_name: <span class="token string">"node测试"</span>
    static_configs:
      - targets: <span class="token punctuation">[</span><span class="token string">"172.16.11.220:9100"</span><span class="token punctuation">]</span>
      - targets: <span class="token punctuation">[</span><span class="token string">"172.16.11.209:9100"</span><span class="token punctuation">]</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412161103170.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<h4 id="_2-2-重启服务端" tabindex="-1"><a class="header-anchor" href="#_2-2-重启服务端" aria-hidden="true">#</a> 2.2 重启服务端</h4>
...
<h4 id="_2-3-服务端添加客户端完成" tabindex="-1"><a class="header-anchor" href="#_2-3-服务端添加客户端完成" aria-hidden="true">#</a> 2.3 服务端添加客户端完成</h4>
<blockquote>
<font color=red>注：服务端的服务器上也可以安装客户端，操作也是和安装客户端一样的哦！</font></blockquote>
<h3 id="_3、附加-服务端配置文件" tabindex="-1"><a class="header-anchor" href="#_3、附加-服务端配置文件" aria-hidden="true">#</a> 3、附加（服务端配置文件）</h3>
<h4 id="_3-1-监测-prometheus配置文件是否正确" tabindex="-1"><a class="header-anchor" href="#_3-1-监测-prometheus配置文件是否正确" aria-hidden="true">#</a> 3.1 监测 Prometheus配置文件是否正确</h4>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment">#进入prometheus目录</span>
<span class="token builtin class-name">cd</span> /usr/local/prometheus/
...
<h4 id="_3-2-监测服务ip添加后缀" tabindex="-1"><a class="header-anchor" href="#_3-2-监测服务ip添加后缀" aria-hidden="true">#</a> 3.2 监测服务ip添加后缀</h4>
...
<h3 id="_4、实例-监控远程mysql服务" tabindex="-1"><a class="header-anchor" href="#_4、实例-监控远程mysql服务" aria-hidden="true">#</a> 4、实例：监控远程MySQL服务</h3>
<p>在被客户端 agent上安装 mysqld_exporter 组件<br>
下载地址：<a href="https://prometheus.io/download/" target="_blank" rel="noopener noreferrer">https://prometheus.io/download/<ExternalLinkIcon/></a></p>
<h4 id="_4-1-下载安装包-两种方式" tabindex="-1"><a class="header-anchor" href="#_4-1-下载安装包-两种方式" aria-hidden="true">#</a> 4.1 下载安装包（两种方式）</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412161103020.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>等待下载完成之后，</p>
<h4 id="_4-2-解压安装包并放到指定目录" tabindex="-1"><a class="header-anchor" href="#_4-2-解压安装包并放到指定目录" aria-hidden="true">#</a> 4.2 解压安装包并放到指定目录</h4>
...
<h4 id="_4-3-安装mysql数据库-并授权" tabindex="-1"><a class="header-anchor" href="#_4-3-安装mysql数据库-并授权" aria-hidden="true">#</a> 4.3 安装mysql数据库，并授权</h4>
...
<h4 id="_4-4-创建一个mysqld-exporter配置文件" tabindex="-1"><a class="header-anchor" href="#_4-4-创建一个mysqld-exporter配置文件" aria-hidden="true">#</a> 4.4 创建一个mysqld_exporter配置文件</h4>
<blockquote>
...
<h4 id="_4-5-配置系统启动文件-设置开机自启-两种方式-推荐第二种" tabindex="-1"><a class="header-anchor" href="#_4-5-配置系统启动文件-设置开机自启-两种方式-推荐第二种" aria-hidden="true">#</a> 4.5 配置系统启动文件，设置开机自启 （两种方式：推荐第二种）</h4>
...
<h4 id="_4-6-页面访问" tabindex="-1"><a class="header-anchor" href="#_4-6-页面访问" aria-hidden="true">#</a> 4.6 页面访问</h4>
<blockquote>
<p>ip:port<br>
...
<h4 id="_4-7-客户端安装完成" tabindex="-1"><a class="header-anchor" href="#_4-7-客户端安装完成" aria-hidden="true">#</a> 4.7 客户端安装完成</h4>
<h4 id="_4-8-将-mysql-服务添加到服务端【修改prometheus服务器的配置文件】" tabindex="-1"><a class="header-anchor" href="#_4-8-将-mysql-服务添加到服务端【修改prometheus服务器的配置文件】" aria-hidden="true">#</a> 4.8 将 mysql 服务添加到服务端【修改Prometheus服务器的配置文件】</h4>
<blockquote>
...
<h4 id="_4-9-添加成功" tabindex="-1"><a class="header-anchor" href="#_4-9-添加成功" aria-hidden="true">#</a> 4.9 添加成功！！！</h4>
<h2 id="四、部署-grafana-可视化" tabindex="-1"><a class="header-anchor" href="#四、部署-grafana-可视化" aria-hidden="true">#</a> 四、部署 Grafana（可视化）</h2>
<h3 id="_1、grafana-简介" tabindex="-1"><a class="header-anchor" href="#_1、grafana-简介" aria-hidden="true">#</a> 1、Grafana 简介</h3>
<blockquote>
...
<h3 id="_2、grafana-部署" tabindex="-1"><a class="header-anchor" href="#_2、grafana-部署" aria-hidden="true">#</a> 2、Grafana 部署</h3>
<blockquote>
...
<h4 id="_2-1-下载安装包" tabindex="-1"><a class="header-anchor" href="#_2-1-下载安装包" aria-hidden="true">#</a> 2.1 下载安装包</h4>
<blockquote>
...
<h4 id="_2-2-启动-grafana-并设置开机自启" tabindex="-1"><a class="header-anchor" href="#_2-2-启动-grafana-并设置开机自启" aria-hidden="true">#</a> 2.2 启动 grafana 并设置开机自启</h4>
...
<h4 id="_2-3-页面访问" tabindex="-1"><a class="header-anchor" href="#_2-3-页面访问" aria-hidden="true">#</a> 2.3 页面访问</h4>
<blockquote>
<p>ip:port<br>
...
<h4 id="_2-4-配置数据源" tabindex="-1"><a class="header-anchor" href="#_2-4-配置数据源" aria-hidden="true">#</a> 2.4 配置数据源</h4>
<blockquote>
...
<h4 id="_2-5-导入模板" tabindex="-1"><a class="header-anchor" href="#_2-5-导入模板" aria-hidden="true">#</a> 2.5 导入模板</h4>
<p>可以看到我们刚刚创建的</p>
...
<h4 id="_2-6-为数据源做自定义数据展示" tabindex="-1"><a class="header-anchor" href="#_2-6-为数据源做自定义数据展示" aria-hidden="true">#</a> 2.6 为数据源做自定义数据展示</h4>
...
<h4 id="_2-7-导入grafana监控面板" tabindex="-1"><a class="header-anchor" href="#_2-7-导入grafana监控面板" aria-hidden="true">#</a> 2.7 导入grafana监控面板</h4>
<blockquote>
...
<h4 id="_2-8-为已有的监控面板添加自定义监控模块展示" tabindex="-1"><a class="header-anchor" href="#_2-8-为已有的监控面板添加自定义监控模块展示" aria-hidden="true">#</a> 2.8 为已有的监控面板添加自定义监控模块展示</h4>
...
<h4 id="_2-9-修改已有的模块数据" tabindex="-1"><a class="header-anchor" href="#_2-9-修改已有的模块数据" aria-hidden="true">#</a> 2.9 修改已有的模块数据</h4>
...
<h3 id="_3、实例-grafana-图形显示-mysql-监控数据" tabindex="-1"><a class="header-anchor" href="#_3、实例-grafana-图形显示-mysql-监控数据" aria-hidden="true">#</a> 3、实例：Grafana 图形显示 MySQL 监控数据</h3>
<blockquote>
<p><strong>在 grafana 上修改配置文件,并下载安装 mysql 监控的 dashboard（包含相关 json 文件，这些 json 文件可以看作是开发人员开发的一个监控模板）。</strong></p>
</blockquote>
<h4 id="_3-1-修改-grafana-ini-配置文件" tabindex="-1"><a class="header-anchor" href="#_3-1-修改-grafana-ini-配置文件" aria-hidden="true">#</a> 3.1 修改 grafana.ini 配置文件</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_3-2-克隆-dashboards-到-var-lib-grafana" tabindex="-1"><a class="header-anchor" href="#_3-2-克隆-dashboards-到-var-lib-grafana" aria-hidden="true">#</a> 3.2 克隆 dashboards 到 /var/lib/grafana/</h4>
...
<h4 id="_3-3-在grafana图形化界面导入相关的json文件" tabindex="-1"><a class="header-anchor" href="#_3-3-在grafana图形化界面导入相关的json文件" aria-hidden="true">#</a> 3.3 在grafana图形化界面导入相关的json文件</h4>
...
<h3 id="_4、grafana-onealert-实现服务告警" tabindex="-1"><a class="header-anchor" href="#_4、grafana-onealert-实现服务告警" aria-hidden="true">#</a> 4、Grafana + onealert 实现服务告警</h3>
...
<h4 id="_4-1-在grafana中配置webhook-url" tabindex="-1"><a class="header-anchor" href="#_4-1-在grafana中配置webhook-url" aria-hidden="true">#</a> 4.1 在Grafana中配置Webhook URL</h4>
<h4 id="_4-2-填写应用名称-点击保存生成appkey-上面已经生成" tabindex="-1"><a class="header-anchor" href="#_4-2-填写应用名称-点击保存生成appkey-上面已经生成" aria-hidden="true">#</a> 4.2 填写应用名称，点击保存生成AppKey（上面已经生成）</h4>
<h4 id="_4-3-创建-contact-points" tabindex="-1"><a class="header-anchor" href="#_4-3-创建-contact-points" aria-hidden="true">#</a> 4.3 创建 contact points</h4>
