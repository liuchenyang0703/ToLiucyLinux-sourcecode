...
<h2 id="_1、修改自定义脚本未重启客户端" tabindex="-1"><a class="header-anchor" href="#_1、修改自定义脚本未重启客户端" aria-hidden="true">#</a> 1、修改自定义脚本未重启客户端</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="_2、未开启zabbix的通信端口" tabindex="-1"><a class="header-anchor" href="#_2、未开启zabbix的通信端口" aria-hidden="true">#</a> 2、未开启zabbix的通信端口</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3、item的超时时间" tabindex="-1"><a class="header-anchor" href="#_3、item的超时时间" aria-hidden="true">#</a> 3、Item的超时时间</h2>
...
<h2 id="_4、zabbix-agentd与item-key版本不兼容" tabindex="-1"><a class="header-anchor" href="#_4、zabbix-agentd与item-key版本不兼容" aria-hidden="true">#</a> 4、zabbix_agentd与item_key版本不兼容</h2>
<p>zabbix_agentd版本兼容性导致item_key不支持的故障；<br>
有可能是自己升级了客户端或者服务端导致两个端口版本不一致，进而产生错误。<br>
解决版本;升级客户端或者服务端到相同的版本；</p>
<h2 id="_5、未开启远程执行操作命令的配置" tabindex="-1"><a class="header-anchor" href="#_5、未开启远程执行操作命令的配置" aria-hidden="true">#</a> 5、未开启远程执行操作命令的配置</h2>
