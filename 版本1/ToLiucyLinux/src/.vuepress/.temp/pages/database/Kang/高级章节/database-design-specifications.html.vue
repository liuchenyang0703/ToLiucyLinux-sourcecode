...
<h2 id="_1-为什么需要数据库设计" tabindex="-1"><a class="header-anchor" href="#_1-为什么需要数据库设计" aria-hidden="true">#</a> 1. 为什么需要数据库设计</h2>
...
<h2 id="_2-范-式" tabindex="-1"><a class="header-anchor" href="#_2-范-式" aria-hidden="true">#</a> 2. 范 式</h2>
<h3 id="_2-1-范式简介" tabindex="-1"><a class="header-anchor" href="#_2-1-范式简介" aria-hidden="true">#</a> 2.1 范式简介</h3>
<p>在关系型数据库中，关于数据表设计的基本原则、规则就称为范式。可以理解为，一张数据表的设计结 构需要满足的某种设计标准的 级别 。要想设计一个结构合理的关系型数据库，必须满足一定的范式。</p>
<h3 id="_2-2-范式都包括哪些" tabindex="-1"><a class="header-anchor" href="#_2-2-范式都包括哪些" aria-hidden="true">#</a> 2.2 范式都包括哪些</h3>
...
<h3 id="_2-4-第一范式-1st-nf" tabindex="-1"><a class="header-anchor" href="#_2-4-第一范式-1st-nf" aria-hidden="true">#</a> 2.4 第一范式(1st NF)</h3>
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>(球员编号, 比赛编号) → (姓名, 年龄, 比赛时间, 比赛场地，得分)
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>(球员编号) → (姓名，年龄)
...
<h3 id="_2-6-第三范式-3rd-nf" tabindex="-1"><a class="header-anchor" href="#_2-6-第三范式-3rd-nf" aria-hidden="true">#</a> 2.6 第三范式(3rd NF)</h3>
...
<h3 id="_2-7-小结" tabindex="-1"><a class="header-anchor" href="#_2-7-小结" aria-hidden="true">#</a> 2.7 小结</h3>
...
<h2 id="_3-反范式化" tabindex="-1"><a class="header-anchor" href="#_3-反范式化" aria-hidden="true">#</a> 3. 反范式化</h2>
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>select employee_id,department_name
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>SELECT p.comment_text, p.comment_time, stu.stu_name
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>SELECT comment_text, comment_time, stu_name
FROM class_comment2
...
<h3 id="_3-3-反范式的新问题" tabindex="-1"><a class="header-anchor" href="#_3-3-反范式的新问题" aria-hidden="true">#</a> 3.3 反范式的新问题</h3>
<ul>
<li>存储 空间变大了</li>
...
<h3 id="_3-4-反范式的适用场景" tabindex="-1"><a class="header-anchor" href="#_3-4-反范式的适用场景" aria-hidden="true">#</a> 3.4 反范式的适用场景</h3>
<p>当冗余信息有价值或者能 <code v-pre>大幅度提高查询效率</code> 的时候，我们才会采取反范式的优化。</p>
<h4 id="_1-增加冗余字段的建议" tabindex="-1"><a class="header-anchor" href="#_1-增加冗余字段的建议" aria-hidden="true">#</a> 1. 增加冗余字段的建议</h4>
<p>增加冗余字段一定要符合如下两个条件。只要满足这两个条件，才可以考虑增加夯余字段。</p>
<p>1）这个冗余字段<code v-pre>不需要经常进行修改</code>。</p>
<p>2）这个冗余字段<code v-pre>查询的时候不可或缺</code>。</p>
<h4 id="_2-历史快照、历史数据的需要" tabindex="-1"><a class="header-anchor" href="#_2-历史快照、历史数据的需要" aria-hidden="true">#</a> 2. 历史快照、历史数据的需要</h4>
...
<h2 id="_4-bcnf-巴斯范式" tabindex="-1"><a class="header-anchor" href="#_4-bcnf-巴斯范式" aria-hidden="true">#</a> 4. BCNF(巴斯范式)</h2>
...
<p>这2个表都满足第三范式的要求了。</p>
<h3 id="_7-4-反范式化-业务优先的原则" tabindex="-1"><a class="header-anchor" href="#_7-4-反范式化-业务优先的原则" aria-hidden="true">#</a> 7.4 反范式化：业务优先的原则</h3>
...
<h2 id="_8-er模型" tabindex="-1"><a class="header-anchor" href="#_8-er模型" aria-hidden="true">#</a> 8. ER模型</h2>
...
<h3 id="_8-1-er模型包括哪些要素" tabindex="-1"><a class="header-anchor" href="#_8-1-er模型包括哪些要素" aria-hidden="true">#</a> 8.1 ER模型包括哪些要素？</h3>
...
<h3 id="_8-2-关系的类型" tabindex="-1"><a class="header-anchor" href="#_8-2-关系的类型" aria-hidden="true">#</a> 8.2 关系的类型</h3>
...
<h3 id="_8-3-建模分析" tabindex="-1"><a class="header-anchor" href="#_8-3-建模分析" aria-hidden="true">#</a> 8.3 建模分析</h3>
...
<h3 id="_8-4-er-模型的细化" tabindex="-1"><a class="header-anchor" href="#_8-4-er-模型的细化" aria-hidden="true">#</a> 8.4 ER 模型的细化</h3>
...
<h4 id="_1-一个实体转换成一个数据库" tabindex="-1"><a class="header-anchor" href="#_1-一个实体转换成一个数据库" aria-hidden="true">#</a> 1. 一个实体转换成一个数据库</h4>
...
<h4 id="_2-一个多对多的关系转换成一个数据表" tabindex="-1"><a class="header-anchor" href="#_2-一个多对多的关系转换成一个数据表" aria-hidden="true">#</a> 2. 一个多对多的关系转换成一个数据表</h4>
...
<h4 id="_3-通过外键来表达1对多的关系" tabindex="-1"><a class="header-anchor" href="#_3-通过外键来表达1对多的关系" aria-hidden="true">#</a> 3. 通过外键来表达1对多的关系</h4>
...
<h2 id="_10-数据库对象编写建议" tabindex="-1"><a class="header-anchor" href="#_10-数据库对象编写建议" aria-hidden="true">#</a> 10. 数据库对象编写建议</h2>
<h3 id="_10-1-关于库" tabindex="-1"><a class="header-anchor" href="#_10-1-关于库" aria-hidden="true">#</a> 10.1 关于库</h3>
<ol>
...
<h3 id="_10-2-关于表、列" tabindex="-1"><a class="header-anchor" href="#_10-2-关于表、列" aria-hidden="true">#</a> 10.2 关于表、列</h3>
<ol>
<li>
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>CREATE TABLE user_info (
...
<h3 id="_10-3-关于索引" tabindex="-1"><a class="header-anchor" href="#_10-3-关于索引" aria-hidden="true">#</a> 10.3 关于索引</h3>
<ol>
...
<h3 id="_10-4-sql编写" tabindex="-1"><a class="header-anchor" href="#_10-4-sql编写" aria-hidden="true">#</a> 10.4 SQL编写</h3>
<ol>
...
<h2 id="_11-powerdesigner的使用" tabindex="-1"><a class="header-anchor" href="#_11-powerdesigner的使用" aria-hidden="true">#</a> 11. PowerDesigner的使用</h2>
...
<h3 id="_11-1-开始界面" tabindex="-1"><a class="header-anchor" href="#_11-1-开始界面" aria-hidden="true">#</a> 11.1 开始界面</h3>
...
<h3 id="_11-2-概念数据模型" tabindex="-1"><a class="header-anchor" href="#_11-2-概念数据模型" aria-hidden="true">#</a> 11.2 概念数据模型</h3>
