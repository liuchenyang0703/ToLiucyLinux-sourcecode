...
<h2 id="_1-数据库调优的措施" tabindex="-1"><a class="header-anchor" href="#_1-数据库调优的措施" aria-hidden="true">#</a> 1. 数据库调优的措施</h2>
<h3 id="_1-1-调优的目标" tabindex="-1"><a class="header-anchor" href="#_1-1-调优的目标" aria-hidden="true">#</a> 1.1 调优的目标</h3>
<ul>
<li>尽可能节省系统资源 ，以便系统可以提供更大负荷的服务。（吞吐量更大）</li>
<li>合理的结构设计和参数调整，以提高用户操作响应的速度 。（响应速度更快）</li>
<li>减少系统的瓶颈，提高MySQL数据库整体的性能。</li>
</ul>
<h3 id="_1-2-如何定位调优问题" tabindex="-1"><a class="header-anchor" href="#_1-2-如何定位调优问题" aria-hidden="true">#</a> 1.2 如何定位调优问题</h3>
...
<h3 id="_1-3-调优的维度和步骤" tabindex="-1"><a class="header-anchor" href="#_1-3-调优的维度和步骤" aria-hidden="true">#</a> 1.3 调优的维度和步骤</h3>
<p>我们需要调优的对象是整个数据库管理系统，它不仅包括 SQL 查询，还包括数据库的部署配置、架构 等。从这个角度来说，我们思考的维度就不仅仅局限在 SQL 优化上了。通过如下的步骤我们进行梳理：</p>
<h4 id="第1步-选择适合的-dbms" tabindex="-1"><a class="header-anchor" href="#第1步-选择适合的-dbms" aria-hidden="true">#</a> 第1步：选择适合的 DBMS</h4>
...
<h4 id="第2步-优化表设计" tabindex="-1"><a class="header-anchor" href="#第2步-优化表设计" aria-hidden="true">#</a> 第2步：优化表设计</h4>
...
<h4 id="第3步-优化逻辑查询" tabindex="-1"><a class="header-anchor" href="#第3步-优化逻辑查询" aria-hidden="true">#</a> 第3步：优化逻辑查询</h4>
...
<h4 id="第4步-优化物理查询" tabindex="-1"><a class="header-anchor" href="#第4步-优化物理查询" aria-hidden="true">#</a> 第4步：优化物理查询</h4>
...
<h4 id="第5步-使用-redis-或-memcached-作为缓存" tabindex="-1"><a class="header-anchor" href="#第5步-使用-redis-或-memcached-作为缓存" aria-hidden="true">#</a> 第5步：使用 Redis 或 Memcached 作为缓存</h4>
...
<h4 id="第6步-库级优化" tabindex="-1"><a class="header-anchor" href="#第6步-库级优化" aria-hidden="true">#</a> 第6步：库级优化</h4>
...
<h2 id="_2-优化mysql服务器" tabindex="-1"><a class="header-anchor" href="#_2-优化mysql服务器" aria-hidden="true">#</a> 2. 优化MySQL服务器</h2>
...
<h3 id="_2-1-优化服务器硬件" tabindex="-1"><a class="header-anchor" href="#_2-1-优化服务器硬件" aria-hidden="true">#</a> 2.1 优化服务器硬件</h3>
...
<h3 id="_2-2-优化mysql的参数" tabindex="-1"><a class="header-anchor" href="#_2-2-优化mysql的参数" aria-hidden="true">#</a> 2.2 优化MySQL的参数</h3>
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql&gt; show global status like 'Thread%';
+-------------------+-------+
| Variable_name | Value |
+-------------------+-------+
| Threads_cached | 2 |
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysqld]
port = 3306 
serverid = 1 
...
<h2 id="_3-优化数据库结构" tabindex="-1"><a class="header-anchor" href="#_3-优化数据库结构" aria-hidden="true">#</a> 3. 优化数据库结构</h2>
...
<h3 id="_3-1-拆分表-冷热数据分离" tabindex="-1"><a class="header-anchor" href="#_3-1-拆分表-冷热数据分离" aria-hidden="true">#</a> 3.1 拆分表：冷热数据分离</h3>
...
<p>创建这两个表的SQL语句如下：</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>CREATE TABLE members (
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>SELECT * FROM members LEFT JOIN members_detail on members.id =
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>CREATE TABLE `temp_student` (
`id` INT(11) NOT NULL AUTO_INCREMENT,
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>insert into temp_student(stu_name,className,monitor)
...
<h3 id="_3-4-优化数据类型" tabindex="-1"><a class="header-anchor" href="#_3-4-优化数据类型" aria-hidden="true">#</a> 3.4 优化数据类型</h3>
...
<h3 id="_3-5-优化插入记录的速度" tabindex="-1"><a class="header-anchor" href="#_3-5-优化插入记录的速度" aria-hidden="true">#</a> 3.5 优化插入记录的速度</h3>
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>insert into student values(1,'zhangsan',18,1);
...
<h3 id="_3-6-使用非空约束" tabindex="-1"><a class="header-anchor" href="#_3-6-使用非空约束" aria-hidden="true">#</a> 3.6 使用非空约束</h3>
...
<h3 id="_3-7-分析表、检查表与优化表" tabindex="-1"><a class="header-anchor" href="#_3-7-分析表、检查表与优化表" aria-hidden="true">#</a> 3.7 分析表、检查表与优化表</h3>
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>ANALYZE [LOCAL | NO_WRITE_TO_BINLOG] TABLE tbl_name[,tbl_name]…
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql&gt; ANALYZE TABLE user;
+--------------+---------+----------+---------+
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>CHECK TABLE tbl_name [, tbl_name] ... [option] ...
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>OPTIMIZE [LOCAL | NO_WRITE_TO_BINLOG] TABLE tbl_name [, tbl_name] ...
...
<p>到底优化了没有呢？看官网！</p>
<p><a><a href="https://dev.mysql.com/doc/refman/8.0/en/optimize-table.html" target="_blank" rel="noopener noreferrer">MySQL :: MySQL 8.0 Reference Manual :: 13.7.3.4 OPTIMIZE TABLE Statement<ExternalLinkIcon/></a></a></p>
...
<h4 id="_3-8-小结" tabindex="-1"><a class="header-anchor" href="#_3-8-小结" aria-hidden="true">#</a> 3.8 小结</h4>
...
<h2 id="_4-大表优化" tabindex="-1"><a class="header-anchor" href="#_4-大表优化" aria-hidden="true">#</a> 4. 大表优化</h2>
<p>当MySQL单表记录数过大时，数据库的CRUD性能会明显下降，一些常见的优化措施如下：</p>
<h3 id="_4-1-限定查询的范围" tabindex="-1"><a class="header-anchor" href="#_4-1-限定查询的范围" aria-hidden="true">#</a> 4.1 限定查询的范围</h3>
<p>禁止不带任何限制数据范围条件的查询语句。比如：我们当用户在查询订单历史的时候，我们可以控制 在一个月的范围内；</p>
<h3 id="_4-2-读-写分离" tabindex="-1"><a class="header-anchor" href="#_4-2-读-写分离" aria-hidden="true">#</a> 4.2 读/写分离</h3>
...
<h2 id="_5-其它调优策略" tabindex="-1"><a class="header-anchor" href="#_5-其它调优策略" aria-hidden="true">#</a> 5. 其它调优策略</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>SET SESSION MAX_EXECUTION_TIME=2000; #指定该会话中SELECT语句的超时时间
...
<h3 id="_5-3-mysql-8-0新特性-隐藏索引对调优的帮助" tabindex="-1"><a class="header-anchor" href="#_5-3-mysql-8-0新特性-隐藏索引对调优的帮助" aria-hidden="true">#</a> 5.3 MySQL 8.0新特性：隐藏索引对调优的帮助</h3>
