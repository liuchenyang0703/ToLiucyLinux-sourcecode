...
<h2 id="_1-索引的声明与使用" tabindex="-1"><a class="header-anchor" href="#_1-索引的声明与使用" aria-hidden="true">#</a> 1. 索引的声明与使用</h2>
<h3 id="_1-1-索引的分类" tabindex="-1"><a class="header-anchor" href="#_1-1-索引的分类" aria-hidden="true">#</a> 1.1 索引的分类</h3>
...
<h3 id="_1-2-创建索引" tabindex="-1"><a class="header-anchor" href="#_1-2-创建索引" aria-hidden="true">#</a> 1.2 创建索引</h3>
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>CREATE TABLE table_name [col_name data_type]
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>CREATE TABLE book(
book_id INT ,
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>SHOW INDEX FROM test1 \G
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>ALTER TABLE student
drop PRIMARY KEY;
...
<p>引举:</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>CREATE TABLE test2(
id INT NOT NULL,
name CHAR(50) NULL,
INDEX single_idx_name(name(20))
);
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>该语句执行完毕之后，使用SHOW CREATE TABLE查看表结构：</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>SHOW INDEX FROM test2 \G
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>CREATE TABLE test3(
id INT(11) NOT NULL,
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>SHOW INDEX FROM test3 \G
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>EXPLAIN SELECT * FROM test3 WHERE id=1 AND name='songhongkang' \G
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>CREATE TABLE test4(
id INT NOT NULL,
name CHAR(30) NOT NULL,
age INT NOT NULL,
info VARCHAR(255),
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>SHOW INDEX FROM test4 \G
...
<p>举例2：</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>CREATE TABLE articles (
...
<p>举例3：</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>CREATE TABLE `papers` (
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>SELECT * FROM papers WHERE content LIKE ‘%查询字符串%’;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>全文索引用match+against方式查询：</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>SELECT * FROM papers WHERE MATCH(title,content) AGAINST (‘查询字符串’);
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>CREATE TABLE test5(
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>SHOW INDEX FROM test5 \G
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>ALTER TABLE table_name ADD [UNIQUE | FULLTEXT | SPATIAL] [INDEX | KEY]
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>CREATE [UNIQUE | FULLTEXT | SPATIAL] INDEX index_name
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>ALTER TABLE table_name DROP INDEX index_name;
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>DROP INDEX index_name ON table_name;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><blockquote>
<p>提示: 删除表中的列时，如果要删除的列为索引的组成部分，则该列也会从索引中删除。如果组成索引的所有列都被删除，则整个索引将被删除。</p>
</blockquote>
<h2 id="_2-mysql8-0索引新特性" tabindex="-1"><a class="header-anchor" href="#_2-mysql8-0索引新特性" aria-hidden="true">#</a> 2. MySQL8.0索引新特性</h2>
<h3 id="_2-1-支持降序索引" tabindex="-1"><a class="header-anchor" href="#_2-1-支持降序索引" aria-hidden="true">#</a> 2.1 支持降序索引</h3>
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>CREATE TABLE ts1(a int,b int,index idx_a_b(a,b desc));
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>EXPLAIN SELECT * FROM ts1 ORDER BY a, b DESC LIMIT 5;
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>CREATE TABLE tablename(
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>CREATE INDEX indexname
...
<p>语法形式如下：</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>ALTER TABLE tablename
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>ALTER TABLE tablename ALTER INDEX index_name INVISIBLE; #切换成隐藏索引
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql&gt; select @@optimizer_switch \G
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>在输出的结果信息中找到如下属性配置。</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>use_invisible_indexes=off
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql&gt; set session optimizer_switch=&quot;use_invisible_indexes=on&quot;;
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>use_invisible_indexes=on
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>explain select * from classes where cname = '高一2班';
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql&gt; set session optimizer_switch=&quot;use_invisible_indexes=off&quot;;
Query OK, 0 rows affected (0.00 sec)
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>CREATE DATABASE atguigudb1;
USE atguigudb1;
#1.创建学生表和课程表
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>#函数1：创建随机产生字符串函数
DELIMITER //
...
END //
DELIMITER ;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>#函数2：创建随机数函数
DELIMITER //
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>show variables like 'log_bin_trust_function_creators';
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>log_bin_trust_function_creators=1
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code># 存储过程1：创建插入课程表存储过程
DELIMITER //
...
END //
DELIMITER ;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code># 存储过程2：创建插入学生信息表存储过程
DELIMITER //
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>CALL insert_course(100);
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>CALL insert_stu(1000000);
...
<h4 id="_2-频繁作为-where-查询条件的字段" tabindex="-1"><a class="header-anchor" href="#_2-频繁作为-where-查询条件的字段" aria-hidden="true">#</a> 2. 频繁作为 WHERE 查询条件的字段</h4>
...
<h4 id="_3-经常-group-by-和-order-by-的列" tabindex="-1"><a class="header-anchor" href="#_3-经常-group-by-和-order-by-的列" aria-hidden="true">#</a> 3. 经常 GROUP BY 和 ORDER BY 的列</h4>
...
<h4 id="_4-update、delete-的-where-条件列" tabindex="-1"><a class="header-anchor" href="#_4-update、delete-的-where-条件列" aria-hidden="true">#</a> 4. UPDATE、DELETE 的 WHERE 条件列</h4>
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>SELECT DISTINCT(student_id) FROM `student_info`;
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>SELECT s.course_id, name, s.student_id, c.course_name
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>create table shop(address varchar(120) not null);
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>select count(distinct address) / count(*) from shop
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>通过不同长度去计算，与全表的选择性对比：</p>
<p>公式：</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>count(distinct left(列名, 索引长度))/count(*)
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>例如：</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>select count(distinct left(address,10)) / count(*) as sub10, -- 截取前10个字符的选择度
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>SELECT * FROM shop
ORDER BY address
LIMIT 12;
...
<h4 id="_9-区分度高-散列性高-的列适合作为索引" tabindex="-1"><a class="header-anchor" href="#_9-区分度高-散列性高-的列适合作为索引" aria-hidden="true">#</a> 9. 区分度高(散列性高)的列适合作为索引</h4>
...
<h4 id="_10-使用最频繁的列放到联合索引的左侧" tabindex="-1"><a class="header-anchor" href="#_10-使用最频繁的列放到联合索引的左侧" aria-hidden="true">#</a> 10. 使用最频繁的列放到联合索引的左侧</h4>
<p>这样也可以较少的建立一些索引。同时，由于&quot;最左前缀原则&quot;，可以增加联合索引的使用率。</p>
<h4 id="_11-在多个字段都要创建索引的情况下-联合索引优于单值索引" tabindex="-1"><a class="header-anchor" href="#_11-在多个字段都要创建索引的情况下-联合索引优于单值索引" aria-hidden="true">#</a> 11. 在多个字段都要创建索引的情况下，联合索引优于单值索引</h4>
<h3 id="_3-3-限制索引的数目" tabindex="-1"><a class="header-anchor" href="#_3-3-限制索引的数目" aria-hidden="true">#</a> 3.3 限制索引的数目</h3>
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>SELECT course_id, student_id, create_time
FROM student_info
...
<p>举例：创建表1：</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>CREATE TABLE t_without_index(
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>#创建存储过程
DELIMITER //
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>CREATE TABLE t_with_index(
a INT PRIMARY KEY AUTO_INCREMENT,
b INT,
INDEX idx_b(b)
);
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql&gt; select * from t_without_index where b = 9879;
+------+------+
| a | b |
+------+------+
| 1242 | 9879 |
...
<h4 id="_3-有大量重复数据的列上不要建立索引" tabindex="-1"><a class="header-anchor" href="#_3-有大量重复数据的列上不要建立索引" aria-hidden="true">#</a> 3. 有大量重复数据的列上不要建立索引</h4>
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>CREATE TABLE student_gender(
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>SELECT * FROM student_gender WHERE student_gender = 1;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><blockquote>
<p>结论：当数据重复度大，比如 高于 10% 的时候，也不需要对这个字段使用索引。</p>
</blockquote>
<h4 id="_4-避免对经常更新的表创建过多的索引" tabindex="-1"><a class="header-anchor" href="#_4-避免对经常更新的表创建过多的索引" aria-hidden="true">#</a> 4.  避免对经常更新的表创建过多的索引</h4>
...
<h4 id="_5-不建议用无序的值作为索引" tabindex="-1"><a class="header-anchor" href="#_5-不建议用无序的值作为索引" aria-hidden="true">#</a> 5. 不建议用无序的值作为索引</h4>
<p>例如身份证、UUID(在索引比较时需要转为ASCII，并且插入时可能造成页分裂)、MD5、HASH、无序长字 符串等。</p>
<h4 id="_6-删除不再使用或者很少使用的索引" tabindex="-1"><a class="header-anchor" href="#_6-删除不再使用或者很少使用的索引" aria-hidden="true">#</a> 6. 删除不再使用或者很少使用的索引</h4>
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>CREATE TABLE repeat_index_demo (
