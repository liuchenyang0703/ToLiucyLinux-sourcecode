...
<h3 id="_2-1-索引概述" tabindex="-1"><a class="header-anchor" href="#_2-1-索引概述" aria-hidden="true">#</a> 2.1 索引概述</h3>
...
<h3 id="_2-2-优点" tabindex="-1"><a class="header-anchor" href="#_2-2-优点" aria-hidden="true">#</a> 2.2 优点</h3>
...
<h3 id="_2-3-缺点" tabindex="-1"><a class="header-anchor" href="#_2-3-缺点" aria-hidden="true">#</a> 2.3 缺点</h3>
...
<p>先来看一个精确匹配的例子：</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>SELECT [列名列表] FROM 表名 WHERE 列名 = xxx;
...
<h4 id="_2-在很多页中查找" tabindex="-1"><a class="header-anchor" href="#_2-在很多页中查找" aria-hidden="true">#</a> 2. 在很多页中查找</h4>
...
<p>建一个表：</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql&gt; CREATE TABLE index_demo(
-&gt; c1 INT,
-&gt; c2 INT,
-&gt; c3 CHAR(1),
-&gt; PRIMARY KEY(c1)
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>INSERT INTO index_demo VALUES(1, 4, 'u'), (3, 9, 'd'), (5, 3, 'y');
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>INSERT INTO index_demo VALUES(4, 4, 'a');
...
<h4 id="_2-innodb中的索引方案" tabindex="-1"><a class="header-anchor" href="#_2-innodb中的索引方案" aria-hidden="true">#</a> 2. InnoDB中的索引方案</h4>
<h5 id="_1-迭代1次-目录项纪录的页" tabindex="-1"><a class="header-anchor" href="#_1-迭代1次-目录项纪录的页" aria-hidden="true">#</a> ① 迭代1次：目录项纪录的页</h5>
...
<h3 id="_3-3-常见索引概念" tabindex="-1"><a class="header-anchor" href="#_3-3-常见索引概念" aria-hidden="true">#</a> 3.3 常见索引概念</h3>
<p>索引按照物理实现方式，索引可以分为 2 种：聚簇（聚集）和非聚簇（非聚集）索引。我们也把非聚集 索引称为二级索引或者辅助索引。</p>
<h4 id="_1-聚簇索引" tabindex="-1"><a class="header-anchor" href="#_1-聚簇索引" aria-hidden="true">#</a> 1. 聚簇索引</h4>
...
<h4 id="_3-联合索引" tabindex="-1"><a class="header-anchor" href="#_3-联合索引" aria-hidden="true">#</a> 3.联合索引</h4>
...
<h3 id="_3-4-innodb的b-树索引的注意事项" tabindex="-1"><a class="header-anchor" href="#_3-4-innodb的b-树索引的注意事项" aria-hidden="true">#</a> 3.4 InnoDB的B+树索引的注意事项</h3>
<h4 id="_1-根页面位置万年不动" tabindex="-1"><a class="header-anchor" href="#_1-根页面位置万年不动" aria-hidden="true">#</a> 1. 根页面位置万年不动</h4>
<p>实际上B+树的形成过程是这样的：</p>
<ul>
...
<h2 id="_4-myisam中的索引方案" tabindex="-1"><a class="header-anchor" href="#_4-myisam中的索引方案" aria-hidden="true">#</a> 4. MyISAM中的索引方案</h2>
<p>B树索引使用存储引擎如表所示：</p>
<table>
<thead>
<tr>
...
<h2 id="_6-mysql数据结构选择的合理性" tabindex="-1"><a class="header-anchor" href="#_6-mysql数据结构选择的合理性" aria-hidden="true">#</a> 6. MySQL数据结构选择的合理性</h2>
...
<h3 id="_6-1-全表查询" tabindex="-1"><a class="header-anchor" href="#_6-1-全表查询" aria-hidden="true">#</a> 6.1 全表查询</h3>
<p>这里都懒得说了。</p>
<h3 id="_6-2-hash查询" tabindex="-1"><a class="header-anchor" href="#_6-2-hash查询" aria-hidden="true">#</a> 6.2 Hash查询</h3>
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>// 算法复杂度为 O(n)
@Test
public void test1(){
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>// 算法复杂度为 O(1)
@Test
public void test2(){
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql&gt; show variables like '%adaptive_hash_index';
...
<h3 id="_6-7-r树" tabindex="-1"><a class="header-anchor" href="#_6-7-r树" aria-hidden="true">#</a> 6.7 R树</h3>
...
<h3 id="_6-8-小结" tabindex="-1"><a class="header-anchor" href="#_6-8-小结" aria-hidden="true">#</a> 6.8 小结</h3>
