...
<h2 id="_1-物理备份与逻辑备份" tabindex="-1"><a class="header-anchor" href="#_1-物理备份与逻辑备份" aria-hidden="true">#</a> 1. 物理备份与逻辑备份</h2>
...
<h2 id="_2-mysqldump实现逻辑备份" tabindex="-1"><a class="header-anchor" href="#_2-mysqldump实现逻辑备份" aria-hidden="true">#</a> 2. mysqldump实现逻辑备份</h2>
<p>mysqldump是MySQL提供的一个非常有用的数据库备份工具。</p>
<h3 id="_2-1-备份一个数据库" tabindex="-1"><a class="header-anchor" href="#_2-1-备份一个数据库" aria-hidden="true">#</a> 2.1 备份一个数据库</h3>
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysqldump –u 用户名称 –h 主机名称 –p密码 待备份的数据库名称[tbname, [tbname...]]&gt; 备份文件名称.sql
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><blockquote>
<p>说明： 备份的文件并非一定要求后缀名为.sql，例如后缀名为.txt的文件也是可以的。</p>
</blockquote>
<p>举例：使用root用户备份atguigu数据库：</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysqldump -uroot -p atguigu&gt;atguigu.sql #备份文件存储在当前目录下
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysqldump -uroot -p atguigudb1 &gt; /var/lib/mysql/atguigu.sql
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>备份文件剖析：</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>-- MySQL dump 10.13 Distrib 8.0.26, for Linux (x86_64)
--
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysqldump -uroot -pxxxxxx --all-databases &gt; all_database.sql
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysqldump –u user –h host –p --databases [数据库的名称1 [数据库的名称2...]] &gt; 备份文件名称.sql
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>举例：</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysqldump -uroot -p --databases atguigu atguigu12 &gt;two_database.sql
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>或</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysqldump -uroot -p -B atguigu atguigu12 &gt; two_database.sql
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysqldump –u user –h host –p 数据库的名称 [表名1 [表名2...]] &gt; 备份文件名称.sql
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>举例：备份atguigu数据库下的book表</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysqldump -uroot -p atguigu book&gt; book.sql
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>book.sql文件内容如下</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysqldump -uroot -p atguigu book&gt; book.sql^C
[root@node1 ~]# ls
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>#备份多张表
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysqldump -uroot -p atguigu student --where=&quot;id &lt; 10 &quot; &gt; student_part_id10_low_bak.sql
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>内容如下所示，insert语句只有id小于10的部分</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>LOCK TABLES `student` WRITE;
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysqldump -uroot -p atguigu --ignore-table=atguigu.student &gt; no_stu_bak.sql
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>通过如下指定判定文件中没有student表结构：</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>grep &quot;student&quot; no_stu_bak.sql
...
<li>
<p>只备份结构</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysqldump -uroot -p atguigu --no-data &gt; atguigu_no_data_bak.sql
...
<li>
<p>只备份数据</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysqldump -uroot -p atguigu --no-create-info &gt; atguigu_no_create_info_bak.sql
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql&gt; SELECT SPECIFIC_NAME,ROUTINE_TYPE ,ROUTINE_SCHEMA FROM
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysqldump -uroot -p -R -E --databases atguigu &gt; fun_atguigu_bak.sql
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>查询备份文件中是否存在函数，如下所示，可以看到确实包含了函数。</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>grep -C 5 &quot;rand_num&quot; fun_atguigu_bak.sql
--
--
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>--add-drop-database：在每个CREATE DATABASE语句前添加DROP DATABASE语句。
...
<h2 id="_3-mysql命令恢复数据" tabindex="-1"><a class="header-anchor" href="#_3-mysql命令恢复数据" aria-hidden="true">#</a> 3. mysql命令恢复数据</h2>
...
<p>基本语法：</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql –u root –p [dbname] &lt; backup.sql
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql -uroot -p &lt; atguigu.sql
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>否则需要指定数据库名称，如下所示</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql -uroot -p atguigu4&lt; atguigu.sql
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql –u root –p &lt; all.sql
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql -uroot -pxxxxxx &lt; all.sql
...
<p>举例：</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>sed -n '/^-- Current Database: `atguigu`/,/^-- Current Database: `/p' all_database.sql &gt; atguigu.sql
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>cat atguigu.sql | sed -e '/./{H;$!d;}' -e 'x;/CREATE TABLE `class`/!d;q' &gt; class_structure.sql
...
<h2 id="_5-物理恢复-直接复制到数据库目录" tabindex="-1"><a class="header-anchor" href="#_5-物理恢复-直接复制到数据库目录" aria-hidden="true">#</a> 5. 物理恢复：直接复制到数据库目录</h2>
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>chown -R mysql.mysql /var/lib/mysql/dbname
...
<h2 id="_6-表的导出与导入" tabindex="-1"><a class="header-anchor" href="#_6-表的导出与导入" aria-hidden="true">#</a> 6. 表的导出与导入</h2>
<h3 id="_6-1-表的导出" tabindex="-1"><a class="header-anchor" href="#_6-1-表的导出" aria-hidden="true">#</a> 6.1 表的导出</h3>
<h4 id="_1-使用select-into-outfile导出文本文件" tabindex="-1"><a class="header-anchor" href="#_1-使用select-into-outfile导出文本文件" aria-hidden="true">#</a> 1. 使用SELECT…INTO OUTFILE导出文本文件</h4>
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>use atguigu;
select * from account;
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql&gt; SHOW GLOBAL VARIABLES LIKE '%secure%';
+--------------------------+-----------------------+
| Variable_name            | Value                 |
+--------------------------+-----------------------+
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>SELECT * FROM account INTO OUTFILE &quot;/var/lib/mysql-files/account.txt&quot;;
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>1 张三 90
2 李四 100
3 王五 0
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysqldump -uroot -p -T &quot;/var/lib/mysql-files/&quot; atguigu account
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>[root@node1 mysql-files]# cat account.sql
-- MySQL dump 10.13 Distrib 8.0.26, for Linux (x86_64)
--
-- Host: localhost Database: atguigu
-- ------------------------------------------------------
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>[root@node1 mysql-files]# cat account.txt
1 张三 90
2 李四 100
3 王五 0
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>举例2：</strong> 使用mysqldump将atguigu数据库中的account表导出到文本文件，使用FIELDS选项，要求字段之 间使用逗号“，”间隔，所有字符类型字段值用双引号括起来：</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysqldump -uroot -p -T &quot;/var/lib/mysql-files/&quot; atguigu account --fields-terminatedby=',' --fields-optionally-enclosed-by='\&quot;'
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql -uroot -p --execute=&quot;SELECT * FROM account;&quot; atguigu&gt; &quot;/var/lib/mysql-files/account.txt&quot;
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql -uroot -p --vertical --execute=&quot;SELECT * FROM account;&quot; atguigu &gt; &quot;/var/lib/mysql-files/account_1.txt&quot;
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>[root@node1 mysql-files]# cat account_1.txt
*************************** 1. row ***************************
id: 1
name: 张三
balance: 90
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql -uroot -p --xml --execute=&quot;SELECT * FROM account;&quot; atguigu&gt;&quot;/var/lib/mysqlfiles/account_3.xml&quot;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>[root@node1 mysql-files]# cat account_3.xml
&lt;?xml version=&quot;1.0&quot;?&gt;
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>SELECT * FROM atguigu.account INTO OUTFILE '/var/lib/mysql-files/account_0.txt';
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>删除account表中的数据：</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>DELETE FROM atguigu.account;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>从文本文件account.txt中恢复数据：</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>LOAD DATA INFILE '/var/lib/mysql-files/account_0.txt' INTO TABLE atguigu.account;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>查询account表中的数据：</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql&gt; select * from account;
+----+--------+---------+
| id | name   | balance |
+----+--------+---------+
| 1 | 张三     | 90      |
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>SELECT * FROM atguigu.account INTO OUTFILE '/var/lib/mysql-files/account_1.txt' FIELDS TERMINATED BY ',' ENCLOSED BY '\&quot;';
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>删除account表中的数据：</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>DELETE FROM atguigu.account;
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>LOAD DATA INFILE '/var/lib/mysql-files/account_1.txt' INTO TABLE atguigu.account FIELDS TERMINATED BY ',' ENCLOSED BY '\&quot;';
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>查询account表中的数据，具体SQL如下：</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>select * from account;
mysql&gt; select * from account;
+----+--------+---------+
| id | name   | balance |
+----+--------+---------+
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>SELECT * FROM atguigu.account INTO OUTFILE '/var/lib/mysql-files/account.txt' FIELDS TERMINATED BY ',' ENCLOSED BY '\&quot;';
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>删除account表中的数据：</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>DELETE FROM atguigu.account;
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysqlimport -uroot -p atguigu '/var/lib/mysql-files/account.txt' --fields-terminated-by=',' --fields-optionally-enclosed-by='\&quot;'
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>查询account表中的数据：</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>select * from account;
mysql&gt; select * from account;
+----+--------+---------+
...
<h3 id="_7-2-迁移方案" tabindex="-1"><a class="header-anchor" href="#_7-2-迁移方案" aria-hidden="true">#</a> 7.2 迁移方案</h3>
<ul>
<li>物理迁移</li>
</ul>
...
<h3 id="_7-3-迁移注意点" tabindex="-1"><a class="header-anchor" href="#_7-3-迁移注意点" aria-hidden="true">#</a> 7.3 迁移注意点</h3>
...
<p>举例：</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>#host1的机器中备份所有数据库,并将数据库迁移到名为host2的机器上
...
<h3 id="_8-2-truncate-drop-误删库-表" tabindex="-1"><a class="header-anchor" href="#_8-2-truncate-drop-误删库-表" aria-hidden="true">#</a> 8.2 truncate/drop ：误删库/表</h3>
...
<h3 id="_8-3-预防使用truncate-drop误删库-表" tabindex="-1"><a class="header-anchor" href="#_8-3-预防使用truncate-drop误删库-表" aria-hidden="true">#</a> 8.3 预防使用truncate/drop误删库/表</h3>
...
<h3 id="_8-4-rm-误删mysql实例" tabindex="-1"><a class="header-anchor" href="#_8-4-rm-误删mysql实例" aria-hidden="true">#</a> 8.4 rm：误删MySQL实例</h3>
