...
<h2 id="_1-数据库的存储结构-页" tabindex="-1"><a class="header-anchor" href="#_1-数据库的存储结构-页" aria-hidden="true">#</a> 1. 数据库的存储结构：页</h2>
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>show variables like '%innodb_page_size%'
...
<h3 id="第二部分-user-records-用户记录-、最大最小记录、free-space-空闲空间" tabindex="-1"><a class="header-anchor" href="#第二部分-user-records-用户记录-、最大最小记录、free-space-空闲空间" aria-hidden="true">#</a> 第二部分：User Records (用户记录)、最大最小记录、Free Space (空闲空间)</h3>
<p>见文件InnoDB数据库存储结构.mmap</p>
<h3 id="第三部分-page-directory-页目录-和-page-header-页面头部" tabindex="-1"><a class="header-anchor" href="#第三部分-page-directory-页目录-和-page-header-页面头部" aria-hidden="true">#</a> 第三部分：Page Directory (页目录) 和 Page Header (页面头部)</h3>
<p>见文件InnoDB数据库存储结构.mmap</p>
<h3 id="_2-3-从数据库页的角度看b-树如何查询" tabindex="-1"><a class="header-anchor" href="#_2-3-从数据库页的角度看b-树如何查询" aria-hidden="true">#</a> 2.3 从数据库页的角度看B+树如何查询</h3>
...
<h2 id="_3-innodb行格式-或记录格式" tabindex="-1"><a class="header-anchor" href="#_3-innodb行格式-或记录格式" aria-hidden="true">#</a> 3. InnoDB行格式 (或记录格式)</h2>
<p>见文件InnoDB数据库存储结构.mmap</p>
<h2 id="_4-区、段与碎片区" tabindex="-1"><a class="header-anchor" href="#_4-区、段与碎片区" aria-hidden="true">#</a> 4. 区、段与碎片区</h2>
<h3 id="_4-1-为什么要有区" tabindex="-1"><a class="header-anchor" href="#_4-1-为什么要有区" aria-hidden="true">#</a> 4.1 为什么要有区？</h3>
...
<h3 id="_4-2-为什么要有段" tabindex="-1"><a class="header-anchor" href="#_4-2-为什么要有段" aria-hidden="true">#</a> 4.2 为什么要有段？</h3>
...
<h3 id="_4-3-为什么要有碎片区" tabindex="-1"><a class="header-anchor" href="#_4-3-为什么要有碎片区" aria-hidden="true">#</a> 4.3 为什么要有碎片区？</h3>
...
<h3 id="_4-4-区的分类" tabindex="-1"><a class="header-anchor" href="#_4-4-区的分类" aria-hidden="true">#</a> 4.4 区的分类</h3>
<p>区大体上可以分为4种类型：</p>
<ul>
...
<h2 id="_5-表空间" tabindex="-1"><a class="header-anchor" href="#_5-表空间" aria-hidden="true">#</a> 5. 表空间</h2>
...
<h3 id="_5-1-独立表空间" tabindex="-1"><a class="header-anchor" href="#_5-1-独立表空间" aria-hidden="true">#</a> 5.1 独立表空间</h3>
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>show variables like 'innodb_file_per_table'
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>USE information_schema;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>SHOW TABLES LIKE 'innodb_sys%';
