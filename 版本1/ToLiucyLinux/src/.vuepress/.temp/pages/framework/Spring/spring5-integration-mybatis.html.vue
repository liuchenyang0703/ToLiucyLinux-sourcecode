...
<p>在我们之前的系列文章中，我们已经深入探讨了<a href="https://so.csdn.net/so/search?q=Spring5&amp;spm=1001.2101.3001.7020" target="_blank" rel="noopener noreferrer">Spring5<ExternalLinkIcon/></a>的两大核心组件：<a href="https://gaoziman.blog.csdn.net/article/details/131940061" target="_blank" rel="noopener noreferrer">IOC<ExternalLinkIcon/></a> 和 <a href="https://gaoziman.blog.csdn.net/article/details/132355403" target="_blank" rel="noopener noreferrer">AOP<ExternalLinkIcon/></a>，它们是Spring框架的基石。下面我们接着讨论开始讨论Spring5对于持久层框架MyBatis的整合，让我们一起开启新的的篇章吧。</p>
<h2 id="_2-准备工作" tabindex="-1"><a class="header-anchor" href="#_2-准备工作" aria-hidden="true">#</a> 2.准备工作</h2>
<p>在开始之前，确保您已经安装了以下软件：</p>
<ul>
<li>JDK 1.8或更高版本</li>
<li>Maven3.8+</li>
<li>Eclipse或IntelliJ IDEA（或您最喜欢的Java IDE）</li>
<li>MySQL8.0</li>
<li>MyBatis3.5</li>
</ul>
<h2 id="_3-为什么要整合持久层" tabindex="-1"><a class="header-anchor" href="#_3-为什么要整合持久层" aria-hidden="true">#</a> 3.为什么要整合持久层？</h2>
<p>Spring整合持久层的主要目的是为了简化和提高应用程序的开发和维护效率，以及提供更好的可扩展性和可测试性。以下是一些Spring整合持久层的好处：</p>
<ol>
<li><strong>降低开发复杂性</strong>：持久层是应用程序中一个重要的组成部分，负责数据的存储和访问。通过Spring整合持久层，可以使用Spring提供的一致的编程模型和API，简化数据库操作和事务管理的代码，减少开发人员的工作量和复杂性。</li>
<li><strong>提供事务管理：</strong> 持久层通常需要处理事务，确保数据的一致性和完整性。Spring提供了强大的事务管理功能，可以通过声明式事务管理或编程式事务管理来管理事务。整合持久层后，可以轻松地配置和管理事务，而无需手动编写繁琐的事务管理代码。</li>
<li><strong>支持多种持久化技术：</strong> Spring整合持久层提供了对多种持久化技术的支持，如关系型数据库（如MySQL、Oracle）、NoSQL数据库（如MongoDB、Redis）、对象关系映射（ORM）框架（如Hibernate、MyBatis）等。这使得开发人员可以根据项目需求选择合适的持久化技术，并无缝地集成到应用程序中。</li>
<li><strong>提供数据访问抽象层：</strong> Spring提供了一套数据访问抽象层，即Spring Data，它简化了对数据的访问和操作。通过Spring Data，可以使用简洁的API进行常见的数据访问操作，如查询、插入、更新和删除等。Spring Data还提供了对分页、排序、缓存等功能的支持，进一步提高了开发效率。</li>
<li><strong>支持依赖注入和面向切面编程：</strong> Spring的核心特性之一是依赖注入（DI）和面向切面编程（AOP）。通过整合持久层，可以将持久层组件作为Spring的bean进行管理，并通过依赖注入将其注入到其他组件中。同时，可以使用AOP功能来实现横切关注点，如日志记录、性能监控等。</li>
<li><strong>企业级应用的需求</strong>：在JavaEE的开发中，数据存储和管理是不可或缺的部分，尤其当涉及到大量的用户信息、交易记录、商品数据等。为了确保数据的一致性、安全性和高效性，我们需要一种可靠的方法来访问和操作数据库，这就是持久层的职责。</li>
</ol>
<p>综上所述，Spring整合持久层可以简化开发工作，提供事务管理、多种持久化技术的支持，提供数据访问抽象层，并支持依赖注入和面向切面编程。这些优势使得应用程序更易于开发、维护和扩展，提高了开发效率和代码质量。</p>
<h2 id="_4-spring能与哪些持久层技术整合" tabindex="-1"><a class="header-anchor" href="#_4-spring能与哪些持久层技术整合" aria-hidden="true">#</a> 4.Spring能与哪些持久层技术整合？</h2>
<p>Spring可以与多种持久层技术进行整合，包括但不限于以下几种：</p>
<ol>
<li><strong>JDBC：</strong> Spring提供了JdbcTemplate等工具类来简化JDBC的使用。它提供了一种更简单、更安全、更可靠的方式来执行SQL语句并处理结果集。</li>
<li><strong>ORM框架：</strong> Spring与多个ORM框架（对象关系映射）提供商进行了整合，包括Hibernate、MyBatis、JPA等。通过Spring的整合，可以使用ORM框架来简化数据库操作，提供对象级别的持久化。</li>
<li><strong>JPA(Java Persistence API)：</strong> Spring提供了对JPA的支持，可以通过配置和注解的方式来定义实体类与数据库表之间的映射关系，使用JPA进行对象的持久化操作。</li>
<li><strong>NoSQL数据库：</strong> Spring还可以与各种NoSQL数据库进行整合，如MongoDB、Redis、Cassandra等。通过Spring Data模块，可以使用统一的API和命名约定来进行数据访问和操作。</li>
<li><strong>Spring Data JPA：</strong> Spring Data JPA是Spring对JPA的扩展，提供了更高级的功能和更简化的API。它结合了Spring和JPA的特性，使得使用JPA更加便捷。</li>
<li><strong>Spring Data JDBC：</strong> Spring Data JDBC是Spring对JDBC的扩展，提供了一种更简单的方式来进行JDBC操作。它通过注解和命名约定来进行数据库表和实体类之间的映射，简化了JDBC的使用。</li>
<li><strong>Hibernate (JPA)：</strong> Hibernate是一个流行的ORM（对象关系映射）框架，而JPA（Java持久化API）是Java平台上的一个规范，Hibernate是JPA的一种实现。Spring为Hibernate提供了HibernateTemplate工具，它可以简化许多常见的Hibernate操作，并且为我们处理事务、会话等常见问题。使用Spring与Hibernate的整合，开发者可以轻松地将数据库记录映射到Java对象，并执行持久化操作。</li>
<li><strong>MyBatis：</strong> MyBatis是另一个流行的持久层框架，它允许开发者直接编写SQL，同时提供了灵活的结果映射功能。Spring为MyBatis提供了一系列工具，如SqlSessionFactoryBean和MapperScannerConfigurer，这些工具旨在简化MyBatis配置和使用过程。通过整合，开发者可以在Spring应用中方便地使用MyBatis的特性，同时享受Spring提供的事务管理、依赖注入等功能。</li>
</ol>
<p>总之，Spring可以与多种持久层技术进行整合，通过提供统一的API和工具类，简化了数据访问和持久化操作的开发工作。无论是关系型数据库还是NoSQL数据库，都可以方便地与Spring整合使用。</p>
<h2 id="_5-spring与mybatis整合步骤" tabindex="-1"><a class="header-anchor" href="#_5-spring与mybatis整合步骤" aria-hidden="true">#</a> 5.Spring与MyBatis整合步骤</h2>
<h3 id="_5-1-mybatis步骤回顾" tabindex="-1"><a class="header-anchor" href="#_5-1-mybatis步骤回顾" aria-hidden="true">#</a> 5.1 MyBatis步骤回顾</h3>
<p>MyBatis原生的开发一共有如下几个步骤</p>
<div class="language-markdown line-numbers-mode" data-ext="md"><pre v-pre class="language-markdown"><code>1.实体
2.实体别名
3.数据表
4.创建DAO接口
5.实现Mapper文件
6.注册Mapper文件
7.MyBatisAPI的调用
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_5-2-整合步骤" tabindex="-1"><a class="header-anchor" href="#_5-2-整合步骤" aria-hidden="true">#</a> 5.2 整合步骤</h3>
<h4 id="_1-创建maven项目" tabindex="-1"><a class="header-anchor" href="#_1-创建maven项目" aria-hidden="true">#</a> 1.创建Maven项目</h4>
<p>首先，我们需要创建一个Maven项目。打开IDEA，选择自己的工作目录，点击确定即可：</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/Leo100/202310192118524.png" alt="image-20231019211823353" tabindex="0" loading="lazy"><figcaption>image-20231019211823353</figcaption></figure>
<p>创建一个名为<code v-pre>Leo-spring-mybatis</code>的新Maven项目。</p>
<h4 id="_2-添加依赖项" tabindex="-1"><a class="header-anchor" href="#_2-添加依赖项" aria-hidden="true">#</a> 2.添加依赖项</h4>
<p>打开<code v-pre>pom.xml</code>文件，并添加以下依赖项：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这些依赖项将添加所需的Spring和MyBatis库以及MySQL数据库驱动程序。</p>
<h4 id="_3-配置配置文件" tabindex="-1"><a class="header-anchor" href="#_3-配置配置文件" aria-hidden="true">#</a> 3.配置配置文件</h4>
<p>在<code v-pre>src/main/resources</code>目录下创建一个名为<code v-pre>mybatis-config.xml</code>的新文件，并添加以下内容：</p>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>configuration</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在这个文件中，我们配置了一个<code v-pre>dataSource</code> bean，它使用MySQL数据库的连接信息。然后，我们配置了一个<code v-pre>sqlSessionFactory</code> bean，它使用<code v-pre>dataSource</code> bean并指定了MyBatis映射文件的位置。最后，我们配置了一个<code v-pre>sqlSession</code> bean，它使用<code v-pre>sqlSessionFactory</code> bean。</p>
<h4 id="_4-创建数据库表以及实体类" tabindex="-1"><a class="header-anchor" href="#_4-创建数据库表以及实体类" aria-hidden="true">#</a> 4.创建数据库表以及实体类</h4>
<p><code v-pre>SQL语句</code></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在<code v-pre>src/main/java/com/integration</code>目录下创建一个名为<code v-pre>User.java</code>的新Java类，并添加以下内容：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">org<span class="token punctuation">.</span>javatop<span class="token punctuation">.</span>integration</span><span class="token punctuation">;</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">User</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这是一个简单的User类，它包含id、name和email字段，并提供了相应的getter和setter方法以及toString方法。</p>
<h4 id="_5-创建数据访问对象-mapper" tabindex="-1"><a class="header-anchor" href="#_5-创建数据访问对象-mapper" aria-hidden="true">#</a> 5.创建数据访问对象(mapper)</h4>
<p>在<code v-pre>src/main/java/com/integration</code>目录下创建一个名为<code v-pre>UserDao.java</code>的新Java接口，并添加以下内容：</p>
...
<h4 id="_6-创建mybatis映射文件" tabindex="-1"><a class="header-anchor" href="#_6-创建mybatis映射文件" aria-hidden="true">#</a> 6.创建MyBatis映射文件</h4>
<p>在<code v-pre>src/main/resources/org/javatop/integration/mapper</code>目录下创建一个名为<code v-pre>UserMapper.xml</code>的新文件，并添加以下内容：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这个文件定义了一些SQL语句，用于查询、插入、更新和删除用户数据。</p>
<h4 id="_7-测试应用程序" tabindex="-1"><a class="header-anchor" href="#_7-测试应用程序" aria-hidden="true">#</a> 7.测试应用程序</h4>
<p>在<code v-pre>test/org/javatop/</code>目录下创建TestMyBatis测试类编写测试方法</p>
...
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/Leo100/202310192212859.png" alt="image-20231019221207683" tabindex="0" loading="lazy"><figcaption>image-20231019221207683</figcaption></figure>
<h3 id="_5-3-结论" tabindex="-1"><a class="header-anchor" href="#_5-3-结论" aria-hidden="true">#</a> 5.3 结论</h3>
<p>我们详细介绍了如何使用Spring 5整合MyBatis框架来构建一个完整的Java应用程序。我们学习了如何配置Spring和MyBatis，创建数据模型，实现数据访问对象和服务层，以及创建控制器来处理HTTP请求。最后，我们测试了应用程序的不同功能。希望这篇博客对您有所帮助！</p>
<h3 id="_5-4-原生mybatis存在的问题配置繁琐" tabindex="-1"><a class="header-anchor" href="#_5-4-原生mybatis存在的问题配置繁琐" aria-hidden="true">#</a> 5.4 原生MyBatis存在的问题配置繁琐：</h3>
<ol>
<li><strong>实体别名注册：</strong> 在MyBatis中，为每个实体类定义别名可以使XML映射文件中的代码更加简洁。但当有大量实体类时，手动为每一个实体类设置别名会非常繁琐。</li>
<li>M<strong>apper文件注册：</strong> 在配置MyBatis时，我们需要为每个Mapper XML文件进行注册，这使得配置文件变得冗长，难以管理。<br>
包扫描：虽然现代版本的MyBatis提供了package属性来自动扫描别名，但在之前的版本中这是不支持的，增加了使用的复杂性。<br>
代码冗余：</li>
<li><strong>API调用：</strong> 在使用MyBatis API进行数据库操作时，我们往往需要执行多个步骤，包括获取SqlSession、执行操作、处理异常和关闭SqlSession等。这些操作在每次数据库访问时都需要重复，导致代码冗余。</li>
<li><strong>资源管理：</strong> 虽然MyBatis为我们提供了资源的自动管理，但在某些情况下，开发者仍需要手动管理数据库连接、会话等资源，这增加了开发的复杂性。</li>
<li><strong>异常处理：</strong> 在使用MyBatis进行数据库操作时，可能会抛出多种异常。处理这些异常需要额外的代码，使得主逻辑变得不那么清晰。</li>
</ol>
