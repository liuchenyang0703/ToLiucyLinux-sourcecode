<template><div><h2 id="_1-静态代理设计模式" tabindex="-1"><a class="header-anchor" href="#_1-静态代理设计模式" aria-hidden="true">#</a> 1. 静态代理设计模式</h2>
<h3 id="_1-1-为什么需要代理设计模式" tabindex="-1"><a class="header-anchor" href="#_1-1-为什么需要代理设计模式" aria-hidden="true">#</a> 1.1 为什么需要代理设计模式</h3>
<ul>
<li>
<p>在JavaEE分层开发开发中，那个层次对于我们来讲最重要</p>
<div class="language-markdown line-numbers-mode" data-ext="md"><pre v-pre class="language-markdown"><code>DAO ---> Service --> Controller 

JavaEE分层开发中，最为重要的是Service层
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li>
<li>
<p>Service层中包含了哪些代码？</p>
<div class="language-markdown line-numbers-mode" data-ext="md"><pre v-pre class="language-markdown"><code>Service层中 = 核心功能(几十行 上百代码) + 额外功能(附加功能)
...
<p>Controller层（Service层的调用者）除了需要核心功能，还需要这些额外功能。</p>
<p>但是从软件设计者角度看：Service层最好不要写额外功能。</p>
</li>
<li>
<p>现实生活中的解决方式</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/cisyam/202308151115949.png" alt="image-20230815111510825" tabindex="0" loading="lazy"><figcaption>image-20230815111510825</figcaption></figure>
</li>
</ul>
<p>代理模式是一种比较好理解的<code v-pre>设计模式</code>。简单来说就是 我们使用代理对象来代替对真实对象(real object)的访问，这样就可以在不修改原目标对象的前提下，提供额外的功能操作，扩展目标对象的功能。</p>
<p>代理模式的主要作用是扩展<code v-pre>目标对象</code>的功能，比如说在目标对象的某个方法执行前后你可以增加一些自定义的操作。</p>
<blockquote>
<p>代理模式: 为一个对象提供一个替身，以控制对这个对象的访问。即通过代理对象访问目标对象.这样做的好处是:可以在目标对象实现的基础上,增强额外的功能操作,即扩展目标对象的功能。</p>
<p>被代理的对象可以是<code v-pre>远程对象</code>、创建开销大的对象或需要安全控制的对象</p>
</blockquote>
<p>举个例子：当我们工作之后需要出去租房子，房东张贴广告带我看房子，最后签合同，但是房东只想坐着签合同并不想到处跑着看房子，于是就找了一个中介专门来宣传广告并且带租户看房子，而房东只负责签合同收钱！中介在这里就可以看作是代理你的<code v-pre>代理对象</code>，<code v-pre>代理的行为（方法）</code>是带租户看房子。</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/cisyam/202308151116886.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<h3 id="_1-2-代理设计模式分析" tabindex="-1"><a class="header-anchor" href="#_1-2-代理设计模式分析" aria-hidden="true">#</a> 1.2 代理设计模式分析</h3>
<h4 id="_2-1-概念" tabindex="-1"><a class="header-anchor" href="#_2-1-概念" aria-hidden="true">#</a> 2.1 概念</h4>
<p>通过代理类，为原始类（目标）增加额外的功能 好处：利于原始类(目标)的维护</p>
<h4 id="_2-2-名词解释" tabindex="-1"><a class="header-anchor" href="#_2-2-名词解释" aria-hidden="true">#</a> 2.2 名词解释</h4>
<div class="language-markdown line-numbers-mode" data-ext="md"><pre v-pre class="language-markdown"><code><span class="token list punctuation">1.</span> 目标类 原始类 
   指的是 业务类 (核心功能 --> 业务运算 DAO调用)
<span class="token list punctuation">2.</span> 目标方法，原始方法
   目标类(原始类)中的方法 就是目标方法(原始方法)
<span class="token list punctuation">3.</span> 额外功能 (附加功能)
   日志，事务，性能
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_2-3-代理开发的核心要素" tabindex="-1"><a class="header-anchor" href="#_2-3-代理开发的核心要素" aria-hidden="true">#</a> 2.3 代理开发的核心要素</h4>
<div class="language-markdown line-numbers-mode" data-ext="md"><pre v-pre class="language-markdown"><code>代理类 = 实现和目标类相同的接口 + 在同名方法中添加额外功能 + 调用原始类同名方法
...
房东 ---> public interface UserService{
          ...
          UserServiceProxy implements UserService
               m1
               m2
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_2-4-编码" tabindex="-1"><a class="header-anchor" href="#_2-4-编码" aria-hidden="true">#</a> 2.4 编码</h4>
<p><strong>静态代理</strong>：为每一个原始类，手动编写一个代理类 (.java .class)</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/cisyam/202308151122402.png" alt="image-20230815112248257" tabindex="0" loading="lazy"><figcaption>image-20230815112248257</figcaption></figure>
<h4 id="_2-5-静态代理存在的问题" tabindex="-1"><a class="header-anchor" href="#_2-5-静态代理存在的问题" aria-hidden="true">#</a> 2.5 静态代理存在的问题</h4>
<div class="language-markdown line-numbers-mode" data-ext="md"><pre v-pre class="language-markdown"><code><span class="token list punctuation">1.</span> 静态类文件数量过多，不利于项目管理
   UserServiceImpl  UserServiceProxy
   OrderServiceImpl OrderServiceProxy
<span class="token list punctuation">2.</span> 额外功能维护性差
   代理类中 额外功能修改复杂(麻烦)
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2-spring的动态代理开发" tabindex="-1"><a class="header-anchor" href="#_2-spring的动态代理开发" aria-hidden="true">#</a> 2. Spring的动态代理开发</h2>
<h3 id="_2-1-spring动态代理的概念" tabindex="-1"><a class="header-anchor" href="#_2-1-spring动态代理的概念" aria-hidden="true">#</a> 2.1 Spring动态代理的概念</h3>
<blockquote>
<p>概念：通过<code v-pre>代理类</code>为原始类(目标类)增加额外功能,代理类由Spring动态生成。<br>
好处：利于<code v-pre>原始类</code>(目标类)的维护</p>
</blockquote>
<h3 id="_2-2-搭建开发环境" tabindex="-1"><a class="header-anchor" href="#_2-2-搭建开发环境" aria-hidden="true">#</a> 2.2 搭建开发环境</h3>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>dependency</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-3-spring动态代理的开发步骤" tabindex="-1"><a class="header-anchor" href="#_2-3-spring动态代理的开发步骤" aria-hidden="true">#</a> 2.3 Spring动态代理的开发步骤</h3>
<h4 id="_1-创建原始对象-目标对象" tabindex="-1"><a class="header-anchor" href="#_1-创建原始对象-目标对象" aria-hidden="true">#</a> 1. 创建原始对象(目标对象)</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_2-定义额外功能" tabindex="-1"><a class="header-anchor" href="#_2-定义额外功能" aria-hidden="true">#</a> 2. 定义额外功能</h4>
<p><strong>实现MethodBeforeAdvice接口</strong></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_3-定义切入点" tabindex="-1"><a class="header-anchor" href="#_3-定义切入点" aria-hidden="true">#</a> 3. 定义切入点</h4>
<div class="language-markdown line-numbers-mode" data-ext="md"><pre v-pre class="language-markdown"><code><span class="token list punctuation">1.</span> 切入点：额外功能加入的位置
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span><span class="token namespace">aop:</span>config</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_4-组装" tabindex="-1"><a class="header-anchor" href="#_4-组装" aria-hidden="true">#</a> 4.  组装</h4>
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code><span class="token comment">&lt;!-- 组装切入点与额外功能 --></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_5-测试调用" tabindex="-1"><a class="header-anchor" href="#_5-测试调用" aria-hidden="true">#</a> 5.  测试调用</h4>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>目的：获得<span class="token class-name">Spring</span>工厂创建的动态代理对象，并进行调用
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>控制台打印：</strong>  可以发现在日志之前输入了</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/cisyam/202308151144512.png" alt="image-20230815114453445" tabindex="0" loading="lazy"><figcaption>image-20230815114453445</figcaption></figure>
<h3 id="_2-4-动态代理细节分析" tabindex="-1"><a class="header-anchor" href="#_2-4-动态代理细节分析" aria-hidden="true">#</a> 2.4 动态代理细节分析</h3>
<h4 id="_4-1-spring创建的动态代理类在哪里" tabindex="-1"><a class="header-anchor" href="#_4-1-spring创建的动态代理类在哪里" aria-hidden="true">#</a> 4.1 Spring创建的动态代理类在哪里？</h4>
<blockquote>
<p>Spring框架在运行时，通过动态字节码技术，在JVM创建的，运行在JVM内部，等程序结束后就消失了。</p>
...
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/202305291502334.png" alt="image-20200423165547079" tabindex="0" loading="lazy"><figcaption>image-20200423165547079</figcaption></figure>
<h4 id="_4-2-动态代理编程简化代理的开发" tabindex="-1"><a class="header-anchor" href="#_4-2-动态代理编程简化代理的开发" aria-hidden="true">#</a> 4.2 动态代理编程简化代理的开发</h4>
<blockquote>
<p>在额外功能不改变的前提下，创建其他目标类（原始类）的代理对象时，只需要指定原始(目标)对象即可。</p>
</blockquote>
<h2 id="_3-spring动态代理详解" tabindex="-1"><a class="header-anchor" href="#_3-spring动态代理详解" aria-hidden="true">#</a> 3. Spring动态代理详解</h2>
<h3 id="_3-1-额外功能的详解" tabindex="-1"><a class="header-anchor" href="#_3-1-额外功能的详解" aria-hidden="true">#</a> 3.1 额外功能的详解</h3>
<ul>
<li>
<p>MethodBeforeAdvice分析</p>
<p>作用：<code v-pre>原始方法执行之前，运行额外功能。</code></p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Before</span> <span class="token keyword">implements</span> <span class="token class-name">MethodBeforeAdvice</span> <span class="token punctuation">{</span>
...
<p>实战：需要时才用，可能都会用到，也有可能都不用。</p>
<ul>
<li>
<p>MethodInterceptor(方法拦截器)</p>
<p><code v-pre>MethodInterceptor</code>接口：额外功能可定义在原始方法执行 前、后、前和后。</p>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>  <span class="token keyword">public</span> <span class="token class-name">Object</span> <span class="token function">invoke</span><span class="token punctuation">(</span><span class="token class-name">MethodInvocation</span> invocation<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">Throwable</span> <span class="token punctuation">{</span>
    ...
    <span class="token keyword">return</span> ret<span class="token punctuation">;</span>
  <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>额外功能运行在原始方法执行之前和之后（实战：事务需要在之前和之后都运行）</p>
...
<span class="token keyword">public</span> <span class="token class-name">Object</span> <span class="token function">invoke</span><span class="token punctuation">(</span><span class="token class-name">MethodInvocation</span> invocation<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">Throwable</span> <span class="token punctuation">{</span>
  ...
  <span class="token keyword">return</span> ret<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>额外功能运行在原始方法抛出异常时</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>  <span class="token annotation punctuation">@Override</span>
<span class="token keyword">public</span> <span class="token class-name">Object</span> <span class="token function">invoke</span><span class="token punctuation">(</span><span class="token class-name">MethodInvocation</span> invocation<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">Throwable</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-2-切入点详解" tabindex="-1"><a class="header-anchor" href="#_3-2-切入点详解" aria-hidden="true">#</a> 3.2 切入点详解</h3>
<p>切入点决定了额外功能加入的位置。</p>
...
1. execution()  切入点函数
2. * *(..)      切入点表达式 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_1-切入点表达式" tabindex="-1"><a class="header-anchor" href="#_1-切入点表达式" aria-hidden="true">#</a> 1.  切入点表达式</h4>
<ul>
<li>
<p>方法切入点表达式：</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/202305291502578.png" alt="image-20200425105040237" tabindex="0" loading="lazy"><figcaption>image-20200425105040237</figcaption></figure>
<div class="language-markdown line-numbers-mode" data-ext="md"><pre v-pre class="language-markdown"><code><span class="token list punctuation">*</span>  *(..)  --> 所有方法
...
<p>举例：</p>
<div class="language-markdown line-numbers-mode" data-ext="md"><pre v-pre class="language-markdown"><code>  <span class="token title important"><span class="token punctuation">#</span> 定义login方法作为切入点</span>
...
<li>
<p>类切入点表达式：</p>
<p>指定特定的类作为切入点，即这个类中所有的方法都会加上额外功能。</p>
<p>举例：</p>
<div class="language-markdown line-numbers-mode" data-ext="md"><pre v-pre class="language-markdown"><code><span class="token title important"><span class="token punctuation">#</span> 类中的所有方法都加入额外功能 </span>
...
<li>
<p>包切入点表达式：</p>
<p>指定包作为切入点，即这个包中的所有类及其方法都会加入额外的功能。</p>
<p>举例：</p>
<div class="language-markdown line-numbers-mode" data-ext="md"><pre v-pre class="language-markdown"><code><span class="token title important"><span class="token punctuation">#</span> proxy包作为切入点，即proxy包下所有类中的所有方法都会加入额外功能，但是不包括其子包中的类！</span>
...
<h4 id="_2-切入点函数" tabindex="-1"><a class="header-anchor" href="#_2-切入点函数" aria-hidden="true">#</a> 2 切入点函数</h4>
<p>作用：用于执行切入点表达式。</p>
<ol>
<li>
<p><code v-pre>execution()</code></p>
<div class="language-markdown line-numbers-mode" data-ext="md"><pre v-pre class="language-markdown"><code>最为重要的切入点函数，功能最全！
...
<li>
<p><code v-pre>args()</code></p>
<div class="language-markdown line-numbers-mode" data-ext="md"><pre v-pre class="language-markdown"><code><span class="token title important"><span class="token punctuation">#</span> 作用：用于函数(方法)参数的匹配</span>
...
<li>
<p><code v-pre>within()</code></p>
<div class="language-markdown line-numbers-mode" data-ext="md"><pre v-pre class="language-markdown"><code><span class="token title important"><span class="token punctuation">#</span> 作用：用于进行类、包切入点表达式的匹配</span>
...
<li>
<p><code v-pre>@annotation()</code></p>
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code><span class="token comment">&lt;!-- 作用：为具有特殊注解的方法加入额外功能 --></span>
...
<li>
<p>切入点函数间的逻辑运算：</p>
<p>目的：整合多个切入点函数一起配合工作，进而完成更为复杂的需求。</p>
<ul>
<li>
<p>and 与操作（同时满足）</p>
<div class="language-markdown line-numbers-mode" data-ext="md"><pre v-pre class="language-markdown"><code><span class="token title important"><span class="token punctuation">#</span> 案例：方法名为login，同时有2个字符串类型的参数：</span>
...
<li>
<p>or 或操作（满足一种即可）</p>
<div class="language-markdown line-numbers-mode" data-ext="md"><pre v-pre class="language-markdown"><code>   <span class="token title important"><span class="token punctuation">#</span> 案例：register方法 和 login方法作为切入点 </span>
...
<h2 id="_4-aop编程" tabindex="-1"><a class="header-anchor" href="#_4-aop编程" aria-hidden="true">#</a> 4. AOP编程</h2>
<h3 id="_4-1-aop概念" tabindex="-1"><a class="header-anchor" href="#_4-1-aop概念" aria-hidden="true">#</a> 4.1 AOP概念</h3>
<div class="language-markdown line-numbers-mode" data-ext="md"><pre v-pre class="language-markdown"><code><span class="token title important"><span class="token punctuation">#</span> AOP (Aspect Oriented Programing)   面向切面编程 = Spring动态代理开发</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-2-aop编程的开发步骤" tabindex="-1"><a class="header-anchor" href="#_4-2-aop编程的开发步骤" aria-hidden="true">#</a> 4.2 AOP编程的开发步骤</h3>
<ol>
<li>原始对象</li>
...
<h3 id="_4-3-切面的名词解释" tabindex="-1"><a class="header-anchor" href="#_4-3-切面的名词解释" aria-hidden="true">#</a> 4.3 切面的名词解释</h3>
<div class="language-markdown line-numbers-mode" data-ext="md"><pre v-pre class="language-markdown"><code>切面 = 切入点 + 额外功能 

几何学
   面 = 点 + 相同的性质
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/202305291503173.png" alt="image-20230529150312064" tabindex="0" loading="lazy"><figcaption>image-20230529150312064</figcaption></figure>
<h2 id="_5-aop的底层实现原理" tabindex="-1"><a class="header-anchor" href="#_5-aop的底层实现原理" aria-hidden="true">#</a> 5. AOP的底层实现原理</h2>
<h3 id="_5-1-核心问题" tabindex="-1"><a class="header-anchor" href="#_5-1-核心问题" aria-hidden="true">#</a> 5.1 核心问题</h3>
<ul>
<li>AOP如何创建动态代理类？(动态字节码技术)</li>
<li>Spring工厂如何加工创建代理对象？通过原始对象的id值，获得的是代理对象。</li>
</ul>
<h3 id="_5-2-动态代理类的创建" tabindex="-1"><a class="header-anchor" href="#_5-2-动态代理类的创建" aria-hidden="true">#</a> 5.2 动态代理类的创建</h3>
<h4 id="_1-jdk的动态代理" tabindex="-1"><a class="header-anchor" href="#_1-jdk的动态代理" aria-hidden="true">#</a> 1. JDK的动态代理</h4>
<ul>
<li>
<p><code v-pre>Proxy.newProxyInstance()</code>方法参数详解:</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/202305291502314.png" alt="image-20200428175248912" tabindex="0" loading="lazy"><figcaption>image-20200428175248912</figcaption></figure>
</li>
</ul>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/202305291502410.png" alt="image-20200428175316276" tabindex="0" loading="lazy"><figcaption>image-20200428175316276</figcaption></figure>
<ul>
<li>
<p>编码：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">TestJDKProxy</span> <span class="token punctuation">{</span>
...
<h4 id="_2-cglib的动态代理" tabindex="-1"><a class="header-anchor" href="#_2-cglib的动态代理" aria-hidden="true">#</a> 2. CGlib的动态代理</h4>
<ul>
<li>原理：通过父子继承关系创建代理对象。原始类作为父类，代理类作为子类，这样既可以保证2者方法一致，同时在代理类中提供新的实现(额外功能+原始方法)</li>
</ul>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/202305291502484.png" alt="image-20200429111709226" tabindex="0" loading="lazy"><figcaption>image-20200429111709226</figcaption></figure>
<ul>
<li>
<p>CGlib编码：</p>
...
<div class="language-markdown line-numbers-mode" data-ext="md"><pre v-pre class="language-markdown"><code><span class="token list punctuation">1.</span> JDK动态代理   Proxy.newProxyInstance()  
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_5-3-spring工厂如何返回代理对象" tabindex="-1"><a class="header-anchor" href="#_5-3-spring工厂如何返回代理对象" aria-hidden="true">#</a> 5.3 Spring工厂如何返回代理对象</h3>
<ul>
<li>思路分析：</li>
</ul>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/202305291503338.png" alt="image-20200430113353205" tabindex="0" loading="lazy"><figcaption>image-20200430113353205</figcaption></figure>
<ul>
<li>
<p>编码模拟：</p>
...
<h2 id="_6-基于注解的aop编程" tabindex="-1"><a class="header-anchor" href="#_6-基于注解的aop编程" aria-hidden="true">#</a> 6. 基于注解的AOP编程</h2>
<h3 id="_6-1-开发步骤" tabindex="-1"><a class="header-anchor" href="#_6-1-开发步骤" aria-hidden="true">#</a> 6.1 开发步骤：</h3>
<ol>
<li>
<p>原始对象</p>
</li>
...
<h3 id="_6-2-细节分析" tabindex="-1"><a class="header-anchor" href="#_6-2-细节分析" aria-hidden="true">#</a> 6.2 细节分析：</h3>
<ul>
<li>
<p>切入点复用：</p>
...
<li>
<p>动态代理的创建方式：</p>
<div class="language-markdown line-numbers-mode" data-ext="md"><pre v-pre class="language-markdown"><code>AOP底层实现  2种代理创建方式
...
<h2 id="_7-aop开发中的一个坑" tabindex="-1"><a class="header-anchor" href="#_7-aop开发中的一个坑" aria-hidden="true">#</a> 7. AOP开发中的一个坑</h2>
<p>坑：在同一个业务类中，业务方法间相互调用时，只有最外层的方法,加入了额外功能(内部的方法，通过普通的方式调用，运行的都是原始方法)。如果想让内层的方法也调用代理对象的方法，就要实现AppicationContextAware获得工厂，进而获得代理对象。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">UserServiceImpl</span> <span class="token keyword">implements</span> <span class="token class-name">UserService</span><span class="token punctuation">,</span> <span class="token class-name">ApplicationContextAware</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_8-aop阶段知识总结" tabindex="-1"><a class="header-anchor" href="#_8-aop阶段知识总结" aria-hidden="true">#</a> 8. AOP阶段知识总结</h2>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/cisyam/202308180944260.png" alt="AOP 总结" tabindex="0" loading="lazy"><figcaption>AOP 总结</figcaption></figure>
