<template><div><figure><img src="https://img-blog.csdnimg.cn/direct/ac9849a85ee448d3830389d1d2646d91.jpeg" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<blockquote>
...
<h1 id="一、pipeline-流水线的简介" tabindex="-1"><a class="header-anchor" href="#一、pipeline-流水线的简介" aria-hidden="true">#</a> 一、Pipeline 流水线的简介</h1>
<h2 id="_1-1-什么是jenkins的流水线" tabindex="-1"><a class="header-anchor" href="#_1-1-什么是jenkins的流水线" aria-hidden="true">#</a> 1.1 什么是Jenkins的流水线？</h2>
...
<h2 id="_1-2-pipeline中几个重要概念" tabindex="-1"><a class="header-anchor" href="#_1-2-pipeline中几个重要概念" aria-hidden="true">#</a> 1.2 Pipeline中几个重要概念：</h2>
<blockquote>
<ul>
...
<h2 id="_1-3-pipeline优势" tabindex="-1"><a class="header-anchor" href="#_1-3-pipeline优势" aria-hidden="true">#</a> 1.3 Pipeline优势</h2>
...
<h1 id="二、pipeline流水线-简单的构建" tabindex="-1"><a class="header-anchor" href="#二、pipeline流水线-简单的构建" aria-hidden="true">#</a> 二、Pipeline流水线 简单的构建</h1>
...
<h2 id="_2-1-jenkinsfile-必备的五个组成部分" tabindex="-1"><a class="header-anchor" href="#_2-1-jenkinsfile-必备的五个组成部分" aria-hidden="true">#</a> 2.1 jenkinsfile 必备的五个组成部分</h2>
...
<h2 id="_2-2-jenkins-上创建一个-pipeline-流水线任务" tabindex="-1"><a class="header-anchor" href="#_2-2-jenkins-上创建一个-pipeline-流水线任务" aria-hidden="true">#</a> 2.2 Jenkins 上创建一个 Pipeline 流水线任务</h2>
<h3 id="_2-2-1-jenkins-上安装blue-ocean插件" tabindex="-1"><a class="header-anchor" href="#_2-2-1-jenkins-上安装blue-ocean插件" aria-hidden="true">#</a> 2.2.1 Jenkins 上安装Blue Ocean插件</h3>
<p>找到插件商场；</p>
<p>Manage Jenkins --&gt; Plugins --&gt; 点击Available plugins ：搜索Blue Ocean --&gt; 点击安装</p>
<figure><img src="https://img-blog.csdnimg.cn/direct/7922e54a0b5e418f89627cca8bb03c2e.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<figure><img src="https://img-blog.csdnimg.cn/direct/b1307fff15824137b0a0afe6ec6ecedf.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>因为我这里已经安装了，就从installed里面截图了。找到<code v-pre>Blue Ocean</code>点击安装。</p>
<figure><img src="https://img-blog.csdnimg.cn/direct/64b7b7eebc334439974b3c305f593585.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<figure><img src="https://img-blog.csdnimg.cn/direct/749a8c3407634b80acccbc7265583c4f.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>等待安装完重启jenkins；重启完之后就可以在首页中的左侧看到<code v-pre>打开Blue Ocean</code>了；</p>
<figure><img src="https://img-blog.csdnimg.cn/direct/aedc44abe17f490fb049814303faae6a.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>然后我们新建一个流水线任务；</p>
<h3 id="_2-2-2-新建一个-pipeline-任务" tabindex="-1"><a class="header-anchor" href="#_2-2-2-新建一个-pipeline-任务" aria-hidden="true">#</a> 2.2.2 新建一个 Pipeline 任务</h3>
<p>点击新建Item -- &gt; 选中Pipeline，输入一个任务名称；</p>
<figure><img src="https://img-blog.csdnimg.cn/direct/b6891318d6c9466eb821fdefe65864f6.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>自己定义一下描述即可；</p>
<figure><img src="https://img-blog.csdnimg.cn/direct/922d184f9cca420a8cbaa846982f3f08.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<h3 id="_2-2-3-编辑流水线" tabindex="-1"><a class="header-anchor" href="#_2-2-3-编辑流水线" aria-hidden="true">#</a> 2.2.3 编辑流水线</h3>
<figure><img src="https://img-blog.csdnimg.cn/direct/9b14b31a582d4e94a57f152ba559b27d.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>鉴于对新手不太友好，我们这里先看看，然后使用<code v-pre>Hello World脚本生成</code>；生成Groovy脚本；</p>
<figure><img src="https://img-blog.csdnimg.cn/direct/110d6fa0893d492db80381a87cd6e1d7.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>默认会生成一个<code v-pre>Hello World脚本</code>，可以看到应用到了上面说的Jenkinsfile必备的五个组成部分；其他的就可以自行添加了，我们先来测试；</p>
<h3 id="_2-2-4-保存并构建流水线" tabindex="-1"><a class="header-anchor" href="#_2-2-4-保存并构建流水线" aria-hidden="true">#</a> 2.2.4 保存并构建流水线</h3>
<ul>
<li>直接点击保存 --&gt; 然后build构建</li>
</ul>
<figure><img src="https://img-blog.csdnimg.cn/direct/47f33a7f835044439907f1bad56fee5a.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<figure><img src="https://img-blog.csdnimg.cn/direct/c7188daf5e8a4149915f429dafb0d368.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
...
<figure><img src="https://img-blog.csdnimg.cn/direct/6fba362a143d4a47a8010b702f4ef6f7.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>SUCCESS表示执行完成，没有报错：</p>
<figure><img src="https://img-home.csdnimg.cn/images/20230724024159.png?origin_url=C%3A\Users\user\AppData\Roaming\Typora\typora-user-images\image-20231213153516936.png&amp;pos_id=img-ogG1S0Me-1710232718085" alt="外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传" tabindex="0" loading="lazy"><figcaption>外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传</figcaption></figure>
<p>我们执行完也可以看一下阶段视图</p>
<figure><img src="https://img-blog.csdnimg.cn/direct/2a11852389c34a5bb74efd3eded8b3d0.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>这样一个简单的流水线就构建成功了，可视化我们可以点击左侧的 <code v-pre>打开Blue Ocean</code>，就可以看到刚刚执行的流程；</p>
<figure><img src="https://img-blog.csdnimg.cn/direct/b358898dcccb4b98aa098c15e9555ab6.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<figure><img src="https://img-blog.csdnimg.cn/direct/7acf02978b2e4139865bc505c9ecb83a.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<figure><img src="https://img-blog.csdnimg.cn/direct/72429b0af8374b2bb45d442b6c38fecd.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>这样就可以看到可视化执行过程了，当然因为这个是只有一个<code v-pre>stage</code>所以看着不是很清晰，后面我们会添加更多的<code v-pre>stage</code>，这时候的可视化过程就发挥到了他的作用了。</p>
<h1 id="三、pipeline流水线-声明式语法解析" tabindex="-1"><a class="header-anchor" href="#三、pipeline流水线-声明式语法解析" aria-hidden="true">#</a> 三、Pipeline流水线 声明式语法解析</h1>
<p>可参考：</p>
<p><a href="https://liucy.blog.csdn.net/article/details/136528857" target="_blank" rel="noopener noreferrer">【Jenkins】Pipeline流水线语法解析全集 -- 声明式流水线<ExternalLinkIcon/></a></p>
<p><a href="https://liucy.blog.csdn.net/article/details/136567517" target="_blank" rel="noopener noreferrer">【Jenkins】Pipeline流水线语法解析全集 -- 脚本式流水线、groovy语法<ExternalLinkIcon/></a></p>
<h1 id="四、【进阶】基于pipeline-流水线实现项目的更新" tabindex="-1"><a class="header-anchor" href="#四、【进阶】基于pipeline-流水线实现项目的更新" aria-hidden="true">#</a> 四、【进阶】基于Pipeline 流水线实现项目的更新</h1>
<h2 id="_4-1-熟悉项目更新流程" tabindex="-1"><a class="header-anchor" href="#_4-1-熟悉项目更新流程" aria-hidden="true">#</a> 4.1 熟悉项目更新流程</h2>
...
<p>解析：</p>
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code>agent <span class="token punctuation">{</span>
    label '224'
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在node为224的服务器上执行此操作，224为添加node时自定义的名字，具体如何添加node，可查看：<a href="https://liucy.blog.csdn.net/article/details/136528857" target="_blank" rel="noopener noreferrer">【Jenkins】Pipeline流水线语法解析全集 -- 声明式流水线 <ExternalLinkIcon/></a>中的如何创建一个node节点。</p>
<br>
...
<h2 id="_4-2-基于上面创建的pipeline流水线任务修改-可自行重新创建" tabindex="-1"><a class="header-anchor" href="#_4-2-基于上面创建的pipeline流水线任务修改-可自行重新创建" aria-hidden="true">#</a> 4.2 基于上面创建的Pipeline流水线任务修改（可自行重新创建）</h2>
...
<figure><img src="https://img-blog.csdnimg.cn/img_convert/f627bd1c6e95f3627965e92e865fc7bb.png" alt="image-20240312162945962" tabindex="0" loading="lazy"><figcaption>image-20240312162945962</figcaption></figure>
<h2 id="_4-3-保存并构建流水线" tabindex="-1"><a class="header-anchor" href="#_4-3-保存并构建流水线" aria-hidden="true">#</a> 4.3 保存并构建流水线</h2>
<figure><img src="https://img-blog.csdnimg.cn/img_convert/dedda8e01a575c125fb4d3d97d3e95f5.png" alt="image-20240312163333547" tabindex="0" loading="lazy"><figcaption>image-20240312163333547</figcaption></figure>
<ul>
<li>跑完也可以查看阶段视图：项目 --&gt; 状态</li>
</ul>
<figure><img src="https://img-blog.csdnimg.cn/direct/240ff8f7b73d4d429bacde685175caab.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<h2 id="_4-5-查看服务是否正常" tabindex="-1"><a class="header-anchor" href="#_4-5-查看服务是否正常" aria-hidden="true">#</a> 4.5 查看服务是否正常</h2>
<figure><img src="https://img-blog.csdnimg.cn/img_convert/a3ab9d31d7a8a99992bf20589753a7ae.png" alt="image-20240312163254879" tabindex="0" loading="lazy"><figcaption>image-20240312163254879</figcaption></figure>
<p>这个是执行完发送的邮件，具体服务是否正常，需要根据自己的服务类型去判断；也可自行添加调用，判别服务是否正常。</p>
<hr>
<p>自此，流水线自动更新服务就完成了！！！</p>
<h1 id="五、相关专栏" tabindex="-1"><a class="header-anchor" href="#五、相关专栏" aria-hidden="true">#</a> 五、相关专栏</h1>
<table>
<thead>
<tr>
<th>专栏名称</th>
...
<tr>
<td><a href="https://liucy.blog.csdn.net/article/details/136656568" target="_blank" rel="noopener noreferrer">【Linux】Jenkins Pipeline流水线详解及基于Jenkins流水线实现自动更新项目<ExternalLinkIcon/></a></td>
<td><a href="https://liucy.blog.csdn.net/article/details/136656568" target="_blank" rel="noopener noreferrer">https://liucy.blog.csdn.net/article/details/136656568<ExternalLinkIcon/></a></td>
</tr>
</tbody>
</table>
</div></template>
