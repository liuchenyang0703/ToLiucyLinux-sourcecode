...
<hr>
<h2 id="一、nginx虚拟主机-部署网站" tabindex="-1"><a class="header-anchor" href="#一、nginx虚拟主机-部署网站" aria-hidden="true">#</a> 一、nginx虚拟主机，部署网站</h2>
<blockquote>
<p>都是在同一台服务器上部署</p>
</blockquote>
<h2 id="二、部署单域名-ip网站服务" tabindex="-1"><a class="header-anchor" href="#二、部署单域名-ip网站服务" aria-hidden="true">#</a> 二、部署单域名/IP网站服务</h2>
<h3 id="_1、创建一个普通用户-用户管理nginx网站服务" tabindex="-1"><a class="header-anchor" href="#_1、创建一个普通用户-用户管理nginx网站服务" aria-hidden="true">#</a> 1、创建一个普通用户，用户管理nginx网站服务</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2、修改nginx主配置文件" tabindex="-1"><a class="header-anchor" href="#_2、修改nginx主配置文件" aria-hidden="true">#</a> 2、修改nginx主配置文件</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412161334848.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>ok则为正常，没有错误；</p>
<ul>
<li>启动nginx</li>
</ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_5、域名访问地址" tabindex="-1"><a class="header-anchor" href="#_5、域名访问地址" aria-hidden="true">#</a> 5、域名访问地址</h3>
<blockquote>
...
<h3 id="_6、ip访问地址" tabindex="-1"><a class="header-anchor" href="#_6、ip访问地址" aria-hidden="true">#</a> 6、IP访问地址</h3>
...
<h2 id="三、nginx的配置文件匹配" tabindex="-1"><a class="header-anchor" href="#三、nginx的配置文件匹配" aria-hidden="true">#</a> 三、nginx的配置文件匹配</h2>
...
<h2 id="四、部署多域名网站服务" tabindex="-1"><a class="header-anchor" href="#四、部署多域名网站服务" aria-hidden="true">#</a> 四、部署多域名网站服务</h2>
<h3 id="_1、首先准备两个域名、index路径、nginx配置文件" tabindex="-1"><a class="header-anchor" href="#_1、首先准备两个域名、index路径、nginx配置文件" aria-hidden="true">#</a> 1、首先准备两个域名、index路径、nginx配置文件</h3>
<table>
<thead>
<tr>
<th>域名</th>
...
<p>配置域名的话自己配置就可以；</p>
<h3 id="_2、创建两个域名的nginx配置文件" tabindex="-1"><a class="header-anchor" href="#_2、创建两个域名的nginx配置文件" aria-hidden="true">#</a> 2、创建两个域名的nginx配置文件</h3>
<ul>
<li>test1域名</li>
</ul>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3、创建两个域名的index-html访问页面" tabindex="-1"><a class="header-anchor" href="#_3、创建两个域名的index-html访问页面" aria-hidden="true">#</a> 3、创建两个域名的index.html访问页面</h3>
<ul>
...
&lt;H2> test2 页面测试 &lt;/H2>
EOF</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4、检查nignx配置是否有误-并-重启nginx服务" tabindex="-1"><a class="header-anchor" href="#_4、检查nignx配置是否有误-并-重启nginx服务" aria-hidden="true">#</a> 4、检查nignx配置是否有误 并 重启nginx服务</h3>
...
systemctl restart nginx
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_5、页面访问两个域名" tabindex="-1"><a class="header-anchor" href="#_5、页面访问两个域名" aria-hidden="true">#</a> 5、页面访问两个域名</h3>
<blockquote>
<p>test1.top<br>
teset2.top</p>
</blockquote>
<p>可以看到分别两个页面，这样多域名网站服务部署成功。</p>
<h2 id="五、部署多端口网站服务" tabindex="-1"><a class="header-anchor" href="#五、部署多端口网站服务" aria-hidden="true">#</a> 五、部署多端口网站服务</h2>
<h3 id="_1、首先准备两个端口、index路径、nginx配置文件-一个即可" tabindex="-1"><a class="header-anchor" href="#_1、首先准备两个端口、index路径、nginx配置文件-一个即可" aria-hidden="true">#</a> 1、首先准备两个端口、index路径、nginx配置文件（一个即可）</h3>
<table>
<thead>
<tr>
<th>端口</th>
...
<h3 id="_2、创建两个port的nginx配置文件-一个配置中" tabindex="-1"><a class="header-anchor" href="#_2、创建两个port的nginx配置文件-一个配置中" aria-hidden="true">#</a> 2、创建两个port的nginx配置文件（一个配置中）</h3>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3、创建两个端口的index-html页面" tabindex="-1"><a class="header-anchor" href="#_3、创建两个端口的index-html页面" aria-hidden="true">#</a> 3、创建两个端口的index.html页面</h3>
...
&lt;H1>我是82，欢迎来到我的页面&lt;/H1>
EOF</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4、检查nignx配置是否有误-并-重启nginx服务-1" tabindex="-1"><a class="header-anchor" href="#_4、检查nignx配置是否有误-并-重启nginx服务-1" aria-hidden="true">#</a> 4、检查nignx配置是否有误 并 重启nginx服务</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 检查nignx配置是否有误</span>
nginx <span class="token parameter variable">-t</span>

<span class="token comment"># 重启nginx服务</span>
systemctl restart nginx
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_5、页面访问两个端口" tabindex="-1"><a class="header-anchor" href="#_5、页面访问两个端口" aria-hidden="true">#</a> 5、页面访问两个端口</h3>
<p>ip:端口</p>
<ul>
<li>ip:81</li>
</ul>
...
<h4 id="_5-1-页面访问两个端口-各添加一个jpg页面" tabindex="-1"><a class="header-anchor" href="#_5-1-页面访问两个端口-各添加一个jpg页面" aria-hidden="true">#</a> 5.1 页面访问两个端口 --&gt; 各添加一个jpg页面</h4>
...
<h4 id="_5-2-页面访问两个端口-各添加一个txt资源" tabindex="-1"><a class="header-anchor" href="#_5-2-页面访问两个端口-各添加一个txt资源" aria-hidden="true">#</a> 5.2 页面访问两个端口 --&gt; 各添加一个txt资源</h4>
...
<h3 id="到这里就完成了nginx部署一个网站及多个域名的网站和多个端口的网站" tabindex="-1"><a class="header-anchor" href="#到这里就完成了nginx部署一个网站及多个域名的网站和多个端口的网站" aria-hidden="true">#</a> 到这里就完成了nginx部署一个网站及多个域名的网站和多个端口的网站</h3>
...
<h2 id="七、相关专栏" tabindex="-1"><a class="header-anchor" href="#七、相关专栏" aria-hidden="true">#</a> 七、相关专栏</h2>
<blockquote>
