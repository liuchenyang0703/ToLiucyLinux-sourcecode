...
<figure><img src="https://img-blog.csdnimg.cn/13e70db213ef46fba6bcf12482445256.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<h1 id="安装一些必要的命令-需要用到的" tabindex="-1"><a class="header-anchor" href="#安装一些必要的命令-需要用到的" aria-hidden="true">#</a> 安装一些必要的命令（需要用到的）</h1>
...
<p>或者是直接使用我提供的离线包：<a href="https://download.csdn.net/download/liu_chen_yang/87958990" target="_blank" rel="noopener noreferrer">openssh升级9.3所需的离线包 <ExternalLinkIcon/></a></p>
<p><strong>网盘下载：</strong><br>
链接：<a href="https://pan.baidu.com/s/1DbdMNM3fbvLgB0mcVSo3pw" target="_blank" rel="noopener noreferrer">https://pan.baidu.com/s/1DbdMNM3fbvLgB0mcVSo3pw<ExternalLinkIcon/></a><br>
提取码：4qm0</p>
...
<h1 id="centos-服务器升级openssh到9-3p1" tabindex="-1"><a class="header-anchor" href="#centos-服务器升级openssh到9-3p1" aria-hidden="true">#</a> Centos 服务器升级OpenSSH到9.3p1</h1>
<h2 id="_1、安装依赖" tabindex="-1"><a class="header-anchor" href="#_1、安装依赖" aria-hidden="true">#</a> 1、安装依赖</h2>
<p><a href="#click_me_jump">安装一些必要的命令（需要用到的）</a></p>
<h2 id="_2、编译安装openssl" tabindex="-1"><a class="header-anchor" href="#_2、编译安装openssl" aria-hidden="true">#</a> 2、编译安装openssl</h2>
...
<p><img src="https://img-blog.csdnimg.cn/944b44d1363f4dd288211b863b1c7df7.png" alt="" loading="lazy"><br>
<img src="https://img-blog.csdnimg.cn/0e31c72b56ce4e09916cc291e2a31251.png" alt="" loading="lazy"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>或者是使用我提供的离线包：<a href="https://download.csdn.net/download/liu_chen_yang/87958990" target="_blank" rel="noopener noreferrer">openssh升级9.3所需的离线包 <ExternalLinkIcon/></a></p>
<p><strong>网盘下载：</strong><br>
链接：<a href="https://pan.baidu.com/s/1DbdMNM3fbvLgB0mcVSo3pw" target="_blank" rel="noopener noreferrer">https://pan.baidu.com/s/1DbdMNM3fbvLgB0mcVSo3pw<ExternalLinkIcon/></a><br>
提取码：4qm0</p>
<hr>
<p>如果遇到以下问题，后面加上<code v-pre>--no-check-certificate</code></p>
<figure><img src="https://img-blog.csdnimg.cn/3be70e41f33f44f6b3f445776e80d4ba.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/2b1c024b563642acabac5226d595b2ed.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/c8f7d72ebba545f9aa2a3d306434d3d9.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h2 id="_3、查看、备份并卸载原有openssh" tabindex="-1"><a class="header-anchor" href="#_3、查看、备份并卸载原有openssh" aria-hidden="true">#</a> 3、查看、备份并卸载原有OpenSSH</h2>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/93bcc6d3205a4b97b266ddbc8071febd.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/277bdd224f9e4ef09d818e5d3505aca9.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h2 id="_4、下载openssh二进制包" tabindex="-1"><a class="header-anchor" href="#_4、下载openssh二进制包" aria-hidden="true">#</a> 4、下载OpenSSH二进制包</h2>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">wget</span> https://cdn.openbsd.org/pub/OpenBSD/OpenSSH/portable/openssh-9.3p1.tar.gz
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/8552f7289d3b4be5a0382f387714c048.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>或者是使用我提供的离线包：<a href="https://download.csdn.net/download/liu_chen_yang/87958990" target="_blank" rel="noopener noreferrer">openssh升级9.3所需的离线包 <ExternalLinkIcon/></a></p>
<p><strong>网盘下载：</strong><br>
链接：<a href="https://pan.baidu.com/s/1DbdMNM3fbvLgB0mcVSo3pw" target="_blank" rel="noopener noreferrer">https://pan.baidu.com/s/1DbdMNM3fbvLgB0mcVSo3pw<ExternalLinkIcon/></a><br>
提取码：4qm0</p>
<h2 id="_5、解压并编译安装openssh" tabindex="-1"><a class="header-anchor" href="#_5、解压并编译安装openssh" aria-hidden="true">#</a> 5、解压并编译安装OpenSSH</h2>
...
<span class="token punctuation">[</span>root@localhost ~<span class="token punctuation">]</span><span class="token comment"># mv openssh-9.3p1.tar.gz /usr/local/</span>

<span class="token comment"># 进入/usr/local/目录解压openssh9.3</span>
...
<span class="token punctuation">[</span>root@localhost local<span class="token punctuation">]</span><span class="token comment"># tar xf openssh-9.3p1.tar.gz</span>

<span class="token comment"># 进入openssh目录</span>
<span class="token punctuation">[</span>root@localhost local<span class="token punctuation">]</span><span class="token comment"># cd openssh-9.3p1</span>

<span class="token comment"># 编译安装</span>
<span class="token punctuation">[</span>root@localhost openssh-9.3p1<span class="token punctuation">]</span><span class="token comment"># CCFLAGS="-I/usr/local/include" \</span>
...
<span class="token punctuation">[</span>root@localhost openssh-9.3p1<span class="token punctuation">]</span><span class="token comment"># make -j 4</span>
<span class="token punctuation">[</span>root@localhost openssh-9.3p1<span class="token punctuation">]</span><span class="token comment"># make install</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_6、授权" tabindex="-1"><a class="header-anchor" href="#_6、授权" aria-hidden="true">#</a> 6、授权</h2>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@localhost openssh-9.3p1<span class="token punctuation">]</span><span class="token comment"># chmod 600 /etc/ssh/*</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="_7、复制配置文件" tabindex="-1"><a class="header-anchor" href="#_7、复制配置文件" aria-hidden="true">#</a> 7、复制配置文件</h2>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@localhost openssh-9.3p1<span class="token punctuation">]</span><span class="token comment"># cp -rf /usr/local/sbin/sshd /usr/sbin/sshd</span>
<span class="token punctuation">[</span>root@localhost openssh-9.3p1<span class="token punctuation">]</span><span class="token comment"># cp -rf /usr/local/bin/ssh /usr/bin/ssh</span>
<span class="token punctuation">[</span>root@localhost openssh-9.3p1<span class="token punctuation">]</span><span class="token comment"># cp -rf /usr/local/bin/ssh-keygen /usr/bin/ssh-keygen</span>
<span class="token punctuation">[</span>root@localhost openssh-9.3p1<span class="token punctuation">]</span><span class="token comment"># cp -ar /usr/local/openssh-9.3p1/contrib/redhat/sshd.init /etc/init.d/sshd</span>
<span class="token punctuation">[</span>root@localhost openssh-9.3p1<span class="token punctuation">]</span><span class="token comment"># cp -ar /usr/local/openssh-9.3p1/contrib/redhat/sshd.pam /etc/pam.d/sshd.pam</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_8、修改配置允许root用户远程登录" tabindex="-1"><a class="header-anchor" href="#_8、修改配置允许root用户远程登录" aria-hidden="true">#</a> 8、修改配置允许root用户远程登录</h2>
...
<span class="token punctuation">[</span>root@localhost openssh-9.3p1<span class="token punctuation">]</span><span class="token comment"># sed -i "s/^#Port/Port/g" /etc/ssh/sshd_config</span>
<span class="token punctuation">[</span>root@localhost openssh-9.3p1<span class="token punctuation">]</span><span class="token comment"># chmod 755 /etc/init.d/sshd</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_9、启用sshd-生成服务配置文件-并重启服务" tabindex="-1"><a class="header-anchor" href="#_9、启用sshd-生成服务配置文件-并重启服务" aria-hidden="true">#</a> 9、启用sshd，生成服务配置文件，并重启服务</h2>
...
<span class="token punctuation">[</span>root@localhost openssh-9.3p1<span class="token punctuation">]</span><span class="token comment"># systemctl enable sshd</span>
sshd.service is not a native service, redirecting to /sbin/chkconfig.
Executing /sbin/chkconfig sshd on

<span class="token comment"># 重启服务</span>
<span class="token punctuation">[</span>root@localhost openssh-9.3p1<span class="token punctuation">]</span><span class="token comment"># systemctl restart sshd</span>
<span class="token comment"># 查看服务状态</span>
<span class="token punctuation">[</span>root@localhost openssh-9.3p1<span class="token punctuation">]</span><span class="token comment"># systemctl status sshd</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/77139bd1d39b4a219b92a29d51a529fc.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h2 id="_10、验证升级是否成功" tabindex="-1"><a class="header-anchor" href="#_10、验证升级是否成功" aria-hidden="true">#</a> 10、验证升级是否成功</h2>
...
OpenSSH_9.3p1, OpenSSL <span class="token number">1.0</span>.2k-fips  <span class="token number">26</span> Jan <span class="token number">2017</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/9cdbe36990b7412db6ad0bdfa67b5774.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h1 id="可能遇到的问题及解决方式" tabindex="-1"><a class="header-anchor" href="#可能遇到的问题及解决方式" aria-hidden="true">#</a> 可能遇到的问题及解决方式</h1>
<h2 id="问题一" tabindex="-1"><a class="header-anchor" href="#问题一" aria-hidden="true">#</a> 问题一：</h2>
<p>编译如果有此报错，可能是你没安装gcc…需要的命令，返回最上面：  <a href="#click_me_jump">安装一些必要的命令（需要用到的）</a>，安装完再次编译就可以了。</p>
<figure><img src="https://img-blog.csdnimg.cn/0e2a3cc5ff714da1a9992828bd3e5948.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h2 id="问题二" tabindex="-1"><a class="header-anchor" href="#问题二" aria-hidden="true">#</a> 问题二：</h2>
<p>编译时报错信息：</p>
...
configure: error: <span class="token keyword">in</span> <span class="token variable"><span class="token variable">`</span>/usr/local/openssh-9.3p1':
...
<h2 id="问题三" tabindex="-1"><a class="header-anchor" href="#问题三" aria-hidden="true">#</a> 问题三：</h2>
<p>编译时报错信息：</p>
...
<h2 id="问题四" tabindex="-1"><a class="header-anchor" href="#问题四" aria-hidden="true">#</a> 问题四：</h2>
