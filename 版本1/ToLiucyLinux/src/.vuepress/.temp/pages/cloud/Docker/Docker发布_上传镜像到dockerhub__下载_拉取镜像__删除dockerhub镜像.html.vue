...
<h2 id="一、注册dockerhub" tabindex="-1"><a class="header-anchor" href="#一、注册dockerhub" aria-hidden="true">#</a> 一、注册dockerhub</h2>
...
登录到这个界面。<br>
<img src="https://img-blog.csdnimg.cn/5fc6f849ea32429e8d2ef44f13cdc90a.png" alt="在这里插入图片描述" loading="lazy"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/90bee4e9006d491385d0000a8b5fbd3b.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>（2）docker images查看<br>
<img src="https://img-blog.csdnimg.cn/2cd0d6b8906b4c2eb6ac85fcccbac543.png" alt="在这里插入图片描述" loading="lazy"><br>
这里一个镜像就打好了；</p>
...
<img src="https://img-blog.csdnimg.cn/d463b9e6290b43608e6f76827d764c04.png" alt="在这里插入图片描述" loading="lazy"><br>
这里一个镜像就拉好了；</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/d276bff183c04ff59cfabcc95e5b689b.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
...
<img src="https://img-blog.csdnimg.cn/dabc3fb466a04c44b68477cd8db2766a.png" alt="在这里插入图片描述" loading="lazy"><br>
...
<img src="https://img-blog.csdnimg.cn/aecc40177b4f4593a5353db1c885f92c.png" alt="在这里插入图片描述" loading="lazy"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://img-blog.csdnimg.cn/f2452bb0168c410db6ba9f4914ed08a9.png" alt="在这里插入图片描述" loading="lazy"><br>
拉取成功，后续需要修改镜像名可以通过“<font color=red>docker tag 原镜像名 要修改的镜像名</font>” 来修改。<br>
也可以从dockerhub中查看拉取镜像的命令；<br>
点击你想要拉取的镜像；<br>
<img src="https://img-blog.csdnimg.cn/88ee9479e1b348b4820d624ad5832431.png" alt="在这里插入图片描述" loading="lazy"><br>
然后选择tag，就可以看到有一个拉取镜像的命令了；<br>
<img src="https://img-blog.csdnimg.cn/bb23bc66a2be4bf89bd6a5879ff2610e.png" alt="在这里插入图片描述" loading="lazy"></p>
...
<img src="https://img-blog.csdnimg.cn/ffd475977fec452390aa0f235b33e34f.png" alt="在这里插入图片描述" loading="lazy"><br>
然后会让你再次输入要删除的镜像，就和提示你确认是否删除是一样的，怕你误删；输入完镜像名之后再次点击delete就可以删除了；<br>
<img src="https://img-blog.csdnimg.cn/712b10d6c1e44a6db4d81be165d4a65d.png" alt="在这里插入图片描述" loading="lazy"><br>
然后就可以看到只剩一个镜像了，这时就删除成功了。<br>
<img src="https://img-blog.csdnimg.cn/23a5cdf86cd243a9864ac69eb17f1cce.png" alt="在这里插入图片描述" loading="lazy"></p>
