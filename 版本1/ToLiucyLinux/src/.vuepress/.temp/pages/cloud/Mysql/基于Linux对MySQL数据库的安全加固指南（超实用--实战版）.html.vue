...
<hr>
<p>@[toc]<br>
<img src="https://img-blog.csdnimg.cn/306574aa33344995bc7dca1f2a0aa5ba.jpeg#pic_center" alt="IMG_202307267457_jpg.jpg" loading="lazy"></p>
...
<p>下面给大家讲解一些实例吧！</p>
<h1 id="数据库加固实例" tabindex="-1"><a class="header-anchor" href="#数据库加固实例" aria-hidden="true">#</a> 数据库加固实例</h1>
...
<figure><img src="https://img-blog.csdnimg.cn/81c9b7abbf784b59b6835c3e03d171eb.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>修改完重启一下服务即可生效。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/e30be3e33ff6489e9a12acae014e801d.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>开启完，重启服务生效；</p>
<hr>
<p>mariadb日志一般会存储在 <code v-pre>/var/lib/mysql</code> 下；<br>
容器的方式部署的mysql，日志数据一般会存在 <code v-pre>/var/lib/mysql/data/</code> 下。</p>
<figure><img src="https://img-blog.csdnimg.cn/27aed8f281df4275bc1ba77c7750a898.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
...
<figure><img src="https://img-blog.csdnimg.cn/fbb5e9f4736b47deb8a9d12e5183a26a.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
...
<p><img src="https://img-blog.csdnimg.cn/d148d81701984c51a691d01cbc95a6ba.png" alt="在这里插入图片描述" loading="lazy"><br>
<img src="https://img-blog.csdnimg.cn/af5d712ab35346b79abf73a01eb5264c.png" alt="在这里插入图片描述" loading="lazy"></p>
<ul>
<li>然后看mysql/user表，可以看到多了一个cs用户，只可以本地访问数据库，然后测试登陆；</li>
</ul>
<figure><img src="https://img-blog.csdnimg.cn/c7489a5048f140a4bf02b499e61e227a.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/930327c0592f41c28cb2442d4dc6e7a7.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>成功登陆，并且有<code v-pre>cs</code>这个库的所有权限；<br>
而用第三方登陆，就登陆不上，比如我们用<code v-pre>navicat</code>连接测试；<br>
很显然，登陆不上的这是；</p>
<figure><img src="https://img-blog.csdnimg.cn/4da55b74ee2545e89d44f221b4394b94.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
...
<span class="token keyword">select</span> * from mysql.user where <span class="token assign-left variable">user</span><span class="token operator">=</span><span class="token string">"cs"</span> <span class="token punctuation">\</span>G<span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/3f51517d5db34f408715499c40ff01bc.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<ul>
<li>然后看mysql/user表，可以看到多了一个好几个cs用户，但是host不一样，也就是可以访问的ip主机不一样，只有上面显示的这几个访问数据库，然后测试登陆；</li>
</ul>
<figure><img src="https://img-blog.csdnimg.cn/5f66b7516f144bd38e7f162a505df232.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
...
<figure><img src="https://img-blog.csdnimg.cn/7d4782bcf55345af97cb0fda8641cfee.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
...
<h1 id="本文可参考文献" tabindex="-1"><a class="header-anchor" href="#本文可参考文献" aria-hidden="true">#</a> 本文可参考文献</h1>
<table>
<thead>
<tr>
<th>文章标题</th>
