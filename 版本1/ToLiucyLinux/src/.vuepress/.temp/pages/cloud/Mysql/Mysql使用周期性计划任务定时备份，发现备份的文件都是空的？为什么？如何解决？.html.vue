<template><div><figure><img src="https://img-blog.csdnimg.cn/f599934504f440d8872f960b2e7ee0c5.jpeg#pic_center" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<blockquote>
...
<hr>
<p>@[toc]</p>
<h1 id="前言-问题说明" tabindex="-1"><a class="header-anchor" href="#前言-问题说明" aria-hidden="true">#</a> 前言 / 问题说明</h1>
<blockquote>
...
<h1 id="问题分析" tabindex="-1"><a class="header-anchor" href="#问题分析" aria-hidden="true">#</a> 问题分析</h1>
<h2 id="_1、首先我们分析手动执行是否成功" tabindex="-1"><a class="header-anchor" href="#_1、首先我们分析手动执行是否成功" aria-hidden="true">#</a> 1、首先我们分析手动执行是否成功</h2>
...
那么就可以排除脚本的本身问题；</p>
<h2 id="_2、我们分析定时任务中的命令写的是否正确" tabindex="-1"><a class="header-anchor" href="#_2、我们分析定时任务中的命令写的是否正确" aria-hidden="true">#</a> 2、我们分析定时任务中的命令写的是否正确</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/54e16ff4d3ed4e82b89f3e92fac17c08.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
...
<h2 id="_3、检查crontab中的执行环境" tabindex="-1"><a class="header-anchor" href="#_3、检查crontab中的执行环境" aria-hidden="true">#</a> 3、检查crontab中的执行环境</h2>
...
<h2 id="_4、发现问题-周期性计划任务中执行找不到mysqldump命令" tabindex="-1"><a class="header-anchor" href="#_4、发现问题-周期性计划任务中执行找不到mysqldump命令" aria-hidden="true">#</a> 4、发现问题，周期性计划任务中执行找不到mysqldump命令</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/6ca70cc1110c481db3f14766df7df17e.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
