<template><div><figure><img src="https://img-blog.csdnimg.cn/direct/b8f8ff707cbf4d989b86ab482e06bab7.jpeg#pic_center" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<blockquote>
...
<p><img src="https://img-blog.csdnimg.cn/direct/bbe3cc3619b34c3ba459d380778d49d9.png" alt="在这里插入图片描述" loading="lazy"><br>
<img src="https://img-blog.csdnimg.cn/direct/fa6ed0ebc54945609c1687f8f06561f3.png" alt="在这里插入图片描述" loading="lazy"></p>
<p>设置好之后，启动虚拟机，进行磁盘管理，和磁盘扩容。</p>
<h1 id="一、查看磁盘空间" tabindex="-1"><a class="header-anchor" href="#一、查看磁盘空间" aria-hidden="true">#</a> 一、查看磁盘空间</h1>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/direct/8e6c01a550434422a9b98600850057e2.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/direct/74f7f7d75b854be29df4cc0be5a969b4.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>使用<code v-pre>fdisk -l</code>可以看到<code v-pre>/dev/sdb</code>下还有50G空间；目前是空闲的；我们需要将他这50G挂载到/data/上；</p>
<h1 id="二、进行磁盘分区" tabindex="-1"><a class="header-anchor" href="#二、进行磁盘分区" aria-hidden="true">#</a> 二、进行磁盘分区</h1>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">fdisk</span> <span class="token parameter variable">-l</span>
lsblk
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/direct/fa25038d616d41dbb281718b471abb3b.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<figure><img src="https://img-blog.csdnimg.cn/direct/ea0e654d3f5d445bbbfc254e58baaf4f.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>可以看到sdb分出来一个区为50G；</p>
<p>接下来我们就是挂载磁盘分区。</p>
<h1 id="三、挂载-dev-sdb1到-data-目录" tabindex="-1"><a class="header-anchor" href="#三、挂载-dev-sdb1到-data-目录" aria-hidden="true">#</a> 三、挂载<code v-pre>/dev/sdb1</code>到/data/目录</h1>
<ul>
...
<figure><img src="https://img-blog.csdnimg.cn/direct/708e598be9ac4827b44878e11f8cf32e.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>所以需要先格式化磁盘分区。</p>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/direct/4ee319e6e48248f8affd940e56891634.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>扩展：</p>
<blockquote>
<p>mkfs：	创建文件系统<br>
-f：		强制覆盖</p>
...
<figure><img src="https://img-blog.csdnimg.cn/direct/ae85c3ab984d49cd9acaa1ce9e0e64e2.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>这个直接mount挂载完只是临时挂载，如果不设置永久挂载，服务器重启之后就会掉，还需要手动去挂载，容易丢失数据，所以我们还需要设置永久挂载。</p>
<blockquote>
<p>临时卸载挂载的磁盘为：<code v-pre>numount /data/</code></p>
</blockquote>
<h1 id="四、设置永久挂载" tabindex="-1"><a class="header-anchor" href="#四、设置永久挂载" aria-hidden="true">#</a> 四、设置永久挂载</h1>
...
<h1 id="五、配置完成" tabindex="-1"><a class="header-anchor" href="#五、配置完成" aria-hidden="true">#</a> 五、配置完成</h1>
</div></template>
