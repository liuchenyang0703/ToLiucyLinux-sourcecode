...
<h1 id="❀grep-sed-awk命令以及正则表达式" tabindex="-1"><a class="header-anchor" href="#❀grep-sed-awk命令以及正则表达式" aria-hidden="true">#</a> ❀grep sed awk命令以及正则表达式</h1>
<figure><img src="https://img-blog.csdnimg.cn/f58471169d8f419f8585079d5568d49d.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBAQS3liJjmmajpmLM=,size_20,color_FFFFFF,t_70,g_se,x_16" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<h2 id="grep" tabindex="-1"><a class="header-anchor" href="#grep" aria-hidden="true">#</a> <font color=red>grep</font></h2>
...
<figure><img src="https://img-blog.csdnimg.cn/93ada1b732794ad1bcfecf3f0fac036c.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBAQS3liJjmmajpmLM=,size_20,color_FFFFFF,t_70,g_se,x_16" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h2 id="sed" tabindex="-1"><a class="header-anchor" href="#sed" aria-hidden="true">#</a> <font color=red>sed</font></h2>
<p><strong><font color=green>语法：</font></strong></p>
<blockquote>
...
<figure><img src="https://img-blog.csdnimg.cn/541a46ce5fba4deea086b22287f6485b.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBAQS3liJjmmajpmLM=,size_20,color_FFFFFF,t_70,g_se,x_16" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h2 id="awk" tabindex="-1"><a class="header-anchor" href="#awk" aria-hidden="true">#</a> <font color=red>awk</font></h2>
<p><strong><font color=green>语法：</font></strong></p>
<blockquote>
...
<p><strong><font color=red>awk运算： </font></font></strong></p>
<blockquote>
...
echo a | awk '{print int (1/3*100)}'<font color=blue> <strong>向小数点后面移两位（33）</strong></font></p>
</blockquote>
...
<blockquote>
<p>echo a | awk '{printf &quot;使用率为%.2f\n&quot;,(1/3)}'	<font color=blue><strong>输出(使用率为0.33) </font></strong><br>
...
<p>awk '/<sup class="footnote-ref"><a href="#footnote1">[1]</a><a class="footnote-anchor" id="footnote-ref1" /></sup>/ {print $3}' /etc/fstab	<strong><font color=blue>取消以#号开头的行打印输出第三行 </font></strong></p>
</blockquote>
<p>想要查看更多的正则表达式就去👉<a href="https://blog.csdn.net/liu_chen_yang/article/details/123231302" target="_blank" rel="noopener noreferrer">正则表达式（全）<ExternalLinkIcon/></a>👈</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr class="footnotes-sep">
<section class="footnotes">
<ol class="footnotes-list">
<li id="footnote1" class="footnote-item"><p>^# <a href="#footnote-ref1" class="footnote-backref">↩︎</a></p>
</li>
</ol>
</section>
</div></template>
