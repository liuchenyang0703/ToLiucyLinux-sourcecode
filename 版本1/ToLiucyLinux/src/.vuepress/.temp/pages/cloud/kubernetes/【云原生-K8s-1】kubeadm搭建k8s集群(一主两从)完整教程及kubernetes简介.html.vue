...
<p>@[toc]</p>
<h1 id="kubernetes简介" tabindex="-1"><a class="header-anchor" href="#kubernetes简介" aria-hidden="true">#</a> Kubernetes简介</h1>
<blockquote>
...
<h2 id="_1-kubernetes架构" tabindex="-1"><a class="header-anchor" href="#_1-kubernetes架构" aria-hidden="true">#</a> 1 kubernetes架构</h2>
<blockquote>
...
<figure><img src="https://img-blog.csdnimg.cn/36696d381b224db7b3b78adcb70d9fa3.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<h3 id="_1-1master节点" tabindex="-1"><a class="header-anchor" href="#_1-1master节点" aria-hidden="true">#</a> 1.1master节点</h3>
<blockquote>
...
<h3 id="_1-2-node节点" tabindex="-1"><a class="header-anchor" href="#_1-2-node节点" aria-hidden="true">#</a> 1.2 Node节点</h3>
<blockquote>
...
<h3 id="_1-3-kubectl" tabindex="-1"><a class="header-anchor" href="#_1-3-kubectl" aria-hidden="true">#</a> 1.3 kubectl</h3>
<blockquote>
<p>   集群管理命令行工具集，通过客户端的kubectl命令集操作，API Server响应对应的命令结果，从而达到对kubernetes集群的管理。</p>
</blockquote>
<h2 id="_2-kubeadm" tabindex="-1"><a class="header-anchor" href="#_2-kubeadm" aria-hidden="true">#</a> 2 kubeadm</h2>
...
<h3 id="_2-1-kubeadm功能" tabindex="-1"><a class="header-anchor" href="#_2-1-kubeadm功能" aria-hidden="true">#</a> 2.1 kubeadm功能</h3>
<ul>
...
<h1 id="kubernetes集群部署" tabindex="-1"><a class="header-anchor" href="#kubernetes集群部署" aria-hidden="true">#</a> Kubernetes集群部署</h1>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="修改三台集群的主机名-每个主机限一条命令" tabindex="-1"><a class="header-anchor" href="#修改三台集群的主机名-每个主机限一条命令" aria-hidden="true">#</a> 修改三台集群的主机名：（每个主机限一条命令）</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="所有节点都添加集群ip与主机名到hosts中" tabindex="-1"><a class="header-anchor" href="#所有节点都添加集群ip与主机名到hosts中" aria-hidden="true">#</a> 所有节点都添加集群ip与主机名到hosts中：</h2>
...
EOF</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><font color=red>注意：ip一定要改成自己的ip，不要直接复制粘贴</font><h2 id="三台机器进行时间同步" tabindex="-1"><a class="header-anchor" href="#三台机器进行时间同步" aria-hidden="true">#</a> 三台机器进行时间同步</h2>
...
<h2 id="三台都安装需要的一些命令" tabindex="-1"><a class="header-anchor" href="#三台都安装需要的一些命令" aria-hidden="true">#</a> 三台都安装需要的一些命令：</h2>
<ul>
...
<h2 id="查看kubeadm使用的镜像" tabindex="-1"><a class="header-anchor" href="#查看kubeadm使用的镜像" aria-hidden="true">#</a> 查看kubeadm使用的镜像</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/36e8aa7b5e9a441aa77b6ae6b7b18286.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<h1 id="master节点" tabindex="-1"><a class="header-anchor" href="#master节点" aria-hidden="true">#</a> master节点</h1>
<h2 id="初始化master节点" tabindex="-1"><a class="header-anchor" href="#初始化master节点" aria-hidden="true">#</a> 初始化master节点</h2>
...
<figure><img src="https://img-blog.csdnimg.cn/e39daf29fda141f18c9ba7978d6fa794.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="node节点的加入" tabindex="-1"><a class="header-anchor" href="#node节点的加入" aria-hidden="true">#</a> node节点的加入</h2>
<ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/bae166f9a335479d90f44c7f1e51a871.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>现在的集群状态都是<code v-pre>NotReady</code>表示不可达；这是因为还没有安装网络插件，下面我们来安装一下<code v-pre>网络插件（caclico）</code></p>
<h2 id="给master节点安装pod网络插件-calico" tabindex="-1"><a class="header-anchor" href="#给master节点安装pod网络插件-calico" aria-hidden="true">#</a> 给master节点安装Pod网络插件（calico）</h2>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/d26113d02699441ea81df2e56d0c4221.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="查看节点连接状态" tabindex="-1"><a class="header-anchor" href="#查看节点连接状态" aria-hidden="true">#</a> 查看节点连接状态</h2>
...
<figure><img src="https://img-blog.csdnimg.cn/be3ddfff30be4b9ebf173671569d5801.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<figure><img src="https://img-blog.csdnimg.cn/02850b97224a4adcab8a0857c829d036.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/6cf2f65ebc0c47ecbfa8b43e4784e1c9.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<blockquote>
...
<figure><img src="https://img-blog.csdnimg.cn/4f56ddc1517e43d986810bd6125462d5.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>端口为30000，页面访问，<font color=red>节点的ip+30000;</font></p>
<blockquote>
<font color=red>节点的ip可以为主节点的ip，也可以为从节点的ip。</font></blockquote>
<figure><img src="https://img-blog.csdnimg.cn/a3415ca313324966bff8002871c15123.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="完结⭕" tabindex="-1"><a class="header-anchor" href="#完结⭕" aria-hidden="true">#</a> 完结⭕</h1>
