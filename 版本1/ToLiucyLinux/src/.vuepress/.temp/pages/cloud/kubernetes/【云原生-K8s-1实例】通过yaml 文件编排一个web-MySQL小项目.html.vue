...
<p>@[toc]</p>
<h1 id="_1、启动-mysql-项目" tabindex="-1"><a class="header-anchor" href="#_1、启动-mysql-项目" aria-hidden="true">#</a> 1、启动 mysql 项目</h1>
<h2 id="_1-1-创建-mysql-rc-yaml" tabindex="-1"><a class="header-anchor" href="#_1-1-创建-mysql-rc-yaml" aria-hidden="true">#</a> 1-1 创建 mysql-rc.yaml</h2>
...
<h3 id="_1-1-1-将rc发布到k8s集群里面去" tabindex="-1"><a class="header-anchor" href="#_1-1-1-将rc发布到k8s集群里面去" aria-hidden="true">#</a> 1-1-1 将RC发布到k8s集群里面去</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_1-1-2-查看集群中的pods" tabindex="-1"><a class="header-anchor" href="#_1-1-2-查看集群中的pods" aria-hidden="true">#</a> 1-1-2 查看集群中的pods</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-1-3-负载均衡副本实例-数据库不需要开多个副本-这里只举例如何多开副本" tabindex="-1"><a class="header-anchor" href="#_1-1-3-负载均衡副本实例-数据库不需要开多个副本-这里只举例如何多开副本" aria-hidden="true">#</a> 1-1-3 负载均衡	副本实例（数据库不需要开多个副本）这里只举例如何多开副本</h3>
<ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/3c4b630907384d0782dc971c79309b8d.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>现在启动了5个mysql，负载均衡完成。</p>
<h2 id="_1-2-创建-mysql-svc-yaml" tabindex="-1"><a class="header-anchor" href="#_1-2-创建-mysql-svc-yaml" aria-hidden="true">#</a> 1-2 创建 mysql-svc.yaml</h2>
...
<h3 id="_1-2-1-将services应用到集群中" tabindex="-1"><a class="header-anchor" href="#_1-2-1-将services应用到集群中" aria-hidden="true">#</a> 1-2-1 将services应用到集群中</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_1-2-2-查看services" tabindex="-1"><a class="header-anchor" href="#_1-2-2-查看services" aria-hidden="true">#</a> 1-2-2 查看services</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>kubectl get svc
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/f75eafe62d294e829be59884e125ef33.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<blockquote>
...
<h2 id="_1-3-附加-如何找到并进入mysql数据库中" tabindex="-1"><a class="header-anchor" href="#_1-3-附加-如何找到并进入mysql数据库中" aria-hidden="true">#</a> 1-3 附加：如何找到并进入mysql数据库中？</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/c7ed5705c8114f9393aed695170f6c1a.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/15f5df333da34e44b1e874dc37a29f93.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="https://img-blog.csdnimg.cn/7fd19c8a06bd4d748ddaa1ad0bd6da87.png" alt="在这里插入图片描述" loading="lazy"><br>
...
<h1 id="_2、启动-tomcat-项目" tabindex="-1"><a class="header-anchor" href="#_2、启动-tomcat-项目" aria-hidden="true">#</a> 2、启动 tomcat 项目</h1>
<p>这个tomcat是书里面特定的，所以说我们要先去拉取一下这个镜像，这个镜像是作者已经制定好了的。</p>
<h2 id="_2-1-拉取特定的tomcat镜像" tabindex="-1"><a class="header-anchor" href="#_2-1-拉取特定的tomcat镜像" aria-hidden="true">#</a> 2-1 拉取特定的tomcat镜像</h2>
...
<h2 id="_2-2-创建-tomcat-rc-yaml" tabindex="-1"><a class="header-anchor" href="#_2-2-创建-tomcat-rc-yaml" aria-hidden="true">#</a> 2-2 创建 tomcat-rc.yaml</h2>
...
<h3 id="_2-2-1-将rc发布到k8s集群里面去" tabindex="-1"><a class="header-anchor" href="#_2-2-1-将rc发布到k8s集群里面去" aria-hidden="true">#</a> 2-2-1 将RC发布到k8s集群里面去</h3>
...
<h3 id="_2-2-2-查看集群中的pods" tabindex="-1"><a class="header-anchor" href="#_2-2-2-查看集群中的pods" aria-hidden="true">#</a> 2-2-2 查看集群中的pods</h3>
...
<h2 id="_2-3-创建-tomcat-svc-yaml" tabindex="-1"><a class="header-anchor" href="#_2-3-创建-tomcat-svc-yaml" aria-hidden="true">#</a> 2-3 创建 tomcat-svc.yaml</h2>
...
<h3 id="_2-3-1-将services应用到集群中" tabindex="-1"><a class="header-anchor" href="#_2-3-1-将services应用到集群中" aria-hidden="true">#</a> 2-3-1 将services应用到集群中</h3>
<p>光有RC是不行的，RC不会提供服务的，需要一个Service。将它应用到集群里面去。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_2-3-2-查看services" tabindex="-1"><a class="header-anchor" href="#_2-3-2-查看services" aria-hidden="true">#</a> 2-3-2 查看services</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>kubectl get svc
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/bed1357e39e9424c8a4c10104b60f203.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>30001为映射的端口，是可以对外访问的。</p>
<h1 id="_3、通过浏览器访问" tabindex="-1"><a class="header-anchor" href="#_3、通过浏览器访问" aria-hidden="true">#</a> 3、通过浏览器访问</h1>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/3af6df9ddae54f2c930dbdaae56fb5ee.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/9e98756c1f78400b98c698e25cc9d69a.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>接下来可以尝试单击 “Add..” 按钮添加一条记录并提交，如下图所示，提交以后，数据就被写入 MySQL 数据库中了。</p>
<figure><img src="https://img-blog.csdnimg.cn/1cbf0aa5ba924bbe815899b833d67efd.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>提交为<code v-pre>submit</code>，提交成功会显示如下图；</p>
<figure><img src="https://img-blog.csdnimg.cn/c8a859f8f5834ab7a6c2d179314c16a4.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>如果失败，既有可能是因为数据库副本开的太多，导致数据写入不知道该往哪个数据库中写了。</p>
<p>点击<code v-pre>return</code>即可返回查看到刚刚添加的数据。</p>
<figure><img src="https://img-blog.csdnimg.cn/a9d4b972075a4f8f8ad921209f6173c7.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
