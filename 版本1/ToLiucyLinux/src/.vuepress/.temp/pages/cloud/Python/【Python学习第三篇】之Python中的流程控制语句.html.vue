...
<hr>
<p>@[toc]</p>
<figure><img src="https://img-blog.csdnimg.cn/3c7dfe57708e4f47af2f193b07f0278d.jpeg#pic_center" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<hr>
...
<h1 id="一、流程控制图解" tabindex="-1"><a class="header-anchor" href="#一、流程控制图解" aria-hidden="true">#</a> 一、流程控制图解</h1>
<figure><img src="https://img-blog.csdnimg.cn/35f5cdbc10d043108260d46f8344f381.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<table>
<thead>
<tr>
<th>流程控制操作</th>
...
<h1 id="二、if-条件判断" tabindex="-1"><a class="header-anchor" href="#二、if-条件判断" aria-hidden="true">#</a> 二、if 条件判断</h1>
<p>大家都知道在学习编程中，不管哪门语言都会有：判断、循环语句；而判断语句呢就是我们所有语言中通用的<code v-pre>if</code> 判断。</p>
<h2 id="if-语句的语法结构" tabindex="-1"><a class="header-anchor" href="#if-语句的语法结构" aria-hidden="true">#</a> if 语句的语法结构</h2>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token comment"># 单条件判断：只判断有</span>
...
<h2 id="if-判断示例" tabindex="-1"><a class="header-anchor" href="#if-判断示例" aria-hidden="true">#</a> if 判断示例：</h2>
<ul>
<li>当只有一个条件时</li>
</ul>
<p>当然这个基本不会使用到</p>
...
<span class="token keyword">else</span><span class="token punctuation">:</span>
    <span class="token keyword">print</span><span class="token punctuation">(</span><span class="token string">"请输入正确的数字，您当然输入的结果为：%s"</span> <span class="token operator">%</span>num<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/4808a8bb6f34494493dbd8a783a02774.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<ul>
<li>如果表达式比较长，可以使用圆括号括起来：</li>
</ul>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>a<span class="token operator">=</span><span class="token number">10</span>
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>a<span class="token operator">=</span><span class="token number">29</span>
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>age<span class="token operator">=</span><span class="token number">90</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="if-判断总结" tabindex="-1"><a class="header-anchor" href="#if-判断总结" aria-hidden="true">#</a> if 判断总结：</h2>
<blockquote>
<p>简单来说就是不管是多重判断还是单个还是两个判断，只要满足优先级（层级）最高的一条，则停止；<br>
就比如我1没满足，2满足了，那么就停止；<br>
1没满足，2没满足，也没有3，那就就是输出else的值，然后停止。</p>
</blockquote>
<h1 id="三、for-循环" tabindex="-1"><a class="header-anchor" href="#三、for-循环" aria-hidden="true">#</a> 三、for 循环</h1>
<ul>
<li>
...
<h2 id="for-循环的语法结构" tabindex="-1"><a class="header-anchor" href="#for-循环的语法结构" aria-hidden="true">#</a> for 循环的语法结构</h2>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">for</span> 变量 <span class="token keyword">in</span> 可迭代对象<span class="token punctuation">:</span>
    <span class="token comment"># 执行循环体内的代码</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>下面是关于for循环语法结构的详细说明：</p>
<ol>
...
<h2 id="for-循环示例" tabindex="-1"><a class="header-anchor" href="#for-循环示例" aria-hidden="true">#</a> for 循环示例：</h2>
<ul>
<li>示例1：循环输出数字1-5</li>
</ul>
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">for</span> _ <span class="token keyword">in</span> <span class="token builtin">range</span><span class="token punctuation">(</span><span class="token number">3</span><span class="token punctuation">)</span><span class="token punctuation">:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/00bc5648b2b34974a74e5945c8aef7a3.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<ul>
<li>示例3：如果迭代完还有必须执行的逻辑，可以加一个<code v-pre>else：</code>，与for语句平行缩进，和if一样；</li>
</ul>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">for</span> i <span class="token keyword">in</span> <span class="token punctuation">[</span><span class="token number">1</span><span class="token punctuation">,</span><span class="token number">2</span><span class="token punctuation">,</span><span class="token number">3</span><span class="token punctuation">,</span><span class="token number">4</span><span class="token punctuation">,</span><span class="token number">5</span><span class="token punctuation">]</span><span class="token punctuation">:</span>
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">for</span> i <span class="token keyword">in</span> <span class="token builtin">range</span><span class="token punctuation">(</span><span class="token number">1000</span><span class="token punctuation">)</span><span class="token punctuation">:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="for-循环总结" tabindex="-1"><a class="header-anchor" href="#for-循环总结" aria-hidden="true">#</a> for 循环总结：</h2>
<blockquote>
...
<h1 id="四、while-循环" tabindex="-1"><a class="header-anchor" href="#四、while-循环" aria-hidden="true">#</a> 四、while 循环</h1>
...
<h2 id="while-循环的语法结构" tabindex="-1"><a class="header-anchor" href="#while-循环的语法结构" aria-hidden="true">#</a> while 循环的语法结构</h2>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">while</span> condition<span class="token punctuation">:</span>  
    <span class="token comment"># 代码块（要重复执行的代码）</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>这里的<code v-pre>condition</code>是一个表达式，其结果为真（True）或假（False）。<br>
...
<h2 id="while-循环示例" tabindex="-1"><a class="header-anchor" href="#while-循环示例" aria-hidden="true">#</a> while 循环示例：</h2>
<p>下面是一个简单的示例，演示如何使用<code v-pre>while</code>循环来打印从1到5的数字：</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>count <span class="token operator">=</span> <span class="token number">1</span>
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>number <span class="token operator">=</span> <span class="token number">7</span>
...
<span class="token keyword">while</span> guess <span class="token operator">!=</span> number<span class="token punctuation">:</span>
    ...
    <span class="token keyword">elif</span> guess <span class="token operator">></span> number<span class="token punctuation">:</span>
        <span class="token keyword">print</span><span class="token punctuation">(</span><span class="token string">"猜的数字大了..."</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="while-循环总结" tabindex="-1"><a class="header-anchor" href="#while-循环总结" aria-hidden="true">#</a> while 循环总结：</h2>
<blockquote>
...
<h1 id="五、流程控制语句" tabindex="-1"><a class="header-anchor" href="#五、流程控制语句" aria-hidden="true">#</a> 五、流程控制语句</h1>
<h2 id="_5-1-break-语句" tabindex="-1"><a class="header-anchor" href="#_5-1-break-语句" aria-hidden="true">#</a> 5.1 break 语句</h2>
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">for</span> i <span class="token keyword">in</span> <span class="token builtin">range</span><span class="token punctuation">(</span><span class="token number">10000</span><span class="token punctuation">)</span><span class="token punctuation">:</span>
...
<h2 id="_5-2-continue-语句" tabindex="-1"><a class="header-anchor" href="#_5-2-continue-语句" aria-hidden="true">#</a> 5.2 continue 语句</h2>
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>a <span class="token operator">=</span> <span class="token number">0</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_5-3-pass-语句" tabindex="-1"><a class="header-anchor" href="#_5-3-pass-语句" aria-hidden="true">#</a> 5.3 pass 语句</h2>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>a <span class="token operator">=</span> <span class="token number">100</span>
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">def</span> <span class="token function">my_function</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">:</span>
...
<h1 id="六、异常处理" tabindex="-1"><a class="header-anchor" href="#六、异常处理" aria-hidden="true">#</a> 六、异常处理</h1>
<blockquote>
<p>异常是什么？<br>
异常就是再写代码中出现的一些报错信息。</p>
</blockquote>
<h2 id="_6-1-try-except-语句" tabindex="-1"><a class="header-anchor" href="#_6-1-try-except-语句" aria-hidden="true">#</a> 6.1 try-except 语句</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="七、raise-语句" tabindex="-1"><a class="header-anchor" href="#七、raise-语句" aria-hidden="true">#</a> 七、raise 语句</h1>
<h1 id="八、with-语句" tabindex="-1"><a class="header-anchor" href="#八、with-语句" aria-hidden="true">#</a> 八、with 语句</h1>
<h1 id="九、小结" tabindex="-1"><a class="header-anchor" href="#九、小结" aria-hidden="true">#</a> 九、小结</h1>
<blockquote>
<p>本节主要讲了：</p>
</blockquote>
<hr>
<blockquote>
<p>讲到这里就完成了第三篇《python中的流程控制语句》，接下来我还会持续输出Python学习文章，大家可以订阅我的专栏：<a href="https://blog.csdn.net/liu_chen_yang/category_11693372.html?spm=1001.2014.3001.5482" target="_blank" rel="noopener noreferrer">《python 学习》<ExternalLinkIcon/></a><br>
🐋 希望大家多多支持，我们一起进步！😄<br>
🎉如果文章对你有帮助的话，欢迎 点赞 👍🏻 评论 💬 收藏 ⭐️ 加关注+💗</p>
</blockquote>
<blockquote>
...
<p>新文已发布，新文地址：<a href="https://liucy.blog.csdn.net/article/details/132416515" target="_blank" rel="noopener noreferrer">https://liucy.blog.csdn.net/article/details/132416515<ExternalLinkIcon/></a><br>
《linux使用stress命令进行压力测试cpu》<br>
期待大佬们的三连支持，祝您生活愉快！<br>
【群发消息，如有打扰，实属抱歉，还请见谅，感谢您的支持】</p>
</div></template>
