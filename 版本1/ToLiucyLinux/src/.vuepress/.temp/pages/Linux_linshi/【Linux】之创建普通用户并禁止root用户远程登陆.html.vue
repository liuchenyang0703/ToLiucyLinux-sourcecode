...
<h2 id="_1、创建普通用户并设置密码" tabindex="-1"><a class="header-anchor" href="#_1、创建普通用户并设置密码" aria-hidden="true">#</a> 1、创建普通用户并设置密码</h2>
<h3 id="_1-1、创建普通用户" tabindex="-1"><a class="header-anchor" href="#_1-1、创建普通用户" aria-hidden="true">#</a> 1.1、创建普通用户</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412181625050.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h3 id="_1-2、给test用户设置登录密码" tabindex="-1"><a class="header-anchor" href="#_1-2、给test用户设置登录密码" aria-hidden="true">#</a> 1.2、给test用户设置登录密码</h3>
...
<h3 id="_1-3、给test用户设置权限" tabindex="-1"><a class="header-anchor" href="#_1-3、给test用户设置权限" aria-hidden="true">#</a> 1.3、给test用户设置权限</h3>
<p>可以使用visudo来设置</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_1-4、测试test普通用户" tabindex="-1"><a class="header-anchor" href="#_1-4、测试test普通用户" aria-hidden="true">#</a> 1.4、测试test普通用户</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2、禁止root用户远程登录" tabindex="-1"><a class="header-anchor" href="#_2、禁止root用户远程登录" aria-hidden="true">#</a> 2、禁止root用户远程登录</h2>
