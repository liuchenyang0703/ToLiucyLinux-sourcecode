...
<h2 id="_1-查看服务器已安装的所有内核版本" tabindex="-1"><a class="header-anchor" href="#_1-查看服务器已安装的所有内核版本" aria-hidden="true">#</a> 1.查看服务器已安装的所有内核版本</h2>
...
<h2 id="_2-修改版本配置" tabindex="-1"><a class="header-anchor" href="#_2-修改版本配置" aria-hidden="true">#</a> 2.修改版本配置</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412181357876.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h2 id="_3-编译配置" tabindex="-1"><a class="header-anchor" href="#_3-编译配置" aria-hidden="true">#</a> 3.编译配置</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="_4-重启系统" tabindex="-1"><a class="header-anchor" href="#_4-重启系统" aria-hidden="true">#</a> 4.重启系统</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="_5-重启后查看内核版本" tabindex="-1"><a class="header-anchor" href="#_5-重启后查看内核版本" aria-hidden="true">#</a> 5.重启后查看内核版本</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412181356462.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>完成版本切换。</p>
