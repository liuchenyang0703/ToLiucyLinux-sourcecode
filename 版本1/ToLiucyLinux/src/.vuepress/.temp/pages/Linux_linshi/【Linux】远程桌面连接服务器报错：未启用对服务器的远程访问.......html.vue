...
<h2 id="操作环境说明" tabindex="-1"><a class="header-anchor" href="#操作环境说明" aria-hidden="true">#</a> 操作环境说明：</h2>
<table>
<thead>
<tr>
<th>系统</th>
...
<h2 id="远程报错" tabindex="-1"><a class="header-anchor" href="#远程报错" aria-hidden="true">#</a> 远程报错</h2>
...
<h2 id="一、安装gnome默认桌面环境" tabindex="-1"><a class="header-anchor" href="#一、安装gnome默认桌面环境" aria-hidden="true">#</a> 一、安装GNOME默认桌面环境</h2>
...
<h2 id="二、安装xrdp-xrdp端口为3389" tabindex="-1"><a class="header-anchor" href="#二、安装xrdp-xrdp端口为3389" aria-hidden="true">#</a> 二、安装Xrdp（xrdp端口为3389）</h2>
...
<p>已经启动没问题。</p>
<h3 id="_1-配置xrdp" tabindex="-1"><a class="header-anchor" href="#_1-配置xrdp" aria-hidden="true">#</a> 1 配置Xrdp</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_2-配置防火墙-如果启用了防火墙的话-放行3389端口" tabindex="-1"><a class="header-anchor" href="#_2-配置防火墙-如果启用了防火墙的话-放行3389端口" aria-hidden="true">#</a> 2 配置防火墙（如果启用了防火墙的话），放行3389端口</h3>
<blockquote>
<p>默认情况下，Xrdp监听3389端口，如果使用的是云服务器（如阿里云、华为云），可以通过安全组规则放行3389端口。</p>
</blockquote>
<h2 id="三、测试验证" tabindex="-1"><a class="header-anchor" href="#三、测试验证" aria-hidden="true">#</a> 三、测试验证</h2>
