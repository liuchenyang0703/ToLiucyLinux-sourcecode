...
<hr>
<h2 id="一、nfs简介与rpc简介" tabindex="-1"><a class="header-anchor" href="#一、nfs简介与rpc简介" aria-hidden="true">#</a> 一、NFS简介与RPC简介</h2>
<h3 id="_1-nfs服务简介" tabindex="-1"><a class="header-anchor" href="#_1-nfs服务简介" aria-hidden="true">#</a> 1. NFS服务简介</h3>
...
<h3 id="_2-rpc协议简介" tabindex="-1"><a class="header-anchor" href="#_2-rpc协议简介" aria-hidden="true">#</a> 2. RPC协议简介</h3>
...
<h3 id="_3-nfs工作流程" tabindex="-1"><a class="header-anchor" href="#_3-nfs工作流程" aria-hidden="true">#</a> 3. NFS工作流程</h3>
...
<h2 id="二、准备工作" tabindex="-1"><a class="header-anchor" href="#二、准备工作" aria-hidden="true">#</a> 二、准备工作</h2>
<h3 id="_2-1-服务器信息" tabindex="-1"><a class="header-anchor" href="#_2-1-服务器信息" aria-hidden="true">#</a> 2.1 服务器信息</h3>
<table>
<thead>
<tr>
...
<h3 id="_2-2-防火墙配置" tabindex="-1"><a class="header-anchor" href="#_2-2-防火墙配置" aria-hidden="true">#</a> 2.2 防火墙配置</h3>
<ul>
<li>关闭防火墙服务</li>
</ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-3-selinux沙盒" tabindex="-1"><a class="header-anchor" href="#_2-3-selinux沙盒" aria-hidden="true">#</a> 2.3 selinux沙盒</h3>
...
<font color=red>修改配置文件永久生效要重启服务器；</font><h2 id="三、部署-nfs-和-rpc-服务" tabindex="-1"><a class="header-anchor" href="#三、部署-nfs-和-rpc-服务" aria-hidden="true">#</a> 三、部署 NFS 和 RPC 服务</h2>
<p>两台都安装</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412181440383.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h2 id="四、配置共享目录" tabindex="-1"><a class="header-anchor" href="#四、配置共享目录" aria-hidden="true">#</a> 四、配置共享目录</h2>
...
/data/test *
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="五、挂载共享目录及配置永久挂载" tabindex="-1"><a class="header-anchor" href="#五、挂载共享目录及配置永久挂载" aria-hidden="true">#</a> 五、挂载共享目录及配置永久挂载</h2>
