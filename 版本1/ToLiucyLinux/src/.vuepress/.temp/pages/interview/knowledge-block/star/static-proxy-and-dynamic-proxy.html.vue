...
<p>在了解静态代理和动态代理之前，我们需要先了解一下什么是代理模式</p>
</blockquote>
<h2 id="_1-代理模式" tabindex="-1"><a class="header-anchor" href="#_1-代理模式" aria-hidden="true">#</a> 1. 代理模式</h2>
...
<ol>
<li><code v-pre>代理模式:</code> 为一个对象提供一个替身，以控制对这个对象的访问。即通过代理对象访问目标对象.这样做的好处是:可以在目标对象实现的基础上,增强额外的功能操作,即<strong>扩展目标对象的功能</strong>。</li>
...
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/cisyam/202308141120518.png" alt="image-20230814112036352" tabindex="0" loading="lazy"><figcaption>image-20230814112036352</figcaption></figure>
...
<p><strong>静态代理中，我们对目标对象的每个方法的增强都是手动完成的，非常不灵活（比如接口一旦新增加方法，目标对象和代理对象都要进行修改）且麻烦(需要对每个目标类都单独写一个代理类）。</strong>  实际应用场景非常非常少，日常开发几乎看不到使用静态代理的场景。</p>
...
<li>
<p>测试</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@org.junit.Test</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>控制台打印 ：</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/cisyam/202308141145127.png" alt="image-20230814114502067" tabindex="0" loading="lazy"><figcaption>image-20230814114502067</figcaption></figure>
</li>
</ol>
<h3 id="静态代理存在的问题" tabindex="-1"><a class="header-anchor" href="#静态代理存在的问题" aria-hidden="true">#</a> 静态代理存在的问题</h3>
...
<span class="token list punctuation">2.</span> 额外功能维护性差
   代理类中 额外功能修改复杂(麻烦)
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3-动态代理" tabindex="-1"><a class="header-anchor" href="#_3-动态代理" aria-hidden="true">#</a> 3. 动态代理</h2>
<p>相比于静态代理来说，动态代理更加灵活。我们不需要针对每个目标类都单独创建一个代理类，并且也不需要我们必须实现接口，我们可以直接代理实现类( <code v-pre>CGLIB 动态代理机制</code>)。</p>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>概念：通过代理类为原始类(目标类)增加额外功能,代理类由Spring动态生成。
好处：利于原始类(目标类)的维护
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>代理运行对象在程序运行的过程中动态的在内存进行构建，可以灵活的进行业务功能的切换。</strong></p>
<h3 id="_3-1-jdk动态代理" tabindex="-1"><a class="header-anchor" href="#_3-1-jdk动态代理" aria-hidden="true">#</a> 3.1 JDK动态代理</h3>
<blockquote>
<p>JDK动态代理是基于 Java 的反射机制实现的。使用 JDK中接口和类实现代理对象的动态创建。JDK的动态代理要求目标对象必须实现接口，而代理对象不必实现业务接口，这是 java 设计上的要求。从 jdk1.3 以来，java 语言通过 java.lang.reflect 包提供三个类和接口支持代理模式，它们分别Proxy, Method和 InvocationHandler。</p>
</blockquote>
<ul>
<li>
<p>目标对象必须实现业务接口</p>
...
<li>
<p>JDK代理代理对象不需要实现业务接口</p>
</li>
<li>
<p>动态代理的对象在程序运行中不存在</p>
</li>
<li>
<p>动态代理灵活的进行业务功能的切换</p>
</li>
</ul>
<h4 id="_1-proxy类" tabindex="-1"><a class="header-anchor" href="#_1-proxy类" aria-hidden="true">#</a> 1. Proxy类</h4>
<blockquote>
<p>​	通过JDK的 <code v-pre>java.lang.reflect.Proxy</code> 类实现动态代理，会使用其静态方法 <code v-pre>newProxyInstance()</code>，依据目标对象、业务接口及调用处理器三者，自动生成一个动态代理对象。</p>
</blockquote>
...
handler：调用处理器。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_2-method类" tabindex="-1"><a class="header-anchor" href="#_2-method类" aria-hidden="true">#</a> 2. Method类</h4>
<blockquote>
<p><code v-pre>invoke()</code>方法的第二个参数为 <code v-pre>Method</code> 类对象，该类有一个方法也叫 invoke()，可以调用目标方法。这两个 invoke()方法，虽然同名，但无关。</p>
</blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/cisyam/202308141348381.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<blockquote>
<p>在 <code v-pre>invoke</code> 方法中可以截取对目标方法的调用。在这里进行功能增强。Java 的动态代理是建立在反射机制之上的。实现了 <code v-pre>InvocationHandler</code> 接口的类用于加强目标类的主业务逻辑。这个接口中有一个方法 <code v-pre>invoke()</code>，具体加强的代码逻辑就是定义在该方法中的。通过代理对象执行接口中的方法时，会自动调用 invoke()方法。</p>
</blockquote>
<h4 id="_4-实现步骤" tabindex="-1"><a class="header-anchor" href="#_4-实现步骤" aria-hidden="true">#</a> 4. 实现步骤</h4>
<ol>
<li>
<p>代理对象不需要实现接口。</p>
</li>
<li>
<p>代理对象的生成是利用JDK中的proxy类，动态的在内存中构建代理对象。</p>
</li>
<li>
<p>代码实现接口</p>
</li>
<li>
<p><code v-pre>ProxyFactory.java</code> 代理实例生成工厂</p>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code> <span class="token annotation punctuation">@org.junit.Test</span>
    ...
    <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>控制台打印 ：</strong></p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/cisyam/202308141357779.png" alt="image-20230814135707682" tabindex="0" loading="lazy"><figcaption>image-20230814135707682</figcaption></figure>
</li>
</ol>
<blockquote>
<p>注意：JDK动态代理中，代理对象不需要实现接口，但是目标对象一定要实现接口，否则不能用JDK动态代理。</p>
</blockquote>
<h3 id="_3-2-cglib动态代理" tabindex="-1"><a class="header-anchor" href="#_3-2-cglib动态代理" aria-hidden="true">#</a> 3.2 CGlib动态代理</h3>
<p><strong>Code Generation Library</strong> ，又称为子类通过动态的的在内存中构建子类对象，重写父类方法进行代理功能的增强。</p>
<blockquote>
<p>想要功能扩展，但目标对象没有实现接口，怎样功能扩展？</p>
<p>解决方案：<strong>子类的方式</strong></p>
<p>Class subclass extends UserDao{}</p>
<p>以子类的方式实现(cglib代理)，在内存中构建一个子类对象从而实现对目标对象功能的扩展。</p>
</blockquote>
<h4 id="_1-cglib动态代理的特点" tabindex="-1"><a class="header-anchor" href="#_1-cglib动态代理的特点" aria-hidden="true">#</a> 1. CGlib动态代理的特点</h4>
<ol>
<li>JDK动态代理有一个限制，就是使用动态代理的目标对象必须实现一个或多个接口。如果想代理没有实现类的接口，就可以使用CGLIB进行代理。</li>
<li>CGLIB是一个强大的高性能的代码生成包，它可以在运行期扩展Java类与实现Java接口。它广泛的被许多AOP的框架使用，例如Spring AOP和dynaop，为他们提供方法的interception。</li>
<li>CGLIB包的底层是通过使用一个小而快的字节码处理框架ASM，来转换字节码并生成新的类。不鼓励直接使用ASM，因为它要求你必须对JVM内部结构包括class文件的格式和指令集都很熟悉。</li>
</ol>
<h4 id="_2-cglib的实现步骤" tabindex="-1"><a class="header-anchor" href="#_2-cglib的实现步骤" aria-hidden="true">#</a> 2. CGLIB的实现步骤</h4>
<ol>
<li>
<p>需要spring-core-5.2.5.jar依赖即可。</p>
</li>
<li>
<p>引入功能包后，就可以在内存中动态构建子类</p>
</li>
<li>
<p>被代理的类不能为final， 否则报错。</p>
</li>
<li>
<p>目标对象的方法如果为final/static, 那么就不会被拦截，即不会执行目标对象额外的业务方法。</p>
</li>
<li>
<p>编写 <strong>ProxyFactory.java</strong></p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>leo<span class="token punctuation">.</span>demo02<span class="token punctuation">.</span>service<span class="token punctuation">.</span>impl</span><span class="token punctuation">;</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code> <span class="token annotation punctuation">@org.junit.Test</span>
    <span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">test04</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
        ...
        service<span class="token punctuation">.</span><span class="token function">sell</span><span class="token punctuation">(</span><span class="token string">"卖房"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>控制台打印：</strong></p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/cisyam/202308141410807.png" alt="image-20230814141003722" tabindex="0" loading="lazy"><figcaption>image-20230814141003722</figcaption></figure>
</li>
</ol>
<h3 id="_3-3-jdk-动态代理和-cglib-动态代理对比" tabindex="-1"><a class="header-anchor" href="#_3-3-jdk-动态代理和-cglib-动态代理对比" aria-hidden="true">#</a> 3.3  JDK 动态代理和 CGLIB 动态代理对比</h3>
