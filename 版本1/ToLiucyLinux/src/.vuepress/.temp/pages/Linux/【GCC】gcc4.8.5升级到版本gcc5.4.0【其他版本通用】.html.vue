...
<h2 id="二、gcc-5-4安装包下载" tabindex="-1"><a class="header-anchor" href="#二、gcc-5-4安装包下载" aria-hidden="true">#</a> 二、GCC 5.4安装包下载</h2>
<p>gcc安装包下载地址：</p>
<blockquote>
...
<h3 id="_3-4-新建一个build目录在gcc5-4目录中用于存放编译文件" tabindex="-1"><a class="header-anchor" href="#_3-4-新建一个build目录在gcc5-4目录中用于存放编译文件" aria-hidden="true">#</a> 3.4 新建一个build目录在gcc5.4目录中用于存放编译文件</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-5-编译、安装" tabindex="-1"><a class="header-anchor" href="#_3-5-编译、安装" aria-hidden="true">#</a> 3.5 编译、安装</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412171024264.png" alt="" loading="lazy"><br>
<strong>查看库：</strong></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412171024546.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>有这些就代表安装成功。</p>
<h2 id="四、编译完成gcc还是显示4-8-5解决方法" tabindex="-1"><a class="header-anchor" href="#四、编译完成gcc还是显示4-8-5解决方法" aria-hidden="true">#</a> 四、编译完成gcc还是显示4.8.5解决方法</h2>
<blockquote>
...
<h2 id="五、编译完成gcc的动态库还是不对的话解决方法" tabindex="-1"><a class="header-anchor" href="#五、编译完成gcc的动态库还是不对的话解决方法" aria-hidden="true">#</a> 五、编译完成gcc的动态库还是不对的话解决方法</h2>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412171024050.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412171024656.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
