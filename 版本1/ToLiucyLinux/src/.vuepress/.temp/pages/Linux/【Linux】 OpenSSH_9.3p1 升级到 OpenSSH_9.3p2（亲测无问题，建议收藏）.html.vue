...
<blockquote>
<p>文章声明：此文基于实操撰写 生产环境：此文升级是基于9.3p1升级9.3p2<br>
ssh -V查看版本是：OpenSSH_9.3p1, OpenSSL 1.0.2k-fips  26 Jan 2017<br>
...
<figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/2f8edbcf2f9a4e9cbd60e54f736bdfbd.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
...
<h2 id="此文升级是基于9-3p1升级9-3p2-如是7-4升级9-3p2-可参考文章最后的参考文章" tabindex="-1"><a class="header-anchor" href="#此文升级是基于9-3p1升级9-3p2-如是7-4升级9-3p2-可参考文章最后的参考文章" aria-hidden="true">#</a> 此文升级是基于9.3p1升级9.3p2（如是7.4升级9.3p2，可参考文章最后的参考文章）</h2>
<blockquote>
<p>9.3p1升级文档：<a href="https://liucy.blog.csdn.net/article/details/131398113" target="_blank" rel="noopener noreferrer">【Linux】 OpenSSH_7.4p1 升级到 OpenSSH_9.3p1（亲测无问题，建议收藏）<ExternalLinkIcon/></a></p>
</blockquote>
...
<h3 id="下载-openssh9-3p2-的安装包" tabindex="-1"><a class="header-anchor" href="#下载-openssh9-3p2-的安装包" aria-hidden="true">#</a> 下载 openssh9.3p2 的安装包：</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="解压并编译安装openssh9-3p2" tabindex="-1"><a class="header-anchor" href="#解压并编译安装openssh9-3p2" aria-hidden="true">#</a> 解压并编译安装OpenSSH9.3p2</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="给sshd授3予权限" tabindex="-1"><a class="header-anchor" href="#给sshd授3予权限" aria-hidden="true">#</a> 给sshd授3予权限</h3>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>[root@localhost ~]# ssh -V
OpenSSH_9.3p2, OpenSSL 1.1.1t  7 Feb 2023
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/6551fdeab07d4a31839ea5396b319e18.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
