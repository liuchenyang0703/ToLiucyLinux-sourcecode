...
<h3 id="_1、下载-metrics-server-components-yaml" tabindex="-1"><a class="header-anchor" href="#_1、下载-metrics-server-components-yaml" aria-hidden="true">#</a> 1、下载 metrics-server-components.yaml</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412161404720.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h3 id="_2、将-metrics-server-components-yaml中的-k8s-gcr-io-更改为阿里云镜像地址" tabindex="-1"><a class="header-anchor" href="#_2、将-metrics-server-components-yaml中的-k8s-gcr-io-更改为阿里云镜像地址" aria-hidden="true">#</a> 2、将 metrics-server-components.yaml中的 <a href="http://k8s.gcr.io" target="_blank" rel="noopener noreferrer">k8s.gcr.io<ExternalLinkIcon/></a> 更改为阿里云镜像地址</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_3、执行-metrics-server-components-yaml" tabindex="-1"><a class="header-anchor" href="#_3、执行-metrics-server-components-yaml" aria-hidden="true">#</a> 3、执行 metrics-server-components.yaml</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_4、查看pod" tabindex="-1"><a class="header-anchor" href="#_4、查看pod" aria-hidden="true">#</a> 4、查看pod</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412161404782.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>发现是0/1，表示未启动。</p>
...
也有一种报错如下：</p>
<h4 id="_4-1-查看-metrics-server-647596b58-fgwzg-日志" tabindex="-1"><a class="header-anchor" href="#_4-1-查看-metrics-server-647596b58-fgwzg-日志" aria-hidden="true">#</a> 4.1 查看 metrics-server-647596b58-fgwzg 日志</h4>
...
<h4 id="_4-2-发现报错-x509-cannot-validate-certificate-for-172-16-11-223-because-it-doesn-t-contain-any-ip-sans-node-k8s-node2" tabindex="-1"><a class="header-anchor" href="#_4-2-发现报错-x509-cannot-validate-certificate-for-172-16-11-223-because-it-doesn-t-contain-any-ip-sans-node-k8s-node2" aria-hidden="true">#</a> 4.2 发现报错： x509: cannot validate certificate for 172.16.11.223 because it doesn't contain any IP SANs&quot; node=&quot;k8s-node2&quot;</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_4-4-修改完之后重新应用-metrics-server-components-yaml" tabindex="-1"><a class="header-anchor" href="#_4-4-修改完之后重新应用-metrics-server-components-yaml" aria-hidden="true">#</a> 4.4 修改完之后重新应用 metrics-server-components.yaml</h4>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>kubectl apply <span class="token parameter variable">-f</span> metrics-server-components.yaml
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412161404774.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h4 id="_4-5-再次查看pod启动状态" tabindex="-1"><a class="header-anchor" href="#_4-5-再次查看pod启动状态" aria-hidden="true">#</a> 4.5 再次查看pod启动状态</h4>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>kubectl get pod <span class="token parameter variable">-A</span> <span class="token operator">|</span><span class="token function">grep</span> me
...
<h3 id="_5、验证是否成功" tabindex="-1"><a class="header-anchor" href="#_5、验证是否成功" aria-hidden="true">#</a> 5、验证是否成功</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412161404980.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>完成。</p>
</div></template>
