...
<h2 id="具体报错信息" tabindex="-1"><a class="header-anchor" href="#具体报错信息" aria-hidden="true">#</a> 具体报错信息：</h2>
...
<h3 id="时间问题排查" tabindex="-1"><a class="header-anchor" href="#时间问题排查" aria-hidden="true">#</a> 时间问题排查</h3>
<p>首先我们先看时间问题；<br>
在docker拉取镜像时出现 x509 报错,一般都是证书问题或者系统时间问题导致，可以先执行 ​​date​​ 看一下系统时间对不对,如果服务器系统时间跟现实实际时间对不上的话，一般就是系统时间问题，同步时间即可。</p>
<h4 id="_1-查看时间" tabindex="-1"><a class="header-anchor" href="#_1-查看时间" aria-hidden="true">#</a> 1 查看时间</h4>
...
<h4 id="_2-安装同步时间工具-ntpdate" tabindex="-1"><a class="header-anchor" href="#_2-安装同步时间工具-ntpdate" aria-hidden="true">#</a> 2 安装同步时间工具 ntpdate</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="_3-同步时间" tabindex="-1"><a class="header-anchor" href="#_3-同步时间" aria-hidden="true">#</a> 3 同步时间</h4>
<p>安装完命令之后同步时间；</p>
...
<h4 id="_4-再次查看当前系统时间" tabindex="-1"><a class="header-anchor" href="#_4-再次查看当前系统时间" aria-hidden="true">#</a> 4 再次查看当前系统时间</h4>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@k8d mysql<span class="token punctuation">]</span><span class="token comment"># date</span>
...
<h4 id="_5-再次拉取镜像" tabindex="-1"><a class="header-anchor" href="#_5-再次拉取镜像" aria-hidden="true">#</a> 5 再次拉取镜像</h4>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@k8d mysql<span class="token punctuation">]</span><span class="token comment"># docker pull mysql:5.7.38</span>
Trying to pull repository docker.io/library/mysql <span class="token punctuation">..</span>. 
...
<p>如果还是有报错看第二种方法：</p>
<h3 id="证书问题排查" tabindex="-1"><a class="header-anchor" href="#证书问题排查" aria-hidden="true">#</a> 证书问题排查</h3>
...
<h4 id="编辑-etc-docker-daemon-json文件" tabindex="-1"><a class="header-anchor" href="#编辑-etc-docker-daemon-json文件" aria-hidden="true">#</a> 编辑/etc/docker/daemon.json文件</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="重启docker服务" tabindex="-1"><a class="header-anchor" href="#重启docker服务" aria-hidden="true">#</a> 重启docker服务</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="再次拉取镜像" tabindex="-1"><a class="header-anchor" href="#再次拉取镜像" aria-hidden="true">#</a> 再次拉取镜像</h4>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@k8d mysql<span class="token punctuation">]</span><span class="token comment"># docker pull mysql:5.7.38</span>
Trying to pull repository docker.io/library/mysql <span class="token punctuation">..</span>. 
<span class="token number">5.7</span>.38: Pulling from docker.io/library/mysql
66fb34780033: Pull complete 
...
<h2 id="成功解决" tabindex="-1"><a class="header-anchor" href="#成功解决" aria-hidden="true">#</a> 成功解决</h2>
</div></template>
