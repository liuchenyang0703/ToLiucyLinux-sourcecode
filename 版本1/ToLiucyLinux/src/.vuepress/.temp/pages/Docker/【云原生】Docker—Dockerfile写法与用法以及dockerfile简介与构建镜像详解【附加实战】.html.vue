<template><div><h2 id="一、dockerfile简介" tabindex="-1"><a class="header-anchor" href="#一、dockerfile简介" aria-hidden="true">#</a> 一、dockerfile简介</h2>
<h3 id="什么是dockerfile" tabindex="-1"><a class="header-anchor" href="#什么是dockerfile" aria-hidden="true">#</a>   什么是dockerfile？</h3>
<blockquote>
<p>  Dockerfile 是一个用来构建镜像的文本文件，文本内容包含了一条条构建镜像所需的指令(Instruction)和操作命令;每一条指令构建一层镜像，因此每一条指令的内容，就是描述该层镜像应当如何构建（也就是你要执行的操作命令）。</p>
</blockquote>
<h3 id="dockerfile是什么" tabindex="-1"><a class="header-anchor" href="#dockerfile是什么" aria-hidden="true">#</a>   dockerfile是什么？</h3>
<blockquote>
<ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="为什么要用dockerfile" tabindex="-1"><a class="header-anchor" href="#为什么要用dockerfile" aria-hidden="true">#</a>   为什么要用dockerfile？</h3>
<blockquote>
...
<h3 id="dockerfile、docker镜像和docker容器的关系" tabindex="-1"><a class="header-anchor" href="#dockerfile、docker镜像和docker容器的关系" aria-hidden="true">#</a>   Dockerfile、Docker镜像和Docker容器的关系</h3>
...
<h2 id="二、dockerfile需要注意的编写规范" tabindex="-1"><a class="header-anchor" href="#二、dockerfile需要注意的编写规范" aria-hidden="true">#</a> 二、DockerFile需要注意的编写规范</h2>
<blockquote>
<p>1. # 代表注释<br><br>
2.指令必须要大写，后面最少需要带一个参数，最多无限制;<br><br>
3.执行dockerfile的时候，指令是按照从上到下的顺序执行的；<br></p>
</blockquote>
<h2 id="三、docekrfile指令解析" tabindex="-1"><a class="header-anchor" href="#三、docekrfile指令解析" aria-hidden="true">#</a> 三、Docekrfile指令解析</h2>
<blockquote>
...
<h2 id="四、常用的dockerfile指令详解、格式与用法" tabindex="-1"><a class="header-anchor" href="#四、常用的dockerfile指令详解、格式与用法" aria-hidden="true">#</a> 四、常用的Dockerfile指令详解、格式与用法</h2>
<p><strong><font color=red>（必须）是写dockerfile必须有的，没有加的是（可选）的。</font></strong></p>
<h3 id="_4-1-from-必须" tabindex="-1"><a class="header-anchor" href="#_4-1-from-必须" aria-hidden="true">#</a> 4.1 FROM（必须）</h3>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_4-2-maintainer" tabindex="-1"><a class="header-anchor" href="#_4-2-maintainer" aria-hidden="true">#</a> 4.2 MAINTAINER</h3>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-3-user" tabindex="-1"><a class="header-anchor" href="#_4-3-user" aria-hidden="true">#</a> 4.3 USER</h3>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_4-4-env-必须" tabindex="-1"><a class="header-anchor" href="#_4-4-env-必须" aria-hidden="true">#</a> 4.4 ENV（必须）</h3>
<blockquote>
<p>设置环境变量</p>
</blockquote>
<p><strong><font color=teal>格式</font></strong></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-5-volume" tabindex="-1"><a class="header-anchor" href="#_4-5-volume" aria-hidden="true">#</a> 4.5 VOLUME</h3>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_4-6-expose" tabindex="-1"><a class="header-anchor" href="#_4-6-expose" aria-hidden="true">#</a> 4.6 EXPOSE</h3>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_4-7-copy" tabindex="-1"><a class="header-anchor" href="#_4-7-copy" aria-hidden="true">#</a> 4.7 COPY</h3>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_4-8-add" tabindex="-1"><a class="header-anchor" href="#_4-8-add" aria-hidden="true">#</a> 4.8 ADD</h3>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_4-9-workdir" tabindex="-1"><a class="header-anchor" href="#_4-9-workdir" aria-hidden="true">#</a> 4.9 WORKDIR</h3>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_4-10-run-必须" tabindex="-1"><a class="header-anchor" href="#_4-10-run-必须" aria-hidden="true">#</a> 4.10 RUN（必须）</h3>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_4-11-cmd" tabindex="-1"><a class="header-anchor" href="#_4-11-cmd" aria-hidden="true">#</a> 4.11 CMD</h3>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="五、docker-build构建镜像" tabindex="-1"><a class="header-anchor" href="#五、docker-build构建镜像" aria-hidden="true">#</a> 五、docker build构建镜像</h2>
<p><strong><font color=teal>dockerfile构建镜像的的格式：</font></strong></p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">docker</span> build <span class="token parameter variable">-t</span> 要打的镜像名:版本号 Dockerfile路径
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><strong><font color=teal>dockerfile构建镜像的的实例：</font></strong></p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">docker</span> build <span class="token parameter variable">-t</span> work:v1 <span class="token builtin class-name">.</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="六、【实战】docker自定义镜像" tabindex="-1"><a class="header-anchor" href="#六、【实战】docker自定义镜像" aria-hidden="true">#</a> 六、【实战】docker自定义镜像</h2>
<p>说明：</p>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2、构建镜像" tabindex="-1"><a class="header-anchor" href="#_2、构建镜像" aria-hidden="true">#</a> 2、构建镜像</h3>
...
<h3 id="_3、查看镜像" tabindex="-1"><a class="header-anchor" href="#_3、查看镜像" aria-hidden="true">#</a> 3、查看镜像</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="七、总结" tabindex="-1"><a class="header-anchor" href="#七、总结" aria-hidden="true">#</a> 七、总结</h2>
