...
<h2 id="三、解压-tomcat-压缩包" tabindex="-1"><a class="header-anchor" href="#三、解压-tomcat-压缩包" aria-hidden="true">#</a> 三、解压 Tomcat 压缩包</h2>
...
<h2 id="四、配置环境变量" tabindex="-1"><a class="header-anchor" href="#四、配置环境变量" aria-hidden="true">#</a> 四、配置环境变量</h2>
...
<h2 id="五、测试是否配置成功、启动-tomcat-服务" tabindex="-1"><a class="header-anchor" href="#五、测试是否配置成功、启动-tomcat-服务" aria-hidden="true">#</a> 五、测试是否配置成功、启动 Tomcat 服务</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/b36fc96c523b48acaeb85439270693c4.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<p>到这里也就启动成功了。</p>
<h2 id="六、页面访问" tabindex="-1"><a class="header-anchor" href="#六、页面访问" aria-hidden="true">#</a> 六、页面访问</h2>
<p>默认端口为8080</p>
...
<h2 id="七、部署完成" tabindex="-1"><a class="header-anchor" href="#七、部署完成" aria-hidden="true">#</a> 七、部署完成</h2>
<blockquote>
