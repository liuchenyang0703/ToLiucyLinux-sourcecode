...
<h2 id="一、流程控制图解" tabindex="-1"><a class="header-anchor" href="#一、流程控制图解" aria-hidden="true">#</a> 一、流程控制图解</h2>
...
<h2 id="二、if-条件判断" tabindex="-1"><a class="header-anchor" href="#二、if-条件判断" aria-hidden="true">#</a> 二、if 条件判断</h2>
<p>大家都知道在学习编程中，不管哪门语言都会有：判断、循环语句；而判断语句呢就是我们所有语言中通用的<code v-pre>if</code> 判断。</p>
<h3 id="if-语句的语法结构" tabindex="-1"><a class="header-anchor" href="#if-语句的语法结构" aria-hidden="true">#</a> if 语句的语法结构</h3>
...
<h3 id="if-判断示例" tabindex="-1"><a class="header-anchor" href="#if-判断示例" aria-hidden="true">#</a> if 判断示例：</h3>
<ul>
<li>当只有一个条件时</li>
</ul>
<p>当然这个基本不会使用到</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="if-判断总结" tabindex="-1"><a class="header-anchor" href="#if-判断总结" aria-hidden="true">#</a> if 判断总结：</h3>
<blockquote>
<p>简单来说就是不管是多重判断还是单个还是两个判断，只要满足优先级（层级）最高的一条，则停止；<br>
就比如我1没满足，2满足了，那么就停止；<br>
1没满足，2没满足，也没有3，那就就是输出else的值，然后停止。</p>
</blockquote>
<h2 id="三、for-循环" tabindex="-1"><a class="header-anchor" href="#三、for-循环" aria-hidden="true">#</a> 三、for 循环</h2>
<ul>
<li>
...
<h3 id="for-循环的语法结构" tabindex="-1"><a class="header-anchor" href="#for-循环的语法结构" aria-hidden="true">#</a> for 循环的语法结构</h3>
...
<h3 id="for-循环示例" tabindex="-1"><a class="header-anchor" href="#for-循环示例" aria-hidden="true">#</a> for 循环示例：</h3>
<ul>
<li>示例1：循环输出数字1-5</li>
</ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412161323783.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="for-循环总结" tabindex="-1"><a class="header-anchor" href="#for-循环总结" aria-hidden="true">#</a> for 循环总结：</h3>
<blockquote>
...
<h2 id="四、while-循环" tabindex="-1"><a class="header-anchor" href="#四、while-循环" aria-hidden="true">#</a> 四、while 循环</h2>
...
<h3 id="while-循环的语法结构" tabindex="-1"><a class="header-anchor" href="#while-循环的语法结构" aria-hidden="true">#</a> while 循环的语法结构</h3>
...
<h3 id="while-循环示例" tabindex="-1"><a class="header-anchor" href="#while-循环示例" aria-hidden="true">#</a> while 循环示例：</h3>
...
<span class="token keyword">while</span> guess <span class="token operator">!=</span> number<span class="token punctuation">:</span>
    ...
    <span class="token keyword">elif</span> guess <span class="token operator">></span> number<span class="token punctuation">:</span>
        <span class="token keyword">print</span><span class="token punctuation">(</span><span class="token string">"猜的数字大了..."</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="while-循环总结" tabindex="-1"><a class="header-anchor" href="#while-循环总结" aria-hidden="true">#</a> while 循环总结：</h3>
<blockquote>
...
<h2 id="五、流程控制语句" tabindex="-1"><a class="header-anchor" href="#五、流程控制语句" aria-hidden="true">#</a> 五、流程控制语句</h2>
<h3 id="_5-1-break-语句" tabindex="-1"><a class="header-anchor" href="#_5-1-break-语句" aria-hidden="true">#</a> 5.1 break 语句</h3>
...
<h3 id="_5-2-continue-语句" tabindex="-1"><a class="header-anchor" href="#_5-2-continue-语句" aria-hidden="true">#</a> 5.2 continue 语句</h3>
...
<h2 id="六、异常处理" tabindex="-1"><a class="header-anchor" href="#六、异常处理" aria-hidden="true">#</a> 六、异常处理</h2>
<blockquote>
<p>异常是什么？<br>
异常就是再写代码中出现的一些报错信息。</p>
</blockquote>
<h3 id="_6-1-try-except-语句" tabindex="-1"><a class="header-anchor" href="#_6-1-try-except-语句" aria-hidden="true">#</a> 6.1 try-except 语句</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="七、raise-语句" tabindex="-1"><a class="header-anchor" href="#七、raise-语句" aria-hidden="true">#</a> 七、raise 语句</h2>
<h2 id="八、with-语句" tabindex="-1"><a class="header-anchor" href="#八、with-语句" aria-hidden="true">#</a> 八、with 语句</h2>
<h2 id="九、小结" tabindex="-1"><a class="header-anchor" href="#九、小结" aria-hidden="true">#</a> 九、小结</h2>
<blockquote>
<p>本节主要讲了：</p>
</blockquote>
<hr>
