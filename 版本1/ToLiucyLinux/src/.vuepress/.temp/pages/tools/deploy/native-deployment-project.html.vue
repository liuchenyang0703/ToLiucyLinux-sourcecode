<template><div><h2 id="安装宝塔面板" tabindex="-1"><a class="header-anchor" href="#安装宝塔面板" aria-hidden="true">#</a> 安装宝塔面板</h2>
<ol>
<li>执行以下命令进行安装：</li>
</ol>
<p>CentOS7/8:</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>Ubuntu18.04/20.04:</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">wget</span> <span class="token parameter variable">-O</span> install.sh http://download.bt.cn/install/install_6.0.sh <span class="token operator">&amp;&amp;</span> <span class="token function">bash</span> install.sh
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ol start="2">
<li>安装过程中会提示输入数据库密码等信息，根据提示输入即可。</li>
<li>安装完成后，在浏览器中输入服务器 IP 地址并访问，即可看到宝塔面板的登录界面。</li>
</ol>
<h2 id="宝塔安装软件" tabindex="-1"><a class="header-anchor" href="#宝塔安装软件" aria-hidden="true">#</a> 宝塔安装软件</h2>
<p>安装MySQL，傻瓜式安装，直接点点点<br>
安装之后使用远程软件连接服务器MySQL会报错</p>
<div class="hint-container info">
<p class="hint-container-title">相关信息</p>
<blockquote>
<p>1130-host ‘..‘ is not allowed to connect to this MySql</p>
</blockquote>
<h3 id="在服务器命令行中登录mysql" tabindex="-1"><a class="header-anchor" href="#在服务器命令行中登录mysql" aria-hidden="true">#</a> 在服务器命令行中登录MySQL</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="查看用户表user数据" tabindex="-1"><a class="header-anchor" href="#查看用户表user数据" aria-hidden="true">#</a> 查看用户表user数据</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token keyword">select</span> Host, User,Password from user<span class="token punctuation">;</span>      <span class="token comment">#其中Password为数据库进入密码</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="修改用户表user的host" tabindex="-1"><a class="header-anchor" href="#修改用户表user的host" aria-hidden="true">#</a> 修改用户表user的host</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>update user <span class="token builtin class-name">set</span> <span class="token assign-left variable">Host</span><span class="token operator">=</span><span class="token string">'%'</span> where <span class="token assign-left variable">User</span><span class="token operator">=</span><span class="token string">'root'</span><span class="token punctuation">;</span>
flush privileges<span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>这样即可成功！！！</p>
<div class="hint-container info">
<p class="hint-container-title">相关信息</p>
<p>还需安装其他软件<br>
Java项目管理器(下载之后随便安装一个Tomcat即可获得Java环境)<br>
Redis 安装完毕之后配置 所有都可访问 0.0.0.0 以及配置Redis密码(必需)<br>
Nginx 首先安装完毕 具体配置后面进一步概述</p>
</div>
</div>
<h2 id="运行jar部署后端" tabindex="-1"><a class="header-anchor" href="#运行jar部署后端" aria-hidden="true">#</a> 运行jar部署后端</h2>
<p>打包后端代码jar包<br>
熟练java项目开发的，可以直接通过InteliJ IDEA或者eclipse软件打jar包。不熟悉的有第二种方法，是若依提供的。进入下载的项目文件夹中的bin目录下，直接双击执行package.bat，它会直接在项目中生成target文件夹，里面包含以及打包好的jar包。我们要使用的是ruoyi-admin文件夹下的target里的jar包。运行package.bat需要marven环境&gt;=3.0，操作顺序如下图：<br>
然后通过下面命令进行运行jar包</p>
<div class="hint-container info">
<p class="hint-container-title">相关信息</p>
<p>我这里是/home目录下面</p>
</div>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>nohup java <span class="token operator">-</span>jar xxxxx   <span class="token operator">&amp;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>运行完毕之后，可以在当前运行jar的目录，通过下面命令来看运行的控制台输出。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>tail <span class="token operator">-</span>f nohup<span class="token punctuation">.</span>out
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/202307112127512.png" alt="image.png" tabindex="0" loading="lazy"><figcaption>image.png</figcaption></figure>
<div class="hint-container info">
<p class="hint-container-title">相关信息</p>
<p>这里我们的后端就部署成功了</p>
</div>
<h2 id="填写nginx配置部署前端" tabindex="-1"><a class="header-anchor" href="#填写nginx配置部署前端" aria-hidden="true">#</a> 填写NGINX配置部署前端</h2>
<p>打开dos窗口，进入ruoyi-ui文件夹，并对前端代码进行打包,生成一个dist文件夹，这就是前端代码打包后的文件</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">npm</span> <span class="token function">install</span> --unsafe-perm <span class="token parameter variable">--registry</span><span class="token operator">=</span>https://registry.npm.taobao.org
<span class="token function">npm</span> run build:prod
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>也可以进入ruoyi-ui -&gt; bin目录中 双击鼠标运行build.bat文件<br>
打包后，会生成一个dist文件夹，如图所示：<br>
<img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/202307112127008.png" alt="image.png" loading="lazy"><br>
我们需要通过Xftp将dist文件夹拷贝到我们购买云服务器的一个目录，我这里将其dist文件夹拷贝到home目录门，如下：<br>
<img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/202307112127629.png" alt="image.png" loading="lazy"></p>
<p><strong>到这里我们去宝塔面板配置Linux面板的NGINX配置。</strong></p>
<p>找到NGINX配置修改处，如图：<br>
<img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/202307112127477.png" alt="image.png" loading="lazy"></p>
<p><strong>填入下面的配置，前端就算是配置完毕：</strong></p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>user  www<span class="token punctuation">;</span>
