<template><div><h2 id="fdisk" tabindex="-1"><a class="header-anchor" href="#fdisk"><span><font color=red>fdisk：</font></span></a></h2>
...
<font color=teal>常用的是：df -Th	查看挂载文件</font><h2 id="gdisk" tabindex="-1"><a class="header-anchor" href="#gdisk"><span><font color=red>gdisk：</font></span></a></h2>
...
<hr>
<h2 id="lvm-逻辑卷管理" tabindex="-1"><a class="header-anchor" href="#lvm-逻辑卷管理"><span><font color=red>LVM 逻辑卷管理：</font></span></a></h2>
...
<hr>
<h2 id="cache-缓存" tabindex="-1"><a class="header-anchor" href="#cache-缓存"><span><font color=red>cache 缓存：</font></span></a></h2>
<blockquote>
...
<h2 id="snapshot-快照" tabindex="-1"><a class="header-anchor" href="#snapshot-快照"><span><font color=red>snapshot 快照：</font></span></a></h2>
<blockquote>
<p>-s	快照<br>
-L  值	要设置的大小<br>
-n  名字	要写的名字<br><br>
...
<h2 id="raid-独立磁盘冗余阵列-数据安全性" tabindex="-1"><a class="header-anchor" href="#raid-独立磁盘冗余阵列-数据安全性"><span><font color=red>RAID 独立磁盘冗余阵列 数据安全性</font></span></a></h2>
<blockquote>
<p>硬RAID	软RAID<br></p>
</blockquote>
