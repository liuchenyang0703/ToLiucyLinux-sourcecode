...
<h2 id="_1-为什么需要数据库设计" tabindex="-1"><a class="header-anchor" href="#_1-为什么需要数据库设计"><span>1. 为什么需要数据库设计</span></a></h2>
...
<h2 id="_2-范-式" tabindex="-1"><a class="header-anchor" href="#_2-范-式"><span>2. 范 式</span></a></h2>
<h3 id="_2-1-范式简介" tabindex="-1"><a class="header-anchor" href="#_2-1-范式简介"><span>2.1 范式简介</span></a></h3>
<p>在关系型数据库中，关于数据表设计的基本原则、规则就称为范式。可以理解为，一张数据表的设计结 构需要满足的某种设计标准的 级别 。要想设计一个结构合理的关系型数据库，必须满足一定的范式。</p>
<h3 id="_2-2-范式都包括哪些" tabindex="-1"><a class="header-anchor" href="#_2-2-范式都包括哪些"><span>2.2 范式都包括哪些</span></a></h3>
...
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220706165020939.png" alt="image-20220706165020939" tabindex="0" loading="lazy"><figcaption>image-20220706165020939</figcaption></figure>
<h3 id="_2-3-键和相关属性的概念" tabindex="-1"><a class="header-anchor" href="#_2-3-键和相关属性的概念"><span>2.3 键和相关属性的概念</span></a></h3>
...
<p>这里有两个表：</p>
<p><code v-pre>球员表(player)</code> ：球员编号 | 姓名 | 身份证号 | 年龄 | 球队编号</p>
<p><code v-pre>球队表(team) </code>：球队编号 | 主教练 | 球队所在地</p>
<ul>
...
<h3 id="_2-4-第一范式-1st-nf" tabindex="-1"><a class="header-anchor" href="#_2-4-第一范式-1st-nf"><span>2.4 第一范式(1st NF)</span></a></h3>
<p>第一范式主要确保数据库中每个字段的值必须具有<code v-pre>原子性</code>，也就是说数据表中每个字段的值为<code v-pre>不可再次拆分</code>的最小数据单元。</p>
<p>我们在设计某个字段的时候，对于字段X来说，不能把字段X拆分成字段X-1和字段X-2。事实上，任何的DBMS都会满足第一范式的要求，不会将字段进行拆分。</p>
<p><strong>举例1：</strong></p>
<p>假设一家公司要存储员工的姓名和联系方式。它创建一个如下表：</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220706171057270.png" alt="image-20220706171057270" tabindex="0" loading="lazy"><figcaption>image-20220706171057270</figcaption></figure>
<p>该表不符合 1NF ，因为规则说“表的每个属性必须具有原子（单个）值”，lisi和zhaoliu员工的 emp_mobile 值违反了该规则。为了使表符合 1NF ，我们应该有如下表数据：</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220706171130851.png" alt="image-20220706171130851" tabindex="0" loading="lazy"><figcaption>image-20220706171130851</figcaption></figure>
<p><strong>举例2：</strong></p>
<p>user 表的设计不符合第一范式</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220706171225292.png" alt="image-20220706171225292" tabindex="0" loading="lazy"><figcaption>image-20220706171225292</figcaption></figure>
<p>其中，user_info字段为用户信息，可以进一步拆分成更小粒度的字段，不符合数据库设计对第一范式的 要求。将user_info拆分后如下：</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220706171242455.png" alt="image-20220706171242455" tabindex="0" loading="lazy"><figcaption>image-20220706171242455</figcaption></figure>
...
<p>表1：</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220706171442919.png" alt="image-20220706171442919" tabindex="0" loading="lazy"><figcaption>image-20220706171442919</figcaption></figure>
<p>表2：</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220706171456873.png" alt="image-20220706171456873" tabindex="0" loading="lazy"><figcaption>image-20220706171456873</figcaption></figure>
<h3 id="_2-5-第二范式-2nd-nf" tabindex="-1"><a class="header-anchor" href="#_2-5-第二范式-2nd-nf"><span>2.5 第二范式(2nd NF)</span></a></h3>
...
<div class="language-mysql line-numbers-mode" data-highlighter="shiki" data-ext="mysql" data-title="mysql" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>(球员编号, 比赛编号) → (姓名, 年龄, 比赛时间, 比赛场地，得分)</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p>但是这个数据表不满足第二范式，因为数据表中的字段之间还存在着如下的对应关系：</p>
<div class="language-mysql line-numbers-mode" data-highlighter="shiki" data-ext="mysql" data-title="mysql" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>(球员编号) → (姓名，年龄)</span></span>
<span class="line"><span></span></span>
<span class="line"><span>(比赛编号) → (比赛时间, 比赛场地)</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>对于非主属性来说，并非完全依赖候选键。这样会产生怎样的问题呢？</p>
<ol>
<li><code v-pre>数据冗余</code> ：如果一个球员可以参加 m 场比赛，那么球员的姓名和年龄就重复了 m-1 次。一个比赛 也可能会有 n 个球员参加，比赛的时间和地点就重复了 n-1 次。</li>
<li><code v-pre>插入异常</code> ：如果我们想要添加一场新的比赛，但是这时还没有确定参加的球员都有谁，那么就没法插入。</li>
<li><code v-pre>删除异常</code> ：如果我要删除某个球员编号，如果没有单独保存比赛表的话，就会同时把比赛信息删 除掉。</li>
<li><code v-pre>更新异常</code> ：如果我们调整了某个比赛的时间，那么数据表中所有这个比赛的时间都需要进行调 整，否则就会出现一场比赛时间不同的情况。</li>
</ol>
<p>为了避免出现上述的情况，我们可以把球员比赛表设计为下面的三张表。</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220707122639894.png" alt="image-20220707122639894" tabindex="0" loading="lazy"><figcaption>image-20220707122639894</figcaption></figure>
...
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220707123038469.png" alt="image-20220707123038469" tabindex="0" loading="lazy"><figcaption>image-20220707123038469</figcaption></figure>
...
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220707123104009.png" alt="image-20220707123104009" tabindex="0" loading="lazy"><figcaption>image-20220707123104009</figcaption></figure>
<blockquote>
<p>小结：第二范式（2NF）要求实体的属性完全依赖主关键字。如果存在不完全依赖，那么这个属性和主关键字的这一部分应该分离出来形成一个新的实体，新实体与元实体之间是一对多的关系。</p>
</blockquote>
<h3 id="_2-6-第三范式-3rd-nf" tabindex="-1"><a class="header-anchor" href="#_2-6-第三范式-3rd-nf"><span>2.6 第三范式(3rd NF)</span></a></h3>
<p>第三范式是在第二范式的基础上，确保数据表中的每一个非主键字段都和主键字段直接相关，也就是说，<strong>要求数据表中的所有非主键字段不能依赖于其他非主键字段</strong>。（即，不能存在非主属性A依赖于非主属性B，非主属性B依赖于主键C的情况，即存在“A-&gt;B-&gt;C&quot;的决定关系）通俗地讲，该规则的意思是所有<code v-pre>非主键属性</code>之间不能由依赖关系，必须<code v-pre>相互独立</code>。</p>
<p>这里的主键可以扩展为候选键。</p>
<p><strong>举例1：</strong></p>
<p><code v-pre>部门信息表</code> ：每个部门有部门编号（dept_id）、部门名称、部门简介等信息。</p>
...
<p><strong>举例2：</strong></p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220707124011654.png" alt="image-20220707124011654" tabindex="0" loading="lazy"><figcaption>image-20220707124011654</figcaption></figure>
<p>商品类别名称依赖于商品类别编号，不符合第三范式。</p>
<p>修改：</p>
<p>表1：符合第三范式的 <code v-pre>商品类别表</code> 的设计</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220707124040899.png" alt="image-20220707124040899" tabindex="0" loading="lazy"><figcaption>image-20220707124040899</figcaption></figure>
<p>表2：符合第三范式的 <code v-pre>商品表</code> 的设计</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220707124058174.png" alt="image-20220707124058174" tabindex="0" loading="lazy"><figcaption>image-20220707124058174</figcaption></figure>
...
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220707124136228.png" alt="image-20220707124136228" tabindex="0" loading="lazy"><figcaption>image-20220707124136228</figcaption></figure>
<p>你能看到球员编号决定了球队名称，同时球队名称决定了球队主教练，非主属性球队主教练就会传递依 赖于球员编号，因此不符合 3NF 的要求。</p>
<p>如果要达到 3NF 的要求，需要把数据表拆成下面这样：</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220707124152312.png" alt="image-20220707124152312" tabindex="0" loading="lazy"><figcaption>image-20220707124152312</figcaption></figure>
...
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220707124212114.png" alt="image-20220707124212114" tabindex="0" loading="lazy"><figcaption>image-20220707124212114</figcaption></figure>
<blockquote>
<p>符合3NF后的数据模型通俗地讲，2NF和3NF通常以这句话概括：“每个非键属性依赖于键，依赖于 整个键，并且除了键别无他物”。</p>
</blockquote>
<h3 id="_2-7-小结" tabindex="-1"><a class="header-anchor" href="#_2-7-小结"><span>2.7 小结</span></a></h3>
...
<h2 id="_3-反范式化" tabindex="-1"><a class="header-anchor" href="#_3-反范式化"><span>3. 反范式化</span></a></h2>
<h3 id="_3-1-概述" tabindex="-1"><a class="header-anchor" href="#_3-1-概述"><span>3.1 概述</span></a></h3>
...
<h3 id="_3-2-应用举例" tabindex="-1"><a class="header-anchor" href="#_3-2-应用举例"><span>3.2 应用举例</span></a></h3>
<p><strong>举例1：</strong></p>
...
<div class="language-mysql line-numbers-mode" data-highlighter="shiki" data-ext="mysql" data-title="mysql" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>select employee_id,department_name</span></span>
<span class="line"><span>from employees e join departments d</span></span>
<span class="line"><span>on e.department_id = d.department_id;</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果经常需要进行这个操作，连接查询就会浪费很多时间。可以在 employees 表中增加一个冗余字段 department_name，这样就不用每次都进行连接操作了。</p>
<p><strong>举例2：</strong></p>
<p>反范式化的 <code v-pre>goods商品信息表</code> 设计如下：</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220707125118808.png" alt="image-20220707125118808" tabindex="0" loading="lazy"><figcaption>image-20220707125118808</figcaption></figure>
<p><strong>举例3：</strong></p>
...
<p>商品流水表：</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220707125401029.png" alt="image-20220707125401029" tabindex="0" loading="lazy"><figcaption>image-20220707125401029</figcaption></figure>
<p>商品信息表：</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220707125447317.png" alt="image-20220707125447317" tabindex="0" loading="lazy"><figcaption>image-20220707125447317</figcaption></figure>
<p>新的商品流水表如下所示：</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220707125500378.png" alt="image-20220707125500378" tabindex="0" loading="lazy"><figcaption>image-20220707125500378</figcaption></figure>
<p><strong>举例4：</strong></p>
<p><code v-pre>课程评论表 class_comment</code> ，对应的字段名称及含义如下：</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220707125531172.png" alt="image-20220707125531172" tabindex="0" loading="lazy"><figcaption>image-20220707125531172</figcaption></figure>
...
<div class="language-mysql line-numbers-mode" data-highlighter="shiki" data-ext="mysql" data-title="mysql" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>SELECT p.comment_text, p.comment_time, stu.stu_name</span></span>
<span class="line"><span>FROM class_comment AS p LEFT JOIN student AS stu</span></span>
<span class="line"><span>ON p.stu_id = stu.stu_id</span></span>
<span class="line"><span>WHERE p.class_id = 10001</span></span>
<span class="line"><span>ORDER BY p.comment_id DESC</span></span>
<span class="line"><span>LIMIT 1000;</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>运行结果（1000 条数据行）：</p>
...
<div class="language-mysql line-numbers-mode" data-highlighter="shiki" data-ext="mysql" data-title="mysql" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>SELECT comment_text, comment_time, stu_name</span></span>
<span class="line"><span>FROM class_comment2</span></span>
<span class="line"><span>WHERE class_id = 10001</span></span>
<span class="line"><span>ORDER BY class_id DESC LIMIT 1000;</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>运行结果（1000 条数据）：</p>
...
<h3 id="_3-3-反范式的新问题" tabindex="-1"><a class="header-anchor" href="#_3-3-反范式的新问题"><span>3.3 反范式的新问题</span></a></h3>
<ul>
<li>存储 空间变大了</li>
...
<h3 id="_3-4-反范式的适用场景" tabindex="-1"><a class="header-anchor" href="#_3-4-反范式的适用场景"><span>3.4 反范式的适用场景</span></a></h3>
<p>当冗余信息有价值或者能 <code v-pre>大幅度提高查询效率</code> 的时候，我们才会采取反范式的优化。</p>
<h4 id="_1-增加冗余字段的建议" tabindex="-1"><a class="header-anchor" href="#_1-增加冗余字段的建议"><span>1. 增加冗余字段的建议</span></a></h4>
<p>增加冗余字段一定要符合如下两个条件。只要满足这两个条件，才可以考虑增加夯余字段。</p>
<p>1）这个冗余字段<code v-pre>不需要经常进行修改</code>。</p>
<p>2）这个冗余字段<code v-pre>查询的时候不可或缺</code>。</p>
<h4 id="_2-历史快照、历史数据的需要" tabindex="-1"><a class="header-anchor" href="#_2-历史快照、历史数据的需要"><span>2. 历史快照、历史数据的需要</span></a></h4>
<p>在现实生活中，我们经常需要一些冗余信息，比如订单中的收货人信息，包括姓名、电话和地址等。每 次发生的 <code v-pre>订单收货信息</code> 都属于 <code v-pre>历史快照</code> ，需要进行保存，但用户可以随时修改自己的信息，这时保存这 些冗余信息是非常有必要的。</p>
<p>反范式优化也常用在 <code v-pre>数据仓库</code> 的设计中，因为数据仓库通常<code v-pre>存储历史数据</code> ，对增删改的实时性要求不 强，对历史数据的分析需求强。这时适当允许数据的冗余度，更方便进行数据分析。</p>
<p>我简单总结下数据仓库和数据库在使用上的区别：</p>
<ol>
<li>数据库设计的目的在于<code v-pre>捕捉数据</code>，而数据仓库设计的目的在于<code v-pre>分析数据</code>。</li>
<li>数据库对数据的<code v-pre>增删改实时性</code>要求强，需要存储在线的用户数据，而数据仓库存储的一般是<code v-pre>历史数据</code>。</li>
<li>数据库设计需要<code v-pre>尽量避免冗余</code>，但为了提高查询效率也允许一定的<code v-pre>冗余度</code>，而数据仓库在设计上更偏向采用反范式设计，</li>
</ol>
<h2 id="_4-bcnf-巴斯范式" tabindex="-1"><a class="header-anchor" href="#_4-bcnf-巴斯范式"><span>4. BCNF(巴斯范式)</span></a></h2>
<p>人们在3NF的基础上进行了改进，提出了巴斯范式（BCNF），页脚巴斯 - 科德范式（Boyce - Codd Normal Form）。BCNF被认为没有新的设计规范加入，只是对第三范式中设计规范要求更强，使得数据库冗余度更小。所以，称为是<code v-pre>修正的第三范式</code>，或<code v-pre>扩充的第三范式</code>，BCNF不被称为第四范式。</p>
...
<p><code v-pre>候选键 </code>：是（管理员，物品名）和（仓库名，物品名），然后我们从候选键中选择一个作为主键 ，比 如（仓库名，物品名）。</p>
<p><code v-pre>主属性</code> ：包含在任一候选键中的属性，也就是仓库名，管理员和物品名。</p>
<p><code v-pre>非主属性</code> ：数量这个属性。</p>
...
<p><code v-pre>仓库表</code> ：（仓库名，管理员）</p>
<p><code v-pre>库存表 </code>：（仓库名，物品名，数量）</p>
<p>这样就不存在主属性对于候选键的部分依赖或传递依赖，上面数据表的设计就符合 BCNF。</p>
<p>再举例：</p>
<p>有一个 <code v-pre>学生导师表</code> ，其中包含字段：学生ID，专业，导师，专业GPA，这其中学生ID和专业是联合主键。</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220707132038425.png" alt="image-20220707132038425" tabindex="0" loading="lazy"><figcaption>image-20220707132038425</figcaption></figure>
...
<p>学生导师表：</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220707132344634.png" alt="image-20220707132344634" tabindex="0" loading="lazy"><figcaption>image-20220707132344634</figcaption></figure>
<p>导师表：</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220707132355841.png" alt="image-20220707132355841" tabindex="0" loading="lazy"><figcaption>image-20220707132355841</figcaption></figure>
<h2 id="_5-第四范式" tabindex="-1"><a class="header-anchor" href="#_5-第四范式"><span>5. 第四范式</span></a></h2>
<p>多值依赖的概念：</p>
<ul>
<li><code v-pre>多值依赖</code>即属性之间的一对多关系，记为K—&gt;—&gt;A。</li>
<li><code v-pre>函数依赖</code>事实上是单值依赖，所以不能表达属性值之间的一对多关系。</li>
<li><code v-pre>平凡的多值依赖</code>：全集U=K+A，一个K可以对应于多个A，即K—&gt;—&gt;A。此时整个表就是一组一对多关系。</li>
<li><code v-pre>非平凡的多值依赖</code>：全集U=K+A+B，一个K可以对应于多个A，也可以对应于多个B，A与B相互独立，即K—&gt;—&gt;A，K—&gt;—&gt;B。整个表有多组一对多关系，且有：&quot;一&quot;部分是相同的属性集合，“多”部分是相互独立的属性集合。</li>
</ul>
...
<p>如果要符合第四范式，只需要将上表分为两个表，使它们只有一个多值事实，例如： <code v-pre>职工表一</code> (职工编 号，职工孩子姓名)， <code v-pre>职工表二</code>(职工编号，职工选修课程)，两个表都只有一个多值事实，所以符合第四范式。</p>
<p><strong>举例2：</strong></p>
...
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220707133830721.png" alt="image-20220707133830721" tabindex="0" loading="lazy"><figcaption>image-20220707133830721</figcaption></figure>
...
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220707134028730.png" alt="image-20220707134028730" tabindex="0" loading="lazy"><figcaption>image-20220707134028730</figcaption></figure>
<p>以及</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220707134220820.png" alt="image-20220707134220820" tabindex="0" loading="lazy"><figcaption>image-20220707134220820</figcaption></figure>
<h2 id="_6-第五范式、域键范式" tabindex="-1"><a class="header-anchor" href="#_6-第五范式、域键范式"><span>6. 第五范式、域键范式</span></a></h2>
...
<p>函数依赖是多值依赖的一种特殊的情况，而多值依赖实际上是连接依赖的一种特殊情况。但连接依赖不 像函数依赖和多值依赖可以由 <code v-pre>语义直接导出</code> ，而是在 <code v-pre>关系连接运算</code> 时才反映出来。存在连接依赖的关系 模式仍可能遇到数据冗余及插入、修改、删除异常等问题。</p>
<p>第五范式处理的是 <code v-pre>无损连接问题</code> ，这个范式基本 <code v-pre>没有实际意义</code> ，因为无损连接很少出现，而且难以察觉。而域键范式试图定义一个 <code v-pre>终极范式</code> ，该范式考虑所有的依赖和约束类型，但是实用价值也是最小的，只存在理论研究中。</p>
<h2 id="_7-实战案例" tabindex="-1"><a class="header-anchor" href="#_7-实战案例"><span>7. 实战案例</span></a></h2>
<p>商超进货系统中的<code v-pre>进货单表</code>进行剖析：</p>
<p>进货单表：</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220707134636225.png" alt="image-20220707134636225" tabindex="0" loading="lazy"><figcaption>image-20220707134636225</figcaption></figure>
...
<h3 id="_7-1-迭代1次-考虑1nf" tabindex="-1"><a class="header-anchor" href="#_7-1-迭代1次-考虑1nf"><span>7.1 迭代1次：考虑1NF</span></a></h3>
...
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220707154400580.png" alt="image-20220707154400580" tabindex="0" loading="lazy"><figcaption>image-20220707154400580</figcaption></figure>
<h3 id="_7-2-迭代2次-考虑2nf" tabindex="-1"><a class="header-anchor" href="#_7-2-迭代2次-考虑2nf"><span>7.2 迭代2次：考虑2NF</span></a></h3>
...
<p>原来的数据表就拆分成了3个表。</p>
<p>进货单头表：</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220707164128704.png" alt="image-20220707164128704" tabindex="0" loading="lazy"><figcaption>image-20220707164128704</figcaption></figure>
<p>进货单明细表：</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220707164146216.png" alt="image-20220707164146216" tabindex="0" loading="lazy"><figcaption>image-20220707164146216</figcaption></figure>
<p>商品信息表：</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220707164227845.png" alt="image-20220707164227845" tabindex="0" loading="lazy"><figcaption>image-20220707164227845</figcaption></figure>
...
<h3 id="_7-3-迭代3次-考虑3nf" tabindex="-1"><a class="header-anchor" href="#_7-3-迭代3次-考虑3nf"><span>7.3 迭代3次：考虑3NF</span></a></h3>
<p>我们的进货单头表，还有数据冗余的可能。因为&quot;suppliername&quot;依赖&quot;supplierid&quot;，那么就可以按照第三范式的原则进行拆分了。我们就进一步拆分进货单头表，把它拆解陈供货商表和进货单头表。</p>
<p>供货商表：</p>
...
<p>这2个表都满足第三范式的要求了。</p>
<h3 id="_7-4-反范式化-业务优先的原则" tabindex="-1"><a class="header-anchor" href="#_7-4-反范式化-业务优先的原则"><span>7.4 反范式化：业务优先的原则</span></a></h3>
...
<h2 id="_8-er模型" tabindex="-1"><a class="header-anchor" href="#_8-er模型"><span>8. ER模型</span></a></h2>
...
<h3 id="_8-1-er模型包括哪些要素" tabindex="-1"><a class="header-anchor" href="#_8-1-er模型包括哪些要素"><span>8.1 ER模型包括哪些要素？</span></a></h3>
<p><strong>ER 模型中有三个要素，分别是实体、属性和关系。</strong></p>
<p><code v-pre>实体</code> ，可以看做是数据对象，往往对应于现实生活中的真实存在的个体。在 ER 模型中，用 矩形 来表 示。实体分为两类，分别是 强实体 和 弱实体 。强实体是指不依赖于其他实体的实体；弱实体是指对另 一个实体有很强的依赖关系的实体。</p>
<p><code v-pre>属性</code> ，则是指实体的特性。比如超市的地址、联系电话、员工数等。在 ER 模型中用 椭圆形 来表示。</p>
<p><code v-pre>关系</code> ，则是指实体之间的联系。比如超市把商品卖给顾客，就是一种超市与顾客之间的联系。在 ER 模 型中用 菱形 来表示。</p>
<p>注意：实体和属性不容易区分。这里提供一个原则：我们要从系统整体的角度出发去看，<strong>可以独立存在的是实体，不可再分的是属性</strong>。也就是说，属性不能包含其他属性。</p>
<h3 id="_8-2-关系的类型" tabindex="-1"><a class="header-anchor" href="#_8-2-关系的类型"><span>8.2 关系的类型</span></a></h3>
<p>在 ER 模型的 3 个要素中，关系又可以分为 3 种类型，分别是 一对一、一对多、多对多。</p>
<p><code v-pre>一对一</code> ：指实体之间的关系是一一对应的，比如个人与身份证信息之间的关系就是一对一的关系。一个人只能有一个身份证信息，一个身份证信息也只属于一个人。</p>
<p><code v-pre>一对多</code> ：指一边的实体通过关系，可以对应多个另外一边的实体。相反，另外一边的实体通过这个关系，则只能对应唯一的一边的实体。比如说，我们新建一个班级表，而每个班级都有多个学生，每个学 生则对应一个班级，班级对学生就是一对多的关系。</p>
<p><code v-pre>多对多</code> ：指关系两边的实体都可以通过关系对应多个对方的实体。比如在进货模块中，供货商与超市之 间的关系就是多对多的关系，一个供货商可以给多个超市供货，一个超市也可以从多个供货商那里采购 商品。再比如一个选课表，有许多科目，每个科目有很多学生选，而每个学生又可以选择多个科目，这 就是多对多的关系。</p>
<h3 id="_8-3-建模分析" tabindex="-1"><a class="header-anchor" href="#_8-3-建模分析"><span>8.3 建模分析</span></a></h3>
<p>ER 模型看起来比较麻烦，但是对我们把控项目整体非常重要。如果你只是开发一个小应用，或许简单设 计几个表够用了，一旦要设计有一定规模的应用，在项目的初始阶段，建立完整的 ER 模型就非常关键 了。开发应用项目的实质，其实就是 建模 。</p>
...
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220707170608782.png" alt="image-20220707170608782" tabindex="0" loading="lazy"><figcaption>image-20220707170608782</figcaption></figure>
...
<h3 id="_8-4-er-模型的细化" tabindex="-1"><a class="header-anchor" href="#_8-4-er-模型的细化"><span>8.4 ER 模型的细化</span></a></h3>
<p>有了这个 ER 模型，我们就可以从整体上 理解 电商的业务了。刚刚的 ER 模型展示了电商业务的框架， 但是只包括了订单，地址，用户，购物车，评论，商品，商品分类和订单详情这八个实体，以及它们之 间的关系，还不能对应到具体的表，以及表与表之间的关联。我们需要把 属性加上 ，用 椭圆 来表示， 这样我们得到的 ER 模型就更加完整了。</p>
...
<p>（1） <code v-pre>地址实体</code> 包括用户编号、省、市、地区、收件人、联系电话、是否是默认地址。</p>
<p>（2） <code v-pre>用户实体</code> 包括用户编号、用户名称、昵称、用户密码、手机号、邮箱、头像、用户级别。</p>
<p>（3） <code v-pre>购物车实体</code> 包括购物车编号、用户编号、商品编号、商品数量、图片文件url。</p>
<p>（4） <code v-pre>订单实体</code> 包括订单编号、收货人、收件人电话、总金额、用户编号、付款方式、送货地址、下单 时间。</p>
<p>（5） <code v-pre>订单详情实体</code> 包括订单详情编号、订单编号、商品名称、商品编号、商品数量。</p>
<p>（6） <code v-pre>商品实体</code> 包括商品编号、价格、商品名称、分类编号、是否销售，规格、颜色。</p>
...
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220707171022246.png" alt="image-20220707171022246" tabindex="0" loading="lazy"><figcaption>image-20220707171022246</figcaption></figure>
<h3 id="_8-5-er-模型图转换成数据表" tabindex="-1"><a class="header-anchor" href="#_8-5-er-模型图转换成数据表"><span>8.5 ER 模型图转换成数据表</span></a></h3>
...
<h4 id="_1-一个实体转换成一个数据库" tabindex="-1"><a class="header-anchor" href="#_1-一个实体转换成一个数据库"><span>1. 一个实体转换成一个数据库</span></a></h4>
<p><strong>先来看一下强实体转换成数据表:</strong></p>
<p><code v-pre>用户实体</code>转换成用户表(user_info)的代码如下所示。</p>
...
<h4 id="_2-一个多对多的关系转换成一个数据表" tabindex="-1"><a class="header-anchor" href="#_2-一个多对多的关系转换成一个数据表"><span>2. 一个多对多的关系转换成一个数据表</span></a></h4>
...
<h4 id="_3-通过外键来表达1对多的关系" tabindex="-1"><a class="header-anchor" href="#_3-通过外键来表达1对多的关系"><span>3. 通过外键来表达1对多的关系</span></a></h4>
...
<h4 id="_4-把属性转换成表的字段" tabindex="-1"><a class="header-anchor" href="#_4-把属性转换成表的字段"><span>4. 把属性转换成表的字段</span></a></h4>
...
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220707172918017.png" alt="image-20220707172918017" tabindex="0" loading="lazy"><figcaption>image-20220707172918017</figcaption></figure>
<h2 id="_9-数据表的设计原则" tabindex="-1"><a class="header-anchor" href="#_9-数据表的设计原则"><span>9. 数据表的设计原则</span></a></h2>
...
<h2 id="_10-数据库对象编写建议" tabindex="-1"><a class="header-anchor" href="#_10-数据库对象编写建议"><span>10. 数据库对象编写建议</span></a></h2>
<h3 id="_10-1-关于库" tabindex="-1"><a class="header-anchor" href="#_10-1-关于库"><span>10.1 关于库</span></a></h3>
<ol>
...
<h3 id="_10-2-关于表、列" tabindex="-1"><a class="header-anchor" href="#_10-2-关于表、列"><span>10.2 关于表、列</span></a></h3>
<ol>
<li>
<p>【强制】表和列的名称必须控制在32个字符以内，表名只能使用英文字母、数字和下划线，建议 以 英文字母开头 。</p>
</li>
<li>
<p>【强制】 表名、列名一律小写 ，不同单词采用下划线分割。须见名知意。</p>
</li>
<li>
<p>【强制】表名要求有模块名强相关，同一模块的表名尽量使用 统一前缀 。比如：crm_fund_item</p>
</li>
<li>
<p>【强制】创建表时必须 显式指定字符集 为utf8或utf8mb4。</p>
</li>
<li>
<p>【强制】表名、列名禁止使用关键字（如type,order等）。</p>
</li>
<li>
<p>【强制】创建表时必须 显式指定表存储引擎 类型。如无特殊需求，一律为InnoDB。</p>
</li>
<li>
<p>【强制】建表必须有comment。</p>
</li>
<li>
<p>【强制】字段命名应尽可能使用表达实际含义的英文单词或 缩写 。如：公司 ID，不要使用 corporation_id, 而用corp_id 即可。</p>
</li>
<li>
<p>【强制】布尔值类型的字段命名为 is_描述 。如member表上表示是否为enabled的会员的字段命 名为 is_enabled。</p>
</li>
<li>
<p>【强制】禁止在数据库中存储图片、文件等大的二进制数据 通常文件很大，短时间内造成数据量快速增长，数据库进行数据库读取时，通常会进行大量的随 机IO操作，文件很大时，IO操作很耗时。通常存储于文件服务器，数据库只存储文件地址信息。</p>
</li>
<li>
<p>【建议】建表时关于主键： 表必须有主键</p>
...
<li>
<p>【建议】核心表（如用户表）必须有行数据的 创建时间字段 （create_time）和 最后更新时间字段 （update_time），便于查问题。</p>
</li>
<li>
<p>【建议】表中所有字段尽量都是 NOT NULL 属性，业务可以根据需要定义 DEFAULT值 。 因为使用 NULL值会存在每一行都会占用额外存储空间、数据迁移容易出错、聚合函数计算结果偏差等问 题。</p>
</li>
<li>
<p>【建议】所有存储相同数据的 列名和列类型必须一致 （一般作为关联列，如果查询时关联列类型 不一致会自动进行数据类型隐式转换，会造成列上的索引失效，导致查询效率降低）。</p>
</li>
<li>
<p>【建议】中间表（或临时表）用于保留中间结果集，名称以 tmp_ 开头。 备份表用于备份或抓取源表快照，名称以 bak_ 开头。中间表和备份表定期清理。 1</p>
</li>
<li>
<p>【示范】一个较为规范的建表语句：</p>
</li>
</ol>
<div class="language-mysql line-numbers-mode" data-highlighter="shiki" data-ext="mysql" data-title="mysql" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>CREATE TABLE user_info (</span></span>
<span class="line"><span>`id` int unsigned NOT NULL AUTO_INCREMENT COMMENT '自增主键',</span></span>
<span class="line"><span>`user_id` bigint(11) NOT NULL COMMENT '用户id',</span></span>
<span class="line"><span>`username` varchar(45) NOT NULL COMMENT '真实姓名',</span></span>
<span class="line"><span>`email` varchar(30) NOT NULL COMMENT '用户邮箱',</span></span>
<span class="line"><span>`nickname` varchar(45) NOT NULL COMMENT '昵称',</span></span>
<span class="line"><span>`birthday` date NOT NULL COMMENT '生日',</span></span>
<span class="line"><span>`sex` tinyint(4) DEFAULT '0' COMMENT '性别',</span></span>
<span class="line"><span>`short_introduce` varchar(150) DEFAULT NULL COMMENT '一句话介绍自己，最多50个汉字',</span></span>
<span class="line"><span>`user_resume` varchar(300) NOT NULL COMMENT '用户提交的简历存放地址',</span></span>
<span class="line"><span>`user_register_ip` int NOT NULL COMMENT '用户注册时的源ip',</span></span>
<span class="line"><span>`create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',</span></span>
<span class="line"><span>`update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE</span></span>
<span class="line"><span>CURRENT_TIMESTAMP COMMENT '修改时间',</span></span>
<span class="line"><span>`user_review_status` tinyint NOT NULL COMMENT '用户资料审核状态，1为通过，2为审核中，3为未</span></span>
<span class="line"><span>通过，4为还未提交审核',</span></span>
<span class="line"><span>PRIMARY KEY (`id`),</span></span>
<span class="line"><span>UNIQUE KEY `uniq_user_id` (`user_id`),</span></span>
<span class="line"><span>KEY `idx_username`(`username`),</span></span>
<span class="line"><span>KEY `idx_create_time_status`(`create_time`,`user_review_status`)</span></span>
<span class="line"><span>) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='网站用户基本信息</span></span></code></pre>
...
<h3 id="_10-3-关于索引" tabindex="-1"><a class="header-anchor" href="#_10-3-关于索引"><span>10.3 关于索引</span></a></h3>
<ol>
...
<h3 id="_10-4-sql编写" tabindex="-1"><a class="header-anchor" href="#_10-4-sql编写"><span>10.4 SQL编写</span></a></h3>
<ol>
...
<h2 id="_11-powerdesigner的使用" tabindex="-1"><a class="header-anchor" href="#_11-powerdesigner的使用"><span>11. PowerDesigner的使用</span></a></h2>
<p>PowerDesigner是一款开发人员常用的数据库建模工具，用户利用该软件可以方便地制作 <code v-pre>数据流程图</code> 、 <code v-pre>概念数据模型</code> 、 <code v-pre>物理数据模型</code> ，它几乎包括了数据库模型设计的全过程，是Sybase公司为企业建模和设 计提供的一套完整的集成化企业级建模解决方案。</p>
<h3 id="_11-1-开始界面" tabindex="-1"><a class="header-anchor" href="#_11-1-开始界面"><span>11.1 开始界面</span></a></h3>
...
<h3 id="_11-2-概念数据模型" tabindex="-1"><a class="header-anchor" href="#_11-2-概念数据模型"><span>11.2 概念数据模型</span></a></h3>
<p>常用的模型有4种，分别是 <code v-pre>概念模型(CDM Conceptual Data Model)</code> ， <code v-pre>物理模型（PDM,Physical Data Model）</code> ， <code v-pre>面向对象的模型（OOM Objcet Oriented Model）</code> 和 <code v-pre>业务模型（BPM Business Process Model）</code> ，我们先创建概念数据模型。</p>
...
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220707180254510.png" alt="image-20220707180254510" tabindex="0" loading="lazy"><figcaption>image-20220707180254510</figcaption></figure>
<h3 id="_11-3-物理数据模型" tabindex="-1"><a class="header-anchor" href="#_11-3-物理数据模型"><span>11.3 物理数据模型</span></a></h3>
...
<p>创建好主页面如图所示，但是右边的按钮和概念模型略有差别，物理模型最常用的三个是 <code v-pre>table(表)</code> ， <code v-pre>view(视图)</code>， <code v-pre>reference(关系) </code>；</p>
...
<h3 id="_11-4-概念模型转为物理模型" tabindex="-1"><a class="header-anchor" href="#_11-4-概念模型转为物理模型"><span>11.4 概念模型转为物理模型</span></a></h3>
<p>1：如下图所示先打开概念模型图，然后点击Tool,如下图所示</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220707194228064.png" alt="image-20220707194228064" tabindex="0" loading="lazy"><figcaption>image-20220707194228064</figcaption></figure>
<p>点开的页面如下所示，name和code已经从概念模型1改成物理模型1了</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220707194248236.png" alt="image-20220707194248236" tabindex="0" loading="lazy"><figcaption>image-20220707194248236</figcaption></figure>
<p>完成后如下图所示，将自行打开修改的物理模型，需要注意的是这些表的数据类型已经自行改变了，而 且中间表出现两个主键，即双主键</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220707194308595.png" alt="image-20220707194308595" tabindex="0" loading="lazy"><figcaption>image-20220707194308595</figcaption></figure>
<h3 id="_11-5-物理模型转为概念模型" tabindex="-1"><a class="header-anchor" href="#_11-5-物理模型转为概念模型"><span>11.5 物理模型转为概念模型</span></a></h3>
<p>上面介绍了概念模型转物理模型，下面介绍一下物理模型转概念模型（如下图点击操作即可）</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220707194405358.png" alt="image-20220707194405358" tabindex="0" loading="lazy"><figcaption>image-20220707194405358</figcaption></figure>
<p>然后出现如下图所示界面，然后将物理修改为概念 ，点击应用确认即可</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220707194419360.png" alt="image-20220707194419360" tabindex="0" loading="lazy"><figcaption>image-20220707194419360</figcaption></figure>
<p>点击确认后将自行打开如下图所示的页面，自己观察有何变化，如果转换为oracle的，数据类型会发生变 化，比如Varchar2等等）；</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220707194433407.png" alt="image-20220707194433407" tabindex="0" loading="lazy"><figcaption>image-20220707194433407</figcaption></figure>
<h3 id="_11-6-物理模型导出sql语句" tabindex="-1"><a class="header-anchor" href="#_11-6-物理模型导出sql语句"><span>11.6 物理模型导出SQL语句</span></a></h3>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220707194544714.png" alt="image-20220707194544714" tabindex="0" loading="lazy"><figcaption>image-20220707194544714</figcaption></figure>
<p>打开之后如图所示，修改好存在sql语句的位置和生成文件的名称即可</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220707194557554.png" alt="image-20220707194557554" tabindex="0" loading="lazy"><figcaption>image-20220707194557554</figcaption></figure>
<p>在Selection中选择需要导出的表，然后点击应用和确认即可</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220707194637242.png" alt="image-20220707194637242" tabindex="0" loading="lazy"><figcaption>image-20220707194637242</figcaption></figure>
<p>完成以后出现如下图所示，可以点击Edit或者close按钮</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220707194727849.png" alt="image-20220707194727849" tabindex="0" loading="lazy"><figcaption>image-20220707194727849</figcaption></figure>
