...
<p>大家好，我是Leo😀，之前自学那会有简单了解过MyBatisPlus相关文档，但是随着时间长不用，一些api以及配置都忘了，想翻笔记发现当时的自己只是囫囵吞枣的学习了，任何学习记录都没有留下来，😅😅😅，所以大家可千万不要学我哈！ 这不最近打算重新学习一下MyBatisPlus（下文简称MP），这里也是写篇博客来整理一下相关知识点，与君共勉🫡🫡🫡！</p>
</blockquote>
<p>话不多说，我们先来看一张简单的思维导图，了解一下MP的主要核心功能，脑图在手，思路我有，开干🤔！</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/cisyam/202308311130935.png" alt="image-20230831113008757" tabindex="0" loading="lazy"><figcaption>image-20230831113008757</figcaption></figure>
<h2 id="_1-快速开始" tabindex="-1"><a class="header-anchor" href="#_1-快速开始" aria-hidden="true">#</a> 1. 快速开始</h2>
<h3 id="_1-1-介绍" tabindex="-1"><a class="header-anchor" href="#_1-1-介绍" aria-hidden="true">#</a> 1.1 介绍</h3>
<p>在快速开始我们入门Demo之前，我来首先简单介绍一下 <strong>MP</strong></p>
<p>官网： <a href="https://baomidou.com/" target="_blank" rel="noopener noreferrer">https://baomidou.com/<ExternalLinkIcon/></a><br>
简介：<code v-pre>MyBatis-Plus</code> (opens new window)（简称 MP）是一个 MyBatis (opens new window)的增强工具，在 MyBatis 的基础上只做增强不做改变，为简化开发、提高效率而生。</p>
<blockquote>
<p>愿景：<br>
我们的愿景是成为 MyBatis 最好的搭档，就像 魂斗罗 中的 1P、2P，基友搭配，效率翻倍。</p>
</blockquote>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/cisyam/202308311139334.png" alt="image-20230831113906219" tabindex="0" loading="lazy"><figcaption>image-20230831113906219</figcaption></figure>
<p><strong>特性：</strong></p>
<ol>
<li>
<p>无侵入：只做增强不做改变，引入它不会对现有工程产生影响，如丝般顺滑</p>
</li>
<li>
<p>损耗小：启动即会自动注入基本 CURD，性能基本无损耗，直接面向对象操作</p>
</li>
<li>
<p>强大的 CRUD 操作：内置通用 Mapper、通用 Service，仅仅通过少量配置即可实现单表大部分</p>
<p>CRUD 操作，更有强大的条件构造器，满足各类使用需求</p>
</li>
<li>
<p>支持 Lambda 形式调用：通过 Lambda 表达式，方便的编写各类查询条件，无需再担心字段写错</p>
</li>
<li>
<p>支持主键自动生成：支持多达 4 种主键策略（内含分布式唯一 ID 生成器 - Sequence），可自由配置，完美解决主键问题</p>
</li>
<li>
<p>支持 ActiveRecord 模式：支持 ActiveRecord 形式调用，实体类只需继承 Model 类即可进行强大的 CRUD 操作</p>
</li>
<li>
<p>支持自定义全局通用操作：支持全局通用方法注入（ Write once, use anywhere ）</p>
</li>
<li>
<p>内置代码生成器：采用代码或者 Maven 插件可快速生成 Mapper 、 Model 、 Service 、 Controller 层代码，支持模板引擎，更有超多自定义配置等您来使用</p>
</li>
<li>
<p>内置分页插件：基于 MyBatis 物理分页，开发者无需关心具体操作，配置好插件之后，写分页等同于普通 List 查询</p>
</li>
<li>
<p>分页插件支持多种数据库：支持 MySQL、MariaDB、Oracle、DB2、H2、HSQL、SQLite、Postgre、SQLServer 等多种数据库</p>
</li>
<li>
<p>内置性能分析插件：可输出 Sql 语句以及其执行时间，建议开发测试时启用该功能，能快速揪出慢查询</p>
</li>
<li>
<p>内置全局拦截插件：提供全表 delete 、 update 操作智能分析阻断，也可自定义拦截规则，预防误操</p>
</li>
</ol>
<h3 id="_1-2-框架设计" tabindex="-1"><a class="header-anchor" href="#_1-2-框架设计" aria-hidden="true">#</a> 1.2 框架设计</h3>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/cisyam/202308311143114.png" alt="image-20230831114321021" tabindex="0" loading="lazy"><figcaption>image-20230831114321021</figcaption></figure>
<h3 id="_1-3-快速入门mp" tabindex="-1"><a class="header-anchor" href="#_1-3-快速入门mp" aria-hidden="true">#</a> 1.3 快速入门MP</h3>
<p><strong>我们将通过一个简单的 Demo 来阐述 MyBatis-Plus 的强大功能，在此之前，你需要学会：</strong></p>
<ul>
<li>Java 开发环境以及相应 IDE</li>
<li>熟悉 Spring Boot</li>
<li>熟悉 Maven</li>
</ul>
<h4 id="_1-创建表结构" tabindex="-1"><a class="header-anchor" href="#_1-创建表结构" aria-hidden="true">#</a> 1. 创建表结构</h4>
<p>现有一张 <code v-pre>User</code> 表，其表结构如下：</p>
<table>
<thead>
<tr>
...
<td style="text-align:center"><a href="mailto:admin@qq.com">admin@qq.com</a></td>
<td style="text-align:center">湖北武汉</td>
</tr>
<tr>
<td style="text-align:center">3</td>
<td style="text-align:center">test</td>
<td style="text-align:center">20</td>
<td style="text-align:center"><a href="mailto:test@qq.com">test@qq.com</a></td>
<td style="text-align:center">安徽合肥</td>
</tr>
<tr>
<td style="text-align:center">4</td>
<td style="text-align:center">zhangsan</td>
<td style="text-align:center">17</td>
<td style="text-align:center"><a href="mailto:zhangsan@qq.com">zhangsan@qq.com</a></td>
<td style="text-align:center">北京海淀</td>
</tr>
</tbody>
</table>
...
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token keyword">DELETE</span> <span class="token keyword">FROM</span> <span class="token keyword">user</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_2-创建springboot工程" tabindex="-1"><a class="header-anchor" href="#_2-创建springboot工程" aria-hidden="true">#</a> 2. 创建SpringBoot工程</h4>
<p>本次教程会以<code v-pre>Maven</code>工程创建修改为<code v-pre>SpringBoot</code>工程。</p>
<p>我这里是在父工程下面创建许多子模块，这样就不需要每一个新的demo都需要去创建一个新的工程了，也方便Demo项目统一管理。</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/cisyam/202308311159740.png" alt="image-20230831115942637" tabindex="0" loading="lazy"><figcaption>image-20230831115942637</figcaption></figure>
<h4 id="_3-添加依赖" tabindex="-1"><a class="header-anchor" href="#_3-添加依赖" aria-hidden="true">#</a> 3. 添加依赖</h4>
<p>引入 SpringBoot Starter 父工程：</p>
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code>  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>parent</span><span class="token punctuation">></span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>引入 <code v-pre>spring-boot-starter</code>、<code v-pre>spring-boot-starter-test</code>、<code v-pre>mybatis-plus-boot-starter</code>、MySQL依赖：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_4-配置" tabindex="-1"><a class="header-anchor" href="#_4-配置" aria-hidden="true">#</a> 4. 配置</h4>
<p>在 <code v-pre>application.yml</code> 配置文件中添加 MySQL数据库的相关配置：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在 Spring Boot 启动类中添加 <code v-pre>@MapperScan</code> 注解，扫描 Mapper 文件夹：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_5-编码" tabindex="-1"><a class="header-anchor" href="#_5-编码" aria-hidden="true">#</a> 5. 编码</h4>
<p>编写实体类 <code v-pre>User.java</code>（此处使用了 <a href="https://www.projectlombok.org/" target="_blank" rel="noopener noreferrer">Lombok (opens new window)<ExternalLinkIcon/></a>简化代码）</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>编写 Mapper 包下的 <code v-pre>UserMapper</code>接口</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_6-测试" tabindex="-1"><a class="header-anchor" href="#_6-测试" aria-hidden="true">#</a> 6. 测试</h4>
<p>以上工作都做完就可以开始进行<strong>功能测试</strong>了</p>
<div class="language-JAVA line-numbers-mode" data-ext="JAVA"><pre v-pre class="language-JAVA"><code>package com.Leo.mp.controller;
...
<p>提示</p>
<p>UserMapper 中的 <code v-pre>selectList()</code> 方法的参数为 MP 内置的条件封装器 <code v-pre>Wrapper</code>，所以不填写就是无任何条件</p>
</blockquote>
<p>启动项目，打开浏览器</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/cisyam/202308311345854.png" alt="image-20230831134539746" tabindex="0" loading="lazy"><figcaption>image-20230831134539746</figcaption></figure>
<h4 id="_7-小结" tabindex="-1"><a class="header-anchor" href="#_7-小结" aria-hidden="true">#</a> 7. 小结</h4>
<p>通过以上几个简单的步骤，我们就实现了 User 表的 <code v-pre>查询</code> 功能，甚至连 XML 文件都不用编写！</p>
<p>从以上步骤中，我们可以看到集成<code v-pre>MyBatis-Plus</code>非常的简单，只需要引入 starter 工程，并配置 mapper 扫描路径即可。</p>
<p>但 <code v-pre>MP</code> 的强大远不止这些功能，想要详细了解 那就继续往下看吧！</p>
<h2 id="_2-常见注解" tabindex="-1"><a class="header-anchor" href="#_2-常见注解" aria-hidden="true">#</a> 2. 常见注解</h2>
<p>本文将介绍 <code v-pre>MybatisPlus</code> 注解包相关类详解（更多详细描述可点击查看源码注释）</p>
<h3 id="_2-1-tablename" tabindex="-1"><a class="header-anchor" href="#_2-1-tablename" aria-hidden="true">#</a> 2.1 @TableName</h3>
<ul>
<li>描述：表名注解，标识实体类对应的表, 通俗来说就是让<strong>数据库表名和实体类一一对应</strong></li>
<li>使用位置：<code v-pre>实体类</code></li>
</ul>
<div class="language-JAVA line-numbers-mode" data-ext="JAVA"><pre v-pre class="language-JAVA"><code>@TableName(&quot;user&quot;)
public class User {
    private Long id;
    private String  name;
    private Integer age;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/cisyam/202308311349329.png" alt="image-20230831134901251" tabindex="0" loading="lazy"><figcaption>image-20230831134901251</figcaption></figure>
<p><strong>关于 <code v-pre>autoResultMap</code> 的说明：</strong></p>
<p>MP 会自动构建一个 <code v-pre>resultMap</code> 并注入到 MyBatis 里（一般用不上），请注意以下内容：</p>
<p>因为 MP 底层是 MyBatis，所以 MP 只是帮您注入了常用 CRUD 到 MyBatis 里，注入之前是动态的（根据您的 <code v-pre>实体类字段</code>以及注解变化而变化），但是注入之后是静态的（等于 <code v-pre>XML</code> 配置中的内容）。</p>
<h3 id="_2-2-tableid" tabindex="-1"><a class="header-anchor" href="#_2-2-tableid" aria-hidden="true">#</a> 2.2 @TableId</h3>
<div class="language-JAVA line-numbers-mode" data-ext="JAVA"><pre v-pre class="language-JAVA"><code>public class User {
    @TableId
    private Long id;
    private String  name;
    private Integer age;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/cisyam/202308311414821.png" alt="image-20230831141456740" tabindex="0" loading="lazy"><figcaption>image-20230831141456740</figcaption></figure>
<p><strong>IdType</strong></p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/cisyam/202308311352575.png" alt="image-20230831135246510" tabindex="0" loading="lazy"><figcaption>image-20230831135246510</figcaption></figure>
<h3 id="_2-3-tablefield" tabindex="-1"><a class="header-anchor" href="#_2-3-tablefield" aria-hidden="true">#</a> 2.3 @TableField</h3>
<ul>
<li>描述：<strong>字段注解</strong>（非主键）</li>
</ul>
<div class="language-JAVA line-numbers-mode" data-ext="JAVA"><pre v-pre class="language-JAVA"><code>public class User {
    private Long id;
    @TableField(&quot;username&quot;)
...
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/cisyam/202308311400413.png" alt="image-20230831140046119" tabindex="0" loading="lazy"><figcaption>image-20230831140046119</figcaption></figure>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/cisyam/202308311359990.png" alt="image-20230831135918882" tabindex="0" loading="lazy"><figcaption>image-20230831135918882</figcaption></figure>
<h3 id="_2-4-fieldfill" tabindex="-1"><a class="header-anchor" href="#_2-4-fieldfill" aria-hidden="true">#</a> 2.4 FieldFill</h3>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/cisyam/202308311401931.png" alt="image-20230831140158881" tabindex="0" loading="lazy"><figcaption>image-20230831140158881</figcaption></figure>
<h3 id="_2-5-乐观锁" tabindex="-1"><a class="header-anchor" href="#_2-5-乐观锁" aria-hidden="true">#</a> 2.5 乐观锁</h3>
<blockquote>
<p>描述：乐观锁注解、标记 <code v-pre>@Version</code> 在字段</p>
</blockquote>
<h3 id="_2-6-tablelogic" tabindex="-1"><a class="header-anchor" href="#_2-6-tablelogic" aria-hidden="true">#</a> 2.6 @TableLogic</h3>
<blockquote>
<p>描述：表字段逻辑处理注解（逻辑删除）</p>
</blockquote>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/cisyam/202308311403776.png" alt="image-20230831140301725" tabindex="0" loading="lazy"><figcaption>image-20230831140301725</figcaption></figure>
<h3 id="_2-7-orderby" tabindex="-1"><a class="header-anchor" href="#_2-7-orderby" aria-hidden="true">#</a> 2.7 @OrderBy</h3>
<blockquote>
<p>描述：内置 SQL 默认指定排序，优先级低于 wrapper 条件查询</p>
</blockquote>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/cisyam/202308311403898.png" alt="image-20230831140357839" tabindex="0" loading="lazy"><figcaption>image-20230831140357839</figcaption></figure>
<h2 id="_3-核心功能" tabindex="-1"><a class="header-anchor" href="#_3-核心功能" aria-hidden="true">#</a> 3. 核心功能</h2>
<h3 id="_3-1-主键策略" tabindex="-1"><a class="header-anchor" href="#_3-1-主键策略" aria-hidden="true">#</a> 3.1 主键策略</h3>
<p><code v-pre>MP</code>默认实现5种主键生成策略，分别是：</p>
<ul>
<li><strong>AUTO</strong> ：  配合数据库设置自增主键，可以实现主键的自动增长，类型为 <code v-pre>nmber</code>。</li>
<li><strong>INPUT</strong> ： 由用户输入。</li>
<li><strong>NONE</strong> ： 不设置，等同于<code v-pre>INPUT</code> 。</li>
<li><strong>ASSIGN_ID</strong> ：只有当用户未输入时，采用雪花算法生成一个适用于分布式环境的全局唯一主键，类型可以是<code v-pre>String</code>和<code v-pre>number</code>。</li>
<li><strong>ASSIGN_UUID</strong> ：只有当用户未输入时，生成一个String类型的主键，但不保证全局唯一。</li>
</ul>
<p><code v-pre>IdType</code>默认的全局设置为IdType.ASSIGN_ID,即由mybatis-plus主动分配主键，默认情况下由默认主键生成器实现类DefaultIdentifierGenerator采用雪花算法填充主键。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token class-name">DbConfig</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在<code v-pre>SpringBoot</code>中，可以通过如下配置更改全局配置。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-2-条件构造器" tabindex="-1"><a class="header-anchor" href="#_3-2-条件构造器" aria-hidden="true">#</a> 3.2 条件构造器</h3>
<blockquote>
<p>说明:</p>
<ul>
<li>以下出现的第一个入参<code v-pre>boolean condition</code>表示该条件<strong>是否</strong>加入最后生成的sql中，例如：query.like(StringUtils.isNotBlank(name), Entity::getName, name) .eq(age!=null &amp;&amp; age &gt;= 0, Entity::getAge, age)</li>
<li>以下代码块内的多个方法均为从上往下补全个别<code v-pre>boolean</code>类型的入参,默认为<code v-pre>true</code></li>
<li>以下出现的泛型<code v-pre>Param</code>均为<code v-pre>Wrapper</code>的子类实例(均具有<code v-pre>AbstractWrapper</code>的所有方法)</li>
<li>以下方法在入参中出现的<code v-pre>R</code>为泛型,在普通wrapper中是<code v-pre>String</code>,在<code v-pre>LambdaWrapper</code>中是 函数 (例:<code v-pre>Entity::getId</code>,<code v-pre>Entity</code>为实体类,<code v-pre>getId</code>为字段<code v-pre>id</code>的 getter Method )</li>
<li>以下方法入参中的<code v-pre>R column</code>均表示数据库字段,当<code v-pre>R</code>具体类型为<code v-pre>String</code>时则为数据库字段名( 字段名是数据库关键字的自己用转义符包裹 )!而不是实体类数据字段名!!!,另当<code v-pre>R</code>具体类型为<code v-pre>SFunction</code>时项目runtime不支持eclipse自家的编译器!!!</li>
</ul>
</blockquote>
<p>下面看一图来简单了解一下<code v-pre>Wrapper</code>的结构</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/cisyam/202308311432734.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h4 id="_1-wrapper" tabindex="-1"><a class="header-anchor" href="#_1-wrapper" aria-hidden="true">#</a> 1. Wrapper</h4>
<p>条件构造抽象类，最顶端父类，抽象类中提供3个方法以及其他方法</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/cisyam/202308311434983.png" alt="image-20230831143422871" tabindex="0" loading="lazy"><figcaption>image-20230831143422871</figcaption></figure>
<h4 id="_2-abstractwrapper" tabindex="-1"><a class="header-anchor" href="#_2-abstractwrapper" aria-hidden="true">#</a> 2. AbstractWrapper</h4>
<blockquote>
<p>用于查询条件封装，生成 sql 的 where 条件,QueryWrapper(LambdaQueryWrapper) 和UpdateWrapper(LambdaUpdateWrapper) 的父类用于生成 sql 的 where 条件, entity 属性也用于生成 sql 的 where条件</p>
</blockquote>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/cisyam/202308311435680.png" alt="image-20230831143514543" tabindex="0" loading="lazy"><figcaption>image-20230831143514543</figcaption></figure>
<p>这里列举一下他的重要方法</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/cisyam/202308311435421.png" alt="image-20230831143553299" tabindex="0" loading="lazy"><figcaption>image-20230831143553299</figcaption></figure>
<h4 id="_3-abstractlambdawrapper" tabindex="-1"><a class="header-anchor" href="#_3-abstractlambdawrapper" aria-hidden="true">#</a> 3. AbstractLambdaWrapper</h4>
<blockquote>
<p>Lambda 语法使用 Wrapper统一处理解析 lambda 获取 column。</p>
</blockquote>
<h4 id="_4-lambdaquerywrapper" tabindex="-1"><a class="header-anchor" href="#_4-lambdaquerywrapper" aria-hidden="true">#</a> 4. LambdaQueryWrapper</h4>
<blockquote>
<p>用于Lambda语法使用的查询Wrapper</p>
</blockquote>
<h4 id="_5-lambdaupdatewrapper" tabindex="-1"><a class="header-anchor" href="#_5-lambdaupdatewrapper" aria-hidden="true">#</a> 5. LambdaUpdateWrapper</h4>
<blockquote>
<p>Lambda 更新封装Wrapper</p>
</blockquote>
<h4 id="_6-querywrapper" tabindex="-1"><a class="header-anchor" href="#_6-querywrapper" aria-hidden="true">#</a> 6. QueryWrapper</h4>
<blockquote>
<p>实体类 对象封装操作类，不是用lambda语法,自身的内部属性 实体类 也用于生成 where 条件</p>
</blockquote>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/cisyam/202308311437171.png" alt="image-20230831143717067" tabindex="0" loading="lazy"><figcaption>image-20230831143717067</figcaption></figure>
<h4 id="_7-updatewrapper" tabindex="-1"><a class="header-anchor" href="#_7-updatewrapper" aria-hidden="true">#</a> 7. UpdateWrapper</h4>
<blockquote>
<p>说明:</p>
<p>继承自 <code v-pre>AbstractWrapper</code> ,自身的内部属性 <code v-pre>entity</code> 也用于生成 where 条件<br>
及 <code v-pre>LambdaUpdateWrapper</code>, 可以通过 <code v-pre>new UpdateWrapper().lambda()</code> 方法获取!</p>
</blockquote>
<h5 id="set" tabindex="-1"><a class="header-anchor" href="#set" aria-hidden="true">#</a> set</h5>
...
<li>SQL SET 字段</li>
<li>例: <code v-pre>set(&quot;name&quot;, &quot;Leo&quot;)</code></li>
<li>例: <code v-pre>set(&quot;name&quot;, &quot;&quot;)</code>---&gt;数据库字段值变为<strong>空字符串</strong></li>
<li>例: <code v-pre>set(&quot;name&quot;, null)</code>---&gt;数据库字段值变为<code v-pre>null</code></li>
</ul>
<h5 id="setsql" tabindex="-1"><a class="header-anchor" href="#setsql" aria-hidden="true">#</a> setSql</h5>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token function">setSql</span><span class="token punctuation">(</span><span class="token class-name">String</span> sql<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul>
<li>设置 SET 部分 SQL</li>
<li>例: <code v-pre>setSql(&quot;name = 'Leo'&quot;)</code></li>
</ul>
<h5 id="lambda" tabindex="-1"><a class="header-anchor" href="#lambda" aria-hidden="true">#</a> lambda</h5>
<ul>
<li>获取 <code v-pre>LambdaWrapper</code><br>
在<code v-pre>QueryWrapper</code>中是获取<code v-pre>LambdaQueryWrapper</code><br>
在<code v-pre>UpdateWrapper</code>中是获取<code v-pre>LambdaUpdateWrapper</code></li>
</ul>
<h3 id="_3-3-crud接口" tabindex="-1"><a class="header-anchor" href="#_3-3-crud接口" aria-hidden="true">#</a> 3.3 CRUD接口</h3>
<h4 id="_1-带条件查询" tabindex="-1"><a class="header-anchor" href="#_1-带条件查询" aria-hidden="true">#</a> 1. 带条件查询</h4>
<div class="language-JAVA line-numbers-mode" data-ext="JAVA"><pre v-pre class="language-JAVA"><code>// 根据 entity 条件，查询一条记录
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_2-带条件更新" tabindex="-1"><a class="header-anchor" href="#_2-带条件更新" aria-hidden="true">#</a> 2. 带条件更新</h4>
<div class="language-JAVA line-numbers-mode" data-ext="JAVA"><pre v-pre class="language-JAVA"><code>	UpdateWrapper&lt;Student&gt; updateWrapper = new UpdateWrapper&lt;Student&gt;();
	updateWrapper.eq(&quot;name&quot;, &quot;Leo&quot;).eq(&quot;age&quot;, 18).set(&quot;id&quot;, 100);
	empolyeeMapper.update(student, updateWrapper);
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_3-带条件删除" tabindex="-1"><a class="header-anchor" href="#_3-带条件删除" aria-hidden="true">#</a> 3. 带条件删除</h4>
<div class="language-JAVA line-numbers-mode" data-ext="JAVA"><pre v-pre class="language-JAVA"><code>// 根据 entity 条件，删除记录
int delete(@Param(Constants.WRAPPER) Wrapper&lt;T&gt; wrapper);
// 根据 columnMap 条件，删除记录
int deleteByMap(@Param(Constants.COLUMN_MAP) Map&lt;String, Object&gt; columnMap);
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_4-实战案例" tabindex="-1"><a class="header-anchor" href="#_4-实战案例" aria-hidden="true">#</a> 4. 实战案例</h4>
<div class="language-JAVA line-numbers-mode" data-ext="JAVA"><pre v-pre class="language-JAVA"><code>package com.Leo.mp;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-4-代码生成器" tabindex="-1"><a class="header-anchor" href="#_3-4-代码生成器" aria-hidden="true">#</a> 3.4 代码生成器</h3>
<p>对于单表的操作，虽然MP大大简化了操作，但是每次都需要我们重新创建文件，从mapper到controller，那将会带来太大的工作量。</p>
<p>于是我们选择使用MP为我们带来的新版生成器，一劳永逸🥳</p>
<blockquote>
<p>注意</p>
...
<h4 id="快速入门" tabindex="-1"><a class="header-anchor" href="#快速入门" aria-hidden="true">#</a> 快速入门</h4>
<p><strong>导入依赖</strong></p>
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code><span class="token comment">&lt;!--mybatis-plus-generator 生成器--></span>
        <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>dependency</span><span class="token punctuation">></span></span>
            <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>groupId</span><span class="token punctuation">></span></span>com.baomidou<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>groupId</span><span class="token punctuation">></span></span>
...
<blockquote>
<p>这里我已经根据官网配置生成好了一个通用的MP工具类，大家可以直接拿来用，所见即所得。</p>
</blockquote>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">CodeUtil</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_4-拓展" tabindex="-1"><a class="header-anchor" href="#_4-拓展" aria-hidden="true">#</a> 4. 拓展</h2>
<h3 id="_4-1-全局id生成策略" tabindex="-1"><a class="header-anchor" href="#_4-1-全局id生成策略" aria-hidden="true">#</a> 4.1 全局ID生成策略</h3>
<blockquote>
<p>配置了之后就不需要在实体类主键上配置了</p>
</blockquote>
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code><span class="token key atrule">mybatis-plus</span><span class="token punctuation">:</span>
  <span class="token key atrule">global‐config</span><span class="token punctuation">:</span>
    <span class="token key atrule">db‐config</span><span class="token punctuation">:</span>
      <span class="token key atrule">id‐type</span><span class="token punctuation">:</span> auto
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-2-逻辑删除" tabindex="-1"><a class="header-anchor" href="#_4-2-逻辑删除" aria-hidden="true">#</a> 4.2 逻辑删除</h3>
<p><strong>物理删除</strong>： 在删除的时候直接将数据从数据库干掉DELTE<br>
<strong>逻辑删除</strong>： 从逻辑层面控制删除，通常会在表里添加一个逻辑删除的字段比如 enabled 、is_deleted ，数据默认是有效的（值为1），当用户删除时将数据修改UPDATE 0， 在查询的时候就只查  where is_deleted =1.</p>
<blockquote>
<p>在阿里开发规范中，当我们设计数据库字段表示有 ” 是 否“ 相关概念是，应该是设置为is_xxxx 类型。</p>
</blockquote>
<p>需要添加逻辑删除的字段<br>
局部单表逻辑删除，需要在对应的<code v-pre>pojo</code>类加入对应的逻辑删除标识字段</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@TableLogic</span> <span class="token comment">// 代表逻辑删除（单个字段的）</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>开启全局逻辑删除配置，如果进行了全局逻辑删除配置并且指定了，就可以不用在每个实体类中配置了<code v-pre>@TableLogic</code></p>
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code><span class="token key atrule">mybatis-plus</span><span class="token punctuation">:</span>
  <span class="token key atrule">global‐config</span><span class="token punctuation">:</span>
    <span class="token key atrule">db-config</span><span class="token punctuation">:</span>
      <span class="token key atrule">id‐type</span><span class="token punctuation">:</span> auto
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>当执行删除， 将会把逻辑删除字段进行修改，执行的sql语句为</p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token keyword">update</span> <span class="token keyword">user</span> <span class="token keyword">set</span> is_deletd <span class="token operator">=</span> <span class="token number">0</span> <span class="token keyword">where</span> id<span class="token operator">=</span> ? 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>当执行查询时。会自动查询有效数据 where flag=1</p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token keyword">select</span> id<span class="token punctuation">,</span>name<span class="token punctuation">,</span>age<span class="token punctuation">,</span>email<span class="token punctuation">,</span>address <span class="token keyword">from</span> <span class="token keyword">user</span> <span class="token keyword">where</span> is_deleted<span class="token operator">=</span><span class="token number">1</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_4-3-分页插件" tabindex="-1"><a class="header-anchor" href="#_4-3-分页插件" aria-hidden="true">#</a> 4.3 分页插件</h3>
<h4 id="_1-paginationinnerinterceptor" tabindex="-1"><a class="header-anchor" href="#_1-paginationinnerinterceptor" aria-hidden="true">#</a> 1. PaginationInnerInterceptor</h4>
<h5 id="支持的数据库" tabindex="-1"><a class="header-anchor" href="#支持的数据库" aria-hidden="true">#</a> 支持的数据库</h5>
<ul>
...
<li>达梦数据库，虚谷数据库，人大金仓数据库，南大通用(华库)数据库，南大通用数据库，神通数据库，瀚高数据库，优炫数据库，星瑞格数据库</li>
</ul>
<h5 id="属性介绍" tabindex="-1"><a class="header-anchor" href="#属性介绍" aria-hidden="true">#</a> 属性介绍</h5>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/cisyam/202308311535119.png" alt="image-20230831153549029" tabindex="0" loading="lazy"><figcaption>image-20230831153549029</figcaption></figure>
<h4 id="_2-page" tabindex="-1"><a class="header-anchor" href="#_2-page" aria-hidden="true">#</a> 2. Page</h4>
<p>该类继承了 <code v-pre>IPage</code> 类，实现了 <code v-pre>简单分页模型</code> 如果你要实现自己的分页模型可以继承 <code v-pre>Page</code> 类或者实现 <code v-pre>IPage</code> 类</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/cisyam/202308311535033.png" alt="image-20230831153516852" tabindex="0" loading="lazy"><figcaption>image-20230831153516852</figcaption></figure>
<h4 id="_3-配置类" tabindex="-1"><a class="header-anchor" href="#_3-配置类" aria-hidden="true">#</a> 3. 配置类</h4>
<blockquote>
<p>要使用MP的分页插件，必须配置一个全局配置类，才可以全局生效。下面我就直接放代码，大家可以直接拿来用。</p>
</blockquote>
<div class="language-JAVA line-numbers-mode" data-ext="JAVA"><pre v-pre class="language-JAVA"><code>package com.manman.common.config;
...
<h4 id="_1-介绍" tabindex="-1"><a class="header-anchor" href="#_1-介绍" aria-hidden="true">#</a> 1. 介绍</h4>
<blockquote>
<p>悲观锁：</p>
<p>悲观锁，正如其名，具有强烈的独占和排他特性。它指的是对数据被外界(包括本系统当前的其他事务，以及来自外部系统的事务处理)修改持保守态度。因此，在整个数据处理过程中，将数据处于锁定状态。<br>
假设功能并发量非常大，就需要使用 synchronized 来处理高并发下产生线程不安全问题， 会使其他线程进行挂起等待从而影响系统吞吐量</p>
</blockquote>
<blockquote>
<p>乐观锁：</p>
<p>乐观锁是相对悲观锁而言的，乐观锁假设数据一般情况下不会造成冲突，所以在数据进行提交更新的时候，才会正式对数据的冲突与否进行检测，如果发现冲突了，则返回给用户错误的信息，让用户决定如何去做。乐观锁适用于读多写少的场景，这样可以提高程序的吞吐量。<br>
假设功能产生并发几率极少，采用乐观锁版本机制对比， 如果有冲突 返回给用户错误的信息</p>
</blockquote>
<h4 id="_2-为什么需要锁" tabindex="-1"><a class="header-anchor" href="#_2-为什么需要锁" aria-hidden="true">#</a> 2. 为什么需要锁</h4>
<blockquote>
<p>在多用户环境中，在同一时间可能会有多个用户更新相同的记录，这会产生冲突。这就是著名的并发性问题</p>
</blockquote>
<p><strong>丢失更新</strong>：一个事务的更新覆盖了其它事务的更新结果，就是所谓的更新丢失。例如：用户1把值从500改为8000，用户B把值从500改为200，则多人同时提交同一条记录，后提交的把之前的提交数据覆盖。<br>
脏读：当一个事务读取其它完成一半事务的记录时，就会发生脏读。例如：用户A,B看到的值都是500，用户B把值改为200，用户A读到的值仍为500。</p>
<p>针对一种问题的解决方案，为解决问题而生的。解决什么问题呢？主要是解决丢失更新问题如下图理解</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/cisyam/202308311528221.png" alt="image-20230831152857083" tabindex="0" loading="lazy"><figcaption>image-20230831152857083</figcaption></figure>
<p>为了解决这些并发带来的问题。 我们需要引入<strong>并发控制机制</strong>。</p>
<h4 id="_3-编码实现" tabindex="-1"><a class="header-anchor" href="#_3-编码实现" aria-hidden="true">#</a> 3. 编码实现</h4>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/cisyam/202308311531912.png" alt="image-20230831153117810" tabindex="0" loading="lazy"><figcaption>image-20230831153117810</figcaption></figure>
<ol>
<li>
<p>在对应的实体类中加version字段，并设置成下面这样</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Version</span> <span class="token comment">//这就是控制版本的</span>
...
<li>创建一个新的类，实现<code v-pre>MetaObjectHandler</code>自动填充，像创建时间，更新时间也可以在这操作。</li>
</ol>
...
<blockquote>
<p>接下来在做增加数据的时候，调用 insert 添加方法就可以了。修改的时候呢，我们需要先查人后再做修改，因为我们为了防止问题的发生，需要先去查询版本号比对才进行后续操作！！</p>
</blockquote>
<h2 id="_5-总结" tabindex="-1"><a class="header-anchor" href="#_5-总结" aria-hidden="true">#</a> 5. 总结</h2>
<p>以上便是关于MP相关的内容，本人才疏学浅，文章有什么错误的地方，欢迎大佬们批评指正！我是<code v-pre>Leo</code>，一个在互联网行业的小白，立志成为更好的自己。</p>
<p>如果你想了解更多关于<code v-pre>Leo</code>，可以关注下面这个公众号，后面文章会首先同步至公众号。</p>
<img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/cisyam/202308311543516.png" alt="扫码_搜索联合传播样式-标准色版" style="zoom: 50%;" />
<p>参考资料：</p>
<p><a href="https://baomidou.com/" target="_blank" rel="noopener noreferrer">MP官网<ExternalLinkIcon/></a></p>
