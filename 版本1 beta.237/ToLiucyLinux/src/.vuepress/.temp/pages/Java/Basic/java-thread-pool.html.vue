<template><div><h1 id="java基础篇-线程池相关" tabindex="-1"><a class="header-anchor" href="#java基础篇-线程池相关" aria-hidden="true">#</a> Java基础篇 | 线程池相关</h1>
<p><strong>思维导图</strong></p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/Leo100/202311082028630.png" alt="image-20231108202852387" tabindex="0" loading="lazy"><figcaption>image-20231108202852387</figcaption></figure>
<h2 id="_1-前言" tabindex="-1"><a class="header-anchor" href="#_1-前言" aria-hidden="true">#</a> 1.前言</h2>
<p>大家好，我是Leo哥🫣🫣🫣，<a href="https://blog.csdn.net/qq_58608526/article/details/134225010?spm=1001.2014.3001.5501" target="_blank" rel="noopener noreferrer">继上一篇我们没有学习完的多线程<ExternalLinkIcon/></a>,这一节我们主要学习多线程中的线程池相关内容。好了，话不多说让我们开始吧😎😎😎。</p>
<h2 id="_2-线程状态介绍" tabindex="-1"><a class="header-anchor" href="#_2-线程状态介绍" aria-hidden="true">#</a> 2.线程状态介绍</h2>
<p>在学习线程池之前，我们有必要先了解一下关于线程的集中状态。</p>
...
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/Leo100/202311082114813.png" alt="image-20231108211401746" tabindex="0" loading="lazy"><figcaption>image-20231108211401746</figcaption></figure>
<p>通过源码我们可以看到Java中的线程存在6种状态，每种线程状态的含义如下：</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/Leo100/202311082033311.jpg" alt="VeryCapture_20231108201847" tabindex="0" loading="lazy"><figcaption>VeryCapture_20231108201847</figcaption></figure>
<table>
<thead>
<tr>
<th>线程状态</th>
...
<p><strong>那么线程这几种状态是如何进行转换的呢，我们来看一下下面这张图</strong></p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/Leo100/202311082033858.png" alt="1591163781941" tabindex="0" loading="lazy"><figcaption>1591163781941</figcaption></figure>
<h2 id="_3-线程池" tabindex="-1"><a class="header-anchor" href="#_3-线程池" aria-hidden="true">#</a> 3.线程池</h2>
<h3 id="_3-1线程池-概述" tabindex="-1"><a class="header-anchor" href="#_3-1线程池-概述" aria-hidden="true">#</a> 3.1线程池-概述</h3>
...
<h3 id="_3-2线程池解决了什么问题" tabindex="-1"><a class="header-anchor" href="#_3-2线程池解决了什么问题" aria-hidden="true">#</a> 3.2线程池解决了什么问题</h3>
...
<p><strong>池化思想</strong>不仅仅能应用在计算机领域，在金融、设备、人员管理、工作管理等领域也有相关的应用。</p>
...
<p>在了解完了什么是线程池以及线程池为我们解决了什么问题之后，下面我们来一起深入一下线程池的内部实现原理。</p>
<h3 id="_3-3如何构造一个线程池" tabindex="-1"><a class="header-anchor" href="#_3-3如何构造一个线程池" aria-hidden="true">#</a> 3.3如何构造一个线程池</h3>
<p>ThreadPoolExecutor定义了七大核心属性，这些属性是线程池实现的基石。</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/Leo100/202311082054178.png" alt="image-20231108205407086" tabindex="0" loading="lazy"><figcaption>image-20231108205407086</figcaption></figure>
<ul>
...
<p>一般我们使用类的构造方法创建它的对象，ThreadPoolExecutor提供了四个构造方法。</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/Leo100/202311082100212.png" alt="image-20231108210039039" tabindex="0" loading="lazy"><figcaption>image-20231108210039039</figcaption></figure>
<p>以看到前三个方法最终都调用了最后一个、参数列表最长的那个方法，在这个方法中给七个属性赋值。创建线程池对象，强烈建议通过使用ThreadPoolExecutor的构造方法创建，不要使用Executors，至于建议的理由上文中也有说过，这里再引用阿里《Java开发手册》中的一段描述。</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/Leo100/202311082057945.png" alt="image-20231108205709861" tabindex="0" loading="lazy"><figcaption>image-20231108205709861</figcaption></figure>
<h3 id="_3-4线程池-基本原理" tabindex="-1"><a class="header-anchor" href="#_3-4线程池-基本原理" aria-hidden="true">#</a> 3.4线程池-基本原理</h3>
...
<p>一般我们使用的execute方法是在Executor接口中定义的，而submit方法是在ExecutorService接口中定义的，所以当我们创建一个Executor类型变量引用ThreadPoolExecutor对象实例时可以使用execute方法提交任务，当我们创建一个ExecutorService类型变量时可以使用submit方法，当然我们可以直接创建ThreadPoolExecutor类型变量使用execute方法或submit方法。</p>
<h3 id="_3-5线程池-executors默认线程池" tabindex="-1"><a class="header-anchor" href="#_3-5线程池-executors默认线程池" aria-hidden="true">#</a> 3.5线程池-Executors默认线程池</h3>
<p>概述 : JDK对线程池也进行了相关的实现，在真实企业开发中我们也很少去自定义线程池，而是使用JDK中自带的线程池。</p>
<p>我们可以使用Executors中所提供的<strong>静态</strong>方法来创建线程池</p>
<p>​	<img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/Leo100/202311082103020.png" alt="image-20231108210334960" loading="lazy"></p>
<p><strong>代码实现 :</strong></p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>javatop<span class="token punctuation">.</span>mythreadpool</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-6线程池-executors创建指定上限的线程池" tabindex="-1"><a class="header-anchor" href="#_3-6线程池-executors创建指定上限的线程池" aria-hidden="true">#</a> 3.6线程池-Executors创建指定上限的线程池</h3>
<p><strong>使用Executors中所提供的静态方法来创建线程池</strong></p>
<p>​	<img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/Leo100/202311082106862.png" alt="image-20231108210620804" loading="lazy"></p>
<p><strong>代码实现 :</strong></p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>javatop<span class="token punctuation">.</span>mythreadpool</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-7线程池-threadpoolexecutor" tabindex="-1"><a class="header-anchor" href="#_3-7线程池-threadpoolexecutor" aria-hidden="true">#</a> 3.7线程池-ThreadPoolExecutor</h3>
...
<span class="token comment">//    参数七：任务的拒绝策略</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-8线程池-参数详解" tabindex="-1"><a class="header-anchor" href="#_3-8线程池-参数详解" aria-hidden="true">#</a> 3.8线程池-参数详解</h3>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/Leo100/202311082102435.png" alt="1591165506516" tabindex="0" loading="lazy"><figcaption>1591165506516</figcaption></figure>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/Leo100/202311082104899.png" alt="image-20231108210445832" tabindex="0" loading="lazy"><figcaption>image-20231108210445832</figcaption></figure>
<h3 id="_3-9线程池-非默认任务拒绝策略" tabindex="-1"><a class="header-anchor" href="#_3-9线程池-非默认任务拒绝策略" aria-hidden="true">#</a> 3.9线程池-非默认任务拒绝策略</h3>
<p>RejectedExecutionHandler是jdk提供的一个任务拒绝策略接口，它下面存在4个子类。</p>
<figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/Leo100/202311082105553.png" alt="image-20231108210515478" tabindex="0" loading="lazy"><figcaption>image-20231108210515478</figcaption></figure>
<p>注：明确线程池对多可执行的任务数 = 队列容量 + 最大线程数</p>
<p><strong>案例演示1</strong>：演示ThreadPoolExecutor.AbortPolicy任务处理策略</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">ThreadPoolExecutorDemo01</span> <span class="token punctuation">{</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">ThreadPoolExecutorDemo02</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
        <span class="token doc-comment comment">/**
         * 核心线程数量为1 ， 最大线程池数量为3, 任务容器的容量为1 ,空闲线程的最大存在时间为20s
         */</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">ThreadPoolExecutorDemo04</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
