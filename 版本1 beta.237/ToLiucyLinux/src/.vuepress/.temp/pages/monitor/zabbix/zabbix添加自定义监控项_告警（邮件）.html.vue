...
<h3 id="🥈定义监控项介绍" tabindex="-1"><a class="header-anchor" href="#🥈定义监控项介绍" aria-hidden="true">#</a> 🥈定义监控项介绍</h3>
<blockquote>
...
<h4 id="🥉取值" tabindex="-1"><a class="header-anchor" href="#🥉取值" aria-hidden="true">#</a> 🥉取值</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="🥉配置" tabindex="-1"><a class="header-anchor" href="#🥉配置" aria-hidden="true">#</a> 🥉配置</h4>
...
<font color=red>**注意：**</font>不管取到0或者1都是配置成功了，如果没有配置成功会报错：ZBX_NOTSUPPORTED: Unsupported item key.；<h3 id="🥈web页面" tabindex="-1"><a class="header-anchor" href="#🥈web页面" aria-hidden="true">#</a> 🥈web页面</h3>
<h4 id="🥉添加监控项" tabindex="-1"><a class="header-anchor" href="#🥉添加监控项" aria-hidden="true">#</a> 🥉添加监控项</h4>
...
<h4 id="🥉添加触发器" tabindex="-1"><a class="header-anchor" href="#🥉添加触发器" aria-hidden="true">#</a> 🥉添加触发器</h4>
<p>监控项创建完我们来创建触发器<br>
点击触发器<br>
...
<h4 id="🥉添加报警媒介" tabindex="-1"><a class="header-anchor" href="#🥉添加报警媒介" aria-hidden="true">#</a> 🥉添加报警媒介</h4>
<p>管理——报警媒介类型<br>
...
<h4 id="🥉设置用户和报警媒介" tabindex="-1"><a class="header-anchor" href="#🥉设置用户和报警媒介" aria-hidden="true">#</a> 🥉设置用户和报警媒介</h4>
<p>管理——用户<br>
...
切记一定要点添加或者更新。</p>
<h4 id="🥉添加动作" tabindex="-1"><a class="header-anchor" href="#🥉添加动作" aria-hidden="true">#</a> 🥉添加动作</h4>
...
<p>至此就配置完成，我们开始测试</p>
<h2 id="🥇测试告警和恢复告警" tabindex="-1"><a class="header-anchor" href="#🥇测试告警和恢复告警" aria-hidden="true">#</a> 🥇测试告警和恢复告警</h2>
<p>为了测试我先把jar包杀掉；<br>
