...
<h3 id="安装python3和pip3" tabindex="-1"><a class="header-anchor" href="#安装python3和pip3" aria-hidden="true">#</a> 安装python3和pip3</h3>
<br/>
...
<hr>
<h3 id="升级-更新pip3" tabindex="-1"><a class="header-anchor" href="#升级-更新pip3" aria-hidden="true">#</a> 升级/更新pip3</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="安装项目所需的模块" tabindex="-1"><a class="header-anchor" href="#安装项目所需的模块" aria-hidden="true">#</a> 安装项目所需的模块</h3>
<br>
<h4 id="在线安装所需模块" tabindex="-1"><a class="header-anchor" href="#在线安装所需模块" aria-hidden="true">#</a> 在线安装所需模块</h4>
...
<h4 id="离线安装-下载所需模块和离线包" tabindex="-1"><a class="header-anchor" href="#离线安装-下载所需模块和离线包" aria-hidden="true">#</a> 离线安装/下载所需模块和离线包</h4>
<h5 id="_1、单个模块下载-指定路径" tabindex="-1"><a class="header-anchor" href="#_1、单个模块下载-指定路径" aria-hidden="true">#</a> ①、单个模块下载&amp;&amp;指定路径</h5>
<p><strong><font color=teal>格式：</font></strong></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/065a65e2d7f04562942252f528847f5e.png" alt="在这里插入图片描述" loading="lazy"><br>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/3fdb968ef6684caab60a51fee70dae61.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<h5 id="_2、批量下载模块-指定目录" tabindex="-1"><a class="header-anchor" href="#_2、批量下载模块-指定目录" aria-hidden="true">#</a> ②、批量下载模块&amp;&amp;指定目录</h5>
