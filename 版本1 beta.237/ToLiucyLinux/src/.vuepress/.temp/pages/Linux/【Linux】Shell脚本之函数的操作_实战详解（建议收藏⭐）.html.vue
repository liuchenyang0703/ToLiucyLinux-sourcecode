...
<h4 id="_3-1-求1到6的阶乘" tabindex="-1"><a class="header-anchor" href="#_3-1-求1到6的阶乘" aria-hidden="true">#</a> *.3.1 求1到6的阶乘</h4>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token shebang important">#!/bin/bash</span>
...
<h4 id="_3-2-求1到6的阶乘-只输出6的阶乘" tabindex="-1"><a class="header-anchor" href="#_3-2-求1到6的阶乘-只输出6的阶乘" aria-hidden="true">#</a> *.3.2 求1到6的阶乘，只输出6的阶乘</h4>
<blockquote>
...
<h3 id="_4-判断是否为文件" tabindex="-1"><a class="header-anchor" href="#_4-判断是否为文件" aria-hidden="true">#</a> *.4 判断是否为文件</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token shebang important">#!/bin/bash</span>
...
<h3 id="_5-递归函数" tabindex="-1"><a class="header-anchor" href="#_5-递归函数" aria-hidden="true">#</a> *.5 递归函数</h3>
<h4 id="_5-1-递归显示var下的log里面有哪些是目录" tabindex="-1"><a class="header-anchor" href="#_5-1-递归显示var下的log里面有哪些是目录" aria-hidden="true">#</a> *.5.1 递归显示var下的log里面有哪些是目录</h4>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token shebang important">#!/bin/bash</span>
...
<h4 id="_5-2-交互式-递归方式计算你输入的数值作为阶乘" tabindex="-1"><a class="header-anchor" href="#_5-2-交互式-递归方式计算你输入的数值作为阶乘" aria-hidden="true">#</a> *.5.2 交互式 递归方式计算你输入的数值作为阶乘</h4>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token shebang important">#!/bin/bash</span>
...
<h2 id="如何查看脚本执行过程" tabindex="-1"><a class="header-anchor" href="#如何查看脚本执行过程" aria-hidden="true">#</a> 如何查看脚本执行过程？</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412180958455.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<ul>
...
<h2 id="函数重点" tabindex="-1"><a class="header-anchor" href="#函数重点" aria-hidden="true">#</a> 函数重点：</h2>
<blockquote>
...
<h3 id="举例重点5-启动脚本模板-可根据自己的jar包名称自行修改" tabindex="-1"><a class="header-anchor" href="#举例重点5-启动脚本模板-可根据自己的jar包名称自行修改" aria-hidden="true">#</a> 举例重点5：启动脚本模板（可根据自己的jar包名称自行修改）</h3>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="相关文章" tabindex="-1"><a class="header-anchor" href="#相关文章" aria-hidden="true">#</a> 相关文章：</h2>
<table>
<thead>
<tr>
