...
<figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412181617490.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<font color=red>这里不推荐使用云服务器，因为云服务器会限制25端口，会导致邮件系统收发不了；</font><h2 id="基础原理" tabindex="-1"><a class="header-anchor" href="#基础原理" aria-hidden="true">#</a> 基础原理</h2>
<blockquote>
...
<figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412181617072.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412181617408.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<ul>
<li>阿里云</li>
</ul>
<figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412181617530.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412181617896.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="一-、安装关于权限校验的软件-cyrus-sasl" tabindex="-1"><a class="header-anchor" href="#一-、安装关于权限校验的软件-cyrus-sasl" aria-hidden="true">#</a> 一 、安装关于权限校验的软件  cyrus-sasl</h2>
<p>1)安装</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="二、部署及创建数据库【mysql】" tabindex="-1"><a class="header-anchor" href="#二、部署及创建数据库【mysql】" aria-hidden="true">#</a> 二、部署及创建数据库【mysql】</h2>
<h3 id="_1、部署数据库-mariadb" tabindex="-1"><a class="header-anchor" href="#_1、部署数据库-mariadb" aria-hidden="true">#</a> 1、部署数据库（mariadb）</h3>
...
<figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412181617423.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<h3 id="_2、库、表结构导入" tabindex="-1"><a class="header-anchor" href="#_2、库、表结构导入" aria-hidden="true">#</a> 2、库、表结构导入</h3>
...
<h2 id="三、安装及配置-postfix-邮局" tabindex="-1"><a class="header-anchor" href="#三、安装及配置-postfix-邮局" aria-hidden="true">#</a> 三、安装及配置 postfix 邮局</h2>
<p>1)安装</p>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412181616941.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="四-、安装及配置-dovecot" tabindex="-1"><a class="header-anchor" href="#四-、安装及配置-dovecot" aria-hidden="true">#</a> 四 、安装及配置 dovecot</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412181616617.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>可以看到都安装上了；</p>
<p>2)查看版本号</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412181616440.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>3)配置</p>
<p>先备份配置：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412181616000.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412181616627.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412181616755.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412181616772.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412181616262.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
ll /var/spool/ <span class="token operator">|</span> <span class="token function">grep</span> mail
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412181616865.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<ol start="4">
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="五、邮箱测试" tabindex="-1"><a class="header-anchor" href="#五、邮箱测试" aria-hidden="true">#</a> 五、邮箱测试</h2>
<p>我这里使用<code v-pre>Foxmail邮箱</code></p>
<p><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412181616594.png" alt="" loading="lazy"><br>
<img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412181616795.png" alt="" loading="lazy"></p>
<p>输入自己的email地址，也就是数据库里的邮件地址和密码；</p>
<figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412181616522.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412181616027.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412181616538.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>然后自己就可以直接测试收发邮件了；</p>
<p>发送邮件成功收到；</p>
<figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412181615784.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>收取邮件成功；</p>
<p><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412181615718.png" alt="" loading="lazy"><br>
<img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412181615312.png" alt="" loading="lazy"><br>
<img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412181615660.png" alt="" loading="lazy"></p>
<p>部署完成！！！</p>
