...
<hr>
<h2 id="一、jinjia2-模板" tabindex="-1"><a class="header-anchor" href="#一、jinjia2-模板" aria-hidden="true">#</a> 一、jinjia2 模板</h2>
<p>jinja2是Python的全功能模板引擎。在python的WEB开发中被广泛应用。</p>
<p>Ansible通常会使用jinja2模板来修改被管理主机的配置文件等。</p>
<h3 id="_1-1-在-ansible-中的使用" tabindex="-1"><a class="header-anchor" href="#_1-1-在-ansible-中的使用" aria-hidden="true">#</a> 1.1 在 Ansible 中的使用</h3>
...
<font color=red>Ansible允许jinja2模板中使用条件判断和循环，但是不允许在playbook中使用。通常jinja2模板文件的后缀为`.j2`</font><h3 id="_1-2-jinjia2-模板语法" tabindex="-1"><a class="header-anchor" href="#_1-2-jinjia2-模板语法" aria-hidden="true">#</a> 1.2 jinjia2 模板语法</h3>
<h4 id="_1-2-1-基础语法" tabindex="-1"><a class="header-anchor" href="#_1-2-1-基础语法" aria-hidden="true">#</a> 1.2.1 基础语法</h4>
...
<h4 id="_1-2-2-流程控制" tabindex="-1"><a class="header-anchor" href="#_1-2-2-流程控制" aria-hidden="true">#</a> 1.2.2 流程控制</h4>
<ul class="task-list-container">
...
<p>格式：</p>
<div class="language-jinja2 line-numbers-mode" data-ext="jinja2"><pre v-pre class="language-jinja2"><code><span class="token jinja2 language-jinja2"><span class="token delimiter punctuation">{%</span> <span class="token tag keyword">if</span> <span class="token variable">EXPR</span> <span class="token delimiter punctuation">%}</span></span>
	执行内容
...
<div class="language-jinja2 line-numbers-mode" data-ext="jinja2"><pre v-pre class="language-jinja2"><code><span class="token jinja2 language-jinja2"><span class="token delimiter punctuation">{%</span> <span class="token tag keyword">if</span> <span class="token variable">is_production</span> <span class="token delimiter punctuation">%}</span></span>
    # 生产环境配置
    DebugLevel: 0
<span class="token jinja2 language-jinja2"><span class="token delimiter punctuation">{%</span> <span class="token tag keyword">else</span> <span class="token delimiter punctuation">%}</span></span>
    # 开发/测试环境配置
...
<p>格式：</p>
<div class="language-jinja2 line-numbers-mode" data-ext="jinja2"><pre v-pre class="language-jinja2"><code><span class="token jinja2 language-jinja2"><span class="token delimiter punctuation">{%</span> <span class="token tag keyword">for</span> <span class="token variable">i</span> <span class="token keyword">in</span> <span class="token variable">EXPR</span> <span class="token delimiter punctuation">%}</span></span>
	执行内容
...
<div class="language-jinja2 line-numbers-mode" data-ext="jinja2"><pre v-pre class="language-jinja2"><code><span class="token jinja2 language-jinja2"><span class="token delimiter punctuation">{%</span> <span class="token tag keyword">for</span> <span class="token variable">item</span> <span class="token keyword">in</span> <span class="token variable">list_items</span> <span class="token delimiter punctuation">%}</span></span>
...
<h4 id="_1-2-3-过滤器" tabindex="-1"><a class="header-anchor" href="#_1-2-3-过滤器" aria-hidden="true">#</a> 1.2.3 过滤器</h4>
<ul class="task-list-container">
...
<div class="language-jinja2 line-numbers-mode" data-ext="jinja2"><pre v-pre class="language-jinja2"><code><span class="token jinja2 language-jinja2"><span class="token delimiter punctuation">{{</span> <span class="token variable">variable</span> <span class="token operator">|</span> <span class="token function">default</span><span class="token punctuation">(</span><span class="token string">"default_value"</span><span class="token punctuation">)</span> <span class="token delimiter punctuation">}}</span></span>
...
<div class="language-jinja2 line-numbers-mode" data-ext="jinja2"><pre v-pre class="language-jinja2"><code>The list has <span class="token jinja2 language-jinja2"><span class="token delimiter punctuation">{{</span> <span class="token variable">list_items</span> <span class="token operator">|</span> <span class="token variable">length</span> <span class="token delimiter punctuation">}}</span></span> items.
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="_1-2-4-其他控制结构" tabindex="-1"><a class="header-anchor" href="#_1-2-4-其他控制结构" aria-hidden="true">#</a> 1.2.4 其他控制结构</h4>
<ul class="task-list-container">
...
<h3 id="_1-3-templates-模块" tabindex="-1"><a class="header-anchor" href="#_1-3-templates-模块" aria-hidden="true">#</a> 1.3 templates 模块</h3>
<blockquote>
...
<h3 id="_1-4-jinja2-使用案例" tabindex="-1"><a class="header-anchor" href="#_1-4-jinja2-使用案例" aria-hidden="true">#</a> 1.4 jinja2 使用案例</h3>
...
<h2 id="二、roles-角色" tabindex="-1"><a class="header-anchor" href="#二、roles-角色" aria-hidden="true">#</a> 二、Roles 角色</h2>
<blockquote>
<p>  在Ansible中，有一个roles的概念。roles并不是指定具体的东西，而是一种规范，将复杂的Playbook分割为多个文件的机制，简化复杂的Playbook编写，并且使Playbook的复用变得简单。</p>
</blockquote>
<font color=red>建议：每个roles最好只使用一个tasks这样方便调用，能够很好的做到解耦；</font><h3 id="_2-1-roles介绍与优势" tabindex="-1"><a class="header-anchor" href="#_2-1-roles介绍与优势" aria-hidden="true">#</a> 2.1 Roles介绍与优势</h3>
...
<h3 id="_2-2-roles-的目录结构" tabindex="-1"><a class="header-anchor" href="#_2-2-roles-的目录结构" aria-hidden="true">#</a> 2.2 Roles 的目录结构</h3>
<ul class="task-list-container">
...
<h3 id="_2-3-ansible-galaxy-命令" tabindex="-1"><a class="header-anchor" href="#_2-3-ansible-galaxy-命令" aria-hidden="true">#</a> 2.3 ansible-galaxy 命令</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-4-使用roles-部署nginx" tabindex="-1"><a class="header-anchor" href="#_2-4-使用roles-部署nginx" aria-hidden="true">#</a> 2.4 使用Roles（部署nginx）</h3>
<p>流程：</p>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/42915933fc834abd864aaae0884271b7.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<h3 id="_2-5-查看-nginx-树形目录结构" tabindex="-1"><a class="header-anchor" href="#_2-5-查看-nginx-树形目录结构" aria-hidden="true">#</a> 2.5 查看 nginx 树形目录结构</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>tree /etc/ansible/roles/nginx
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/6dad4ece07df4963b6a7a0f806389915.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
