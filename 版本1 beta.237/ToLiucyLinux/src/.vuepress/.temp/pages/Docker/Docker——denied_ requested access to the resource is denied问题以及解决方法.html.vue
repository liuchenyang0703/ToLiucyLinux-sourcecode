...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412161456163.png" alt="" loading="lazy"><br>
最后就可以看到我们的镜像存储库了。<br>
