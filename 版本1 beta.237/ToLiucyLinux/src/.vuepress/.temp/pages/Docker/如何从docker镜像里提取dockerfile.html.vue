...
<h2 id="从镜像中提取dockerfile的两种方法" tabindex="-1"><a class="header-anchor" href="#从镜像中提取dockerfile的两种方法" aria-hidden="true">#</a> 从镜像中提取dockerfile的两种方法</h2>
<h3 id="_1、history参数" tabindex="-1"><a class="header-anchor" href="#_1、history参数" aria-hidden="true">#</a> 1、history参数</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412161442079.png" alt="" loading="lazy"><br>
虽然docker history命令可以看到所有历史层级的操作，但是还是需要手动去写Dockerfile，看的不是那么全，所以我们还有一个能看到非常详细的工具👇↓👇</p>
<h3 id="_2、dfimage" tabindex="-1"><a class="header-anchor" href="#_2、dfimage" aria-hidden="true">#</a> 2、dfimage</h3>
...
dfimage <span class="token parameter variable">-sV</span><span class="token operator">=</span><span class="token number">1.36</span> nginx:latest
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412161442532.png" alt="" loading="lazy"><br>
即可看到完整的dockerfile，这个工具查看的非常的详细</p>
<h3 id="补充-如何设置永久的别名" tabindex="-1"><a class="header-anchor" href="#补充-如何设置永久的别名" aria-hidden="true">#</a> 补充：如何设置永久的别名</h3>
