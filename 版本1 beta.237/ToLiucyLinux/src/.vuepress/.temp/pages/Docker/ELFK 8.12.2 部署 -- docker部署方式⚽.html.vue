...
<h2 id="一、elfk的部署-docker部署方式⚽" tabindex="-1"><a class="header-anchor" href="#一、elfk的部署-docker部署方式⚽" aria-hidden="true">#</a> 一、ELFK的部署 -- docker部署方式⚽</h2>
<h3 id="_1-前置准备" tabindex="-1"><a class="header-anchor" href="#_1-前置准备" aria-hidden="true">#</a> 1.  前置准备</h3>
<h4 id="_1-1-服务器信息" tabindex="-1"><a class="header-anchor" href="#_1-1-服务器信息" aria-hidden="true">#</a> 1.1 服务器信息</h4>
<table>
<thead>
<tr>
...
<h4 id="_1-2-关闭防火墙及selinux沙盒" tabindex="-1"><a class="header-anchor" href="#_1-2-关闭防火墙及selinux沙盒" aria-hidden="true">#</a> 1.2 关闭防火墙及selinux沙盒</h4>
...
<h4 id="_1-3-将elfk镜像包上传到服务器上-也可以等在执行docker-compose时自动拉取" tabindex="-1"><a class="header-anchor" href="#_1-3-将elfk镜像包上传到服务器上-也可以等在执行docker-compose时自动拉取" aria-hidden="true">#</a> 1.3 将ELFK镜像包上传到服务器上（也可以等在执行docker-compose时自动拉取）</h4>
...
<h4 id="_1-4-校正时间" tabindex="-1"><a class="header-anchor" href="#_1-4-校正时间" aria-hidden="true">#</a> 1.4 校正时间</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_1-5-本文注意事项" tabindex="-1"><a class="header-anchor" href="#_1-5-本文注意事项" aria-hidden="true">#</a> 1.5 本文注意事项</h4>
<blockquote>
...
<h3 id="_2-部署docker" tabindex="-1"><a class="header-anchor" href="#_2-部署docker" aria-hidden="true">#</a> 2. 部署docker</h3>
...
<h3 id="_4-部署elfk" tabindex="-1"><a class="header-anchor" href="#_4-部署elfk" aria-hidden="true">#</a> 4. 部署ELFK</h3>
...
<h4 id="_4-1-创建elfk的项目路径" tabindex="-1"><a class="header-anchor" href="#_4-1-创建elfk的项目路径" aria-hidden="true">#</a> 4.1 创建ELFK的项目路径</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="_4-2-创建es目录及配置文件" tabindex="-1"><a class="header-anchor" href="#_4-2-创建es目录及配置文件" aria-hidden="true">#</a> 4.2 创建ES目录及配置文件</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_4-3-创建logstash目录及配置文件" tabindex="-1"><a class="header-anchor" href="#_4-3-创建logstash目录及配置文件" aria-hidden="true">#</a> 4.3 创建Logstash目录及配置文件</h4>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_4-4-创建kibana目录及配置文件" tabindex="-1"><a class="header-anchor" href="#_4-4-创建kibana目录及配置文件" aria-hidden="true">#</a> 4.4 创建Kibana目录及配置文件</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_4-5-创建filebeat目录及配置文件" tabindex="-1"><a class="header-anchor" href="#_4-5-创建filebeat目录及配置文件" aria-hidden="true">#</a> 4.5 创建filebeat目录及配置文件</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_4-6-导入elfk镜像" tabindex="-1"><a class="header-anchor" href="#_4-6-导入elfk镜像" aria-hidden="true">#</a> 4.6 导入ELFK镜像</h4>
...
<h4 id="_4-7-使用docker-compose启动elfk服务" tabindex="-1"><a class="header-anchor" href="#_4-7-使用docker-compose启动elfk服务" aria-hidden="true">#</a> 4.7 使用docker-compose启动ELFK服务</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412191554963.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<h4 id="_4-8-访问es、kibana地址" tabindex="-1"><a class="header-anchor" href="#_4-8-访问es、kibana地址" aria-hidden="true">#</a> 4.8 访问es、kibana地址</h4>
...
<h4 id="_4-9-安装并配置nginx" tabindex="-1"><a class="header-anchor" href="#_4-9-安装并配置nginx" aria-hidden="true">#</a> 4.9 安装并配置nginx</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412191553772.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<h4 id="_4-10-获取服务日志并进行页面展示" tabindex="-1"><a class="header-anchor" href="#_4-10-获取服务日志并进行页面展示" aria-hidden="true">#</a> 4.10 获取服务日志并进行页面展示</h4>
...
<hr>
<h2 id="二、elk8-12-2版本配置密码认证" tabindex="-1"><a class="header-anchor" href="#二、elk8-12-2版本配置密码认证" aria-hidden="true">#</a> 二、ELK8.12.2版本配置密码认证</h2>
<h3 id="_1、配置-es-开启安全验证" tabindex="-1"><a class="header-anchor" href="#_1、配置-es-开启安全验证" aria-hidden="true">#</a> 1、配置 ES 开启安全验证</h3>
<h4 id="_1-1-修改-es-配置文件" tabindex="-1"><a class="header-anchor" href="#_1-1-修改-es-配置文件" aria-hidden="true">#</a> 1.1 修改 es 配置文件</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_1-2-重启-es-容器" tabindex="-1"><a class="header-anchor" href="#_1-2-重启-es-容器" aria-hidden="true">#</a> 1.2 重启 es 容器</h4>
...
<h4 id="_1-3-进入容器生成密码" tabindex="-1"><a class="header-anchor" href="#_1-3-进入容器生成密码" aria-hidden="true">#</a> 1.3 进入容器生成密码</h4>
...
<h4 id="_1-4-访问-es-页面进行验证" tabindex="-1"><a class="header-anchor" href="#_1-4-访问-es-页面进行验证" aria-hidden="true">#</a> 1.4 访问 es 页面进行验证</h4>
...
<h3 id="_2、配置-logstash-连接用户密码" tabindex="-1"><a class="header-anchor" href="#_2、配置-logstash-连接用户密码" aria-hidden="true">#</a> 2、配置 logstash 连接用户密码</h3>
<h4 id="_2-1-修改-logstash-配置文件" tabindex="-1"><a class="header-anchor" href="#_2-1-修改-logstash-配置文件" aria-hidden="true">#</a> 2.1 修改 logstash 配置文件</h4>
...
<h4 id="_2-2-重启-logstash-容器" tabindex="-1"><a class="header-anchor" href="#_2-2-重启-logstash-容器" aria-hidden="true">#</a> 2.2 重启 logstash 容器</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_3、配置-kibana-连接用户密码" tabindex="-1"><a class="header-anchor" href="#_3、配置-kibana-连接用户密码" aria-hidden="true">#</a> 3、配置 kibana 连接用户密码</h3>
<h4 id="_3-1-修改-kibana-配置文件" tabindex="-1"><a class="header-anchor" href="#_3-1-修改-kibana-配置文件" aria-hidden="true">#</a> 3.1 修改 kibana 配置文件</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_3-2-重启-kibana-容器" tabindex="-1"><a class="header-anchor" href="#_3-2-重启-kibana-容器" aria-hidden="true">#</a> 3.2 重启 kibana 容器</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_3-3-访问-kibana-页面进行验证" tabindex="-1"><a class="header-anchor" href="#_3-3-访问-kibana-页面进行验证" aria-hidden="true">#</a> 3.3 访问 kibana 页面进行验证</h4>
...
<h2 id="三、附加-修改-elk-认证密码" tabindex="-1"><a class="header-anchor" href="#三、附加-修改-elk-认证密码" aria-hidden="true">#</a> 三、附加：修改 ELK 认证密码</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="四、附加-获取多台服务器日志" tabindex="-1"><a class="header-anchor" href="#四、附加-获取多台服务器日志" aria-hidden="true">#</a> 四、附加：获取多台服务器日志</h2>
...
<h3 id="_1、创建filebeat目录及配置文件" tabindex="-1"><a class="header-anchor" href="#_1、创建filebeat目录及配置文件" aria-hidden="true">#</a> 1、创建filebeat目录及配置文件</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 创建filebeat目录</span>
<span class="token function">mkdir</span> <span class="token parameter variable">-p</span> /data/ELK/filebeat/<span class="token punctuation">{</span>config,data,logs<span class="token punctuation">}</span>
...
<span class="token key atrule">output.logstash</span><span class="token punctuation">:</span>
  <span class="token comment"># The Logstash hosts</span>
  <span class="token key atrule">hosts</span><span class="token punctuation">:</span> <span class="token punctuation">[</span><span class="token string">"172.16.11.213:5044"</span><span class="token punctuation">]</span>   
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2、上传并导入-filebeat-镜像" tabindex="-1"><a class="header-anchor" href="#_2、上传并导入-filebeat-镜像" aria-hidden="true">#</a> 2、上传并导入 filebeat 镜像</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_3、使用docker-compose启动filebeat服务" tabindex="-1"><a class="header-anchor" href="#_3、使用docker-compose启动filebeat服务" aria-hidden="true">#</a> 3、使用docker-compose启动filebeat服务</h3>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">docker-compose</span> <span class="token function">ps</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412191552730.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>State状态为：<code v-pre>UP</code>或者<code v-pre>running</code>就为运行状态。</p>
<hr>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_4、登录-kibana-页面查看新节点的日志" tabindex="-1"><a class="header-anchor" href="#_4、登录-kibana-页面查看新节点的日志" aria-hidden="true">#</a> 4、登录 kibana 页面查看新节点的日志</h3>
...
<h2 id="五、附加-kibana-页面操作" tabindex="-1"><a class="header-anchor" href="#五、附加-kibana-页面操作" aria-hidden="true">#</a> 五、附加：kibana 页面操作</h2>
<h3 id="_1、查看日志属于哪个路径下及日志名" tabindex="-1"><a class="header-anchor" href="#_1、查看日志属于哪个路径下及日志名" aria-hidden="true">#</a> 1、查看日志属于哪个路径下及日志名</h3>
...
<h3 id="_2、仪表板" tabindex="-1"><a class="header-anchor" href="#_2、仪表板" aria-hidden="true">#</a> 2、仪表板</h3>
