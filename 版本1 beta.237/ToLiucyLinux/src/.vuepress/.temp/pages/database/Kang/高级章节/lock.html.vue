...
<h2 id="_2-mysql并发事务访问相同记录" tabindex="-1"><a class="header-anchor" href="#_2-mysql并发事务访问相同记录" aria-hidden="true">#</a> 2. MySQL并发事务访问相同记录</h2>
<p>并发事务访问相同记录的情况大致可以划分为3种：</p>
<h3 id="_2-1-读-读情况" tabindex="-1"><a class="header-anchor" href="#_2-1-读-读情况" aria-hidden="true">#</a> 2.1 读-读情况</h3>
...
<h3 id="_2-3-读-写或写-读情况" tabindex="-1"><a class="header-anchor" href="#_2-3-读-写或写-读情况" aria-hidden="true">#</a> 2.3 读-写或写-读情况</h3>
...
<h3 id="_2-4-并发问题的解决方案" tabindex="-1"><a class="header-anchor" href="#_2-4-并发问题的解决方案" aria-hidden="true">#</a> 2.4 并发问题的解决方案</h3>
...
<h4 id="_1-锁定读" tabindex="-1"><a class="header-anchor" href="#_1-锁定读" aria-hidden="true">#</a> 1.锁定读</h4>
...
<h4 id="_2-写操作" tabindex="-1"><a class="header-anchor" href="#_2-写操作" aria-hidden="true">#</a> 2. 写操作</h4>
<img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220711214412163.png" alt="image-20220711214412163"  />
<h3 id="_3-2-从数据操作的粒度划分-表级锁、页级锁、行锁" tabindex="-1"><a class="header-anchor" href="#_3-2-从数据操作的粒度划分-表级锁、页级锁、行锁" aria-hidden="true">#</a> 3.2 从数据操作的粒度划分：表级锁、页级锁、行锁</h3>
<img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220711214719510.png" alt="image-20220711214719510"  />
<h4 id="_1-表锁-table-lock" tabindex="-1"><a class="header-anchor" href="#_1-表锁-table-lock" aria-hidden="true">#</a> 1. 表锁（Table Lock）</h4>
<img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220711214805088.png" alt="image-20220711214805088"  />
<h5 id="_1-表级别的s锁、x锁" tabindex="-1"><a class="header-anchor" href="#_1-表级别的s锁、x锁" aria-hidden="true">#</a> ① 表级别的S锁、X锁</h5>
...
<p>步骤1：创建表并添加数据</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>CREATE TABLE mylock(
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>SHOW OPEN TABLES; # 主要关注In_use字段的值
或者
SHOW OPEN TABLES where In_use &gt; 0;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220711220342251.png" alt="image-20220711220342251"  />
<p>或者</p>
...
<p>步骤3：手动增加表锁命令</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>LOCK TABLES t READ; # 存储引擎会对表t加表级别的共享锁。共享锁也叫读锁或S锁（Share的缩写）
...
<p>步骤4：释放表锁</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>UNLOCK TABLES; # 使用此命令解锁当前加锁的表
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>-- 事务要获取某些行的 S 锁，必须先获得表的 IS 锁。
SELECT column FROM table ... LOCK IN SHARE MODE;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div></li>
<li>
<p><strong>意向排他锁</strong>（intention exclusive lock, IX）：事务有意向对表中的某些行加<strong>排他锁</strong>（X锁）</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>-- 事务要获取某些行的 X 锁，必须先获得表的 IX 锁。
...
('5', 'songhongkang'),
('6', 'leifengyang');
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql&gt; SELECT @@transaction_isolation;
+-------------------------+
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>BEGIN;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220712124209006.png" alt="image-20220712124209006"  />
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>BEGIN;
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>INSERT INTO `teacher` (name) VALUES ('zhangsan'), ('lisi');
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql&gt; select * from teacher;
+----+----------+
| id | name     |
+----+----------+
| 1  | zhangsan |
...
<h5 id="_4-元数据锁-mdl锁" tabindex="-1"><a class="header-anchor" href="#_4-元数据锁-mdl锁" aria-hidden="true">#</a> ④ 元数据锁（MDL锁）</h5>
...
<p>**会话A：**从表中查询数据</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql&gt; BEGIN;
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql&gt; show processlist;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220713142808924.png" alt="image-20220713142808924" tabindex="0" loading="lazy"><figcaption>image-20220713142808924</figcaption></figure>
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>INSERT INTO student VALUES
(1, '张三', '一班'),
(3, '李四', '一班'),
(8, '王五', '二班'),
(15, '赵六', '二班'),
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql&gt; select * from student where id &gt; 20 lock in share mode;
Empty set (0.01 sec)
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220713203124889.png" alt="image-20220713203124889"  />
...
<h4 id="_3-页锁" tabindex="-1"><a class="header-anchor" href="#_3-页锁" aria-hidden="true">#</a> 3. 页锁</h4>
...
<h3 id="_3-3-从对待锁的态度划分-乐观锁、悲观锁" tabindex="-1"><a class="header-anchor" href="#_3-3-从对待锁的态度划分-乐观锁、悲观锁" aria-hidden="true">#</a> 3.3 从对待锁的态度划分:乐观锁、悲观锁</h3>
<p>从对待锁的态度来看锁的话，可以将锁分成乐观锁和悲观锁，从名字中也可以看出这两种锁是两种看待 <code v-pre>数据并发的思维方式</code> 。需要注意的是，乐观锁和悲观锁并不是锁，而是锁的 <code v-pre>设计思想</code> 。</p>
<h4 id="_1-悲观锁-pessimistic-locking" tabindex="-1"><a class="header-anchor" href="#_1-悲观锁-pessimistic-locking" aria-hidden="true">#</a> 1. 悲观锁（Pessimistic Locking）</h4>
...
<h4 id="_2-乐观锁-optimistic-locking" tabindex="-1"><a class="header-anchor" href="#_2-乐观锁-optimistic-locking" aria-hidden="true">#</a> 2. 乐观锁（Optimistic Locking）</h4>
...
<h4 id="_3-两种锁的适用场景" tabindex="-1"><a class="header-anchor" href="#_3-两种锁的适用场景" aria-hidden="true">#</a> 3. 两种锁的适用场景</h4>
...
<h3 id="_3-4-按加锁的方式划分-显式锁、隐式锁" tabindex="-1"><a class="header-anchor" href="#_3-4-按加锁的方式划分-显式锁、隐式锁" aria-hidden="true">#</a> 3.4 按加锁的方式划分：显式锁、隐式锁</h3>
<h4 id="_1-隐式锁" tabindex="-1"><a class="header-anchor" href="#_1-隐式锁" aria-hidden="true">#</a> 1. 隐式锁</h4>
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql&gt; SELECT * FROM performance_schema.data_lock_waits\G;
*************************** 1. row ***************************
						ENGINE: INNODB
...
<p>显示加共享锁：</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>select .... lock in share mode
...
<p>全局锁的命令：</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>Flush tables with read lock
...
<h4 id="_2-产生死锁的必要条件" tabindex="-1"><a class="header-anchor" href="#_2-产生死锁的必要条件" aria-hidden="true">#</a> 2. 产生死锁的必要条件</h4>
<ol>
<li>两个或者两个以上事务</li>
...
<h4 id="_3-如何处理死锁" tabindex="-1"><a class="header-anchor" href="#_3-如何处理死锁" aria-hidden="true">#</a> 3. 如何处理死锁</h4>
...
<h4 id="_4-如何避免死锁" tabindex="-1"><a class="header-anchor" href="#_4-如何避免死锁" aria-hidden="true">#</a> 4. 如何避免死锁</h4>
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code># 事务T1
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>SELECT * FROM information_schema.INNODB_TRX\G;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>重要属性代表含义已在上述中标注。</p>
<p>（2）查询锁等待情况</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>SELECT * FROM data_lock_waits\G;
*************************** 1. row ***************************
							ENGINE: INNODB
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql &gt; SELECT * from performance_schema.data_locks\G;
*************************** 1. row ***************************
ENGINE: INNODB
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>CREATE TABLE `test` (
`id` int(11) NOT NULL,
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>select * from test where id=10 for update
