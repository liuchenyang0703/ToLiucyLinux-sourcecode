...
<h2 id="_1-mysql8新特性概述" tabindex="-1"><a class="header-anchor" href="#_1-mysql8新特性概述" aria-hidden="true">#</a> 1. MySQL8新特性概述</h2>
...
<h3 id="_1-1-mysql8-0-新增特性" tabindex="-1"><a class="header-anchor" href="#_1-1-mysql8-0-新增特性" aria-hidden="true">#</a> 1.1 MySQL8.0 新增特性</h3>
...
<p>基础语法如下：</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>WITH cte_name (col_name1,col_name2 ...) AS (Subquery)
...
<h3 id="_1-2-mysql8-0移除的旧特性" tabindex="-1"><a class="header-anchor" href="#_1-2-mysql8-0移除的旧特性" aria-hidden="true">#</a> 1.2 MySQL8.0移除的旧特性</h3>
...
<h2 id="_2-新特性1-窗口函数" tabindex="-1"><a class="header-anchor" href="#_2-新特性1-窗口函数" aria-hidden="true">#</a> 2. 新特性1：窗口函数</h2>
<h3 id="_2-1-使用窗口函数前后对比" tabindex="-1"><a class="header-anchor" href="#_2-1-使用窗口函数前后对比" aria-hidden="true">#</a> 2.1 使用窗口函数前后对比</h3>
<p>假设我现在有这样一个数据表，它显示了某购物网站在每个城市每个区的销售额：</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>CREATE TABLE sales(
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql&gt; SELECT * FROM sales;
+----+------+--------+-------------+
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>CREATE TEMPORARY TABLE a       -- 创建临时表
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql&gt; SELECT * FROM a;
+-------------+
| sales_value |
+-------------+
|          70 |
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>CREATE TEMPORARY TABLE b    -- 创建临时表
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql&gt; SELECT * FROM b;
+------+-------------+
| city | sales_value |
+------+-------------+
| 北京 |          30 |
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql&gt; SELECT s.city AS 城市,s.county AS 区,s.sales_value AS 区销售额,
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql&gt; SELECT city AS 城市,county AS 区,sales_value AS 区销售额,
...
<h3 id="_2-2-窗口函数分类" tabindex="-1"><a class="header-anchor" href="#_2-2-窗口函数分类" aria-hidden="true">#</a> 2.2 窗口函数分类</h3>
...
<h3 id="_2-3-语法结构" tabindex="-1"><a class="header-anchor" href="#_2-3-语法结构" aria-hidden="true">#</a> 2.3 语法结构</h3>
<p>窗口函数的语法结构是：</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>函数 OVER（[PARTITION BY 字段名 ORDER BY 字段名 ASC|DESC]）
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>或者是：</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>函数 OVER 窗口名 … WINDOW 窗口名 AS （[PARTITION BY 字段名 ORDER BY 字段名 ASC|DESC]）
...
<h3 id="_2-4-分类讲解" tabindex="-1"><a class="header-anchor" href="#_2-4-分类讲解" aria-hidden="true">#</a> 2.4 分类讲解</h3>
<p>创建表：</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>CREATE TABLE goods(
id INT PRIMARY KEY AUTO_INCREMENT,
category_id INT,
category VARCHAR(15),
NAME VARCHAR(30),
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>INSERT INTO goods(category_id,category,NAME,price,stock,upper_time)
VALUES
...
<h4 id="_1-序号函数" tabindex="-1"><a class="header-anchor" href="#_1-序号函数" aria-hidden="true">#</a> 1. 序号函数</h4>
<p><strong>1．ROW_NUMBER()函数</strong></p>
<p>ROW_NUMBER()函数能够对数据中的序号进行顺序显示。</p>
<p>举例：查询 goods 数据表中每个商品分类下价格降序排列的各个商品信息。</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql&gt; SELECT ROW_NUMBER() OVER(PARTITION BY category_id ORDER BY price DESC) AS row_num,
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>mysql> SELECT RANK() OVER(PARTITION BY category_id ORDER BY price DESC) AS row_num,
    -> id, category_id, category, NAME, price, stock
    -> FROM goods;
+---------+----+-------------+---------------+------------+---------+-------+
| row_num | id | category_id | category      | NAME       | price   | stock |
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>mysql> SELECT DENSE_RANK() OVER(PARTITION BY category_id ORDER BY price DESC) AS row_num,
    -> id, category_id, category, NAME, price, stock
    -> FROM goods;
+---------+----+-------------+---------------+------------+---------+-------+
| row_num | id | category_id | category      | NAME       | price   | stock |
...
<h4 id="_2-分布函数" tabindex="-1"><a class="header-anchor" href="#_2-分布函数" aria-hidden="true">#</a> 2. 分布函数</h4>
<p><strong>1．PERCENT_RANK()函数</strong></p>
<p>PERCENT_RANK()函数是等级值百分比函数。按照如下方式进行计算。</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code> (rank - 1) / (rows - 1)
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>#写法一：
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql&gt; SELECT CUME_DIST() OVER(PARTITION BY category_id ORDER BY price ASC) AS cd,
...
+---------------------+----+---------------+------------+---------+
12 rows in set (0.00 sec)
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_3-前后函数" tabindex="-1"><a class="header-anchor" href="#_3-前后函数" aria-hidden="true">#</a> 3. 前后函数</h4>
<p><strong>1．LAG(expr,n)函数</strong></p>
<p>LAG(expr,n)函数返回当前行的前n行的expr的值。</p>
<p>举例：查询goods数据表中前一个商品价格与当前商品价格的差值。</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql&gt; SELECT id, category, NAME, price, pre_price, price - pre_price AS diff_price
    -&gt; FROM (
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql&gt; SELECT id, category, NAME, behind_price, price,behind_price - price AS diff_price
    -&gt; FROM(
...
+----+---------------+------------+--------------+---------+------------+
12 rows in set (0.00 sec)
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_4-首尾函数" tabindex="-1"><a class="header-anchor" href="#_4-首尾函数" aria-hidden="true">#</a> 4. 首尾函数</h4>
<p><strong>1．FIRST_VALUE(expr)函数</strong></p>
<p>FIRST_VALUE(expr)函数返回第一个expr的值。</p>
<p>举例：按照价格排序，查询第1个商品的价格信息。</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql&gt; SELECT id, category, NAME, price, stock,FIRST_VALUE(price) OVER w AS first_price
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql&gt; SELECT id, category, NAME, price, stock,LAST_VALUE(price) OVER w AS last_price
    -&gt; FROM goods WINDOW w AS (PARTITION BY category_id ORDER BY price);
+----+---------------+------------+---------+-------+------------+
...
+----+---------------+------------+---------+-------+------------+
12 rows in set (0.00 sec)
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_5-其他函数" tabindex="-1"><a class="header-anchor" href="#_5-其他函数" aria-hidden="true">#</a> 5. 其他函数</h4>
<p><strong>1．NTH_VALUE(expr,n)函数</strong></p>
<p>NTH_VALUE(expr,n)函数返回第n个expr的值。</p>
<p>举例：查询goods数据表中排名第2和第3的价格信息。</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql&gt; SELECT id, category, NAME, price,NTH_VALUE(price,2) OVER w AS second_price,
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql&gt; SELECT NTILE(3) OVER w AS nt,id, category, NAME, price
    -&gt; FROM goods WINDOW w AS (PARTITION BY category_id ORDER BY price);
+----+----+---------------+------------+---------+
...
+----+----+---------------+------------+---------+
12 rows in set (0.00 sec)
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-5-小-结" tabindex="-1"><a class="header-anchor" href="#_2-5-小-结" aria-hidden="true">#</a> 2.5 小 结</h3>
<p>窗口函数的特点是可以分组，而且可以在分组内排序。另外，窗口函数不会因为分组而减少原表中的行数，这对我们在原表数据的基础上进行统计和排序非常有用。</p>
<h2 id="_3-新特性2-公用表表达式" tabindex="-1"><a class="header-anchor" href="#_3-新特性2-公用表表达式" aria-hidden="true">#</a> 3. 新特性2：公用表表达式</h2>
...
<h3 id="_3-1-普通公用表表达式" tabindex="-1"><a class="header-anchor" href="#_3-1-普通公用表表达式" aria-hidden="true">#</a> 3.1 普通公用表表达式</h3>
<p>普通公用表表达式的语法结构是：</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>WITH CTE名称 
AS （子查询）
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql&gt; SELECT * FROM departments
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql&gt; WITH emp_dept_id
...
<h3 id="_3-2-递归公用表表达式" tabindex="-1"><a class="header-anchor" href="#_3-2-递归公用表表达式" aria-hidden="true">#</a> 3.2 递归公用表表达式</h3>
<p>递归公用表表达式也是一种公用表表达式，只不过，除了普通公用表表达式的特点以外，它还有自己的特点，就是<strong>可以调用自己</strong>。它的语法结构是：</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>WITH RECURSIVE
CTE名称 AS （子查询）
SELECT|DELETE|UPDATE 语句;
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>WITH RECURSIVE cte 
AS 
(
...
<h3 id="_3-3-小-结" tabindex="-1"><a class="header-anchor" href="#_3-3-小-结" aria-hidden="true">#</a> 3.3 小 结</h3>
