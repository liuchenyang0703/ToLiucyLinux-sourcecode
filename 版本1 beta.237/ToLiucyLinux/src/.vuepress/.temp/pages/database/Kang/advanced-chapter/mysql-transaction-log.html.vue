...
<h2 id="_1-redo日志" tabindex="-1"><a class="header-anchor" href="#_1-redo日志" aria-hidden="true">#</a> 1. redo日志</h2>
...
<h3 id="_1-1-为什么需要redo日志" tabindex="-1"><a class="header-anchor" href="#_1-1-为什么需要redo日志" aria-hidden="true">#</a> 1.1 为什么需要REDO日志</h3>
...
<h4 id="_2-特点" tabindex="-1"><a class="header-anchor" href="#_2-特点" aria-hidden="true">#</a> 2. 特点</h4>
<ul>
<li>
...
<h3 id="_1-3-redo的组成" tabindex="-1"><a class="header-anchor" href="#_1-3-redo的组成" aria-hidden="true">#</a> 1.3 redo的组成</h3>
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql&gt; show variables like '%innodb_log_buffer_size%';
+------------------------+----------+
| Variable_name          | Value    |
+------------------------+----------+
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>第1步：先将原始数据从磁盘中读入内存中来，修改数据的内存拷贝
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>CREATE TABLE test_load(
a INT,
b CHAR(80)
)ENGINE=INNODB;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>DELIMITER//
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql&gt; CALL p_load(30000);
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql&gt; set global innodb_flush_log_at_trx_commit = 0;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql&gt; CALL p_load(30000);
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql&gt; set global innodb_flush_log_at_trx_commit = 2;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql&gt; CALL p_load(30000);
Query OK, 0 rows affected(46 sec)
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220710215353893.png" alt="image-20220710215353893" style="float:left;" />
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql&gt; show variables like 'innodb_log_files_in_group';
+---------------------------+-------+
| Variable_name             | Value |
+---------------------------+-------+
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql&gt; show variables like 'innodb_log_file_size';
+----------------------+----------+
| Variable_name        | Value    |
+----------------------+----------+
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>[root@localhost ~]# vim /etc/my.cnf
...
<h3 id="_1-9-redo-log-小结" tabindex="-1"><a class="header-anchor" href="#_1-9-redo-log-小结" aria-hidden="true">#</a> 1.9 redo log 小结</h3>
...
<h2 id="_2-undo日志" tabindex="-1"><a class="header-anchor" href="#_2-undo日志" aria-hidden="true">#</a> 2. Undo日志</h2>
...
<h3 id="_2-1-如何理解undo日志" tabindex="-1"><a class="header-anchor" href="#_2-1-如何理解undo日志" aria-hidden="true">#</a> 2.1 如何理解Undo日志</h3>
...
<h3 id="_2-2-undo日志的作用" tabindex="-1"><a class="header-anchor" href="#_2-2-undo日志的作用" aria-hidden="true">#</a> 2.2 Undo日志的作用</h3>
<ul>
...
<h3 id="_2-3-undo的存储结构" tabindex="-1"><a class="header-anchor" href="#_2-3-undo的存储结构" aria-hidden="true">#</a> 2.3 undo的存储结构</h3>
<h4 id="_1-回滚段与undo页" tabindex="-1"><a class="header-anchor" href="#_1-回滚段与undo页" aria-hidden="true">#</a> 1. 回滚段与undo页</h4>
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql&gt; show variables like 'innodb_undo_logs';
+------------------+-------+
| Variable_name    | Value |
+------------------+-------+
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>mysql&gt; show variables like 'innodb_undo_tablespaces';
+-------------------------+-------+
| Variable_name           | Value |
+-------------------------+-------+
...
<h4 id="_3-回滚段中的数据分类" tabindex="-1"><a class="header-anchor" href="#_3-回滚段中的数据分类" aria-hidden="true">#</a> 3. 回滚段中的数据分类</h4>
<ol>
...
<h3 id="_2-4-undo的类型" tabindex="-1"><a class="header-anchor" href="#_2-4-undo的类型" aria-hidden="true">#</a> 2.4 undo的类型</h3>
...
<h3 id="_2-5-undo-log的生命周期" tabindex="-1"><a class="header-anchor" href="#_2-5-undo-log的生命周期" aria-hidden="true">#</a> 2.5 undo log的生命周期</h3>
<h4 id="_1-简要生成过程" tabindex="-1"><a class="header-anchor" href="#_1-简要生成过程" aria-hidden="true">#</a> 1. 简要生成过程</h4>
...
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>UPDATE user SET name=&quot;Sun&quot; WHERE id=1;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220711164138414.png" alt="image-20220711164138414" tabindex="0" loading="lazy"><figcaption>image-20220711164138414</figcaption></figure>
<p>这时会把老的记录写入新的undo log，让回滚指针指向新的undo log，它的undo no是1，并且新的undo log会指向老的undo log（undo no=0）。</p>
<p>假设现在执行：</p>
<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre v-pre class="language-mysql"><code>UPDATE user SET id=2 WHERE id=1;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20220711164421494.png" alt="image-20220711164421494" tabindex="0" loading="lazy"><figcaption>image-20220711164421494</figcaption></figure>
...
<h4 id="_4-undo-log的删除" tabindex="-1"><a class="header-anchor" href="#_4-undo-log的删除" aria-hidden="true">#</a> 4. undo log的删除</h4>
<ul>
<li>
