<template><div><h2 id="一、登录数据库-查看授权日期" tabindex="-1"><a class="header-anchor" href="#一、登录数据库-查看授权日期" aria-hidden="true">#</a> 一、登录数据库，查看授权日期</h2>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 进入数据库</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="二、更新授权key" tabindex="-1"><a class="header-anchor" href="#二、更新授权key" aria-hidden="true">#</a> 二、更新授权key</h2>
<h3 id="_2-1-备份并替换授权key" tabindex="-1"><a class="header-anchor" href="#_2-1-备份并替换授权key" aria-hidden="true">#</a> 2.1 备份并替换授权key</h3>
<p>将<code v-pre>dm.key</code>移动到/opt/dmsetup/下进行替换并更新</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 先备份key</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-2-重启达梦数据库" tabindex="-1"><a class="header-anchor" href="#_2-2-重启达梦数据库" aria-hidden="true">#</a> 2.2 重启达梦数据库</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 重启</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-3-再次进入数据库查看授权日期是否更改" tabindex="-1"><a class="header-anchor" href="#_2-3-再次进入数据库查看授权日期是否更改" aria-hidden="true">#</a> 2.3 再次进入数据库查看授权日期是否更改</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 进入数据库</span>
<span class="token builtin class-name">cd</span> /opt/dmdbms/bin <span class="token operator">&amp;&amp;</span> ./disql SYSDBA/SYSDBA@localhost:5236
