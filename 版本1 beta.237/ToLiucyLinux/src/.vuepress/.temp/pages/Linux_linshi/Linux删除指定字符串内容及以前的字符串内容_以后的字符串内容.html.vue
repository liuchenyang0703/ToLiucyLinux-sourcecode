...
<hr>
<h2 id="内容编辑" tabindex="-1"><a class="header-anchor" href="#内容编辑" aria-hidden="true">#</a> 内容编辑</h2>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@localhost ~<span class="token punctuation">]</span><span class="token comment"># cat a.txt</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="前" tabindex="-1"><a class="header-anchor" href="#前" aria-hidden="true">#</a> 前</h2>
<h3 id="删除指定内容自身及以前所有的字符串内容" tabindex="-1"><a class="header-anchor" href="#删除指定内容自身及以前所有的字符串内容" aria-hidden="true">#</a> 删除指定内容自身及以前所有的字符串内容</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment">#原始内容</span>
GeForce RTX <span class="token number">2080</span> Ti - 2733M
GeForce RTX <span class="token number">2080</span> Ti - 9282M
NVIDIA GeForce GTX <span class="token number">1080</span> Ti - 2947M
NVIDIA GeForce GTX <span class="token number">1080</span> Ti - 3098M
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="后" tabindex="-1"><a class="header-anchor" href="#后" aria-hidden="true">#</a> 后</h2>
<h3 id="删除指定内容自身及以后所有的字符串内容" tabindex="-1"><a class="header-anchor" href="#删除指定内容自身及以后所有的字符串内容" aria-hidden="true">#</a> 删除指定内容自身及以后所有的字符串内容</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment">#原始内容</span>
GeForce RTX <span class="token number">2080</span> Ti - 2733M
GeForce RTX <span class="token number">2080</span> Ti - 9282M
NVIDIA GeForce GTX <span class="token number">1080</span> Ti - 2947M
...
NVIDIA GeForce GTX <span class="token number">1080</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="删除指定内容以后所有的字符串内容不包括自身" tabindex="-1"><a class="header-anchor" href="#删除指定内容以后所有的字符串内容不包括自身" aria-hidden="true">#</a> 删除指定内容以后所有的字符串内容不包括自身</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment">#原始内容</span>
GeForce RTX <span class="token number">2080</span> Ti - 2733M
GeForce RTX <span class="token number">2080</span> Ti - 9282M
NVIDIA GeForce GTX <span class="token number">1080</span> Ti - 2947M
