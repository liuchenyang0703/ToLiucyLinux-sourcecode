...
<hr>
<h2 id="nvidia-smi简介" tabindex="-1"><a class="header-anchor" href="#nvidia-smi简介" aria-hidden="true">#</a> nvidia-smi简介</h2>
<h3 id="_1、什么是nvidia-smi" tabindex="-1"><a class="header-anchor" href="#_1、什么是nvidia-smi" aria-hidden="true">#</a> 1、什么是nvidia-smi</h3>
<blockquote>
...
<h3 id="_2、介绍nvidia-smi" tabindex="-1"><a class="header-anchor" href="#_2、介绍nvidia-smi" aria-hidden="true">#</a> 2、介绍nvidia-smi</h3>
<blockquote>
...
<h2 id="nvidia-smi命令详解" tabindex="-1"><a class="header-anchor" href="#nvidia-smi命令详解" aria-hidden="true">#</a> nvidia-smi命令详解</h2>
<h3 id="nvidia-smi-表格参数详解" tabindex="-1"><a class="header-anchor" href="#nvidia-smi-表格参数详解" aria-hidden="true">#</a> nvidia-smi 表格参数详解</h3>
...
<h3 id="nvidia-smi-help命令详解" tabindex="-1"><a class="header-anchor" href="#nvidia-smi-help命令详解" aria-hidden="true">#</a> nvidia-smi --help命令详解</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="列出所有可用的-nvidia-设备" tabindex="-1"><a class="header-anchor" href="#列出所有可用的-nvidia-设备" aria-hidden="true">#</a> 列出所有可用的 NVIDIA 设备</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412201007621.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<blockquote>
<p>作用：可用作统计服务器中的显卡数量。</p>
</blockquote>
<h4 id="列出所有被拉入黑名单的nvidia设备" tabindex="-1"><a class="header-anchor" href="#列出所有被拉入黑名单的nvidia设备" aria-hidden="true">#</a> 列出所有被拉入黑名单的NVIDIA设备</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412201007457.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<blockquote>
<p><code v-pre>No blacklisted devices found.</code> 未找到列入黑名单的设备。</p>
</blockquote>
<h4 id="查询nvidiagpu的相关信息" tabindex="-1"><a class="header-anchor" href="#查询nvidiagpu的相关信息" aria-hidden="true">#</a> 查询nvidiaGPU的相关信息</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412201007437.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h4 id="持续刷新显存状态" tabindex="-1"><a class="header-anchor" href="#持续刷新显存状态" aria-hidden="true">#</a> 持续刷新显存状态</h4>
...
<h3 id="查询所有的csv文件-query-gpu可使用的字段及字段说明、实例" tabindex="-1"><a class="header-anchor" href="#查询所有的csv文件-query-gpu可使用的字段及字段说明、实例" aria-hidden="true">#</a> 查询所有的csv文件<code v-pre>--query-gpu</code>可使用的字段及字段说明、实例</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="持续监控nvidia-smi结果写入自定义csv文件-并指定写入文件的监控字段" tabindex="-1"><a class="header-anchor" href="#持续监控nvidia-smi结果写入自定义csv文件-并指定写入文件的监控字段" aria-hidden="true">#</a> 持续监控nvidia-smi结果写入自定义csv文件，并指定写入文件的监控字段</h4>
...
<h4 id="持续监控nvidia-smi结果为csv类型并双重重定向到csv文件中-并指定写入文件的监控字段" tabindex="-1"><a class="header-anchor" href="#持续监控nvidia-smi结果为csv类型并双重重定向到csv文件中-并指定写入文件的监控字段" aria-hidden="true">#</a> 持续监控nvidia-smi结果为csv类型并双重重定向到csv文件中，并指定写入文件的监控字段</h4>
...
<h4 id="指定0显卡输出csv类型的显存总空间及使用空间和剩余空间" tabindex="-1"><a class="header-anchor" href="#指定0显卡输出csv类型的显存总空间及使用空间和剩余空间" aria-hidden="true">#</a> 指定0显卡输出csv类型的显存总空间及使用空间和剩余空间</h4>
...
<h4 id="查询所有的csv文件-format可使用的字段及字段说明、实例" tabindex="-1"><a class="header-anchor" href="#查询所有的csv文件-format可使用的字段及字段说明、实例" aria-hidden="true">#</a> 查询所有的csv文件<code v-pre>--format</code>可使用的字段及字段说明、实例</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="查询总显存不带头部标题" tabindex="-1"><a class="header-anchor" href="#查询总显存不带头部标题" aria-hidden="true">#</a> 查询总显存不带头部标题</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412201007130.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h4 id="查询总显存不带头部标题并且不带单位" tabindex="-1"><a class="header-anchor" href="#查询总显存不带头部标题并且不带单位" aria-hidden="true">#</a> 查询总显存不带头部标题并且不带单位</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412201007634.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h2 id="附加-计算某显卡的剩余显存脚本" tabindex="-1"><a class="header-anchor" href="#附加-计算某显卡的剩余显存脚本" aria-hidden="true">#</a> 附加：计算某显卡的剩余显存脚本</h2>
<blockquote>
