...
<hr>
<h2 id="前言-误删经过" tabindex="-1"><a class="header-anchor" href="#前言-误删经过" aria-hidden="true">#</a> 前言 / 误删经过</h2>
<blockquote>
...
<h2 id="ssh连接登录报错信息" tabindex="-1"><a class="header-anchor" href="#ssh连接登录报错信息" aria-hidden="true">#</a> ssh连接登录报错信息</h2>
<p>报错信息为：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412181613552.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<h3 id="_1、先切换到root用户" tabindex="-1"><a class="header-anchor" href="#_1、先切换到root用户" aria-hidden="true">#</a> 1、先切换到root用户</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2、添加一个新用户" tabindex="-1"><a class="header-anchor" href="#_2、添加一个新用户" aria-hidden="true">#</a> 2、添加一个新用户</h3>
<p>随便添加一个新用户</p>
...
<h3 id="_3、将新创建的用户的家目录复制一个出来名字为误删掉的那个" tabindex="-1"><a class="header-anchor" href="#_3、将新创建的用户的家目录复制一个出来名字为误删掉的那个" aria-hidden="true">#</a> 3、将新创建的用户的家目录复制一个出来名字为误删掉的那个</h3>
...
<p>可以看到登录成功了。</p>
<h2 id="解决完成" tabindex="-1"><a class="header-anchor" href="#解决完成" aria-hidden="true">#</a> 解决完成</h2>
</div></template>
