...
<hr>
<h2 id="一、需求" tabindex="-1"><a class="header-anchor" href="#一、需求" aria-hidden="true">#</a> 一、需求：</h2>
<blockquote>
...
<h2 id="二、现成镜像拉取地址" tabindex="-1"><a class="header-anchor" href="#二、现成镜像拉取地址" aria-hidden="true">#</a> 二、现成镜像拉取地址</h2>
<blockquote>
<p>拉取redhat:7.8命令：<code v-pre>docker pull liuchenyang/redhat:7.8</code></p>
</blockquote>
<h2 id="三、手动加一个yum源-并将其打成镜像" tabindex="-1"><a class="header-anchor" href="#三、手动加一个yum源-并将其打成镜像" aria-hidden="true">#</a> 三、手动加一个yum源，并将其打成镜像</h2>
<h3 id="_1、保证docker已安装" tabindex="-1"><a class="header-anchor" href="#_1、保证docker已安装" aria-hidden="true">#</a> 1、保证docker已安装</h3>
<blockquote>
...
<h3 id="_2、拉取-registry-access-redhat-com-rhel7-7-8-镜像" tabindex="-1"><a class="header-anchor" href="#_2、拉取-registry-access-redhat-com-rhel7-7-8-镜像" aria-hidden="true">#</a> 2、拉取 <a href="http://registry.access.redhat.com/rhel7:7.8" target="_blank" rel="noopener noreferrer">registry.access.redhat.com/rhel7:7.8<ExternalLinkIcon/></a> 镜像</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_3、创建一个容器以-registry-access-redhat-com-rhel7-7-8-为基础镜像" tabindex="-1"><a class="header-anchor" href="#_3、创建一个容器以-registry-access-redhat-com-rhel7-7-8-为基础镜像" aria-hidden="true">#</a> 3、创建一个容器以 <a href="http://registry.access.redhat.com/rhel7:7.8" target="_blank" rel="noopener noreferrer">registry.access.redhat.com/rhel7:7.8<ExternalLinkIcon/></a> 为基础镜像</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_4、进入容器" tabindex="-1"><a class="header-anchor" href="#_4、进入容器" aria-hidden="true">#</a> 4、进入容器</h3>
<h4 id="_4-1-关闭redhat自带的插件subscription-manager。" tabindex="-1"><a class="header-anchor" href="#_4-1-关闭redhat自带的插件subscription-manager。" aria-hidden="true">#</a> 4.1 关闭redhat自带的插件subscription-manager。</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_4-2-新增网络yum源" tabindex="-1"><a class="header-anchor" href="#_4-2-新增网络yum源" aria-hidden="true">#</a> 4.2 新增网络yum源</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_4-3-配置完保存退出-创建yum缓存" tabindex="-1"><a class="header-anchor" href="#_4-3-配置完保存退出-创建yum缓存" aria-hidden="true">#</a> 4.3 配置完保存退出，创建yum缓存</h4>
...
yum makecache
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_4-4-更新yum仓库" tabindex="-1"><a class="header-anchor" href="#_4-4-更新yum仓库" aria-hidden="true">#</a> 4.4 更新yum仓库</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="_4-5-安装常用命令" tabindex="-1"><a class="header-anchor" href="#_4-5-安装常用命令" aria-hidden="true">#</a> 4.5 安装常用命令</h4>
...
<h3 id="_5、将容器打为镜像" tabindex="-1"><a class="header-anchor" href="#_5、将容器打为镜像" aria-hidden="true">#</a> 5、将容器打为镜像</h3>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_6、查看镜像" tabindex="-1"><a class="header-anchor" href="#_6、查看镜像" aria-hidden="true">#</a> 6、查看镜像</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412180922246.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h2 id="四、redhat7-8镜像完成" tabindex="-1"><a class="header-anchor" href="#四、redhat7-8镜像完成" aria-hidden="true">#</a> 四、redhat7.8镜像完成！</h2>
<blockquote>
...
<h2 id="五、参考文献【相关文档】" tabindex="-1"><a class="header-anchor" href="#五、参考文献【相关文档】" aria-hidden="true">#</a> 五、参考文献【相关文档】</h2>
<table>
<thead>
<tr>
<th>文章标题</th>
