...
<h2 id="shell脚本简介" tabindex="-1"><a class="header-anchor" href="#shell脚本简介" aria-hidden="true">#</a> shell脚本简介</h2>
<p>shell 用户与内核沟通的桥梁</p>
<h3 id="shell的分类" tabindex="-1"><a class="header-anchor" href="#shell的分类" aria-hidden="true">#</a> shell的分类：</h3>
<ul>
<li>第一类：bash sh csh</li>
<li>第二类：ksh</li>
</ul>
<h3 id="shell脚本的好处" tabindex="-1"><a class="header-anchor" href="#shell脚本的好处" aria-hidden="true">#</a> shell脚本的好处：</h3>
<p>将命令按照一定顺序保存到文件中，统一执行</p>
<ul>
<li>解决重复性的工作</li>
<li>可以避免一些低级错误</li>
</ul>
<h3 id="一些语言的脚本后缀" tabindex="-1"><a class="header-anchor" href="#一些语言的脚本后缀" aria-hidden="true">#</a> 一些语言的脚本后缀</h3>
<ul>
<li>perl--&gt;.pl</li>
<li>python--&gt;.py</li>
<li>php--&gt;.php</li>
...
<h3 id="编程语言分类" tabindex="-1"><a class="header-anchor" href="#编程语言分类" aria-hidden="true">#</a> 编程语言分类：</h3>
<hr>
<ul>
<li>编译型 C C++</li>
...
<hr>
<h3 id="shell脚本的固定书写" tabindex="-1"><a class="header-anchor" href="#shell脚本的固定书写" aria-hidden="true">#</a> shell脚本的固定书写</h3>
<ul>
<li>创建shell脚本</li>
</ul>
...
<h3 id="如何执行shell脚本" tabindex="-1"><a class="header-anchor" href="#如何执行shell脚本" aria-hidden="true">#</a> 如何执行shell脚本</h3>
<ul>
...
<h2 id="shell脚本变量" tabindex="-1"><a class="header-anchor" href="#shell脚本变量" aria-hidden="true">#</a> shell脚本变量</h2>
<blockquote>
...
<h3 id="变量的命名规则" tabindex="-1"><a class="header-anchor" href="#变量的命名规则" aria-hidden="true">#</a> 变量的命名规则：</h3>
<ul>
...
<h3 id="shell中变量的分类" tabindex="-1"><a class="header-anchor" href="#shell中变量的分类" aria-hidden="true">#</a> shell中变量的分类：</h3>
<ul>
<li>预定义变量</li>
<li>位置变量</li>
<li>环境变量</li>
...
<h2 id="shell脚本的计算" tabindex="-1"><a class="header-anchor" href="#shell脚本的计算" aria-hidden="true">#</a> shell脚本的计算</h2>
<h3 id="只能做整数计算" tabindex="-1"><a class="header-anchor" href="#只能做整数计算" aria-hidden="true">#</a> (( ))	只能做整数计算</h3>
<blockquote>
<ul>
<li>+加</li>
<li>-减</li>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="只能做整数计算-和-一样" tabindex="-1"><a class="header-anchor" href="#只能做整数计算-和-一样" aria-hidden="true">#</a> []只能做整数计算（和(())一样）</h3>
<p>实例：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token shebang important">#!/bin/bash</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="expr只能做整数计算-可用于判断是否为整数" tabindex="-1"><a class="header-anchor" href="#expr只能做整数计算-可用于判断是否为整数" aria-hidden="true">#</a> expr	只能做整数计算（可用于判断是否为整数）</h3>
<blockquote>
<p>加、减、乘、除、余、次方都可以</p>
</blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="bc计算器-可小数点" tabindex="-1"><a class="header-anchor" href="#bc计算器-可小数点" aria-hidden="true">#</a> bc	计算器（可小数点）</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="let整数计算-与-一样" tabindex="-1"><a class="header-anchor" href="#let整数计算-与-一样" aria-hidden="true">#</a> let	整数计算，与(( ))一样</h3>
...
<h2 id="内置命令" tabindex="-1"><a class="header-anchor" href="#内置命令" aria-hidden="true">#</a> 内置命令</h2>
<h3 id="echo" tabindex="-1"><a class="header-anchor" href="#echo" aria-hidden="true">#</a> echo</h3>
<blockquote>
...
<h3 id="read" tabindex="-1"><a class="header-anchor" href="#read" aria-hidden="true">#</a> read</h3>
<blockquote>
...
<h2 id="shell脚本流程控制语句" tabindex="-1"><a class="header-anchor" href="#shell脚本流程控制语句" aria-hidden="true">#</a> shell脚本流程控制语句</h2>
<h3 id="条件测试-前后都要有空格" tabindex="-1"><a class="header-anchor" href="#条件测试-前后都要有空格" aria-hidden="true">#</a> 条件测试（前后都要有空格）</h3>
<p>test 条件 或 [ 条件 ]</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="文件测试-前后都要有空格" tabindex="-1"><a class="header-anchor" href="#文件测试-前后都要有空格" aria-hidden="true">#</a> 文件测试（[]前后都要有空格）</h3>
<ul>
<li>-f	判断是否为文件</li>
</ul>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span> <span class="token parameter variable">-e</span> anaconda-ks.cfg <span class="token punctuation">]</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="整数测试-常用于if判断中" tabindex="-1"><a class="header-anchor" href="#整数测试-常用于if判断中" aria-hidden="true">#</a> 整数测试（常用于if判断中）</h3>
<ul>
<li>-eq	等于</li>
<li>-ne	不等于</li>
<li>-gt	大于</li>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="字符串测试-常用于if判断中" tabindex="-1"><a class="header-anchor" href="#字符串测试-常用于if判断中" aria-hidden="true">#</a> 字符串测试（常用于if判断中）</h3>
<ul>
<li>==		等于</li>
<li>！=	不等于</li>
<li>-z	判断字符串是否为空</li>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="逻辑关系" tabindex="-1"><a class="header-anchor" href="#逻辑关系" aria-hidden="true">#</a> 逻辑关系</h3>
<ul>
<li>&amp;&amp;	与/并且</li>
<li>||	或</li>
<li>!	非</li>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="shell中字符串操作" tabindex="-1"><a class="header-anchor" href="#shell中字符串操作" aria-hidden="true">#</a> shell中字符串操作</h2>
<h3 id="求变量字符串长度" tabindex="-1"><a class="header-anchor" href="#求变量字符串长度" aria-hidden="true">#</a> 求变量字符串长度：</h3>
<ul>
<li id="变量名">1.echo $</li>
</ul>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token shebang important">#!/bin/bash</span>
...
<h3 id="变量字符串的截取" tabindex="-1"><a class="header-anchor" href="#变量字符串的截取" aria-hidden="true">#</a> 变量字符串的截取：</h3>
<ul>
...
<h3 id="变量字符串的替换" tabindex="-1"><a class="header-anchor" href="#变量字符串的替换" aria-hidden="true">#</a> 变量字符串的替换：</h3>
<ul>
...
<h3 id="cut字符串切割" tabindex="-1"><a class="header-anchor" href="#cut字符串切割" aria-hidden="true">#</a> cut字符串切割</h3>
<ul>
<li>-d	自定义分隔符</li>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="shell脚本数组" tabindex="-1"><a class="header-anchor" href="#shell脚本数组" aria-hidden="true">#</a> shell脚本数组</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="数组的增删改查" tabindex="-1"><a class="header-anchor" href="#数组的增删改查" aria-hidden="true">#</a> 数组的增删改查：</h3>
<h4 id="查" tabindex="-1"><a class="header-anchor" href="#查" aria-hidden="true">#</a> 查：</h4>
<ul>
