...
<p>官网地址: <a href="https://kubernetes.io" target="_blank" rel="noopener noreferrer">https://kubernetes.io<ExternalLinkIcon/></a></p>
<h3 id="_1-kubernetes架构" tabindex="-1"><a class="header-anchor" href="#_1-kubernetes架构" aria-hidden="true">#</a> 1 kubernetes架构</h3>
<blockquote>
...
<h4 id="_1-1master节点" tabindex="-1"><a class="header-anchor" href="#_1-1master节点" aria-hidden="true">#</a> 1.1master节点</h4>
<blockquote>
...
<h4 id="_1-2-node节点" tabindex="-1"><a class="header-anchor" href="#_1-2-node节点" aria-hidden="true">#</a> 1.2 Node节点</h4>
<blockquote>
...
<h4 id="_1-3-kubectl" tabindex="-1"><a class="header-anchor" href="#_1-3-kubectl" aria-hidden="true">#</a> 1.3 kubectl</h4>
<blockquote>
<p>   集群管理命令行工具集，通过客户端的kubectl命令集操作，API Server响应对应的命令结果，从而达到对kubernetes集群的管理。</p>
</blockquote>
<h3 id="_2-kubeadm" tabindex="-1"><a class="header-anchor" href="#_2-kubeadm" aria-hidden="true">#</a> 2 kubeadm</h3>
...
<h4 id="_2-1-kubeadm功能" tabindex="-1"><a class="header-anchor" href="#_2-1-kubeadm功能" aria-hidden="true">#</a> 2.1 kubeadm功能</h4>
<ul>
...
<h2 id="kubernetes集群部署" tabindex="-1"><a class="header-anchor" href="#kubernetes集群部署" aria-hidden="true">#</a> Kubernetes集群部署</h2>
<h2 id="准备工作-所有节点都要做同样的操作" tabindex="-1"><a class="header-anchor" href="#准备工作-所有节点都要做同样的操作" aria-hidden="true">#</a> 准备工作（所有节点都要做同样的操作）</h2>
<h3 id="服务器配置" tabindex="-1"><a class="header-anchor" href="#服务器配置" aria-hidden="true">#</a> 服务器配置</h3>
<table>
<thead>
<tr>
<th>集群（一主两从）</th>
...
<h3 id="关闭防火墙" tabindex="-1"><a class="header-anchor" href="#关闭防火墙" aria-hidden="true">#</a> 关闭防火墙</h3>
...
<h3 id="关闭selinux" tabindex="-1"><a class="header-anchor" href="#关闭selinux" aria-hidden="true">#</a> 关闭selinux</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="关闭交换分区" tabindex="-1"><a class="header-anchor" href="#关闭交换分区" aria-hidden="true">#</a> 关闭交换分区</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="修改三台集群的主机名-每个主机限一条命令" tabindex="-1"><a class="header-anchor" href="#修改三台集群的主机名-每个主机限一条命令" aria-hidden="true">#</a> 修改三台集群的主机名：（每个主机限一条命令）</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@k8s-master1 ~<span class="token punctuation">]</span><span class="token comment"># hostnamectl set-hostname k8s-master</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="所有节点都添加集群ip与主机名到hosts中" tabindex="-1"><a class="header-anchor" href="#所有节点都添加集群ip与主机名到hosts中" aria-hidden="true">#</a> 所有节点都添加集群ip与主机名到hosts中：</h3>
...
EOF</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><font color=red>注意：ip一定要改成自己的ip，不要直接复制粘贴</font><h3 id="三台机器进行时间同步" tabindex="-1"><a class="header-anchor" href="#三台机器进行时间同步" aria-hidden="true">#</a> 三台机器进行时间同步</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="特殊说明" tabindex="-1"><a class="header-anchor" href="#特殊说明" aria-hidden="true">#</a> 特殊说明:</h3>
<blockquote>
<p>如果是克隆虚拟机建议执行<font color=red>rm -rf /etc/udev/*</font> 保证网卡UUID不同</p>
</blockquote>
<h3 id="三台都安装需要的一些命令" tabindex="-1"><a class="header-anchor" href="#三台都安装需要的一些命令" aria-hidden="true">#</a> 三台都安装需要的一些命令：</h3>
<ul>
...
<h2 id="部署-docker-所有节点都需要部署" tabindex="-1"><a class="header-anchor" href="#部署-docker-所有节点都需要部署" aria-hidden="true">#</a> 部署 docker（所有节点都需要部署）</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="给docker添加镜像加速器及cgroup并重启docker服务" tabindex="-1"><a class="header-anchor" href="#给docker添加镜像加速器及cgroup并重启docker服务" aria-hidden="true">#</a> 给docker添加镜像加速器及cgroup并重启docker服务</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="docker部署完成" tabindex="-1"><a class="header-anchor" href="#docker部署完成" aria-hidden="true">#</a> docker部署完成</h3>
<h2 id="部署-kubernetes-所有节点都要部署" tabindex="-1"><a class="header-anchor" href="#部署-kubernetes-所有节点都要部署" aria-hidden="true">#</a> 部署 kubernetes（所有节点都要部署）</h2>
<h3 id="配置相关的内核参数" tabindex="-1"><a class="header-anchor" href="#配置相关的内核参数" aria-hidden="true">#</a> 配置相关的内核参数</h3>
<p>将桥接的IPv4 流量传递到iptables 的链</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@docker ~<span class="token punctuation">]</span><span class="token comment"># cat &lt;&lt;EOF >  /etc/sysctl.d/k8s.conf</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="添加-k8s-yum源" tabindex="-1"><a class="header-anchor" href="#添加-k8s-yum源" aria-hidden="true">#</a> 添加 k8s yum源</h3>
...
yum makecache fast
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="安装-kubeadm-kubelet-kubectl" tabindex="-1"><a class="header-anchor" href="#安装-kubeadm-kubelet-kubectl" aria-hidden="true">#</a> 安装 kubeadm kubelet kubectl</h3>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="kubernetes强化tab-安装之后会tab可以补全命令及参数" tabindex="-1"><a class="header-anchor" href="#kubernetes强化tab-安装之后会tab可以补全命令及参数" aria-hidden="true">#</a> kubernetes强化tab（安装之后会tab可以补全命令及参数）</h3>
<ul>
<li>配置环境</li>
</ul>
...
<h3 id="查看kubeadm使用的镜像" tabindex="-1"><a class="header-anchor" href="#查看kubeadm使用的镜像" aria-hidden="true">#</a> 查看kubeadm使用的镜像</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>kubeadm config images list
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><blockquote>
<p>可以发现这里都是国外的镜像<br><br>
<a href="http://k8s.gcr.io/kube-apiserver:v1.20.15" target="_blank" rel="noopener noreferrer">k8s.gcr.io/kube-apiserver:v1.20.15<ExternalLinkIcon/></a><br>
<a href="http://k8s.gcr.io/kube-controller-manager:v1.20.15" target="_blank" rel="noopener noreferrer">k8s.gcr.io/kube-controller-manager:v1.20.15<ExternalLinkIcon/></a><br>
<a href="http://k8s.gcr.io/kube-scheduler:v1.20.15" target="_blank" rel="noopener noreferrer">k8s.gcr.io/kube-scheduler:v1.20.15<ExternalLinkIcon/></a><br>
<a href="http://k8s.gcr.io/kube-proxy:v1.20.15" target="_blank" rel="noopener noreferrer">k8s.gcr.io/kube-proxy:v1.20.15<ExternalLinkIcon/></a><br>
<a href="http://k8s.gcr.io/pause:3.2" target="_blank" rel="noopener noreferrer">k8s.gcr.io/pause:3.2<ExternalLinkIcon/></a><br>
<a href="http://k8s.gcr.io/etcd:3.4.13-0" target="_blank" rel="noopener noreferrer">k8s.gcr.io/etcd:3.4.13-0<ExternalLinkIcon/></a><br>
<a href="http://k8s.gcr.io/coredns:1.7.0" target="_blank" rel="noopener noreferrer">k8s.gcr.io/coredns:1.7.0<ExternalLinkIcon/></a></p>
</blockquote>
<ul>
<li>解决国外镜像不能访问的问题，执行kubeadm.sh脚本，用于拉取镜像/打tag/删除原有镜像；</li>
</ul>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">wget</span> <span class="token parameter variable">-O</span> kubeadm.sh https://files.rundreams.net/sh/kubeadm.sh <span class="token operator">&amp;&amp;</span> <span class="token function">sh</span> kubeadm.sh
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>等待拉取完成。</p>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412161420231.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h2 id="master节点" tabindex="-1"><a class="header-anchor" href="#master节点" aria-hidden="true">#</a> master节点</h2>
<h3 id="初始化master节点" tabindex="-1"><a class="header-anchor" href="#初始化master节点" aria-hidden="true">#</a> 初始化master节点</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>初始化成功图为下：</p>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@k8s-master ~<span class="token punctuation">]</span><span class="token comment"># kubectl get nodes</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412161420835.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>现在的集群状态都是<code v-pre>NotReady</code>表示不可达；这是因为还没有安装网络插件，下面我们来安装一下<code v-pre>网络插件（caclico）</code></p>
<h3 id="给master节点安装pod网络插件-calico" tabindex="-1"><a class="header-anchor" href="#给master节点安装pod网络插件-calico" aria-hidden="true">#</a> 给master节点安装Pod网络插件（calico）</h3>
<blockquote>
<p>选择网络插件：<a href="https://kubernetes.io/docs/concepts/cluster-administration/addons/" target="_blank" rel="noopener noreferrer">https://kubernetes.io/docs/concepts/cluster-administration/addons/<ExternalLinkIcon/></a><br>
快速开始配置：<a href="https://projectcalico.docs.tigera.io/archive/v3.20/getting-started/clis/calicoctl/install" target="_blank" rel="noopener noreferrer">https://projectcalico.docs.tigera.io/archive/v3.20/getting-started/clis/calicoctl/install<ExternalLinkIcon/></a><br>
calico网络插件：<a href="https://docs.projectcalico.org/v3.9/getting-started/kubernetes/" target="_blank" rel="noopener noreferrer">https://docs.projectcalico.org/v3.9/getting-started/kubernetes/<ExternalLinkIcon/></a></p>
</blockquote>
<ul>
<li>在master节点安装calico</li>
</ul>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>kubectl apply <span class="token parameter variable">-f</span> https://docs.projectcalico.org/v3.9/manifests/calico.yaml
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412161420304.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<ul>
<li>确认一下calico是否安装成功</li>
</ul>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>kubectl get pods --all-namespaces <span class="token parameter variable">-w</span>
kubectl get pods <span class="token parameter variable">-n</span> kube-system <span class="token parameter variable">-w</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="查看节点连接状态" tabindex="-1"><a class="header-anchor" href="#查看节点连接状态" aria-hidden="true">#</a> 查看节点连接状态</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>STATUS 状态为<code v-pre>Ready</code>则连接成功。</p>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">cat</span> <span class="token operator">></span> pod_nginx_rs.yaml <span class="token operator">&lt;&lt;</span><span class="token string">EOF
apiVersion: apps/v1
kind: ReplicaSet
metadata:
  name: nginx
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>kubectl apply <span class="token parameter variable">-f</span> pod_nginx_rs.yaml
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul>
<li>查看pod</li>
</ul>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment">#查看所有的pod</span>
kubectl get pods
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment">#将nginx服务由3个扩容为5个</span>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">cat</span> <span class="token operator">></span> pod_nginx_rs_svc.yaml <span class="token operator">&lt;&lt;</span><span class="token string">EOF
apiVersion: v1
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>kubectl apply <span class="token parameter variable">-f</span> pod_nginx_rs_svc.yaml
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul>
<li>查看services</li>
</ul>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>kubectl get svc
kubectl get services
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412161420085.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<blockquote>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment">#删除serviecs</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="完结⭕" tabindex="-1"><a class="header-anchor" href="#完结⭕" aria-hidden="true">#</a> 完结⭕</h2>
