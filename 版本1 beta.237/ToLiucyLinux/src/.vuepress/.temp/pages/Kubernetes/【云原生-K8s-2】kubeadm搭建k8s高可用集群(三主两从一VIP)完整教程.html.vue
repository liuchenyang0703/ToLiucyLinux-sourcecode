...
<h2 id="kubernetes高可用集群部署" tabindex="-1"><a class="header-anchor" href="#kubernetes高可用集群部署" aria-hidden="true">#</a> Kubernetes高可用集群部署</h2>
...
EOF</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><font color=red>注意：ip一定要改成自己的ip，不要直接复制粘贴</font><h3 id="六台机器进行时间同步" tabindex="-1"><a class="header-anchor" href="#六台机器进行时间同步" aria-hidden="true">#</a> 六台机器进行时间同步</h3>
...
<h3 id="六台都安装需要的一些命令" tabindex="-1"><a class="header-anchor" href="#六台都安装需要的一些命令" aria-hidden="true">#</a> 六台都安装需要的一些命令：</h3>
<ul>
...
<h3 id="调整能打开文件数大小" tabindex="-1"><a class="header-anchor" href="#调整能打开文件数大小" aria-hidden="true">#</a> 调整能打开文件数大小</h3>
...
<h3 id="安装配置ipvsadm" tabindex="-1"><a class="header-anchor" href="#安装配置ipvsadm" aria-hidden="true">#</a> 安装配置ipvsadm</h3>
...
<h2 id="部署keepalived、haproxy-配置高可用-所有-主节点-部署" tabindex="-1"><a class="header-anchor" href="#部署keepalived、haproxy-配置高可用-所有-主节点-部署" aria-hidden="true">#</a> 部署keepalived、haproxy --&gt; 配置高可用（所有 <font color=red>主节点</font> 部署）</h2>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="所有-主节点-修改haproxy配置" tabindex="-1"><a class="header-anchor" href="#所有-主节点-修改haproxy配置" aria-hidden="true">#</a> 所有 <font color=red>主节点</font> 修改haproxy配置</h3>
<blockquote>
...
vrrp_instance VI_1 <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="所有-主节点-编写健康检测脚本" tabindex="-1"><a class="header-anchor" href="#所有-主节点-编写健康检测脚本" aria-hidden="true">#</a> 所有 <font color=red>主节点</font> 编写健康检测脚本</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="所有-主节点-启动-keepalived-与-haproxy" tabindex="-1"><a class="header-anchor" href="#所有-主节点-启动-keepalived-与-haproxy" aria-hidden="true">#</a> 所有 <font color=red>主节点</font> 启动 keepalived 与 haproxy</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="k8s-master1主节点查看vip" tabindex="-1"><a class="header-anchor" href="#k8s-master1主节点查看vip" aria-hidden="true">#</a> <font color=red>k8s-master1</font>主节点查看VIP</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="更新配置文件" tabindex="-1"><a class="header-anchor" href="#更新配置文件" aria-hidden="true">#</a> 更新配置文件</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="查看需要的镜像文件" tabindex="-1"><a class="header-anchor" href="#查看需要的镜像文件" aria-hidden="true">#</a> 查看需要的镜像文件</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412161408772.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h3 id="所有master节点启动" tabindex="-1"><a class="header-anchor" href="#所有master节点启动" aria-hidden="true">#</a> 所有master节点启动</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="master1节点-初始化-初始化后生成对应的证书" tabindex="-1"><a class="header-anchor" href="#master1节点-初始化-初始化后生成对应的证书" aria-hidden="true">#</a> <font color=red>master1节点</font> 初始化，初始化后生成对应的证书</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412161408706.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<blockquote>
...
<h3 id="master1节点-配置环境变量-用于访问kubernetes集群" tabindex="-1"><a class="header-anchor" href="#master1节点-配置环境变量-用于访问kubernetes集群" aria-hidden="true">#</a> <font color=red>master1节点 </font>配置环境变量，用于访问Kubernetes集群</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="在-master1节点-查看集群节点状态" tabindex="-1"><a class="header-anchor" href="#在-master1节点-查看集群节点状态" aria-hidden="true">#</a> 在 <font color=red>master1节点</font> 查看集群节点状态</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>kubectl get nodes
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412161408673.png" alt="截图" tabindex="0" loading="lazy"><figcaption>截图</figcaption></figure>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412161408375.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<h3 id="其他master节点加入集群-master2-和-master3-节点操作" tabindex="-1"><a class="header-anchor" href="#其他master节点加入集群-master2-和-master3-节点操作" aria-hidden="true">#</a> 其他master节点加入集群（master2 和 master3 节点操作）</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@k8s-master2 ~<span class="token punctuation">]</span><span class="token comment"># kubeadm join 172.16.11.220:16443 --token 7t2weq.bjbawausm0jaxury \</span>
   ...
   --discovery-token-ca-cert-hash sha256:f370e43a5b3218b7b6094980edd4fac3b6104a272e465767d3c78dfad8c62066 <span class="token punctuation">\</span>
   --control-plane --certificate-key 26270907ae9b940062bd9f5e4daad59e2804a4a5bdbfb61c7ebb0e6d2f5e5839
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412161408788.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>加入成功，可以在master1上使用<code v-pre>kubectl get nods</code>来查看。</p>
<h3 id="node节点配置-node1-和-node2-节点操作" tabindex="-1"><a class="header-anchor" href="#node节点配置-node1-和-node2-节点操作" aria-hidden="true">#</a> Node节点配置（node1 和 node2 节点操作）</h3>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@k8s-node1 ~<span class="token punctuation">]</span><span class="token comment"># kubeadm join 172.16.11.220:16443 --token 7t2weq.bjbawausm0jaxury \</span>
    ...
    --discovery-token-ca-cert-hash sha256:f370e43a5b3218b7b6094980edd4fac3b6104a272e465767d3c78dfad8c62066 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412161408402.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>加入成功，可以在master1上使用<code v-pre>kubectl get nods</code>来查看。</p>
<ul>
<li>master1查看所有节点</li>
</ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412161408771.png" alt="截图" tabindex="0" loading="lazy"><figcaption>截图</figcaption></figure>
<p>现在的集群状态都是<code v-pre>NotReady</code>表示不可达；这是因为还没有安装网络插件，下面我们来安装一下网络插件（caclico）</p>
<h2 id="calico组件-只在-master1节点-操作-【网络插件-用于连接其他节点】" tabindex="-1"><a class="header-anchor" href="#calico组件-只在-master1节点-操作-【网络插件-用于连接其他节点】" aria-hidden="true">#</a> Calico组件（只在  master1节点  操作）【网络插件，用于连接其他节点】</h2>
<blockquote>
...
<h3 id="拉取安装包-安装包内包含-calico组件、metrics组件、dashboard组件" tabindex="-1"><a class="header-anchor" href="#拉取安装包-安装包内包含-calico组件、metrics组件、dashboard组件" aria-hidden="true">#</a> 拉取安装包（安装包内包含：Calico组件、Metrics组件、Dashboard组件）</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="修改相关的配置文件" tabindex="-1"><a class="header-anchor" href="#修改相关的配置文件" aria-hidden="true">#</a> 修改相关的配置文件</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="创建运行并查看容器状态" tabindex="-1"><a class="header-anchor" href="#创建运行并查看容器状态" aria-hidden="true">#</a> 创建运行并查看容器状态</h3>
<ul>
<li>创建并运行yaml文件</li>
</ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412161408959.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<ul>
<li>查看创建的容器状态</li>
</ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412161408018.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<h3 id="查看节点网络连接状态" tabindex="-1"><a class="header-anchor" href="#查看节点网络连接状态" aria-hidden="true">#</a> 查看节点网络连接状态</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412161408097.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>可以看到都连接成功了。</p>
<h2 id="metrics部署-只在-master1节点-操作-【用于查看其他节点的资源使用率】" tabindex="-1"><a class="header-anchor" href="#metrics部署-只在-master1节点-操作-【用于查看其他节点的资源使用率】" aria-hidden="true">#</a> Metrics部署（只在 master1节点 操作）【用于查看其他节点的资源使用率】</h2>
<blockquote>
<p>  在新版的Kubernetes中系统资源的采集均使用Metrics-server，可以通过Metrics采集节点和Pod的内存、磁盘、CPU和网络的使用率。</p>
</blockquote>
<h3 id="将master1节点的front-proxy-ca-crt复制到所有node节点" tabindex="-1"><a class="header-anchor" href="#将master1节点的front-proxy-ca-crt复制到所有node节点" aria-hidden="true">#</a> 将Master1节点的front-proxy-ca.crt复制到所有Node节点</h3>
<ul>
<li>复制到node1节点上</li>
</ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412161408400.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h3 id="安装metrics-server" tabindex="-1"><a class="header-anchor" href="#安装metrics-server" aria-hidden="true">#</a> 安装metrics server</h3>
...
<h3 id="查看节点状态" tabindex="-1"><a class="header-anchor" href="#查看节点状态" aria-hidden="true">#</a> 查看节点状态</h3>
