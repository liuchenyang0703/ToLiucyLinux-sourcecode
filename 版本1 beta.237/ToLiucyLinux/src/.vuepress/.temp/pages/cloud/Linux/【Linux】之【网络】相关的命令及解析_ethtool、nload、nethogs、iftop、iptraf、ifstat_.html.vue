...
<h1 id="一、网络带宽命令" tabindex="-1"><a class="header-anchor" href="#一、网络带宽命令" aria-hidden="true">#</a> 一、网络带宽命令</h1>
<h2 id="_1、ethtool-–-查询与设置网卡参数" tabindex="-1"><a class="header-anchor" href="#_1、ethtool-–-查询与设置网卡参数" aria-hidden="true">#</a> 1、ethtool – 查询与设置网卡参数</h2>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="_2、nload-–-实时统计网卡带宽使用率工具" tabindex="-1"><a class="header-anchor" href="#_2、nload-–-实时统计网卡带宽使用率工具" aria-hidden="true">#</a> 2、nload – 实时统计网卡带宽使用率工具</h2>
<p><strong><font color=teal>语法格式</font></strong></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/b9483a6e74b84dc08518138b4b4c3358.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>监测所有网卡的流量：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="https://img-blog.csdnimg.cn/23b1d0bd53284e4f8866e0baa688a6e2.png" alt="" loading="lazy"><br>
按【回车健】查看下一个网卡监测情况；</p>
<p><strong><font color=teal>字段解析</font></strong></p>
<blockquote>
<p>Curr：当前流量 Avg：平均流量 Min：最小流量 Max：最大流量 Ttl：总流量</p>
</blockquote>
<h1 id="二、网络命令" tabindex="-1"><a class="header-anchor" href="#二、网络命令" aria-hidden="true">#</a> 二、网络命令</h1>
<h2 id="_1、nethogs-–-实时统计网络带宽使用率工具" tabindex="-1"><a class="header-anchor" href="#_1、nethogs-–-实时统计网络带宽使用率工具" aria-hidden="true">#</a> 1、nethogs – 实时统计网络带宽使用率工具</h2>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/7999a8cadf4646cba3ba51e4304ad57f.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h2 id="_3、iptraf-–-实时监视网卡流量" tabindex="-1"><a class="header-anchor" href="#_3、iptraf-–-实时监视网卡流量" aria-hidden="true">#</a> 3、iptraf – 实时监视网卡流量</h2>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/3d742bbd49fa463190e921504fe8e689.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h2 id="_4、ifstat-–-统计网络信息" tabindex="-1"><a class="header-anchor" href="#_4、ifstat-–-统计网络信息" aria-hidden="true">#</a> 4、ifstat – 统计网络信息</h2>
<blockquote>
