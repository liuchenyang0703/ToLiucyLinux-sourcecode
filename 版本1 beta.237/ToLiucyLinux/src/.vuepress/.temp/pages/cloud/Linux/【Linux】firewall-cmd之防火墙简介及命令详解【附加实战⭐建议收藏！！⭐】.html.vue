<template><div><p><img src="https://img-blog.csdnimg.cn/9baf841a005a4fbbbedd0536a5e718a7.png#pic_center" alt="" width="600" height="350" loading="lazy"><br>
<br><br>
<strong><center><font color=red size=5>【Linux】firewall-cmd之防火墙简介及命令详解+实例</font></center></strong></p>
<br>
<p>@[toc]</p>
<h1 id="本文简介" tabindex="-1"><a class="header-anchor" href="#本文简介" aria-hidden="true">#</a> 本文简介</h1>
<blockquote>
...
<h1 id="firewall-cmd命令详解" tabindex="-1"><a class="header-anchor" href="#firewall-cmd命令详解" aria-hidden="true">#</a> firewall-cmd命令详解</h1>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="语法格式" tabindex="-1"><a class="header-anchor" href="#语法格式" aria-hidden="true">#</a> 语法格式</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="常用参数-选项" tabindex="-1"><a class="header-anchor" href="#常用参数-选项" aria-hidden="true">#</a> 常用参数/选项</h2>
<table>
	<tr>
	    <th>选项分类</th>
	    <th>参数/选项</th>
...
<h3 id="_1、防火墙的常规操作" tabindex="-1"><a class="header-anchor" href="#_1、防火墙的常规操作" aria-hidden="true">#</a> 1、防火墙的常规操作</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2、配置firewalld" tabindex="-1"><a class="header-anchor" href="#_2、配置firewalld" aria-hidden="true">#</a> 2、配置firewalld</h3>
...
<h3 id="_3、服务管理" tabindex="-1"><a class="header-anchor" href="#_3、服务管理" aria-hidden="true">#</a> 3、服务管理</h3>
<p>3.1、显示服务列表</p>
<blockquote>
...
firewall-cmd <span class="token parameter variable">--reload</span>     
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4、端口管理" tabindex="-1"><a class="header-anchor" href="#_4、端口管理" aria-hidden="true">#</a> 4、端口管理</h3>
<blockquote>
<p>永久打开端口需要firewall-cmd --reload重新加载一下；<br>
临时打开就不需要了；</p>
<font color=red>如果设置永久打开端口用了firewall-cmd --reload命令，临时打开的端口就会失效；</font></blockquote>
<h4 id="_4-1、打开443-tcp端口" tabindex="-1"><a class="header-anchor" href="#_4-1、打开443-tcp端口" aria-hidden="true">#</a> 4.1、打开443/TCP端口</h4>
...
firewall-cmd --list-ports
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_4-2、永久打开3306-tcp端口" tabindex="-1"><a class="header-anchor" href="#_4-2、永久打开3306-tcp端口" aria-hidden="true">#</a> 4.2、永久打开3306/TCP端口</h4>
...
<span class="token comment">#查看已开放的端口</span>
firewall-cmd --list-ports
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_4-3、查看已开放的端口-两种方式" tabindex="-1"><a class="header-anchor" href="#_4-3、查看已开放的端口-两种方式" aria-hidden="true">#</a> 4.3、查看已开放的端口（两种方式）</h4>
<blockquote>
<p>两种区别就在：</p>
<ul>
...
firewall-cmd --list-ports
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/d76e7e20c40b47788638955cfa3acbd3.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h4 id="_4-4、删除已开放的某个不需要的端口" tabindex="-1"><a class="header-anchor" href="#_4-4、删除已开放的某个不需要的端口" aria-hidden="true">#</a> 4.4、删除已开放的某个不需要的端口</h4>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>firewall-cmd --remove-port<span class="token operator">=</span><span class="token number">3396</span>/tcp
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="_4-5、批量添加多个端口" tabindex="-1"><a class="header-anchor" href="#_4-5、批量添加多个端口" aria-hidden="true">#</a> 4.5、批量添加多个端口</h4>
...
<span class="token comment">#查看已开放的端口</span>
firewall-cmd --list-ports
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_4-6、批量添加某一段端口" tabindex="-1"><a class="header-anchor" href="#_4-6、批量添加某一段端口" aria-hidden="true">#</a> 4.6、批量添加某一段端口</h4>
...
<span class="token comment">#查看已开放的端口</span>
firewall-cmd --list-ports
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_5、ip管理" tabindex="-1"><a class="header-anchor" href="#_5、ip管理" aria-hidden="true">#</a> 5、IP管理</h3>
<h4 id="_5-1、限制-禁止-ip地址访问" tabindex="-1"><a class="header-anchor" href="#_5-1、限制-禁止-ip地址访问" aria-hidden="true">#</a> 5.1、限制（禁止）IP地址访问</h4>
<ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/f5916c24ef824b0e983c252329db6c2d.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h4 id="_5-2、解除-开放-ip地址限制" tabindex="-1"><a class="header-anchor" href="#_5-2、解除-开放-ip地址限制" aria-hidden="true">#</a> 5.2、解除（开放）IP地址限制</h4>
<ul>
...
firewall-cmd --list-rich-rules
firewall-cmd --list-all
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_5-3、删除限制或解除ip这条防火墙规则-以下ip地址段同" tabindex="-1"><a class="header-anchor" href="#_5-3、删除限制或解除ip这条防火墙规则-以下ip地址段同" aria-hidden="true">#</a> 5.3、删除限制或解除IP这条防火墙规则（以下IP地址段同）</h4>
...
firewall-cmd --list-rich-rules
firewall-cmd --list-all
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/554d402a4ac84f6f9a4a315394a2395c.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h4 id="_5-4、限制-禁止-ip地址段" tabindex="-1"><a class="header-anchor" href="#_5-4、限制-禁止-ip地址段" aria-hidden="true">#</a> 5.4、限制（禁止）IP地址段</h4>
<ul>
...
firewall-cmd --list-rich-rules
firewall-cmd --list-all
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_5-5、解除-开放-ip地址段" tabindex="-1"><a class="header-anchor" href="#_5-5、解除-开放-ip地址段" aria-hidden="true">#</a> 5.5、解除（开放）IP地址段</h4>
<ul>
...
firewall-cmd --list-rich-rules
firewall-cmd --list-all
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_6、直接模式" tabindex="-1"><a class="header-anchor" href="#_6、直接模式" aria-hidden="true">#</a> 6、直接模式</h3>
<blockquote>
...
firewall-cmd <span class="token parameter variable">--reload</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_7、自定义服务管理" tabindex="-1"><a class="header-anchor" href="#_7、自定义服务管理" aria-hidden="true">#</a> 7、自定义服务管理</h3>
<h4 id="_7-1、选项" tabindex="-1"><a class="header-anchor" href="#_7-1、选项" aria-hidden="true">#</a> 7.1、选项</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_8、控制端口-服务" tabindex="-1"><a class="header-anchor" href="#_8、控制端口-服务" aria-hidden="true">#</a> 8、控制端口 / 服务</h3>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_8-1、伪装-ip" tabindex="-1"><a class="header-anchor" href="#_8-1、伪装-ip" aria-hidden="true">#</a> 8.1、伪装 IP</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_9、端口转发" tabindex="-1"><a class="header-anchor" href="#_9、端口转发" aria-hidden="true">#</a> 9、端口转发</h3>
<blockquote>
...
<figure><img src="https://img-blog.csdnimg.cn/bcb3415a5a9d47ddb3ae365b021517a3.gif#pic_center" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
