<template><div><p><img src="https://img-blog.csdnimg.cn/e1802f03d15a46138ee11cdaed06f3fd.jpeg" alt="" loading="lazy"><br>
@[toc]</p>
<h1 id="_1、tomcat介绍" tabindex="-1"><a class="header-anchor" href="#_1、tomcat介绍" aria-hidden="true">#</a> 1、Tomcat介绍</h1>
...
<h1 id="_2、tomcat的安装" tabindex="-1"><a class="header-anchor" href="#_2、tomcat的安装" aria-hidden="true">#</a> 2、Tomcat的安装</h1>
<h2 id="_2-1-安装jdk环境" tabindex="-1"><a class="header-anchor" href="#_2-1-安装jdk环境" aria-hidden="true">#</a> 2.1 安装JDK环境</h2>
<blockquote>
<p>使用我们事先准备好的离线包《jdk1.8》<br>
链接：<a href="https://pan.baidu.com/s/1_JcE1J_M32QRGi35XP6wlg" target="_blank" rel="noopener noreferrer">https://pan.baidu.com/s/1_JcE1J_M32QRGi35XP6wlg<ExternalLinkIcon/></a><br>
提取码：nl6l</p>
</blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2-2-部署tomcat" tabindex="-1"><a class="header-anchor" href="#_2-2-部署tomcat" aria-hidden="true">#</a> 2.2 部署Tomcat</h2>
<h3 id="_2-2-1-下载安装包" tabindex="-1"><a class="header-anchor" href="#_2-2-1-下载安装包" aria-hidden="true">#</a> 2.2.1 下载安装包</h3>
<p>首先我们先下载安装包；</p>
<blockquote>
...
<p><img src="https://img-blog.csdnimg.cn/0637973c1f564906a1d04f3f38c8a6ae.png" alt="" loading="lazy"><br>
<img src="https://img-blog.csdnimg.cn/4acedc4949c6442aa0525b2e191b41ee.png" alt="" loading="lazy"></p>
<figure><img src="https://img-blog.csdnimg.cn/98c3607c05f44fd1885bc810391994a6.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h3 id="_2-2-2-部署tomcat" tabindex="-1"><a class="header-anchor" href="#_2-2-2-部署tomcat" aria-hidden="true">#</a> 2.2.2 部署Tomcat</h3>
<p>下载完成之后上传至服务器；</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/f545d1aaef5446e49b3e934c636243bf.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h3 id="_2-2-3-web页面访问" tabindex="-1"><a class="header-anchor" href="#_2-2-3-web页面访问" aria-hidden="true">#</a> 2.2.3 web页面访问</h3>
<p>启动完成，访问地址测试：ip:8080</p>
<font color=red>默认端口为8080</font><figure><img src="https://img-blog.csdnimg.cn/2c514684b75f473bad046e90900bc947.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>可以访问到，完成部署；</p>
<h3 id="_2-2-4-二进制安装tomcat相关命令" tabindex="-1"><a class="header-anchor" href="#_2-2-4-二进制安装tomcat相关命令" aria-hidden="true">#</a> 2.2.4 二进制安装tomcat相关命令</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2-3-tomcat配置文件详解" tabindex="-1"><a class="header-anchor" href="#_2-3-tomcat配置文件详解" aria-hidden="true">#</a> 2.3 Tomcat配置文件详解</h2>
<h3 id="_2-3-1-tomcat目录详解" tabindex="-1"><a class="header-anchor" href="#_2-3-1-tomcat目录详解" aria-hidden="true">#</a> 2.3.1 Tomcat目录详解</h3>
<blockquote>
<p>路径仅限于本文二进制安装；</p>
</blockquote>
<table>
...
<h3 id="_2-3-2-tomcat中conf目录中配置文件详解" tabindex="-1"><a class="header-anchor" href="#_2-3-2-tomcat中conf目录中配置文件详解" aria-hidden="true">#</a> 2.3.2 Tomcat中conf目录中配置文件详解</h3>
<blockquote>
