...
<font color=teal>日志：记录系统中相关的信息	系统日志	程序日志</font><figure><img src="https://img-blog.csdnimg.cn/9f668f1f37cb48d18510b3d4fd60b18e.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBAQS3liJjmmajpmLM=,size_20,color_FFFFFF,t_70,g_se,x_16" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<blockquote>
...
<h2 id="日志的级别-9个" tabindex="-1"><a class="header-anchor" href="#日志的级别-9个" aria-hidden="true">#</a> 日志的级别（9个）：</h2>
<table>
<thead>
<tr>
<th></th>
...
<h2 id="syslog管理" tabindex="-1"><a class="header-anchor" href="#syslog管理" aria-hidden="true">#</a> syslog管理：</h2>
