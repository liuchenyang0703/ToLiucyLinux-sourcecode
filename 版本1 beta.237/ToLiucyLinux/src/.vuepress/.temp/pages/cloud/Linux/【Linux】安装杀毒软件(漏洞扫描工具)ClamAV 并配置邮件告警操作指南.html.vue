...
<p>@[toc]</p>
<h1 id="clamav简介" tabindex="-1"><a class="header-anchor" href="#clamav简介" aria-hidden="true">#</a> ClamAV简介</h1>
<blockquote>
...
<h1 id="clamav的安装" tabindex="-1"><a class="header-anchor" href="#clamav的安装" aria-hidden="true">#</a> ClamAV的安装</h1>
<p>centos安装方式：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="更新病毒库" tabindex="-1"><a class="header-anchor" href="#更新病毒库" aria-hidden="true">#</a> 更新病毒库</h2>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>freshclam
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/abc4d65e27e445ec870733c482062b9e.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>这样就是更新成功了；</p>
<font color=red>如遇到报错，可参考报错： </font> <a href="https://liucy.blog.csdn.net/article/details/129284185" target="_blank" rel="noopener noreferrer">clamav升级问题报错2：Can‘t query current.cvd.clamav.net<ExternalLinkIcon/></a><h2 id="clamav的使用" tabindex="-1"><a class="header-anchor" href="#clamav的使用" aria-hidden="true">#</a> ClamAV的使用</h2>
<h3 id="clamav的语法" tabindex="-1"><a class="header-anchor" href="#clamav的语法" aria-hidden="true">#</a> ClamAV的语法</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="clamav常用参数" tabindex="-1"><a class="header-anchor" href="#clamav常用参数" aria-hidden="true">#</a> ClamAV常用参数</h3>
<table>
<thead>
<tr>
<th>参数</th>
...
<h3 id="clamav的用法" tabindex="-1"><a class="header-anchor" href="#clamav的用法" aria-hidden="true">#</a> ClamAV的用法</h3>
<h4 id="扫描病毒" tabindex="-1"><a class="header-anchor" href="#扫描病毒" aria-hidden="true">#</a> 扫描病毒</h4>
...
<p>扫描结果如下：</p>
<figure><img src="https://img-blog.csdnimg.cn/639ddeb8905949e7a71b187c82bad56a.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<h4 id="扫描病毒并自动删除病毒" tabindex="-1"><a class="header-anchor" href="#扫描病毒并自动删除病毒" aria-hidden="true">#</a> 扫描病毒并自动删除病毒</h4>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/f08ed36abc7443998bcb8bd1d4c5839d.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>删除完可以再去哪个目录看看。</p>
<h3 id="创建日志保存路径" tabindex="-1"><a class="header-anchor" href="#创建日志保存路径" aria-hidden="true">#</a> 创建日志保存路径</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h1 id="安装配置邮件服务" tabindex="-1"><a class="header-anchor" href="#安装配置邮件服务" aria-hidden="true">#</a> 安装配置邮件服务</h1>
...
<h1 id="配置定时扫描和邮件告警" tabindex="-1"><a class="header-anchor" href="#配置定时扫描和邮件告警" aria-hidden="true">#</a> 配置定时扫描和邮件告警</h1>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><font color=red>注：该脚本只适用于clamscan命令，并不适用于clamdscan命令。</font><h2 id="发送邮件告警样式演示" tabindex="-1"><a class="header-anchor" href="#发送邮件告警样式演示" aria-hidden="true">#</a> 发送邮件告警样式演示：</h2>
<figure><img src="https://img-blog.csdnimg.cn/691cca829b9a4d448ecfa7f403fad9d7.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p><strong>显示内容：</strong></p>
<figure><img src="https://img-blog.csdnimg.cn/direct/8c83fbd750de4ca7a2d4a2d16d7f54a8.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<figure><img src="https://img-blog.csdnimg.cn/direct/da60e9949e5b4908b45f28158b771607.png" alt="" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<h2 id="删除病毒方式" tabindex="-1"><a class="header-anchor" href="#删除病毒方式" aria-hidden="true">#</a> 删除病毒方式</h2>
<blockquote>
...
<h2 id="配置定时扫描" tabindex="-1"><a class="header-anchor" href="#配置定时扫描" aria-hidden="true">#</a> 配置定时扫描</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/7febef6c810044708fb9560b1fcee142.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<figure><img src="https://img-blog.csdnimg.cn/87de1825096c4fea87b200cc54ae2f7f.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>配置完成之后保存退出即可。</p>
<h1 id="附加-升级clamav报错解决方式及相关文章" tabindex="-1"><a class="header-anchor" href="#附加-升级clamav报错解决方式及相关文章" aria-hidden="true">#</a> 附加：升级ClamAV报错解决方式及相关文章</h1>
<table>
<thead>
<tr>
