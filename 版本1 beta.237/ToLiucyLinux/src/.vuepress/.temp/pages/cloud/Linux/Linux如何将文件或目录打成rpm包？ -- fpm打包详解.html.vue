...
<h1 id="说明-fpm参数及解析" tabindex="-1"><a class="header-anchor" href="#说明-fpm参数及解析" aria-hidden="true">#</a> 说明 -- fpm参数及解析</h1>
<ul class="task-list-container">
<li class="task-list-item">
<p><input type="checkbox" class="task-list-item-checkbox" id="task-item-0" checked="checked" disabled="disabled"><label class="task-list-item-label" for="task-item-0"> fpm的功能就是将一种类型的包转换成另一种类型</label></p>
</li>
<li>
<p>fpm支持的源类型包：</p>
</li>
...
<h1 id="一、安装fpm命令" tabindex="-1"><a class="header-anchor" href="#一、安装fpm命令" aria-hidden="true">#</a> 一、安装fpm命令</h1>
<h2 id="_1-1-安装-ruby-环境" tabindex="-1"><a class="header-anchor" href="#_1-1-安装-ruby-环境" aria-hidden="true">#</a> 1.1 安装 ruby 环境</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="_1-2-更换-gem-源为阿里源" tabindex="-1"><a class="header-anchor" href="#_1-2-更换-gem-源为阿里源" aria-hidden="true">#</a> 1.2 更换 gem 源为阿里源</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_1-3-安装-fpm" tabindex="-1"><a class="header-anchor" href="#_1-3-安装-fpm" aria-hidden="true">#</a> 1.3 安装 fpm</h2>
...
<figure><img src="https://img-blog.csdnimg.cn/50905873c52445f58feeff6a0c6f1c84.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>安装成功。</p>
<h1 id="二、将文件打成rpm包" tabindex="-1"><a class="header-anchor" href="#二、将文件打成rpm包" aria-hidden="true">#</a> 二、将文件打成rpm包</h1>
...
<h1 id="三、安装、卸载rpm包" tabindex="-1"><a class="header-anchor" href="#三、安装、卸载rpm包" aria-hidden="true">#</a> 三、安装、卸载rpm包</h1>
<p>首先要将打的rpm包上传到服务器上；</p>
<h2 id="_3-1-安装rpm包" tabindex="-1"><a class="header-anchor" href="#_3-1-安装rpm包" aria-hidden="true">#</a> 3.1 安装rpm包</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="_3-2-查找刚刚安装rpm包" tabindex="-1"><a class="header-anchor" href="#_3-2-查找刚刚安装rpm包" aria-hidden="true">#</a> 3.2 查找刚刚安装rpm包</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="_3-3-卸载刚刚安装的rpm包" tabindex="-1"><a class="header-anchor" href="#_3-3-卸载刚刚安装的rpm包" aria-hidden="true">#</a> 3.3 卸载刚刚安装的rpm包</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h1 id="四、错误整理" tabindex="-1"><a class="header-anchor" href="#四、错误整理" aria-hidden="true">#</a> 四、错误整理</h1>
<h2 id="_2-1-error-error-installing-fpm-rexml-requires-ruby-version-2-5-0" tabindex="-1"><a class="header-anchor" href="#_2-1-error-error-installing-fpm-rexml-requires-ruby-version-2-5-0" aria-hidden="true">#</a> 2.1 ERROR:  Error installing fpm: 	rexml requires Ruby version &gt;= 2.5.0.</h2>
<ul>
<li>报错信息：</li>
</ul>
