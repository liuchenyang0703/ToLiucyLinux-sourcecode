<template><div><figure><img src="https://img-blog.csdnimg.cn/9c9515bda2594d7ba3e6366c5c9d910a.png#pic_center" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<blockquote>
...
<p>@[toc]</p>
<h1 id="shell脚本函数" tabindex="-1"><a class="header-anchor" href="#shell脚本函数" aria-hidden="true">#</a> shell脚本函数</h1>
<h2 id="设置函数的意义" tabindex="-1"><a class="header-anchor" href="#设置函数的意义" aria-hidden="true">#</a> 设置函数的意义</h2>
<blockquote>
<p>函数是一段可以重复利用有组织的代码；可以减少代码，提高代码利用率，使脚本结构更加清晰。</p>
</blockquote>
<h2 id="函数的基本格式" tabindex="-1"><a class="header-anchor" href="#函数的基本格式" aria-hidden="true">#</a> 函数的基本格式</h2>
...
<h2 id="函数的调用-实例" tabindex="-1"><a class="header-anchor" href="#函数的调用-实例" aria-hidden="true">#</a> 函数的调用+实例</h2>
<ul>
<li>实例1</li>
</ul>
<blockquote>
...
<font color=red>这是没有function的函数测试</font><figure><img src="https://img-blog.csdnimg.cn/bb5f89a066a44e0d82be7a990a60fbf4.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<ul>
<li>实例3</li>
</ul>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token shebang important">#!/bin/bash</span>
...
<font color=red>这是没有function的函数测试
...
<font color=red>我想输出函数的f1和f2，结果为：
 这是没有function的函数测试 
 这是function的函数测试2
</font>
- **总结：**
...
<h1 id="函数的返回值" tabindex="-1"><a class="header-anchor" href="#函数的返回值" aria-hidden="true">#</a> 函数的返回值</h1>
...
<font color=red>请输入一个数字：20
40</font>
<p>为什么会变成40呢？是因为里面写了交互式输入的数字*2，结果在$?返回值里返回。</p>
<figure><img src="https://img-blog.csdnimg.cn/678fd48d3fc24b5180b0bf8c4442badc.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<ul>
<li>实例2</li>
</ul>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token shebang important">#!/bin/bash</span>
...
两个数的和为：62
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/4b4d3154cee94bbdaaf242d02e94d554.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h2 id="函数的传参" tabindex="-1"><a class="header-anchor" href="#函数的传参" aria-hidden="true">#</a> 函数的传参</h2>
<blockquote>
...
<figure><img src="https://img-blog.csdnimg.cn/e8d4bcb343094d99ba921d2f9bed34fd.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h2 id="函数变量的作用范围" tabindex="-1"><a class="header-anchor" href="#函数变量的作用范围" aria-hidden="true">#</a> 函数变量的作用范围</h2>
<blockquote>
...
<figure><img src="https://img-blog.csdnimg.cn/6e180ee4c0544199b00ea672ba783cca.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h1 id="函数的参数" tabindex="-1"><a class="header-anchor" href="#函数的参数" aria-hidden="true">#</a> * 函数的参数</h1>
<h2 id="_1-参数的用法" tabindex="-1"><a class="header-anchor" href="#_1-参数的用法" aria-hidden="true">#</a> *.1 参数的用法</h2>
<blockquote>
<p>函数名称：参数1，参数2，参数3</p>
</blockquote>
<h2 id="_2-参数的表示方法" tabindex="-1"><a class="header-anchor" href="#_2-参数的表示方法" aria-hidden="true">#</a> *.2 参数的表示方法</h2>
<blockquote 11="">
<p>$1 $2 <span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mn>3.........</mn></mrow><annotation encoding="application/x-tex">3.........</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.6444em;"></span><span class="mord">3.........</span></span></span></span>{10}$</p>
</blockquote>
<h2 id="_3-参数的案例" tabindex="-1"><a class="header-anchor" href="#_3-参数的案例" aria-hidden="true">#</a> *.3 参数的案例</h2>
<h3 id="_3-0-什么是阶乘" tabindex="-1"><a class="header-anchor" href="#_3-0-什么是阶乘" aria-hidden="true">#</a> *3.0 什么是阶乘？</h3>
<blockquote>
...
例如3：所要求的数是n，则阶乘式是1*2*3*……*n，设得到的积是x，x就是n的阶乘。</p>
<vr>
...
<h3 id="_3-1-求1到6的阶乘" tabindex="-1"><a class="header-anchor" href="#_3-1-求1到6的阶乘" aria-hidden="true">#</a> *.3.1 求1到6的阶乘</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token shebang important">#!/bin/bash</span>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token number">1</span>*1
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>结果为：</p>
<figure><img src="https://img-blog.csdnimg.cn/ddb030aa0dcb43e496f43deba03d7f7b.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h3 id="_3-2-求1到6的阶乘-只输出6的阶乘" tabindex="-1"><a class="header-anchor" href="#_3-2-求1到6的阶乘-只输出6的阶乘" aria-hidden="true">#</a> *.3.2 求1到6的阶乘，只输出6的阶乘</h3>
<blockquote>
...
<figure><img src="https://img-blog.csdnimg.cn/1ca0970e36d14c00a720895bfe1870fd.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<h2 id="_4-判断是否为文件" tabindex="-1"><a class="header-anchor" href="#_4-判断是否为文件" aria-hidden="true">#</a> *.4 判断是否为文件</h2>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token shebang important">#!/bin/bash</span>
...
<figure><img src="https://img-blog.csdnimg.cn/7ce9eff29b8441efbbd77242a47e0a2b.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>脚本解析：<br>
如果没有哪个文件也是会返回40的；</p>
<figure><img src="https://img-blog.csdnimg.cn/22333cd9e6884031915ca4ae004a23aa.png" alt="" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<h2 id="_5-递归函数" tabindex="-1"><a class="header-anchor" href="#_5-递归函数" aria-hidden="true">#</a> *.5 递归函数</h2>
<h3 id="_5-1-递归显示var下的log里面有哪些是目录" tabindex="-1"><a class="header-anchor" href="#_5-1-递归显示var下的log里面有哪些是目录" aria-hidden="true">#</a> *.5.1 递归显示var下的log里面有哪些是目录</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token shebang important">#!/bin/bash</span>
...
<figure><img src="https://img-blog.csdnimg.cn/5e346fe9bdc648db87ea8c55af2f9509.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<h3 id="_5-2-交互式-递归方式计算你输入的数值作为阶乘" tabindex="-1"><a class="header-anchor" href="#_5-2-交互式-递归方式计算你输入的数值作为阶乘" aria-hidden="true">#</a> *.5.2 交互式 递归方式计算你输入的数值作为阶乘</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token shebang important">#!/bin/bash</span>
...
<figure><img src="https://img-blog.csdnimg.cn/258a88d6eb234b26ab3a37889f2c6e2e.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
...
<h1 id="如何查看脚本执行过程" tabindex="-1"><a class="header-anchor" href="#如何查看脚本执行过程" aria-hidden="true">#</a> 如何查看脚本执行过程？</h1>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">sh</span> <span class="token parameter variable">-x</span> 脚本名称
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/151e028b4289443dbfb5960cc7ae6396.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>脚本：</p>
<figure><img src="https://img-blog.csdnimg.cn/596def6d65264950bacf22df83c4d208.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>执行：</p>
<figure><img src="https://img-blog.csdnimg.cn/5e2f15d8e4504d4db969aa5ca1e76ffb.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<h1 id="函数重点" tabindex="-1"><a class="header-anchor" href="#函数重点" aria-hidden="true">#</a> 函数重点：</h1>
<blockquote>
...
<h2 id="举例重点5-启动脚本模板-可根据自己的jar包名称自行修改" tabindex="-1"><a class="header-anchor" href="#举例重点5-启动脚本模板-可根据自己的jar包名称自行修改" aria-hidden="true">#</a> 举例重点5：启动脚本模板（可根据自己的jar包名称自行修改）</h2>
<blockquote>
<p>使用方法：sh <a href="http://start.sh" target="_blank" rel="noopener noreferrer">start.sh<ExternalLinkIcon/></a> start/stop/restart/status</p>
</blockquote>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token shebang important">#!/bin/bash</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="相关文章" tabindex="-1"><a class="header-anchor" href="#相关文章" aria-hidden="true">#</a> 相关文章：</h1>
<table>
<thead>
<tr>
