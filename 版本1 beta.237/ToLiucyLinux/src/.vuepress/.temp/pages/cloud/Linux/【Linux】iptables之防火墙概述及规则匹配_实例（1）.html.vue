<template><div><figure><img src="https://img-blog.csdnimg.cn/536f1ae477b1482ab9eefa6647189da9.png#pic_center" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>@[toc]<br>
<img src="https://img-blog.csdnimg.cn/5c188e0ff3f142468b6b5388bb4297fe.gif#pic_center" alt="" loading="lazy"><br>
<br></p>
<h1 id="一、防火墙的基础概念" tabindex="-1"><a class="header-anchor" href="#一、防火墙的基础概念" aria-hidden="true">#</a> 一、防火墙的基础概念</h1>
<h2 id="_1、防火墙的概念与应用" tabindex="-1"><a class="header-anchor" href="#_1、防火墙的概念与应用" aria-hidden="true">#</a> 1、防火墙的概念与应用</h2>
<p>  网络中的防火墙，是一种将内部网络和外部网络分开的方法，是一种隔离技术。防火墙在内网与外网通信时进行访问控制，依据所设置的规则对数据包作出判断，最大限度地阻止网络中的黑客破坏企业网络，从而加强企业网络安全。</p>
<h2 id="_2、包过滤的工作层次" tabindex="-1"><a class="header-anchor" href="#_2、包过滤的工作层次" aria-hidden="true">#</a> 2、包过滤的工作层次</h2>
<p>  主要是网络层，针对IP数据包，体现对包内的IP地址、端口等信息的处理上。</p>
<h1 id="二、iptables的四表五链" tabindex="-1"><a class="header-anchor" href="#二、iptables的四表五链" aria-hidden="true">#</a> 二、iptables的四表五链</h1>
<blockquote>
...
<figure><img src="https://img-blog.csdnimg.cn/536f1ae477b1482ab9eefa6647189da9.png#pic_center" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<h1 id="三、iptables命令" tabindex="-1"><a class="header-anchor" href="#三、iptables命令" aria-hidden="true">#</a> 三、iptables命令</h1>
<h2 id="_1、语法结构" tabindex="-1"><a class="header-anchor" href="#_1、语法结构" aria-hidden="true">#</a> 1、语法结构</h2>
...
<h2 id="_2、iptables的选项参数及实例" tabindex="-1"><a class="header-anchor" href="#_2、iptables的选项参数及实例" aria-hidden="true">#</a> 2、iptables的选项参数及实例</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="四、iptables规则的匹配类型" tabindex="-1"><a class="header-anchor" href="#四、iptables规则的匹配类型" aria-hidden="true">#</a> 四、iptables规则的匹配类型</h1>
<br>
<p>1、通用匹配<br>
...
<br></p>
<p>常用管理选项汇总表：</p>
<p><img src="https://img-blog.csdnimg.cn/d6817ff5d2df4bd9a9757fb4641faba6.png#pic_center" alt="" loading="lazy"><br>
<br></p>
<figure><img src="https://img-blog.csdnimg.cn/be877e0fae434a57b75bf4ec88e3a11c.png#pic_center" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<br>
<h2 id="_1、通用匹配" tabindex="-1"><a class="header-anchor" href="#_1、通用匹配" aria-hidden="true">#</a> 1、通用匹配</h2>
<blockquote>
<p>常见的通用匹配条件：<br>
  协议匹配：-p 协议名<br>
...
<h3 id="_1-1、协议匹配" tabindex="-1"><a class="header-anchor" href="#_1-1、协议匹配" aria-hidden="true">#</a> 1.1、协议匹配</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/24b66345320646a8b1871c5a5495a760.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/06ebc2ad8b3d43b3bdea314416e931fb.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h3 id="_1-2、地址匹配" tabindex="-1"><a class="header-anchor" href="#_1-2、地址匹配" aria-hidden="true">#</a> 1.2、地址匹配</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/71cf38fb380e4ac6a341fd605f2ec722.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/305bd7c7610f4a0b9b376d857cfbb7cc.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/a5d9d4fbf8944ac295822605408a8551.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h3 id="_1-3、接口匹配" tabindex="-1"><a class="header-anchor" href="#_1-3、接口匹配" aria-hidden="true">#</a> 1.3、接口匹配</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/2e27d35f10874de496cd8476b3121ca9.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/582290220d464da586530d6ed29ec431.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h2 id="_2、隐含匹配" tabindex="-1"><a class="header-anchor" href="#_2、隐含匹配" aria-hidden="true">#</a> 2、隐含匹配</h2>
<blockquote>
<p>常见的隐含匹配条件：<br>
...
<h3 id="_2-1、端口匹配" tabindex="-1"><a class="header-anchor" href="#_2-1、端口匹配" aria-hidden="true">#</a> 2.1、端口匹配</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/9eb9008ce1c847fb8d809ca3e42bd63c.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/526c15aeb51742f296d83a2d0e86f864.png" alt="" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/426aae694a404fa08ab929e11cc91188.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<h3 id="_2-2、tcp匹配" tabindex="-1"><a class="header-anchor" href="#_2-2、tcp匹配" aria-hidden="true">#</a> 2.2、TCP匹配</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/f92fdf502c424941ba32976a02674de6.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<h3 id="_2-3、icmp匹配" tabindex="-1"><a class="header-anchor" href="#_2-3、icmp匹配" aria-hidden="true">#</a> 2.3、ICMP匹配</h3>
...
<p><img src="https://img-blog.csdnimg.cn/669d8cb8dfad47f59ff93a493dee133f.png" alt="在这里插入图片描述" loading="lazy"><img src="https://img-blog.csdnimg.cn/3a2377d2fc304a9b8c7ac7efcd3c751c.png" alt="在这里插入图片描述" loading="lazy"><br>
<img src="https://img-blog.csdnimg.cn/0555aca1249f4022b993f5b5a7d453de.png" alt="在这里插入图片描述" loading="lazy"></p>
<p>获取帮助：<font color=red>iptables -p icmp -h</font></p>
<h2 id="_3、显式匹配" tabindex="-1"><a class="header-anchor" href="#_3、显式匹配" aria-hidden="true">#</a> 3、显式匹配</h2>
<blockquote>
<p>常见的显式匹配条件：<br>
...
<h3 id="_3-1、多端口匹配" tabindex="-1"><a class="header-anchor" href="#_3-1、多端口匹配" aria-hidden="true">#</a> 3.1、多端口匹配</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/7e5713d7d85c40e58605010ba330fe75.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<h3 id="_3-2、ip范围匹配" tabindex="-1"><a class="header-anchor" href="#_3-2、ip范围匹配" aria-hidden="true">#</a> 3.2、IP范围匹配</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/b24b230d3e01498c870da6d83d48f393.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<h3 id="_3-3、mac地址匹配" tabindex="-1"><a class="header-anchor" href="#_3-3、mac地址匹配" aria-hidden="true">#</a> 3.3、MAC地址匹配</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/0b08a5475f6d4941b8c39efbb846d6fc.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<h3 id="_3-4、状态匹配" tabindex="-1"><a class="header-anchor" href="#_3-4、状态匹配" aria-hidden="true">#</a> 3.4、状态匹配</h3>
...
<h1 id="五、iptables-规则的删除" tabindex="-1"><a class="header-anchor" href="#五、iptables-规则的删除" aria-hidden="true">#</a> 五、iptables 规则的删除</h1>
<p>简单来说就是删除的时候把<code v-pre>-I 或者 -A</code>改为<code v-pre>-D</code>，其他的都还和添加的一样。</p>
<h2 id="_1、删除一条指定行数的规则" tabindex="-1"><a class="header-anchor" href="#_1、删除一条指定行数的规则" aria-hidden="true">#</a> 1、删除一条指定行数的规则</h2>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>iptables <span class="token parameter variable">-D</span> INPUT <span class="token number">3</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="_2、删除一条指定ip的规则" tabindex="-1"><a class="header-anchor" href="#_2、删除一条指定ip的规则" aria-hidden="true">#</a> 2、删除一条指定ip的规则</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3、删除指定协议匹配规则" tabindex="-1"><a class="header-anchor" href="#_3、删除指定协议匹配规则" aria-hidden="true">#</a> 3、删除指定协议匹配规则</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_4、删除指定接口规则" tabindex="-1"><a class="header-anchor" href="#_4、删除指定接口规则" aria-hidden="true">#</a> 4、删除指定接口规则</h2>
...
<figure><img src="https://img-blog.csdnimg.cn/bcb3415a5a9d47ddb3ae365b021517a3.gif" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
