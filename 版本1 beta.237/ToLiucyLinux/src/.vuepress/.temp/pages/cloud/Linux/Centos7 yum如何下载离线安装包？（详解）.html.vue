<template><div><figure><img src="https://img-blog.csdnimg.cn/401fdf8f6a4a4a3180ea8d58e3ba3902.jpeg#pic_center" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<blockquote>
...
<h1 id="第一种方法-使用yum-参数安装-【推荐】包含依赖" tabindex="-1"><a class="header-anchor" href="#第一种方法-使用yum-参数安装-【推荐】包含依赖" aria-hidden="true">#</a> 第一种方法：使用yum + 参数安装  -- 【推荐】包含依赖</h1>
<ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://img-blog.csdnimg.cn/05ee69f0e0ef4ef1b1c63b8abe0008e0.png" alt="" loading="lazy"><br>
然后咱们可以把rpm包下载到本地，之后使用的时候就可以上传到内网环境中，直接<font color=red><strong>rpm -ivh 包名</strong></font>安装就可以了。</p>
<h1 id="第二种方法-使用-yumdownloader-命令【只下载你需要的安装包-不包含依赖-】" tabindex="-1"><a class="header-anchor" href="#第二种方法-使用-yumdownloader-命令【只下载你需要的安装包-不包含依赖-】" aria-hidden="true">#</a> 第二种方法：使用 yumdownloader 命令【只下载你需要的安装包（不包含依赖）】</h1>
<ul>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>yumdownloader <span class="token parameter variable">--destdir</span><span class="token operator">=</span>/data/mysql/ mysql
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>下载完之后切换到这个目录看一下，可以看到离线包了。</p>
<figure><img src="https://img-blog.csdnimg.cn/direct/dbce3bbca2a949ebb2feb57697e26f66.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h1 id="两者区别及优缺点" tabindex="-1"><a class="header-anchor" href="#两者区别及优缺点" aria-hidden="true">#</a> 两者区别及优缺点：</h1>
<ul class="task-list-container">
<li>
<p>举实例两者下载的区别：</p>
</li>
<li class="task-list-item">
<p><input type="checkbox" class="task-list-item-checkbox" id="task-item-0" checked="checked" disabled="disabled"><label class="task-list-item-label" for="task-item-0"> 示例1：使用yum + 参数安装</label></p>
</li>
</ul>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>yum <span class="token parameter variable">-y</span> <span class="token function">install</span> gcc gcc-c++ <span class="token parameter variable">--downloadonly</span> <span class="token parameter variable">--downloaddir</span><span class="token operator">=</span>./
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/direct/bca603995f8d4a07a675c2907dff2169.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<ul class="task-list-container">
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>yumdownloader <span class="token parameter variable">--destdir</span><span class="token operator">=</span>./ gcc gcc-c++
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/direct/3de4d494c05e4ab795103b8211b77cf8.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
<li class="task-list-item">
<p><input type="checkbox" class="task-list-item-checkbox" id="task-item-2" checked="checked" disabled="disabled"><label class="task-list-item-label" for="task-item-2"> yum + 参数 优点：<br>
1、会自动下载安装所需软件的所有依赖包，保证离线安装包的完整性；<br>
2、无需安装，可直接使用命令+参数下载。</label></p>
</li>
<li class="task-list-item">
<p><input type="checkbox" class="task-list-item-checkbox" id="task-item-3" checked="checked" disabled="disabled"><label class="task-list-item-label" for="task-item-3"> yum + 参数 缺点：<br>
1、如果服务器上已经安装过这个命令或者包的话，下载会提示已经安装过，所以安装的时候需要使用空环境。</label></p>
</li>
</ul>
<figure><img src="https://img-blog.csdnimg.cn/direct/fe612e1d21e44551950b5de937bdc88a.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<ul class="task-list-container">
<li class="task-list-item">
