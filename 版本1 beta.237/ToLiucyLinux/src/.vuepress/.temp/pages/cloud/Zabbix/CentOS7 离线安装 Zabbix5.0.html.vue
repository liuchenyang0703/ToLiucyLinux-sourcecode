<template><div><figure><img src="https://img-blog.csdnimg.cn/4922b09c13244741b72bfaa365c03062.jpeg" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<h1 id="❀写在最前-相关文章" tabindex="-1"><a class="header-anchor" href="#❀写在最前-相关文章" aria-hidden="true">#</a> ❀写在最前（相关文章）</h1>
<blockquote>
...
<h1 id="在有外网的环境中操作并下载离线安装包" tabindex="-1"><a class="header-anchor" href="#在有外网的环境中操作并下载离线安装包" aria-hidden="true">#</a> 在有外网的环境中操作并下载离线安装包</h1>
<h2 id="_1、获取zabbix源" tabindex="-1"><a class="header-anchor" href="#_1、获取zabbix源" aria-hidden="true">#</a> 1、获取zabbix源</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://img-blog.csdnimg.cn/23cba35fd42f432587d192e2d78c79be.png" alt="在这里插入图片描述" loading="lazy"><br>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/1cf0e5c912be4d61bf058f723eb0ad2f.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/75c7b35453e44c71b4fd19cb96e78247.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>这就相当于下载了一个zabbix的源；</p>
<h2 id="_2、修改zabbix-repo文件" tabindex="-1"><a class="header-anchor" href="#_2、修改zabbix-repo文件" aria-hidden="true">#</a> 2、修改zabbix.repo文件</h2>
...
<figure><img src="https://img-blog.csdnimg.cn/a89a1f3f44e3466d82524d8205d7515d.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<h2 id="_3、修改yum源为阿里源" tabindex="-1"><a class="header-anchor" href="#_3、修改yum源为阿里源" aria-hidden="true">#</a> 3、修改yum源为阿里源</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/14ffcd9a1d984787a8d31b1fb3cef79f.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<h2 id="_4、下载安装zabbix5-0所需的rpm包" tabindex="-1"><a class="header-anchor" href="#_4、下载安装zabbix5-0所需的rpm包" aria-hidden="true">#</a> 4、下载安装zabbix5.0所需的rpm包</h2>
<p>使用<font color=red>yum --downloadonly </font>进行下载rpm包和相关依赖包</p>
<font color=red>--downloaddir</font>参数可进行设置下载保存路径<h3 id="下载mariadb-mysql-数据库" tabindex="-1"><a class="header-anchor" href="#下载mariadb-mysql-数据库" aria-hidden="true">#</a> 下载mariadb（mysql）数据库</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="下载-zabbix主服务" tabindex="-1"><a class="header-anchor" href="#下载-zabbix主服务" aria-hidden="true">#</a> 下载 zabbix主服务</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="下载-red-hat-software-collections" tabindex="-1"><a class="header-anchor" href="#下载-red-hat-software-collections" aria-hidden="true">#</a> 下载 Red Hat Software Collections</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="安装-red-hat-software-collections" tabindex="-1"><a class="header-anchor" href="#安装-red-hat-software-collections" aria-hidden="true">#</a> 安装 Red Hat Software Collections</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="下载-zabbix-web服务" tabindex="-1"><a class="header-anchor" href="#下载-zabbix-web服务" aria-hidden="true">#</a> 下载 Zabbix web服务</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="下载zabbix-get服务" tabindex="-1"><a class="header-anchor" href="#下载zabbix-get服务" aria-hidden="true">#</a> 下载zabbix_get服务</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="_5、创建本地yum仓库" tabindex="-1"><a class="header-anchor" href="#_5、创建本地yum仓库" aria-hidden="true">#</a> 5、创建本地yum仓库</h2>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/d4e6a35af8504c319307a712d1468b64.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>完了会生成一个repodata子目录</p>
<figure><img src="https://img-blog.csdnimg.cn/f76cf54eaf8c47748e20f92bd1bbcfd8.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>将 /tmp/offline_rpm/下面全部可以打个tar包，后续直接用脚本安装即可；</p>
<h1 id="在内网中离线安装-使用脚本一键安装" tabindex="-1"><a class="header-anchor" href="#在内网中离线安装-使用脚本一键安装" aria-hidden="true">#</a> 在内网中离线安装（使用脚本一键安装）</h1>
<p><strong><font color=red>大家可以边做边写成脚本</font></strong></p>
<h2 id="_1、准备yum仓库" tabindex="-1"><a class="header-anchor" href="#_1、准备yum仓库" aria-hidden="true">#</a> 1、准备yum仓库</h2>
...
<figure><img src="https://img-blog.csdnimg.cn/0013c925927c4ac18ac6d7af67933786.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-1、新建一个repo源文件" tabindex="-1"><a class="header-anchor" href="#_1-1、新建一个repo源文件" aria-hidden="true">#</a> 1.1、新建一个repo源文件</h3>
...
yum makecache
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2、安装-zabbix-server-和-agent" tabindex="-1"><a class="header-anchor" href="#_2、安装-zabbix-server-和-agent" aria-hidden="true">#</a> 2、安装 Zabbix server 和 agent</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="_3、安装mysql数据库" tabindex="-1"><a class="header-anchor" href="#_3、安装mysql数据库" aria-hidden="true">#</a> 3、安装mysql数据库</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="_4、安装rhel-software-collections-scls" tabindex="-1"><a class="header-anchor" href="#_4、安装rhel-software-collections-scls" aria-hidden="true">#</a> 4、安装RHEL Software collections（SCLs）</h2>
<p>Software collections是一个Linux软件多版本共存的解决方案。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>yum <span class="token parameter variable">-y</span> <span class="token function">install</span> centos-release-scl
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="_5、安装前端组件" tabindex="-1"><a class="header-anchor" href="#_5、安装前端组件" aria-hidden="true">#</a> 5、安装前端组件</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="_6、安装zabbix-get-调试组件" tabindex="-1"><a class="header-anchor" href="#_6、安装zabbix-get-调试组件" aria-hidden="true">#</a> 6、安装zabbix-get，调试组件</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="_7、配置数据库" tabindex="-1"><a class="header-anchor" href="#_7、配置数据库" aria-hidden="true">#</a> 7、配置数据库</h2>
<h3 id="_7-1、启动mariadb并设置开机自启" tabindex="-1"><a class="header-anchor" href="#_7-1、启动mariadb并设置开机自启" aria-hidden="true">#</a> 7.1、启动mariadb并设置开机自启</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_7-2、mysql安全配置向导-可忽略" tabindex="-1"><a class="header-anchor" href="#_7-2、mysql安全配置向导-可忽略" aria-hidden="true">#</a> 7.2、mysql安全配置向导（可忽略）</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_7-3、设置mysql的登录密码" tabindex="-1"><a class="header-anchor" href="#_7-3、设置mysql的登录密码" aria-hidden="true">#</a> 7.3、设置mysql的登录密码</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_7-4、设置mysql用户相关的操作" tabindex="-1"><a class="header-anchor" href="#_7-4、设置mysql用户相关的操作" aria-hidden="true">#</a> 7.4、设置mysql用户相关的操作</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/670a0413de0248cf982c56d85e514c77.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<h3 id="_7-5、导入初始架构和数据" tabindex="-1"><a class="header-anchor" href="#_7-5、导入初始架构和数据" aria-hidden="true">#</a> 7.5、导入初始架构和数据</h3>
...
<figure><img src="https://img-blog.csdnimg.cn/63a9e8fb3b50489c88d312cd80ad0a8f.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<h2 id="_8、修改-zabbix-server-和-php配置文件" tabindex="-1"><a class="header-anchor" href="#_8、修改-zabbix-server-和-php配置文件" aria-hidden="true">#</a> 8、修改 zabbix-server 和 php配置文件</h2>
<h3 id="_8-1、编辑-zabbix-server-conf" tabindex="-1"><a class="header-anchor" href="#_8-1、编辑-zabbix-server-conf" aria-hidden="true">#</a> 8.1、编辑 zabbix_server.conf</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_8-2、编辑php配置文件" tabindex="-1"><a class="header-anchor" href="#_8-2、编辑php配置文件" aria-hidden="true">#</a> 8.2、编辑php配置文件</h3>
...
<h2 id="_9、启动所有服务并设置开机自启" tabindex="-1"><a class="header-anchor" href="#_9、启动所有服务并设置开机自启" aria-hidden="true">#</a> 9、启动所有服务并设置开机自启</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/4d460f06e3d64461b28d0b74cf120b56.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<h2 id="_10、如果存在问题请检查日志" tabindex="-1"><a class="header-anchor" href="#_10、如果存在问题请检查日志" aria-hidden="true">#</a> 10、如果存在问题请检查日志</h2>
...
<h1 id="页面访问" tabindex="-1"><a class="header-anchor" href="#页面访问" aria-hidden="true">#</a> 页面访问</h1>
<blockquote>
<p>ip/zabbix</p>
</blockquote>
<figure><img src="https://img-blog.csdnimg.cn/4a1142adb6824466a115181be7a62c4d.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>一路next step，到这个要输入密码，密码是123456</p>
<figure><img src="https://img-blog.csdnimg.cn/d2cacb6b930341eb8e14daaa80ab1926.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>下一步，需要你给这个监控起一个名字；</p>
<figure><img src="https://img-blog.csdnimg.cn/a91bb4038ed74405b221b4e7946a573a.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>一直下一步,直到登录（默认的账号是：Admin   密码是：zabbix）</p>
<figure><img src="https://img-blog.csdnimg.cn/64f6fe65385d4277bf87f825c1605d3b.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>登录进入页面就可以了；</p>
<figure><img src="https://img-blog.csdnimg.cn/23aab963851c432c9c334289f1eb32cf.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<h1 id="重要" tabindex="-1"><a class="header-anchor" href="#重要" aria-hidden="true">#</a> 重要：</h1>
