...
<h1 id="🏆zabbix5-0部署" tabindex="-1"><a class="header-anchor" href="#🏆zabbix5-0部署" aria-hidden="true">#</a> 🏆Zabbix5.0部署</h1>
<figure><img src="https://img-blog.csdnimg.cn/b4986ba5c5bf4129af6ea52228b1b4a2.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBAQS3liJjmmajpmLM=,size_20,color_FFFFFF,t_70,g_se,x_16" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<h2 id="🥇系统环境" tabindex="-1"><a class="header-anchor" href="#🥇系统环境" aria-hidden="true">#</a> 🥇系统环境</h2>
<p>系统环境：CentOS-7-x86_64-Minimal-1708</p>
<h2 id="🥇关闭防火墙与selinux" tabindex="-1"><a class="header-anchor" href="#🥇关闭防火墙与selinux" aria-hidden="true">#</a> 🥇关闭防火墙与selinux</h2>
<p>关闭防火墙</p>
...
<h2 id="🥇替换阿里云zabbix源" tabindex="-1"><a class="header-anchor" href="#🥇替换阿里云zabbix源" aria-hidden="true">#</a> 🥇替换阿里云Zabbix源</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/1ab10f70fed748c4ae2562500a7a3896.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBAQS3liJjmmajpmLM=,size_20,color_FFFFFF,t_70,g_se,x_16" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<h2 id="🥇由于zabbix提供集中的web监控管理界面-因此服务在web界面的呈现需要lamp架构支持。安装httpd-php" tabindex="-1"><a class="header-anchor" href="#🥇由于zabbix提供集中的web监控管理界面-因此服务在web界面的呈现需要lamp架构支持。安装httpd-php" aria-hidden="true">#</a> 🥇由于zabbix提供集中的web监控管理界面，因此服务在web界面的呈现需要LAMP架构支持。安装httpd php</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="🥈安装常用的开发软件" tabindex="-1"><a class="header-anchor" href="#🥈安装常用的开发软件" aria-hidden="true">#</a> 🥈安装常用的开发软件</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="🥈安装zabbix5-0仓库" tabindex="-1"><a class="header-anchor" href="#🥈安装zabbix5-0仓库" aria-hidden="true">#</a> 🥈安装zabbix5.0仓库</h2>
...
yum clean all
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/e173576431f841eda4e7e7a1c8fa1189.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<h2 id="🥈安装zabbix-server-和agent" tabindex="-1"><a class="header-anchor" href="#🥈安装zabbix-server-和agent" aria-hidden="true">#</a> 🥈安装zabbix server 和agent</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/bd935fbda21c49368d1a84883e987297.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<h2 id="🏅启用red-hat软件集合" tabindex="-1"><a class="header-anchor" href="#🏅启用red-hat软件集合" aria-hidden="true">#</a> 🏅启用Red Hat软件集合</h2>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/a13a5b6fec7c4b34ae368605a760929b.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<h2 id="🏅启用zabbix-deprecated-repository" tabindex="-1"><a class="header-anchor" href="#🏅启用zabbix-deprecated-repository" aria-hidden="true">#</a> 🏅启用zabbix-deprecated repository</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/0e18482f626f41a98dc3cc27d5ca695c.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<h2 id="🥈安装zabbix前端" tabindex="-1"><a class="header-anchor" href="#🥈安装zabbix前端" aria-hidden="true">#</a> 🥈安装zabbix前端</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/762d289a74eb43ec8d276aa4766ab7f4.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBAQS3liJjmmajpmLM=,size_20,color_FFFFFF,t_70,g_se,x_16" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<h2 id="🥈安装mysql数据库" tabindex="-1"><a class="header-anchor" href="#🥈安装mysql数据库" aria-hidden="true">#</a> 🥈安装mysql数据库</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/2d4213a609434881806e12aed9366e55.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<h2 id="🏅启动mariadb" tabindex="-1"><a class="header-anchor" href="#🏅启动mariadb" aria-hidden="true">#</a> 🏅启动mariadb</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="🏅启动mysql后执行初始化安全设置" tabindex="-1"><a class="header-anchor" href="#🏅启动mysql后执行初始化安全设置" aria-hidden="true">#</a> 🏅启动mysql后执行初始化安全设置</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="🥈创建数据库" tabindex="-1"><a class="header-anchor" href="#🥈创建数据库" aria-hidden="true">#</a> 🥈创建数据库</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/a8b481becd7a4f119b8e83604105c8ec.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<h2 id="🥈在zabbix服务器主机上-导入初始架构和数据。系统将提示您输入新创建的密码" tabindex="-1"><a class="header-anchor" href="#🥈在zabbix服务器主机上-导入初始架构和数据。系统将提示您输入新创建的密码" aria-hidden="true">#</a> 🥈在Zabbix服务器主机上，导入初始架构和数据。系统将提示您输入新创建的密码</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="🏅为zabbix服务器配置数据库" tabindex="-1"><a class="header-anchor" href="#🏅为zabbix服务器配置数据库" aria-hidden="true">#</a> 🏅为zabbix服务器配置数据库</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="🏅为zabbix前端配置php" tabindex="-1"><a class="header-anchor" href="#🏅为zabbix前端配置php" aria-hidden="true">#</a> 🏅为Zabbix前端配置PHP</h2>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="🥇-启动zabbix服务" tabindex="-1"><a class="header-anchor" href="#🥇-启动zabbix服务" aria-hidden="true">#</a> 🥇 启动zabbix服务</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="🥇配置zabbix-web前端" tabindex="-1"><a class="header-anchor" href="#🥇配置zabbix-web前端" aria-hidden="true">#</a> 🥇配置Zabbix Web前端</h2>
<blockquote>
<ul>
...
<p><img src="https://img-blog.csdnimg.cn/d36be293c1854cdf8e42fff69948204f.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBAQS3liJjmmajpmLM=,size_20,color_FFFFFF,t_70,g_se,x_16" alt="在这里插入图片描述" loading="lazy"><br>
<img src="https://img-blog.csdnimg.cn/026b80961c9a44099af037e668fde5fe.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBAQS3liJjmmajpmLM=,size_20,color_FFFFFF,t_70,g_se,x_16" alt="在这里插入图片描述" loading="lazy"></p>
<blockquote>
<ul>
<li>配置mysql数据库账号和密码， 输入zabbix帐户的密码，点next step下一步</li>
</ul>
</blockquote>
<figure><img src="https://img-blog.csdnimg.cn/20b5aad230564b8586f474c9b4e2c3c2.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBAQS3liJjmmajpmLM=,size_20,color_FFFFFF,t_70,g_se,x_16" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<blockquote>
<ul>
<li>Name那里起一个名， 点next step下一步</li>
</ul>
</blockquote>
<p><img src="https://img-blog.csdnimg.cn/fb7cf9eef08546b988a089dc13d698f1.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBAQS3liJjmmajpmLM=,size_20,color_FFFFFF,t_70,g_se,x_16" alt="在这里插入图片描述" loading="lazy"><br>
<img src="https://img-blog.csdnimg.cn/c49b462f55074fa79aa815450b50b1e0.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBAQS3liJjmmajpmLM=,size_20,color_FFFFFF,t_70,g_se,x_16" alt="在这里插入图片描述" loading="lazy"></p>
<p><strong><font color=red>至此zabbix前端配置完成</font></strong></p>
<p>输入账号Admin密码zabbix</p>
<p><img src="https://img-blog.csdnimg.cn/41f8ff2de3c34582a0360a29403c6054.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBAQS3liJjmmajpmLM=,size_20,color_FFFFFF,t_70,g_se,x_16" alt="在这里插入图片描述" loading="lazy"><br>
进入zabbix页面<br>
<img src="https://img-blog.csdnimg.cn/ffa88bb7f85f4edda66c3d36a0bd5a8c.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBAQS3liJjmmajpmLM=,size_20,color_FFFFFF,t_70,g_se,x_16" alt="在这里插入图片描述" loading="lazy"></p>
<h2 id="🥇-后续配置zabbix页面语言为中文" tabindex="-1"><a class="header-anchor" href="#🥇-后续配置zabbix页面语言为中文" aria-hidden="true">#</a> 🥇 后续配置zabbix页面语言为中文</h2>
<p>1.Zabbix前端界面设置成中文<br>
选择User settings,语言选择中文，点击update<img src="https://img-blog.csdnimg.cn/de136879c4314e8fbb60821b1c3c74c0.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBAQS3liJjmmajpmLM=,size_20,color_FFFFFF,t_70,g_se,x_16" alt="在这里插入图片描述" loading="lazy"><br>
就修改成功了，同时zabbix也就部署完成了。<br>
<img src="https://img-blog.csdnimg.cn/54b26c2d52fd40b08b62dc177e860799.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBAQS3liJjmmajpmLM=,size_20,color_FFFFFF,t_70,g_se,x_16" alt="在这里插入图片描述" loading="lazy"></p>
...
<img src="https://img-blog.csdnimg.cn/0165960269f541bcb201416b22c6c13b.gif" alt="在这里插入图片描述" loading="lazy"></p>
</div></template>
