...
<p>或者是使用我提供的离线包：<a href="https://download.csdn.net/download/liu_chen_yang/88333704?spm=1001.2014.3001.5503" target="_blank" rel="noopener noreferrer">openssh7.4p1 升级到 openssh9.3p2 所需的离线包  <ExternalLinkIcon/></a></p>
<p><strong>网盘下载：</strong><br>
链接：<a href="https://pan.baidu.com/s/1W426VDGwchE9ndKGV-eyxw?pwd=f2um" target="_blank" rel="noopener noreferrer">https://pan.baidu.com/s/1W426VDGwchE9ndKGV-eyxw?pwd=f2um<ExternalLinkIcon/></a><br>
提取码：f2um</p>
...
<h1 id="centos-服务器升级openssh到9-3p2" tabindex="-1"><a class="header-anchor" href="#centos-服务器升级openssh到9-3p2" aria-hidden="true">#</a> Centos 服务器升级OpenSSH到9.3p2</h1>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>或者是使用我提供的离线包：<a href="https://download.csdn.net/download/liu_chen_yang/88333704?spm=1001.2014.3001.5503" target="_blank" rel="noopener noreferrer">openssh7.4p1 升级到 openssh9.3p2 所需的离线包  <ExternalLinkIcon/></a></p>
<p><strong>网盘下载：</strong><br>
链接：<a href="https://pan.baidu.com/s/1W426VDGwchE9ndKGV-eyxw?pwd=f2um" target="_blank" rel="noopener noreferrer">https://pan.baidu.com/s/1W426VDGwchE9ndKGV-eyxw?pwd=f2um<ExternalLinkIcon/></a><br>
提取码：f2um</p>
<hr>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">wget</span> https://cdn.openbsd.org/pub/OpenBSD/OpenSSH/portable/openssh-9.3p2.tar.gz
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/f40d28397a8345929823da7b31ea4a13.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<p>或者是使用我提供的离线包：<a href="https://download.csdn.net/download/liu_chen_yang/88333704?spm=1001.2014.3001.5503" target="_blank" rel="noopener noreferrer">openssh7.4p1 升级到 openssh9.3p2 所需的离线包  <ExternalLinkIcon/></a></p>
<p><strong>网盘下载：</strong><br>
链接：<a href="https://pan.baidu.com/s/1W426VDGwchE9ndKGV-eyxw?pwd=f2um" target="_blank" rel="noopener noreferrer">https://pan.baidu.com/s/1W426VDGwchE9ndKGV-eyxw?pwd=f2um<ExternalLinkIcon/></a><br>
提取码：f2um</p>
...
<span class="token punctuation">[</span>root@localhost ~<span class="token punctuation">]</span><span class="token comment"># mv openssh-9.3p2.tar.gz /usr/local/</span>
...
<span class="token punctuation">[</span>root@localhost local<span class="token punctuation">]</span><span class="token comment"># tar xf openssh-9.3p2.tar.gz</span>

<span class="token comment"># 进入openssh目录</span>
<span class="token punctuation">[</span>root@localhost local<span class="token punctuation">]</span><span class="token comment"># cd openssh-9.3p2</span>

<span class="token comment"># 编译安装</span>
<span class="token punctuation">[</span>root@localhost openssh-9.3p2<span class="token punctuation">]</span><span class="token comment"># CCFLAGS="-I/usr/local/include" \</span>
...
<span class="token punctuation">[</span>root@localhost openssh-9.3p2<span class="token punctuation">]</span><span class="token comment"># make -j 4</span>
<span class="token punctuation">[</span>root@localhost openssh-9.3p2<span class="token punctuation">]</span><span class="token comment"># make install</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_6、授权" tabindex="-1"><a class="header-anchor" href="#_6、授权" aria-hidden="true">#</a> 6、授权</h2>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@localhost openssh-9.3p2<span class="token punctuation">]</span><span class="token comment"># chmod 600 /etc/ssh/*</span>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@localhost openssh-9.3p2<span class="token punctuation">]</span><span class="token comment"># cp -rf /usr/local/sbin/sshd /usr/sbin/sshd</span>
<span class="token punctuation">[</span>root@localhost openssh-9.3p2<span class="token punctuation">]</span><span class="token comment"># cp -rf /usr/local/bin/ssh /usr/bin/ssh</span>
<span class="token punctuation">[</span>root@localhost openssh-9.3p2<span class="token punctuation">]</span><span class="token comment"># cp -rf /usr/local/bin/ssh-keygen /usr/bin/ssh-keygen</span>
<span class="token punctuation">[</span>root@localhost openssh-9.3p2<span class="token punctuation">]</span><span class="token comment"># cp -ar /usr/local/openssh-9.3p2/contrib/redhat/sshd.init /etc/init.d/sshd</span>
<span class="token punctuation">[</span>root@localhost openssh-9.3p2<span class="token punctuation">]</span><span class="token comment"># cp -ar /usr/local/openssh-9.3p2/contrib/redhat/sshd.pam /etc/pam.d/sshd.pam</span>
...
<span class="token punctuation">[</span>root@localhost openssh-9.3p2<span class="token punctuation">]</span><span class="token comment"># sed -i "s/^#Port/Port/g" /etc/ssh/sshd_config</span>
<span class="token punctuation">[</span>root@localhost openssh-9.3p2<span class="token punctuation">]</span><span class="token comment"># chmod 755 /etc/init.d/sshd</span>
...
<span class="token punctuation">[</span>root@localhost openssh-9.3p2<span class="token punctuation">]</span><span class="token comment"># systemctl enable sshd</span>
sshd.service is not a native service, redirecting to /sbin/chkconfig.
Executing /sbin/chkconfig sshd on

<span class="token comment"># 重启服务</span>
<span class="token punctuation">[</span>root@localhost openssh-9.3p2<span class="token punctuation">]</span><span class="token comment"># systemctl restart sshd</span>
<span class="token comment"># 查看服务状态</span>
<span class="token punctuation">[</span>root@localhost openssh-9.3p2<span class="token punctuation">]</span><span class="token comment"># systemctl status sshd</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/8ac24286ef2b4a23a47a389bb9d5fa1b.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
...
OpenSSH_9.3p2, OpenSSL <span class="token number">1.1</span>.1t  <span class="token number">7</span> Feb <span class="token number">2023</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/e578300732234bc8b51ca1fa6a8236ab.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
