...
<h1 id="此文升级是基于9-3p2升级9-4p1-如是7-4升级9-4p1-可参考文章最后的参考文章" tabindex="-1"><a class="header-anchor" href="#此文升级是基于9-3p2升级9-4p1-如是7-4升级9-4p1-可参考文章最后的参考文章" aria-hidden="true">#</a> 此文升级是基于9.3p2升级9.4p1（如是7.4升级9.4p1，可参考文章最后的参考文章）</h1>
<blockquote>
...
<h2 id="备份openssh9-3p2的配置文件" tabindex="-1"><a class="header-anchor" href="#备份openssh9-3p2的配置文件" aria-hidden="true">#</a> 备份openssh9.3p2的配置文件</h2>
...
<h2 id="下载-openssh9-4p1-的安装包" tabindex="-1"><a class="header-anchor" href="#下载-openssh9-4p1-的安装包" aria-hidden="true">#</a> 下载 openssh9.4p1 的安装包：</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="解压并编译安装openssh9-4p1" tabindex="-1"><a class="header-anchor" href="#解压并编译安装openssh9-4p1" aria-hidden="true">#</a> 解压并编译安装OpenSSH9.4p1</h2>
