...
<hr>
<p>@[toc]</p>
<h1 id="一、什么是-podman" tabindex="-1"><a class="header-anchor" href="#一、什么是-podman" aria-hidden="true">#</a> 一、什么是 podman？</h1>
<figure><img src="https://i-blog.csdnimg.cn/direct/7b3605d9f4014cde82288b595890088f.png#pic_center" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
...
<h1 id="二、部署-podman" tabindex="-1"><a class="header-anchor" href="#二、部署-podman" aria-hidden="true">#</a> 二、部署 podman</h1>
<blockquote>
...
<p>离线安装：<a href="https://download.csdn.net/download/liu_chen_yang/89525105" target="_blank" rel="noopener noreferrer">podman 离线安装包<ExternalLinkIcon/></a></p>
<hr>
<p><strong>Podman 在 CentOS 8 和 Stream 的 AppStream 存储库中可用，可直接进行yum安装。</strong></p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 安装podman</span>
...
<span class="token comment"># 启动podman服务</span>
systemctl start <span class="token function">podman</span>
<span class="token comment"># 重启podman服务</span>
systemctl restart <span class="token function">podman</span>
<span class="token comment"># 停止podman服务</span>
systemctl stop <span class="token function">podman</span>
<span class="token comment"># 查看podman服务状态（）</span>
systemctl status <span class="token function">podman</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="三、podman-参数" tabindex="-1"><a class="header-anchor" href="#三、podman-参数" aria-hidden="true">#</a> 三、podman 参数</h1>
<p>podman常用参数和docker常用参数都是一样的；这里举例几个就行，具体的可以查看docker的命令参数：<a href="https://liucy.blog.csdn.net/article/details/123842609" target="_blank" rel="noopener noreferrer">linux（centos）中部署docker（步骤超全，含带一些发展史和一些概念）<ExternalLinkIcon/></a>，查看后面的<font color=red>docker镜像管理、docker容器管理、docker运行容器命令</font>。</p>
<h2 id="_1、podman-镜像管理" tabindex="-1"><a class="header-anchor" href="#_1、podman-镜像管理" aria-hidden="true">#</a> 1、podman 镜像管理</h2>
...
<h2 id="_2、podman容器管理" tabindex="-1"><a class="header-anchor" href="#_2、podman容器管理" aria-hidden="true">#</a> 2、podman容器管理</h2>
<table>
<thead>
<tr>
...
<h2 id="_3、podman运行容器命令" tabindex="-1"><a class="header-anchor" href="#_3、podman运行容器命令" aria-hidden="true">#</a> 3、podman运行容器命令</h2>
...
CONTAINER ID   IMAGE          COMMAND                  CREATED         STATUS         PORTS     NAMES
cef133be2d53   nginx:latest   <span class="token string">"/podman-entrypoint.…"</span>   <span class="token number">6</span> seconds ago   Up <span class="token number">5</span> seconds   <span class="token number">80</span>/tcp    relaxed_lichterman
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="四、附加-修改podman-存储路径" tabindex="-1"><a class="header-anchor" href="#四、附加-修改podman-存储路径" aria-hidden="true">#</a> 四、附加：修改podman 存储路径</h1>
...
<h2 id="_1、podman-中没有数据修改存储路径" tabindex="-1"><a class="header-anchor" href="#_1、podman-中没有数据修改存储路径" aria-hidden="true">#</a> 1、podman 中没有数据修改存储路径</h2>
<ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://i-blog.csdnimg.cn/direct/37ce1097611641c68619e8969c5c9ce9.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://i-blog.csdnimg.cn/direct/becbd30bdfb44033b099000373028d12.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>运行状态，那么就没问题了，接下来可以试试<code v-pre>拉取镜像</code>或者<code v-pre>导入镜像</code>；</p>
<h2 id="_2、podman-中有数据迁移修改存储路径" tabindex="-1"><a class="header-anchor" href="#_2、podman-中有数据迁移修改存储路径" aria-hidden="true">#</a> 2、podman 中有数据迁移修改存储路径</h2>
<blockquote>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 创建一个storage.conf文件</span>
...
<span class="token comment"># 查看podman服务状态</span>
systemctl status <span class="token function">podman</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://i-blog.csdnimg.cn/direct/aa3ff95c7ae544e1a64d6bd3ac036c4d.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>没有启动起来，报错了；</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 查看podman报错详细信息</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://i-blog.csdnimg.cn/direct/066862d1b170450aad8e9bdf5fc42330.png" alt="在这里插入图片描述" loading="lazy"><br>
...
<a href="https://github.com/etcd-io/bbolt" target="_blank" rel="noopener noreferrer">https://github.com/etcd-io/bbolt<ExternalLinkIcon/></a> 页面罗列了不少bolt工具，笔者选用了boltdbweb这款Go写的Web工具来查看和修改。</p>
<figure><img src="https://i-blog.csdnimg.cn/direct/ef98db067917486f9a00e51fdddf6258.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>打开<code v-pre>runtime-config</code>可以看到里面有<code v-pre>graph-root</code>就是podman的存储路径；</p>
<figure><img src="https://i-blog.csdnimg.cn/direct/23831e5e78f243ee9c52a808d3b0e0c0.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
...
<hr>
<p>修改数据库这边我没有弄，参考的：	 <a href="https://blog.csdn.net/witton/article/details/128497746" target="_blank" rel="noopener noreferrer">改变podman的存储路径 - witton<ExternalLinkIcon/></a>，总之，如果数据多的话先备份，而且并不建议更换。</p>
<hr>
<h1 id="五、参考文章" tabindex="-1"><a class="header-anchor" href="#五、参考文章" aria-hidden="true">#</a> 五、参考文章</h1>
<table>
<thead>
<tr>
<th>文件名</th>
...
<tbody>
<tr>
<td><a href="https://blog.csdn.net/witton/article/details/128497746" target="_blank" rel="noopener noreferrer">改变podman的存储路径 - witton<ExternalLinkIcon/></a></td>
