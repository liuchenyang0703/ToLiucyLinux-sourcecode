...
<h1 id="docker中两项核心技术" tabindex="-1"><a class="header-anchor" href="#docker中两项核心技术" aria-hidden="true">#</a> Docker中两项核心技术</h1>
...
<h1 id="docker核心概念" tabindex="-1"><a class="header-anchor" href="#docker核心概念" aria-hidden="true">#</a> Docker核心概念</h1>
<p><strong><font color=green> 1. 镜像(Image)</strong></p>
...
<p><strong><font color=green>2. 容器(Container)</strong></p>
...
<p><strong><font color=green>3. 仓库(Repository)</strong></p>
<blockquote>
<p>仓库（Repository）是集中存储镜像的地方，仓库分为公有仓库与私有仓库。比如Docker Hub，就是Docker官方提供的一个仓库服务器。</p>
</blockquote>
<h1 id="docker的逻辑架构" tabindex="-1"><a class="header-anchor" href="#docker的逻辑架构" aria-hidden="true">#</a> Docker的逻辑架构</h1>
<blockquote>
...
<h1 id="docker优缺点" tabindex="-1"><a class="header-anchor" href="#docker优缺点" aria-hidden="true">#</a> docker优缺点</h1>
<p>  优点：</p>
<blockquote>
<ol>
...
<h1 id="docker-vs-虚拟化" tabindex="-1"><a class="header-anchor" href="#docker-vs-虚拟化" aria-hidden="true">#</a> Docker VS 虚拟化</h1>
<p>虚拟化：</p>
<blockquote>
...
<h1 id="docker部署与管理" tabindex="-1"><a class="header-anchor" href="#docker部署与管理" aria-hidden="true">#</a> docker部署与管理</h1>
...
<p><img src="https://img-blog.csdnimg.cn/01511ba039ee418c8b8c3e8e3f44ab9d.png" alt="在这里插入图片描述" loading="lazy"><br>
<img src="https://i-blog.csdnimg.cn/direct/52fec39861a44249b91cc8998329b861.png" alt="在这里插入图片描述" loading="lazy"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="添加镜像加速器" tabindex="-1"><a class="header-anchor" href="#添加镜像加速器" aria-hidden="true">#</a> 添加镜像加速器</h1>
...
<img src="https://img-blog.csdnimg.cn/0150e473cda440c2b37f7e6c311ef056.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBAQS3liJjmmajpmLM=,size_20,color_FFFFFF,t_70,g_se,x_16" alt="在这里插入图片描述" loading="lazy"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="docker镜像管理" tabindex="-1"><a class="header-anchor" href="#docker镜像管理" aria-hidden="true">#</a> docker镜像管理</h2>
...
<p>docker中还提供了专门管理镜像的子命令docker image,用法与docker命令类似。</p>
<table>
<thead>
<tr>
...
<td>创建容器</td>
<td>docker exec -itd--name nginx nginx:v1创建容器并运行</td>
<td></td>
</tr>
<tr>
...
<td>更新容器配置</td>
<td>docker update --restart=always nginx</td>
<td></td>
</tr>
<tr>
...
<h2 id="docker运行容器命令" tabindex="-1"><a class="header-anchor" href="#docker运行容器命令" aria-hidden="true">#</a> docker运行容器命令</h2>
<p>docker container run命令是根据指定镜像创建一个容器并启动运行。如果本地没有该镜像，则从docker仓库中拉去镜像。所以<br>
docker container run = docker image pull +  docker container create + docker container start<br>
命令格式:docker container run [选项] 镜像名称|镜像ID  [command]<br>
常用选项:</p>
<table>
<thead>
<tr>
