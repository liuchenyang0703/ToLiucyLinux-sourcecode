...
<h1 id="二、华为云耀云服务器l实例" tabindex="-1"><a class="header-anchor" href="#二、华为云耀云服务器l实例" aria-hidden="true">#</a> 二、华为云耀云服务器L实例</h1>
<h2 id="_2-1-华为云耀云服务器l实例简介" tabindex="-1"><a class="header-anchor" href="#_2-1-华为云耀云服务器l实例简介" aria-hidden="true">#</a> 2.1 华为云耀云服务器L实例简介</h2>
<blockquote>
...
<figure><img src="https://img-blog.csdnimg.cn/07fe2d09e56e40c3a1481bd1344ff7d8.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<h2 id="_2-2-华为云耀云服务器l实例地址" tabindex="-1"><a class="header-anchor" href="#_2-2-华为云耀云服务器l实例地址" aria-hidden="true">#</a> 2.2 华为云耀云服务器L实例地址</h2>
<blockquote>
...
<h2 id="_2-3-华为云耀云服务器l实例产品架构" tabindex="-1"><a class="header-anchor" href="#_2-3-华为云耀云服务器l实例产品架构" aria-hidden="true">#</a> 2.3 华为云耀云服务器L实例产品架构</h2>
...
<h1 id="三、购买云耀云服务器l实例" tabindex="-1"><a class="header-anchor" href="#三、购买云耀云服务器l实例" aria-hidden="true">#</a> 三、购买云耀云服务器L实例</h1>
<h2 id="_3-1-登录华为云官网购买" tabindex="-1"><a class="header-anchor" href="#_3-1-登录华为云官网购买" aria-hidden="true">#</a> 3.1 登录华为云官网购买</h2>
<blockquote>
...
<figure><img src="https://img-blog.csdnimg.cn/fabeee444a5247ddb8395bbd59e86235.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<blockquote>
<p>区域：华北—北京四；<br>
...
<p><img src="https://img-blog.csdnimg.cn/f2790be17dcd4f858bb3e27c20a7bd9e.png" alt="在这里插入图片描述" loading="lazy"><br>
<img src="https://img-blog.csdnimg.cn/38dea457fd4e44a299b116bf2d8b607c.png" alt="在这里插入图片描述" loading="lazy"><br>
<img src="https://img-blog.csdnimg.cn/5c8dd6ec41f94173bce2e7bbb6ad0e30.png" alt="在这里插入图片描述" loading="lazy"></p>
<ul>
<li>检查配置 --&gt; 确认购买</li>
</ul>
<figure><img src="https://img-blog.csdnimg.cn/d7eb34cd7a0b4ac9888980b257bdd286.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<ul>
<li>购买成功；</li>
</ul>
<h2 id="_3-2-重置密码" tabindex="-1"><a class="header-anchor" href="#_3-2-重置密码" aria-hidden="true">#</a> 3.2 重置密码</h2>
<ul>
<li>
<p>到控制台查看我的资源<br>
...
<h2 id="_3-3-使用xshell链接服务器" tabindex="-1"><a class="header-anchor" href="#_3-3-使用xshell链接服务器" aria-hidden="true">#</a> 3.3 使用xshell链接服务器</h2>
<blockquote>
<p>使用ip、密码链接即可</p>
</blockquote>
<h1 id="四、检查docker环境及服务状态" tabindex="-1"><a class="header-anchor" href="#四、检查docker环境及服务状态" aria-hidden="true">#</a> 四、检查docker环境及服务状态</h1>
<blockquote>
<p>因为购买的就是 Docker可视化-Portainer	 的，所以不用安装docker</p>
</blockquote>
<h2 id="_4-1-检查docker版本" tabindex="-1"><a class="header-anchor" href="#_4-1-检查docker版本" aria-hidden="true">#</a> 4.1 检查Docker版本</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_4-2-检查docker服务状态" tabindex="-1"><a class="header-anchor" href="#_4-2-检查docker服务状态" aria-hidden="true">#</a> 4.2 检查docker服务状态</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="五、部署nacos2-2-3" tabindex="-1"><a class="header-anchor" href="#五、部署nacos2-2-3" aria-hidden="true">#</a> 五、部署nacos2.2.3</h1>
<h2 id="_5-1-下载-nacos2-2-3-镜像" tabindex="-1"><a class="header-anchor" href="#_5-1-下载-nacos2-2-3-镜像" aria-hidden="true">#</a> 5.1 下载 nacos2.2.3 镜像</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/5421a8b72aae4e6ca277a9b13727bf96.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<h2 id="_5-2-查看镜像" tabindex="-1"><a class="header-anchor" href="#_5-2-查看镜像" aria-hidden="true">#</a> 5.2 查看镜像</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/ef0c9339111d42eeb9edea014bdb2721.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>可以自己将镜像重新命名，或者直接使用此名字都可以；<br>
重新命名命令为：<code v-pre>docker tag liuchenyang/redhat-nacos:latest nacos:latest</code></p>
<h2 id="_5-3-创建nacos容器" tabindex="-1"><a class="header-anchor" href="#_5-3-创建nacos容器" aria-hidden="true">#</a> 5.3 创建nacos容器</h2>
...
<figure><img src="https://img-blog.csdnimg.cn/4212d684529845d1b0922cfbe603b98c.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/dcc633ef50834a0d9f645bd0dd8fc548.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>这里可以看到，端口已经启动了；但是因为是云服务器，还需要在云服务器上开放 8848 端口；<br>
开放完端口之后，页面访问。</p>
<h2 id="_5-4-页面访问nacos" tabindex="-1"><a class="header-anchor" href="#_5-4-页面访问nacos" aria-hidden="true">#</a> 5.4 页面访问nacos</h2>
<blockquote>
<p>172.16.11.10:8848/nacos</p>
</blockquote>
<figure><img src="https://img-blog.csdnimg.cn/e62256998e9d4ebb977a91dd9d2c6e9a.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<figure><img src="https://img-blog.csdnimg.cn/19b981b910c34e68b890ec2396cfcfff.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<blockquote>
<p>因为此部署没有设置数据库，所以会自动跳进来；</p>
</blockquote>
<h1 id="六、完成部署" tabindex="-1"><a class="header-anchor" href="#六、完成部署" aria-hidden="true">#</a> 六、完成部署</h1>
</div></template>
