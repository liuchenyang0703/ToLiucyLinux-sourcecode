...
<p>@[toc]</p>
<h1 id="docker-compose简介" tabindex="-1"><a class="header-anchor" href="#docker-compose简介" aria-hidden="true">#</a> docker-compose简介</h1>
<h2 id="docker-compose基础概念" tabindex="-1"><a class="header-anchor" href="#docker-compose基础概念" aria-hidden="true">#</a> docker-compose基础概念</h2>
<blockquote>
...
<h2 id="为什么要用docker-compose" tabindex="-1"><a class="header-anchor" href="#为什么要用docker-compose" aria-hidden="true">#</a> 为什么要用docker-compose</h2>
<blockquote>
...
<h1 id="yaml文件格式编写及编写注意事项" tabindex="-1"><a class="header-anchor" href="#yaml文件格式编写及编写注意事项" aria-hidden="true">#</a> YAML文件格式编写及编写注意事项</h1>
...
<p>请严格按照YAML文件格式来写，如格式写错docker-compose启动服务时一般会报：<font color=red>ERROR: In file './nginx.yaml', service 'hostname' must be a mapping not a st</p>
</blockquote>
</font> 这个错；解决方式就是看自己的YAML文件格式写的是否正确。
...
<h1 id="docker-compose的安装" tabindex="-1"><a class="header-anchor" href="#docker-compose的安装" aria-hidden="true">#</a> docker-compose的安装</h1>
<h2 id="在线安装" tabindex="-1"><a class="header-anchor" href="#在线安装" aria-hidden="true">#</a> 在线安装</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/e51d826c103a428f826a0acd6ce56463.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>安装完成。</p>
<h1 id="docker-compose常用的命令详解" tabindex="-1"><a class="header-anchor" href="#docker-compose常用的命令详解" aria-hidden="true">#</a> docker-compose常用的命令详解</h1>
...
<h1 id="docker-compose常用的字段详解" tabindex="-1"><a class="header-anchor" href="#docker-compose常用的字段详解" aria-hidden="true">#</a> docker-compose常用的字段详解</h1>
<table>
<thead>
<tr>
<th>字段</th>
...
<h1 id="docker-compose常用的命令、字段详解实例" tabindex="-1"><a class="header-anchor" href="#docker-compose常用的命令、字段详解实例" aria-hidden="true">#</a> docker-compose常用的命令、字段详解实例</h1>
<p>运行这些命令需要结合docker-compose一起使用。</p>
<p>且必须要在含有docker-compose.yml文件的目录中才可以使用，不然报错。</p>
<h2 id="docker-compose命令格式-带-的是常用的" tabindex="-1"><a class="header-anchor" href="#docker-compose命令格式-带-的是常用的" aria-hidden="true">#</a> docker-compose命令格式，带*的是常用的</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_1-docker-compose-h" tabindex="-1"><a class="header-anchor" href="#_1-docker-compose-h" aria-hidden="true">#</a> 1 docker-compose -h</h2>
...
<h2 id="_2-docker-compose-up" tabindex="-1"><a class="header-anchor" href="#_2-docker-compose-up" aria-hidden="true">#</a> *2 docker-compose up</h2>
<p>选项包括：</p>
<ul>
<li>-d 在后台运行服务容器</li>
...
<span class="token function">docker-compose</span> <span class="token parameter variable">-f</span> nginx.yaml up <span class="token parameter variable">-d</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3-docker-compose-images" tabindex="-1"><a class="header-anchor" href="#_3-docker-compose-images" aria-hidden="true">#</a> *3 docker-compose images</h2>
<p>如果yaml文件名不是“docker-compose.yml, docker-compose.yaml, compose.yml, compose.yaml”，就需要使用-f指定yaml文件</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_4-docker-compose-ps" tabindex="-1"><a class="header-anchor" href="#_4-docker-compose-ps" aria-hidden="true">#</a> *4 docker-compose ps</h2>
...
<font color=red>最重要的必须在存放yaml文件的目录来执行。</font><h2 id="_5-docker-compose-stop" tabindex="-1"><a class="header-anchor" href="#_5-docker-compose-stop" aria-hidden="true">#</a> *5 docker-compose stop</h2>
<p>选项包括：</p>
<ul>
<li>-t, –timeout TIMEOUT 停止容器时候的超时（默认为10秒）</li>
</ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_6-docker-compose-start" tabindex="-1"><a class="header-anchor" href="#_6-docker-compose-start" aria-hidden="true">#</a> *6 docker-compose start</h2>
<p>如果yaml文件名不是“docker-compose.yml, docker-compose.yaml, compose.yml, compose.yaml”，就需要使用-f指定yaml文件</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment">#启动所有服务</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_7-docker-compose-restart" tabindex="-1"><a class="header-anchor" href="#_7-docker-compose-restart" aria-hidden="true">#</a> *7 docker-compose restart</h2>
<p>如果yaml文件名不是“docker-compose.yml, docker-compose.yaml, compose.yml, compose.yaml”，就需要使用-f指定yaml文件</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_8-docker-compose-down" tabindex="-1"><a class="header-anchor" href="#_8-docker-compose-down" aria-hidden="true">#</a> *8 docker-compose down</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_9-docker-compose-logs" tabindex="-1"><a class="header-anchor" href="#_9-docker-compose-logs" aria-hidden="true">#</a> *9 docker-compose logs</h2>
<p>如果yaml文件名不是“docker-compose.yml, docker-compose.yaml, compose.yml, compose.yaml”，就需要使用-f指定yaml文件</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_10-docker-compose-top" tabindex="-1"><a class="header-anchor" href="#_10-docker-compose-top" aria-hidden="true">#</a> *10 docker-compose top</h2>
<p>如果yaml文件名不是“docker-compose.yml, docker-compose.yaml, compose.yml, compose.yaml”，就需要使用-f指定yaml文件</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_11-docker-compose-build" tabindex="-1"><a class="header-anchor" href="#_11-docker-compose-build" aria-hidden="true">#</a> 11 docker-compose build</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_12-docker-compose-exec" tabindex="-1"><a class="header-anchor" href="#_12-docker-compose-exec" aria-hidden="true">#</a> 12 docker-compose exec</h2>
<p>选项包括：</p>
<ul>
<li>-d 分离模式，后台运行命令。</li>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_13-docker-compose-scale" tabindex="-1"><a class="header-anchor" href="#_13-docker-compose-scale" aria-hidden="true">#</a> 13 docker-compose scale</h2>
<ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_14-docker-compose-pause" tabindex="-1"><a class="header-anchor" href="#_14-docker-compose-pause" aria-hidden="true">#</a> *14 docker-compose pause</h2>
<p>如果yaml文件名不是“docker-compose.yml, docker-compose.yaml, compose.yml, compose.yaml”，就需要使用-f指定yaml文件</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_15-docker-compose-unpause" tabindex="-1"><a class="header-anchor" href="#_15-docker-compose-unpause" aria-hidden="true">#</a> *15 docker-compose unpause</h2>
<p>如果yaml文件名不是“docker-compose.yml, docker-compose.yaml, compose.yml, compose.yaml”，就需要使用-f指定yaml文件</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_16-docker-compose-pull" tabindex="-1"><a class="header-anchor" href="#_16-docker-compose-pull" aria-hidden="true">#</a> 16 docker-compose pull</h2>
<p>拉取服务依赖的镜像。<br>
选项包括：</p>
<ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_17-docker-compose-push" tabindex="-1"><a class="header-anchor" href="#_17-docker-compose-push" aria-hidden="true">#</a> 17 docker-compose push</h2>
<p>选项包括：</p>
<ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_18-docker-compose-rm" tabindex="-1"><a class="header-anchor" href="#_18-docker-compose-rm" aria-hidden="true">#</a> 18 docker-compose rm</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_19-dokcer-compose-config" tabindex="-1"><a class="header-anchor" href="#_19-dokcer-compose-config" aria-hidden="true">#</a> *19 dokcer-compose config</h2>
<p>选项包括：</p>
<ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="docker-compose常用字段详解-yaml模板文件-带-的是常用的" tabindex="-1"><a class="header-anchor" href="#docker-compose常用字段详解-yaml模板文件-带-的是常用的" aria-hidden="true">#</a> docker-compose常用字段详解（yaml模板文件），带*的是常用的</h2>
<blockquote>
...
<h2 id="_1-version" tabindex="-1"><a class="header-anchor" href="#_1-version" aria-hidden="true">#</a> *1 version</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="_2-services" tabindex="-1"><a class="header-anchor" href="#_2-services" aria-hidden="true">#</a> *2 services</h2>
...
services: 
  ...
  nginx: 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3-hostname" tabindex="-1"><a class="header-anchor" href="#_3-hostname" aria-hidden="true">#</a> *3 hostname</h2>
<ul>
...
services: 
  ...
  nginx: 
    hostname: nginx
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_4-container-name" tabindex="-1"><a class="header-anchor" href="#_4-container-name" aria-hidden="true">#</a> *4 container_name</h2>
<ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_5-image" tabindex="-1"><a class="header-anchor" href="#_5-image" aria-hidden="true">#</a> *5 image</h2>
<ul>
...
services: 
  ...
  nginx: 
    ...
    container_name: nginx
	image: nginx:latest
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_6-ports" tabindex="-1"><a class="header-anchor" href="#_6-ports" aria-hidden="true">#</a> *6 ports</h2>
<p>ports格式为：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_7-volumes" tabindex="-1"><a class="header-anchor" href="#_7-volumes" aria-hidden="true">#</a> *7 volumes</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_8-restart" tabindex="-1"><a class="header-anchor" href="#_8-restart" aria-hidden="true">#</a> *8 restart</h2>
...
services: 
  ...
  nginx: 
    ...
    restart: always
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_9-volumes-from" tabindex="-1"><a class="header-anchor" href="#_9-volumes-from" aria-hidden="true">#</a> 9 volumes_from</h2>
<p>从另一个服务或容器挂载其数据卷：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>version: <span class="token string">"3"</span>
services: 
  ...
  nginx: 
    ...
    volumes_from:
      - service_name    
        - container_name
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_10-command" tabindex="-1"><a class="header-anchor" href="#_10-command" aria-hidden="true">#</a> *10 command</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_11-build" tabindex="-1"><a class="header-anchor" href="#_11-build" aria-hidden="true">#</a> 11 build</h2>
...
<h2 id="_12-context" tabindex="-1"><a class="header-anchor" href="#_12-context" aria-hidden="true">#</a> 12 context</h2>
<p>context选项可以是Dockerfile的文件路径，也可以是到链接到git仓库的url，当提供的值是相对路径时，被解析为相对于撰写文件的路径，此目录也是发送到Docker守护进程的context</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>build:
  context: ./dir
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_13-dockerfile" tabindex="-1"><a class="header-anchor" href="#_13-dockerfile" aria-hidden="true">#</a> 13 dockerfile</h2>
<p>使用dockerfile文件来构建，必须指定构建路径</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>build: 
  context: <span class="token builtin class-name">.</span>
  dockerfile: Dockerfile-alternate
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_14-depends-on" tabindex="-1"><a class="header-anchor" href="#_14-depends-on" aria-hidden="true">#</a> 14 depends_on</h2>
...
<h2 id="_15-pid" tabindex="-1"><a class="header-anchor" href="#_15-pid" aria-hidden="true">#</a> 15 pid</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="_16-labels" tabindex="-1"><a class="header-anchor" href="#_16-labels" aria-hidden="true">#</a> 16 labels</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_17-network-mode" tabindex="-1"><a class="header-anchor" href="#_17-network-mode" aria-hidden="true">#</a> 17 network_mode</h2>
<p>设置网络模式。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_18-dns" tabindex="-1"><a class="header-anchor" href="#_18-dns" aria-hidden="true">#</a> 18 dns</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_19-dns-search" tabindex="-1"><a class="header-anchor" href="#_19-dns-search" aria-hidden="true">#</a> 19 dns_search</h2>
...
dns_search：
    - domain1.example.com
    - domain2.example.com
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_20-entrypoint" tabindex="-1"><a class="header-anchor" href="#_20-entrypoint" aria-hidden="true">#</a> 20 entrypoint</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="_21-env-file" tabindex="-1"><a class="header-anchor" href="#_21-env-file" aria-hidden="true">#</a> 21 env_file</h2>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>env_file:
  ...
  - ./apps/web.env
  - ./opt/secrets.env
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_22-cap-add" tabindex="-1"><a class="header-anchor" href="#_22-cap-add" aria-hidden="true">#</a> 22 cap_add</h2>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>cap_add:
    - ALL
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_23-cap-drop" tabindex="-1"><a class="header-anchor" href="#_23-cap-drop" aria-hidden="true">#</a> 23 cap_drop</h2>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>cap_drop:
    - NET_ADMIN
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_24-cgroup-parent" tabindex="-1"><a class="header-anchor" href="#_24-cgroup-parent" aria-hidden="true">#</a> 24 cgroup_parent</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="_25-expose" tabindex="-1"><a class="header-anchor" href="#_25-expose" aria-hidden="true">#</a> 25 expose</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_26-extends" tabindex="-1"><a class="header-anchor" href="#_26-extends" aria-hidden="true">#</a> 26 extends</h2>
...
<h2 id="_27-external-links" tabindex="-1"><a class="header-anchor" href="#_27-external-links" aria-hidden="true">#</a> 27 external_links</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_28-links" tabindex="-1"><a class="header-anchor" href="#_28-links" aria-hidden="true">#</a> 28 links</h2>
...
<h2 id="_29-working-dir" tabindex="-1"><a class="header-anchor" href="#_29-working-dir" aria-hidden="true">#</a> 29 working_dir</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h1 id="标准yaml文件名为-docker-compose-yml-docker-compose-yaml-compose-yml-compose-yaml" tabindex="-1"><a class="header-anchor" href="#标准yaml文件名为-docker-compose-yml-docker-compose-yaml-compose-yml-compose-yaml" aria-hidden="true">#</a> 标准yaml文件名为：docker-compose.yml, docker-compose.yaml, compose.yml, compose.yaml</h1>
...
<h1 id="docker-compose-模板文件详写实例" tabindex="-1"><a class="header-anchor" href="#docker-compose-模板文件详写实例" aria-hidden="true">#</a> docker-compose 模板文件详写实例</h1>
<p>三个nginx服务，访问端口分别为:[80,81,82]</p>
<h2 id="_1-创建模板yaml文件" tabindex="-1"><a class="header-anchor" href="#_1-创建模板yaml文件" aria-hidden="true">#</a> 1 创建模板yaml文件</h2>
...
services:                   <span class="token comment">#服务</span>
  ...
  nginx3:
    ...
    volumes:
     ...
     - /etc/localtime:/etc/localtime
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="启动nginx服务" tabindex="-1"><a class="header-anchor" href="#启动nginx服务" aria-hidden="true">#</a> 启动nginx服务</h2>
...
<span class="token function">docker-compose</span> up <span class="token parameter variable">-d</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/05a6b930e9b74990a89e1f3936064a8c.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<h2 id="_3-访问nginx页面" tabindex="-1"><a class="header-anchor" href="#_3-访问nginx页面" aria-hidden="true">#</a> 3 访问nginx页面</h2>
...
<h1 id="重要-yaml需要注意的" tabindex="-1"><a class="header-anchor" href="#重要-yaml需要注意的" aria-hidden="true">#</a> 重要：YAML需要注意的</h1>
