...
<hr>
<h1 id="声明式流水线" tabindex="-1"><a class="header-anchor" href="#声明式流水线" aria-hidden="true">#</a> 声明式流水线</h1>
...
<blockquote>
<p>更多的配置案例可参考：<a href="https://www.jenkins.io/zh/doc/book/pipeline/syntax/#parameters-example" target="_blank" rel="noopener noreferrer">流水线语法（jenkins.io）<ExternalLinkIcon/></a></p>
</blockquote>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>pipeline <span class="token punctuation">{</span>
    agent any
...
<h1 id="如何创建一个node节点" tabindex="-1"><a class="header-anchor" href="#如何创建一个node节点" aria-hidden="true">#</a> 如何创建一个node节点？</h1>
...
<figure><img src="https://img-blog.csdnimg.cn/img_convert/00ca47f3aadec673e6d53041e6fef763.png" alt="image-20231226113332353" tabindex="0" loading="lazy"><figcaption>image-20231226113332353</figcaption></figure>
<figure><img src="https://img-blog.csdnimg.cn/img_convert/54218ee2196edbc6c34a47efc8f07b7d.png" alt="image-20231226113350109" tabindex="0" loading="lazy"><figcaption>image-20231226113350109</figcaption></figure>
<p>点进来之后，直接<code v-pre>new node</code>创建即可。</p>
<figure><img src="https://img-blog.csdnimg.cn/img_convert/11d9b00443b0becd654e2b58eb1903af.png" alt="image-20231226113443840" tabindex="0" loading="lazy"><figcaption>image-20231226113443840</figcaption></figure>
<p>这里可以自己写节点名称，这里测试我就写test1了。</p>
<figure><img src="https://img-blog.csdnimg.cn/img_convert/677c9048a192ec1062b65df79e0ab43e.png" alt="image-20231226113506143" tabindex="0" loading="lazy"><figcaption>image-20231226113506143</figcaption></figure>
<figure><img src="https://img-blog.csdnimg.cn/img_convert/626eeaf100fa9bbe038f201ab287ddc0.png" alt="image-20240125111153073" tabindex="0" loading="lazy"><figcaption>image-20240125111153073</figcaption></figure>
<p>写完之后点击<code v-pre>create</code>创建即可，创建完之后会跳转到里面进行配置<code v-pre>node</code>信息。</p>
<figure><img src="https://img-blog.csdnimg.cn/img_convert/d95c81c4c5d070c1a9c661671054b8c2.png" alt="image-20231226115217676" tabindex="0" loading="lazy"><figcaption>image-20231226115217676</figcaption></figure>
<p>点击保存即可；</p>
<ul>
<li>
...
3.发送公钥：        ssh-copy-id <a href="http://172.16.xx.xxx" target="_blank" rel="noopener noreferrer">172.16.xx.xxx<ExternalLinkIcon/></a><br>
4.免密登录测试： ssh <a href="http://172.16.xx.xxx" target="_blank" rel="noopener noreferrer">172.16.xx.xxx<ExternalLinkIcon/></a></p>
</blockquote>
<p>配置完之后可以进行连接了。</p>
<p>保存完点击刚刚创建的node节点，点进去，然后点击侧边的日志，可以看到连接情况；</p>
<figure><img src="https://img-blog.csdnimg.cn/img_convert/bbcdb934072ec54ce8c506f110c40422.png" alt="image-20240125111950335" tabindex="0" loading="lazy"><figcaption>image-20240125111950335</figcaption></figure>
<figure><img src="https://img-blog.csdnimg.cn/img_convert/dd98672021f9af79cdd4eecfea71a53c.png" alt="image-20231226130556616" tabindex="0" loading="lazy"><figcaption>image-20231226130556616</figcaption></figure>
<p>连接成功会显示已同步：</p>
<figure><img src="https://img-blog.csdnimg.cn/img_convert/5eb6ab0e56802b9e030b164235860ac3.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
<h2 id="agent" tabindex="-1"><a class="header-anchor" href="#agent" aria-hidden="true">#</a> agent</h2>
...
<h2 id="stages" tabindex="-1"><a class="header-anchor" href="#stages" aria-hidden="true">#</a> stages</h2>
<p>接着来看下stages模块，stages模块由多个stage组成，一个stage表示一个阶段，比如我们通常将发布的整个流程分为编译，传输，部署等几个阶段。</p>
<h2 id="stage" tabindex="-1"><a class="header-anchor" href="#stage" aria-hidden="true">#</a> stage</h2>
<p>一个<code v-pre>stages</code>可以有多个<code v-pre>stage</code>；一个stage表示一个阶段，比如我们通常将发布的整个流程分为编译，传输，部署等几个阶段。</p>
<h2 id="steps" tabindex="-1"><a class="header-anchor" href="#steps" aria-hidden="true">#</a> steps</h2>
...
<h2 id="post" tabindex="-1"><a class="header-anchor" href="#post" aria-hidden="true">#</a> post</h2>
...
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code>pipeline <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/img_convert/25efe9ccbdff3950d065680915169cf1.png" alt="image-20240126143719547" tabindex="0" loading="lazy"><figcaption>image-20240126143719547</figcaption></figure>
<ul class="task-list-container">
...
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code>pipeline <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/img_convert/e0d68d462be92562a401eba162a29bc2.png" alt="image-20240126095209114" tabindex="0" loading="lazy"><figcaption>image-20240126095209114</figcaption></figure>
<ul class="task-list-container">
...
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code>pipeline <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/img_convert/6b3ab2f900dd36673127d2430effaa8b.png" alt="image-20240126143320776" tabindex="0" loading="lazy"><figcaption>image-20240126143320776</figcaption></figure>
<ul class="task-list-container">
...
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code>pipeline <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/img_convert/e03322a0bc7dc7f94723f5c48770a4a8.png" alt="image-20240126150106957" tabindex="0" loading="lazy"><figcaption>image-20240126150106957</figcaption></figure>
<blockquote>
<p>① 按照惯例，<code v-pre>post</code> 部分应该放在流水线的底部。</p>
</blockquote>
<h2 id="environment" tabindex="-1"><a class="header-anchor" href="#environment" aria-hidden="true">#</a> environment</h2>
...
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code>pipeline <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/img_convert/a1a310bdb6e12e90868d2830e3f49a0a.png" alt="image-20240220100551154" tabindex="0" loading="lazy"><figcaption>image-20240220100551154</figcaption></figure>
<blockquote>
<p>代码分析：</p>
<figure><img src="https://img-blog.csdnimg.cn/img_convert/989dffcbfb86c847696145aa7e690e3e.png" alt="image-20240220101045685" tabindex="0" loading="lazy"><figcaption>image-20240220101045685</figcaption></figure>
</blockquote>
<ul>
...
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code>pipeline <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/img_convert/8cc84ddd380da16d00def37ea85021b3.png" alt="image-20240220100655699" tabindex="0" loading="lazy"><figcaption>image-20240220100655699</figcaption></figure>
<blockquote>
<p>代码分析：</p>
<figure><img src="https://img-blog.csdnimg.cn/img_convert/c2bb03dc16dcae39c441cf6625e41c0a.png" alt="image-20240220101555304" tabindex="0" loading="lazy"><figcaption>image-20240220101555304</figcaption></figure>
</blockquote>
<hr>
<p>除了自定义的这几个环境变量之后，我们还有系统自带的全局环境变量，可访问：<a href="http://ip:port/job/%E9%A1%B9%E7%9B%AE%E5%90%8D/pipeline-syntax/globals" target="_blank" rel="noopener noreferrer">http://ip:port/job/项目名/pipeline-syntax/globals<ExternalLinkIcon/></a></p>
<blockquote>
...
<tr>
<td>BUILD_URL</td>
<td>可以定位此次构建结果的 URL（比如 <a href="http://buildserver/jenkins/job/MyJobName/17/" target="_blank" rel="noopener noreferrer">http://buildserver/jenkins/job/MyJobName/17/<ExternalLinkIcon/></a> ）</td>
</tr>
<tr>
...
<tr>
<td>JENKINS_URL</td>
<td>Jenkins 服务器的完整 URL，比如 <a href="https://example.com" target="_blank" rel="noopener noreferrer">https://example.com<ExternalLinkIcon/></a>:port/jenkins/ （注意：只有在“系统设置”中设置了 Jenkins URL 才可用）。</td>
</tr>
<tr>
<td>JOB_NAME</td>
...
<h2 id="tools" tabindex="-1"><a class="header-anchor" href="#tools" aria-hidden="true">#</a> tools</h2>
...
<h2 id="input" tabindex="-1"><a class="header-anchor" href="#input" aria-hidden="true">#</a> input</h2>
...
<figure><img src="https://img-blog.csdnimg.cn/img_convert/988e3b4f9402ba61191c449f27007bf7.png" alt="image-20240222133008528" tabindex="0" loading="lazy"><figcaption>image-20240222133008528</figcaption></figure>
<p>点击进入跳转到此，会有一个默认的用户名和密码，是在<code v-pre>parameters</code>中设定的默认值。</p>
<figure><img src="https://img-blog.csdnimg.cn/img_convert/a9482e102f00ad6bfc24a8f8a8c413cf.png" alt="image-20240222133343179" tabindex="0" loading="lazy"><figcaption>image-20240222133343179</figcaption></figure>
<p>点击继续即可；</p>
<figure><img src="https://img-blog.csdnimg.cn/img_convert/d69c633dd5acaf40d41a6627e1bd55f8.png" alt="image-20240222133848575" tabindex="0" loading="lazy"><figcaption>image-20240222133848575</figcaption></figure>
...
<figure><img src="https://img-blog.csdnimg.cn/img_convert/b4635cf45971d0a889c6fb0db7ac4050.png" alt="image-20240226103614135" tabindex="0" loading="lazy"><figcaption>image-20240226103614135</figcaption></figure>
<ul>
<li>第一次会构建失败，然后我们可以看到，构建的标志变了，变成了<code v-pre>Build with Parameters</code>，然后再次点击一下即可，就会跳到以下界面；</li>
</ul>
<figure><img src="https://img-blog.csdnimg.cn/img_convert/874f6ed43f2244bf732c514d1e025439.png" alt="image-20240226103808763" tabindex="0" loading="lazy"><figcaption>image-20240226103808763</figcaption></figure>
<ul>
<li>第一个是输入你的名字，可以随便写一个；第二个是一个选项框，提供了三个选项，可以任意选；</li>
</ul>
<figure><img src="https://img-blog.csdnimg.cn/img_convert/743d6c86aaa2e0e1c07594091b644625.png" alt="image-20240226103833763" tabindex="0" loading="lazy"><figcaption>image-20240226103833763</figcaption></figure>
<ul>
<li>然后在开始点击构建，就会输入echo里的数据及变量信息；</li>
</ul>
<figure><img src="https://img-blog.csdnimg.cn/img_convert/c0e761290482696e7f1a84640a1edb8e.png" alt="image-20240226104207259" tabindex="0" loading="lazy"><figcaption>image-20240226104207259</figcaption></figure>
<p>执行成功。</p>
...
<p disableConcurrentBuilds()="">disableConcurrentBuilds<br>
- 不允许并行执行Pipeline,可用于防止同时访问共享资源等。例如：options</p>
<p skipDefaultCheckout()="">skipDefaultCheckout<br>
- 默认跳过来自源代码控制的代码。例如：options</p>
<p timeout(time:="" 1,="" unit:="" HOURS)="">skipStagesAfterUnstable<br>
一旦构建状态进入了“Unstable”状态，就跳过此stage。例如：options { skipStagesAfterUnstable() }<br>
timeout<br>
- 设置Pipeline运行的超时时间。例如：options</p>
<p retry(3)="">retry<br>
- 失败后，重试整个Pipeline的次数。例如：options</p>
<p>timestamps<br>
...
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code>pipeline <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="parallel" tabindex="-1"><a class="header-anchor" href="#parallel" aria-hidden="true">#</a> parallel</h2>
...
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code>pipeline <span class="token punctuation">{</span>  
    ...
    <span class="token punctuation">}</span>  
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="tiggers" tabindex="-1"><a class="header-anchor" href="#tiggers" aria-hidden="true">#</a> tiggers</h2>
...
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code>pipeline <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="when" tabindex="-1"><a class="header-anchor" href="#when" aria-hidden="true">#</a> when</h2>
...
<figure><img src="https://img-blog.csdnimg.cn/direct/c7c42c9faa194e12abdd4c753ec8f6f3.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<ul class="task-list-container">
...
<figure><img src="https://img-blog.csdnimg.cn/img_convert/ae661d57bcb103b789ecf2ecadbc1aa0.png" alt="image-20240307100517366" tabindex="0" loading="lazy"><figcaption>image-20240307100517366</figcaption></figure>
<ul class="task-list-container">
...
<figure><img src="https://img-blog.csdnimg.cn/img_convert/b09eb31fffb39de2a3784be0581a1c69.png" alt="image-20240307101435744" tabindex="0" loading="lazy"><figcaption>image-20240307101435744</figcaption></figure>
...
<blockquote>
<p>那么学习<code v-pre>script</code>块，我们就还需要学习<code v-pre>groovy</code>语法，所以，首先我们就需要先来了解一下语法，也就是<code v-pre>脚本式流水线</code>，可以查看下一章：<a href="https://liucy.blog.csdn.net/article/details/136567517" target="_blank" rel="noopener noreferrer">【Jenkins】Pipeline流水线语法解析全集 -- 脚本式流水线、groovy语法<ExternalLinkIcon/></a></p>
</blockquote>
