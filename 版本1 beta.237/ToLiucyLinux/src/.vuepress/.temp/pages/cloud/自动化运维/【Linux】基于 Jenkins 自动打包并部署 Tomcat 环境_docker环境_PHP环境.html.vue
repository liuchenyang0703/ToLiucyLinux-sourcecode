<template><div><figure><img src="https://img-blog.csdnimg.cn/c0aa11fd101543d0a17ef264c0609468.jpeg" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<blockquote>
...
<h1 id="jenkins的基本配置" tabindex="-1"><a class="header-anchor" href="#jenkins的基本配置" aria-hidden="true">#</a> jenkins的基本配置</h1>
<h2 id="_1、修改-jenkins-初始密码" tabindex="-1"><a class="header-anchor" href="#_1、修改-jenkins-初始密码" aria-hidden="true">#</a> 1、修改 jenkins 初始密码</h2>
<p>1  点击Jenkins的管理<br>
2  进入用户<br>
3  设置修改密码</p>
<p><img src="https://img-blog.csdnimg.cn/31df0c79e09f4d9aa2c3f8453f237b60.png" alt="在这里插入图片描述" loading="lazy"><br>
<img src="https://img-blog.csdnimg.cn/1014ef8d72a149bf813b1335b1540e74.png" alt="在这里插入图片描述" loading="lazy"><br>
<img src="https://img-blog.csdnimg.cn/180c0f1b574343baa0097d0a05520664.png" alt="在这里插入图片描述" loading="lazy"><br>
<img src="https://img-blog.csdnimg.cn/089bf009eb8a48d08e4f89458685ac1c.png" alt="在这里插入图片描述" loading="lazy"></p>
<p><img src="https://img-blog.csdnimg.cn/3f52f0f56e2b4cca90a33d4d6ec77762.png" alt="在这里插入图片描述" loading="lazy"><br>
<img src="https://img-blog.csdnimg.cn/f12898c529a548f48c326a701d2b1bdc.png" alt="在这里插入图片描述" loading="lazy"></p>
<h2 id="_2、安装-jenkins-必要插件" tabindex="-1"><a class="header-anchor" href="#_2、安装-jenkins-必要插件" aria-hidden="true">#</a> 2、安装 Jenkins 必要插件</h2>
...
<p><img src="https://img-blog.csdnimg.cn/c31abbbda15f4b1295bb326ff9c220e8.png" alt="在这里插入图片描述" loading="lazy"><img src="https://img-blog.csdnimg.cn/38d4ddbcd3ef4eb49b5de8dae87ccf14.png" alt="在这里插入图片描述" loading="lazy"><img src="https://img-blog.csdnimg.cn/4346fbf977a54640b40865794391f933.png" alt="在这里插入图片描述" loading="lazy"><img src="https://img-blog.csdnimg.cn/1d3c7745bc8f46c081bbc016daa4321b.png" alt="在这里插入图片描述" loading="lazy"><img src="https://img-blog.csdnimg.cn/18eb45bda8ec4fc2b45e575e18a9875b.png" alt="在这里插入图片描述" loading="lazy"></p>
<h2 id="_3、配置-jenkins-并发执行数量" tabindex="-1"><a class="header-anchor" href="#_3、配置-jenkins-并发执行数量" aria-hidden="true">#</a> 3、配置 jenkins 并发执行数量</h2>
<p>用于提高提高执行效率</p>
<font color=red>Manage Jenkins</font> >> <font color=red>Configure System</font> >> <font color=red>Maven 项目配置</font><figure><img src="https://img-blog.csdnimg.cn/1268310994bc41c49751155aad084ad4.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>并发执行者数量  如果构建任务数量多的时候,我们可以在同一时间内构建多个；<br>
默认是2个</p>
<p><img src="https://img-blog.csdnimg.cn/bc31c6fcb70a47b4a5af3b95ac2ecd8f.png" alt="在这里插入图片描述" loading="lazy"><img src="https://img-blog.csdnimg.cn/0536f9383e9943fb831f4268e23300f8.png" alt="" loading="lazy"></p>
<h2 id="_4、配置邮件地址" tabindex="-1"><a class="header-anchor" href="#_4、配置邮件地址" aria-hidden="true">#</a> 4、配置邮件地址</h2>
<p>在测试完成后，主动发邮件告知测试情况</p>
<font color=red>Manage Jenkins</font> >> <font color=red>Configure System</font> >> <font color=red>Jenkins Location</font><p><img src="https://img-blog.csdnimg.cn/ca9de6d6a8804980a4d2e38556d88705.png" alt="在这里插入图片描述" loading="lazy"><img src="https://img-blog.csdnimg.cn/e2d16418a1f14ca3a8988f355dc7e81c.png" alt="在这里插入图片描述" loading="lazy"><img src="https://img-blog.csdnimg.cn/c60e8c9508b64ea09da14785f0a25574.png" alt="在这里插入图片描述" loading="lazy"></p>
<h1 id="基于-jenkins-自动打包并部署-tomcat-环境" tabindex="-1"><a class="header-anchor" href="#基于-jenkins-自动打包并部署-tomcat-环境" aria-hidden="true">#</a> 基于 Jenkins 自动打包并部署 Tomcat 环境</h1>
<h2 id="传统网站部署的流程" tabindex="-1"><a class="header-anchor" href="#传统网站部署的流程" aria-hidden="true">#</a> 传统网站部署的流程</h2>
<blockquote>
...
<p><img src="https://img-blog.csdnimg.cn/0e1de9e7a3f3449ea51afebec2c01efa.png#pic_center" alt="在这里插入图片描述" loading="lazy"><br>
<img src="https://img-blog.csdnimg.cn/296c30bebf414c9b8e9a435880bfb9a5.png#pic_center" alt="!在这里插入图片描述(https://img-blog.csdnimg.cn/c9acdc7b28b1472eb27e3ee224475e1e.png" loading="lazy"></p>
...
<h2 id="主流网站部署的流程" tabindex="-1"><a class="header-anchor" href="#主流网站部署的流程" aria-hidden="true">#</a> 主流网站部署的流程</h2>
<blockquote>
...
<figure><img src="https://img-blog.csdnimg.cn/a6d999bd9fb647b4aadf67092587c348.png#pic_center" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
...
<figure><img src="https://img-blog.csdnimg.cn/f55e3534b05d4bcc807c4199587fc0e1.png#pic_center" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_1、配置-git-主机" tabindex="-1"><a class="header-anchor" href="#_1、配置-git-主机" aria-hidden="true">#</a> 1、配置 git 主机</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2、配置-jenkins-主机" tabindex="-1"><a class="header-anchor" href="#_2、配置-jenkins-主机" aria-hidden="true">#</a> 2、配置 jenkins 主机</h2>
<p>① 给Jenkins添加验证凭据<br>
在 Jenkins 的首页中点击“<font color=red>凭据</font>”进入凭据页面；<br>
注：有是版本不一样，位置不一样，根据自己的实际版本来定；</p>
<figure><img src="https://img-blog.csdnimg.cn/b5501484432b4864a546a22c05239733.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>在凭据页面中，点击“Jenkins”跳转到“系统”页面。点击左侧导航栏中“添加域”，跳转到“添加域”页面。在该页面创建域名为“crushlinux”并点击“ok”完成配置。</p>
<p><img src="https://img-blog.csdnimg.cn/0ceb65ac9724444386fefb2645e5d758.png" alt="在这里插入图片描述" loading="lazy"><br>
在添加域里面添加的用户名的密码是web服务器的<br>
Jenkins要往web服务器上面去部署,所以Jenkins要有权限去远程连接web服务器</p>
<figure><img src="https://img-blog.csdnimg.cn/4b8a3964fa7247fab871e3d91296d02c.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>点击左侧导航栏中的“添加凭据”。</p>
<p><img src="https://img-blog.csdnimg.cn/07a62894b8934b61b6afc09446839d2a.png" alt="在这里插入图片描述" loading="lazy"><img src="https://img-blog.csdnimg.cn/467bea9c13154a58966118bec6e302af.png" alt="在这里插入图片描述" loading="lazy"></p>
<p>填写以上数据后，点击“确定”就可以查看到新增的远程 web 主机账号。</p>
<p><img src="https://img-blog.csdnimg.cn/a8e353a8c076438f91afa937451d525a.png" alt="在这里插入图片描述" loading="lazy"><br>
...
<p><img src="https://img-blog.csdnimg.cn/ffc515317d4b40c2bcaa887f6970f932.png" alt="在这里插入图片描述" loading="lazy"><br>
<img src="https://img-blog.csdnimg.cn/5049adc621bd45319bcd3ff09b4f4cd1.png" alt="在这里插入图片描述" loading="lazy"><img src="https://img-blog.csdnimg.cn/b09ad61c7a984e0db8455aee1d25dd58.png" alt="在这里插入图片描述" loading="lazy"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://img-blog.csdnimg.cn/b6a627195fd14c9dbf4b1ff2eafcea3e.png" alt="在这里插入图片描述" loading="lazy"><img src="https://img-blog.csdnimg.cn/9fbcfb59dc5a42bfb4f7ff05582a3e0a.png" alt="在这里插入图片描述" loading="lazy"></p>
...
<p><img src="https://img-blog.csdnimg.cn/310a8292ff074fb4834db827c7697074.png" alt="在这里插入图片描述" loading="lazy"><br>
Git 配置</p>
...
/usr/bin/git
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/dfae6c3f292f4c9e83f973a179a829bf.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>以上全局基本配置完毕后，点击保存即可完成。</p>
<h2 id="_3、配置-web-主机" tabindex="-1"><a class="header-anchor" href="#_3、配置-web-主机" aria-hidden="true">#</a> 3、配置 web 主机</h2>
...
<h2 id="_4、新建-maven-项目" tabindex="-1"><a class="header-anchor" href="#_4、新建-maven-项目" aria-hidden="true">#</a> 4、新建 Maven 项目</h2>
<p>  在以上配置完成后，回到 Jenkins 首页，选择“新建任务”，然后输入一个任务名称“probe”，并选中“Maven project”点击当前页面下方的“确定”按钮。</p>
<p><img src="https://img-blog.csdnimg.cn/ba446e99d12640dbaf94928c504982b0.png" alt="在这里插入图片描述" loading="lazy"><img src="https://img-blog.csdnimg.cn/a2086736504c46de9f5bd13d6b1e05aa.png" alt="在这里插入图片描述" loading="lazy"></p>
<p>在点击“确定”按钮后，选择“源码管理”选中“Git”,配置“RepositoriesURL”为git@172.16.11.203:/home/git/probe.g</p>
<figure><img src="https://img-blog.csdnimg.cn/9531bf1d66204f0f848f829e515c5298.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
...
<p><img src="https://img-blog.csdnimg.cn/fe51e67d200c42e3ae7f44f60f9b63d0.png" alt="在这里插入图片描述" loading="lazy"><img src="https://img-blog.csdnimg.cn/a7693fd32be842e182ec0aaf3a59be3d.png" alt="在这里插入图片描述" loading="lazy"></p>
...
<figure><img src="https://img-blog.csdnimg.cn/1e064921f15547118cd6beefdbf1bbd4.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>  以上全部配置完成后，点击保存即可。然后点击刚才创建的“probe”-&gt;“Build Now”直至项目构建完成。构建过程可以在“控制台输出”中查看到。</p>
<figure><img src="https://img-blog.csdnimg.cn/cc0ff45a0cba4c3fa6ac1bc0aa93a84f.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p><img src="https://img-blog.csdnimg.cn/c97a4bda21064866932f00524253c3b6.png" alt="在这里插入图片描述" loading="lazy"><img src="https://img-blog.csdnimg.cn/1577f744013b40b6a572524cb3077545.png" alt="在这里插入图片描述" loading="lazy"></p>
<h2 id="_5、验证-jenkins-自动打包部署结果" tabindex="-1"><a class="header-anchor" href="#_5、验证-jenkins-自动打包部署结果" aria-hidden="true">#</a> 5、验证 Jenkins 自动打包部署结果</h2>
...
<figure><img src="https://img-blog.csdnimg.cn/48bfabbd45b9427699338c1b235d0214.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/9bc10a1d18b442a8a758d6b9828daf40.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>至此，Jenkins 自动打包部署完毕。</p>
<h1 id="基于-jenkins-自动打包并部署-docker-环境" tabindex="-1"><a class="header-anchor" href="#基于-jenkins-自动打包并部署-docker-环境" aria-hidden="true">#</a> 基于 Jenkins 自动打包并部署 docker 环境</h1>
<h2 id="_1、安装-docker-ce" tabindex="-1"><a class="header-anchor" href="#_1、安装-docker-ce" aria-hidden="true">#</a> 1、安装 docker-ce</h2>
...
OS/Arch: linux/amd64
Experimental: false/
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2、阿里云镜像加速器" tabindex="-1"><a class="header-anchor" href="#_2、阿里云镜像加速器" aria-hidden="true">#</a> 2、阿里云镜像加速器</h2>
...
589MB
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3、构建-tomcat-基础镜像" tabindex="-1"><a class="header-anchor" href="#_3、构建-tomcat-基础镜像" aria-hidden="true">#</a> 3、构建 tomcat 基础镜像</h2>
...
589MB
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_4、构建一个-maven-项目" tabindex="-1"><a class="header-anchor" href="#_4、构建一个-maven-项目" aria-hidden="true">#</a> 4、构建一个 Maven 项目</h2>
<p>在以上配置完成后，回到 Jenkins 首页，选择“新建任务”，然后输入一个任务名称“probe-docker”，并选择“Maven project”配置项，点击当前页面下方的“确定”按钮。</p>
<figure><img src="https://img-blog.csdnimg.cn/ff31479639bc4487a164c97bd147c9de.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>在点击“确定”按钮，选择“源码管理”并选中“Git”,设置“Repository URL”地址。</p>
<figure><img src="https://img-blog.csdnimg.cn/d9de0fe87e814d16b8632b1a41575683.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>选择“Build”-&gt; clean package -Dmaven.test.skip=true</p>
<figure><img src="https://img-blog.csdnimg.cn/87414ec4de184fb694c46dc2b9541de3.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/898a8efe06b948f0b81711f9aca80d3c.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>  以上全部配置完成后，点击保存即可。然后点击刚才创建的工程任务“probe-docker “-&gt;” Build new”直至任务构建完成。开始构建过程中可以点击进度条查看</p>
<figure><img src="https://img-blog.csdnimg.cn/ac1649f7f969422f92b76e35770f9df2.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/eec5312712d9417a8f7645fbdbe5474f.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<h1 id="基于-jenkins-自动化部署-php-环境" tabindex="-1"><a class="header-anchor" href="#基于-jenkins-自动化部署-php-环境" aria-hidden="true">#</a> 基于 Jenkins 自动化部署 PHP 环境</h1>
<p>准备 git 仓库</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/838544d4119f4096be8a5803b722762e.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="基于-rsync-部署" tabindex="-1"><a class="header-anchor" href="#基于-rsync-部署" aria-hidden="true">#</a> 基于 rsync 部署</h2>
<p>创建一个 Freestyle project</p>
<p><img src="https://img-blog.csdnimg.cn/e4cc7fc51d7840228ed59865513edf2b.png" alt="在这里插入图片描述" loading="lazy"><br>
<img src="https://img-blog.csdnimg.cn/1d80709ea27e4a8e88fbd460880c2b28.png" alt="在这里插入图片描述" loading="lazy"></p>
<p>rsync -avz --delete * <a href="mailto:root@172.16.11.204">root@172.16.11.204</a>:/var/www/html/</p>
<p><img src="https://img-blog.csdnimg.cn/1102e0d66a734268b4b16c1bee00c7bc.png" alt="在这里插入图片描述" loading="lazy"><img src="https://img-blog.csdnimg.cn/f3db1eaa744143929e1bfc40a866203a.png" alt="在这里插入图片描述" loading="lazy"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/d14b53d15ba1471982d36e47e41fb372.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<h2 id="基于-ansible-部署" tabindex="-1"><a class="header-anchor" href="#基于-ansible-部署" aria-hidden="true">#</a> 基于 ansible 部署</h2>
...
<figure><img src="https://img-blog.csdnimg.cn/276415ca9f1641cabd97149518592521.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<figure><img src="https://img-blog.csdnimg.cn/58b6523db71e4a73a30ada20619689da.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<figure><img src="https://img-blog.csdnimg.cn/bf876d2e58ac486b9937291b21f4b7c5.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<figure><img src="https://img-blog.csdnimg.cn/b1164e81748b41109332d8acf5778fa0.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://img-blog.csdnimg.cn/41f1d3469f5545b38da90194049c2838.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<p>src=${WORKSPACE} dest=/var/www/html rsync_opts=--exclude=.git</p>
<figure><img src="https://img-blog.csdnimg.cn/6d01660b31004f7ab1782b541a049bd0.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<figure><img src="https://img-blog.csdnimg.cn/a3508fd728db41ff9102045916515c6e.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
