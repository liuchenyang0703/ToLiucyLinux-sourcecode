...
<hr>
<p>@[toc]</p>
<figure><img src="https://img-blog.csdnimg.cn/855c9bc0e2ec444192e8cf5c5e1a8229.gif#pic_center" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
<h1 id="安装mariadb" tabindex="-1"><a class="header-anchor" href="#安装mariadb" aria-hidden="true">#</a> 安装mariadb</h1>
...
<h1 id="初始化mariadb" tabindex="-1"><a class="header-anchor" href="#初始化mariadb" aria-hidden="true">#</a> 初始化mariadb</h1>
...
<h1 id="测试数据库连接并开启远程登陆" tabindex="-1"><a class="header-anchor" href="#测试数据库连接并开启远程登陆" aria-hidden="true">#</a> 测试数据库连接并开启远程登陆</h1>
...
<h1 id="测试本地客户端连接-远程连接" tabindex="-1"><a class="header-anchor" href="#测试本地客户端连接-远程连接" aria-hidden="true">#</a> 测试本地客户端连接（远程连接）</h1>
<p>开放远程登录这时候我们就可以用<code v-pre>navicat、sqlyog</code>等链接工具来连接数据库了，端口3306；自己可以测试一下，如果是直接在linux中用就不用测试了。</p>
<p><img src="https://img-blog.csdnimg.cn/b4b2ab1ac57c4b0fa8af2f7f39827c69.png" alt="在这里插入图片描述" loading="lazy"><br>
<img src="https://img-blog.csdnimg.cn/91efe871b6474deda61743f82c5f1af8.png" alt="在这里插入图片描述" loading="lazy"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="总结" tabindex="-1"><a class="header-anchor" href="#总结" aria-hidden="true">#</a> 总结</h1>
<blockquote>
