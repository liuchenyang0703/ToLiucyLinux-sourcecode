...
<h2 id="docker中两项核心技术" tabindex="-1"><a class="header-anchor" href="#docker中两项核心技术"><span>Docker中两项核心技术</span></a></h2>
<p>  Docker本质就是宿主机的一个进程，Docker是通过Namespace实现资源隔离，通过Cgroup实现资源限制，通过写时复制技术(copy-on-write)实现了高效的文件操作。</p>
<p><strong><font color=teal>  1.Namespace</font></strong></p>
...
<tr>
<td>IPC</td>
<td>进程间通信的隔离，包括常见的几种进程间通信机制，如信号量，消息队列和共享内存。	/2.6.19</td>
</tr>
<tr>
<td>PID</td>
<td>进程ID	/2.6.24</td>
...
<p><strong><font color=teal>  2.Cgroup</font></strong></p>
<p>      Cgroup是Control Groups的缩写，是Linux内核提供的一种可以限制、记录、隔离进程组所使用的物理资源（如CPU、内存、磁盘IO等待）的机制，被LXC、docker等很多项目用于实现进程资源控制。Cgroup本身是提供将进程进行分组化管理的功能和接口的基础结构，I/O或内存的分配控制等具体的资源管理是通过该功能来实现的。<br>
四大功能：</p>
<ul>
...
<h2 id="docker核心概念" tabindex="-1"><a class="header-anchor" href="#docker核心概念"><span>Docker核心概念</span></a></h2>
<p><strong><font color=green> 1. 镜像(Image)</font></strong></p>
<p>   一个带有创建docker容器命令的只读模板，通常在一个基础镜像上添加附加的指令，来创建一个新镜像。</p>
<p>镜像的两个特征：</p>
<blockquote>
<ul>
...
<p><strong><font color=green>2. 容器(Container)</font></strong></p>
<p>  容器与镜像的关系，就如同面向编程中对象与类之间的关系。</p>
<blockquote>
<p>  因为容器是通过镜像来创建的，所以必须先有镜像才能创建容器，而生成的容器是一个独立于宿主机的隔离进程，并且有属于容器自己的网络和命名空间。<br>
  镜像由多个中间层（layer）组成，生成的镜像是只读的，但容器却是可读可写的，这是因为容器是在镜像上面添一层读写层（writer/read layer）来实现的。</p>
</blockquote>
<p><strong><font color=green>3. 仓库(Repository)</font></strong></p>
<blockquote>
<p>仓库（Repository）是集中存储镜像的地方，仓库分为公有仓库与私有仓库。比如Docker Hub，就是Docker官方提供的一个仓库服务器。</p>
</blockquote>
<h2 id="docker的逻辑架构" tabindex="-1"><a class="header-anchor" href="#docker的逻辑架构"><span>Docker的逻辑架构</span></a></h2>
<blockquote>
<p>   Docker采用的是C/S架构，Docker客户端向服务端(docker-daemon)发送指令，docker-daemon负责构建，运行以及分发docker容器，docker的客户端与服务端可以运行在同一台主机上，也可以使用docker的客户端连接远程的服务端，客户端与服务端使用RSET API通信，也可以使用Unix套接字，或者是网络接口。另外还可以使用docker compose作为客户端，它可以控制一组docker容器的应用程序。</p>
</blockquote>
<h2 id="docker优缺点" tabindex="-1"><a class="header-anchor" href="#docker优缺点"><span>docker优缺点</span></a></h2>
<p>  优点：</p>
<blockquote>
<ol>
<li>快速部署：短时间内可以部署成百上千个应用，更快速交付到线上。</li>
<li>高效虚拟化：不需要额外的 hypervisor 支持，直接基于 linux 实现应用虚拟化，相比虚拟机大幅提高性能和效率。</li>
<li>节省开支：提高服务器利用率，降低 IT 支出。</li>
<li>简化配置：将运行环境打包保存至容器，使用时直接启动即可。</li>
<li>快速迁移和扩展： 可夸平台运行在物理机、虚拟机、公有云等环境，良好的兼容性可以方便将应用从A宿主机迁移到B宿主机， 甚至是A平台迁移到B平台。</li>
</ol>
</blockquote>
<p>  缺点：</p>
<blockquote>
<p>隔离性：各应用之间的隔离不如虚拟机彻底。</p>
</blockquote>
<h2 id="docker-vs-虚拟化" tabindex="-1"><a class="header-anchor" href="#docker-vs-虚拟化"><span>Docker VS 虚拟化</span></a></h2>
<p>虚拟化：</p>
<blockquote>
...
<p>Docker：</p>
<blockquote>
<p>  容器技术是和宿主机共享硬件资源及操作系统可以实现资源的动态分配。<br>
  容器包含应用和其所有的依赖包，但是与其他容器共享内核。容器在宿主机操作系统中，在用户空间以分离的进程运行。</p>
</blockquote>
<table><tr><td bgcolor=yellow>服务器虚拟化解决的核心问题是资源调配，而容器解决的核心问题是应用开发、测试和部署。</td></tr></table>
<p>docker与虚拟化区别总结:</p>
<blockquote>
<ol>
<li>docker启动快速属于秒级别。虚拟机通常需要几分钟去启动。</li>
<li>docker需要的资源更少，docker在操作系统级别进行虚拟化，docker容器和内核交互，几乎没有性能损耗，性能优于通过Hypervisor层与内核层的虚拟化。；</li>
<li>docker更轻量，docker的架构可以共用一个内核与共享应用程序库，所占内存极小。同样的硬件环境，Docker运行的镜像数远多于虚拟机数量。对系统的利用率非常高</li>
<li>与虚拟机相比，docker隔离性更弱，docker属于进程之间的隔离，虚拟机可实现系统级别隔离；</li>
<li>快速创建、删除：虚拟化创建是分钟级别的，Docker容器创建是秒级别的，Docker的快速迭代性，决定了无论是开发、测试、部署都可以节约大量时间。</li>
<li>交付、部署：虚拟机可以通过镜像实现环境交付的一致性，但镜像分发无法体系化；Docker在Dockerfile中记录了容器构建过程，可在集群中实现快速分发和快速部署;</li>
</ol>
</blockquote>
<h2 id="docker部署与管理" tabindex="-1"><a class="header-anchor" href="#docker部署与管理"><span>docker部署与管理</span></a></h2>
...
<h4 id="离线安装" tabindex="-1"><a class="header-anchor" href="#离线安装"><span>离线安装</span></a></h4>
<p>连接中有步骤；<br>
<a href="https://download.csdn.net/download/liu_chen_yang/85965917?spm=1001.2014.3001.5503" target="_blank" rel="noopener noreferrer">部署docker的离线包</a><br>
<a href="https://download.csdn.net/download/liu_chen_yang/88647183" target="_blank" rel="noopener noreferrer">docker24.0.5离线安装包 （一键部署）</a></p>
<p><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412161441340.png" alt="" loading="lazy"><br>
<img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412161441465.png" alt="" loading="lazy"></p>
<h4 id="在线安装" tabindex="-1"><a class="header-anchor" href="#在线安装"><span>在线安装</span></a></h4>
<div class="language-bash line-numbers-mode" data-highlighter="shiki" data-ext="bash" data-title="bash" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#A0A1A7;--shiki-dark:#7F848E;--shiki-light-font-style:italic;--shiki-dark-font-style:italic">#安装依赖包</span></span>
...
<span class="line"><span style="--shiki-light:#A0A1A7;--shiki-dark:#7F848E;--shiki-light-font-style:italic;--shiki-dark-font-style:italic">#添加华为云的docker镜像地址</span></span>
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">[root@docker ~]# yum-config-manager --add-repo https://repo.huaweicloud.com/docker-ce/linux/centos/docker-ce.repo</span></span>
...
<span class="line"><span style="--shiki-light:#A0A1A7;--shiki-dark:#7F848E;--shiki-light-font-style:italic;--shiki-dark-font-style:italic">#安装docker，默认安装最新版本</span></span>
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">[root@docker ~]# yum -y install docker-ce</span></span>
...
<span class="line"><span style="--shiki-light:#4078F2;--shiki-dark:#61AFEF">Docker</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379"> version</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379"> 20.10.7,</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379"> build</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379"> f0df350</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">[root@docker ~]# systemctl start docker</span></span>
<span class="line"><span style="--shiki-light:#A0A1A7;--shiki-dark:#7F848E;--shiki-light-font-style:italic;--shiki-dark-font-style:italic">#查看docker可以安装的版本</span></span>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="添加镜像加速器" tabindex="-1"><a class="header-anchor" href="#添加镜像加速器"><span>添加镜像加速器</span></a></h2>
<p>由于docker默认从docker hub(<a href="https://registry.hub.docker.com/" target="_blank" rel="noopener noreferrer">https://registry.hub.docker.com/</a>)下载镜像，所以速度非常慢，可以通过阿里云的镜像加速器提高镜像拉取的速度。<br>
<img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/202412161441041.png" alt="" loading="lazy"></p>
...
<span class="line"><span style="--shiki-light:#50A14F;--shiki-dark:#98C379">  "registry-mirrors": ["https://mrlmpasq.mirror.aliyuncs.com"]</span></span>
<span class="line"><span style="--shiki-light:#50A14F;--shiki-dark:#98C379">}</span></span>
<span class="line"><span style="--shiki-light:#50A14F;--shiki-dark:#98C379">[root@docker ~]# systemctl daemon-reload</span></span>
<span class="line"><span style="--shiki-light:#50A14F;--shiki-dark:#98C379">[root@docker ~]# systemctl restart docker</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="docker镜像管理" tabindex="-1"><a class="header-anchor" href="#docker镜像管理"><span>docker镜像管理</span></a></h3>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">[root@docker ~]# docker images</span></span>
...
<td>docker build -t centos:v1 .</td>
<td>-t 指定镜像名称</td>
</tr>
<tr>
<td>docker search</td>
...
<td>docker pull</td>
<td>拉取镜像</td>
<td>docker pull centos:7</td>
<td></td>
</tr>
<tr>
<td>docker push</td>
<td>推送镜像到仓库</td>
<td>docker push centos:7</td>
<td></td>
</tr>
<tr>
<td>docker tag</td>
<td>为镜像修改或制作标签</td>
<td>docker tag centos:7 centos7:v1</td>
<td></td>
</tr>
<tr>
<td>docker rmi</td>
<td>删除镜像</td>
<td>docker rmi centos7:v1</td>
<td></td>
</tr>
<tr>
<td>docker save</td>
<td>将镜像保存为tar包</td>
<td>docker save -o centos7.tar centos:7</td>
<td>-o 指定生成tar包名称</td>
</tr>
<tr>
<td>docker load</td>
<td>将tar包保存的镜像导入</td>
<td>docker load -i centos.tar</td>
<td>-i 指定读取的tar包名称</td>
</tr>
<tr>
<td>docker histroy</td>
<td>查看镜像创建的历史</td>
<td>docker history centos:7</td>
<td></td>
</tr>
<tr>
<td>docker prune</td>
...
<h3 id="docker容器管理" tabindex="-1"><a class="header-anchor" href="#docker容器管理"><span>docker容器管理</span></a></h3>
<table>
<thead>
<tr>
<th>docker container命令</th>
<th>说明</th>
<th>举例</th>
</tr>
</thead>
...
<td>docker run</td>
<td>运行一个docker容器</td>
<td>docker run -itd --name nginx nginx:v1</td>
</tr>
<tr>
<td>docker container create</td>
<td>创建容器但不运行</td>
<td>docker container create nginx</td>
</tr>
<tr>
<td>docker exec</td>
<td>进入容器或用来在已经运行的容器中执行命令</td>
...
<td>docker rm -f</td>
<td>删除容器</td>
<td>docker rm -f nginx</td>
</tr>
<tr>
<td>docker rename</td>
<td>给容器重命名</td>
<td>docker rename nginx nginx2</td>
</tr>
<tr>
<td>docker commit</td>
<td>提交容器变化为新镜像</td>
<td>docker commit nginx</td>
</tr>
<tr>
<td>docker top</td>
<td>查看容器的进程</td>
<td>docker top nginx2</td>
</tr>
<tr>
<td>docker logs</td>
<td>获取容器日志信息</td>
<td>docker logs nginx2</td>
</tr>
<tr>
<td>docker cp</td>
<td>容器与主机间文件复制</td>
<td>docker cp a.txt nginx:/home/</td>
</tr>
<tr>
<td>docker update</td>
<td>更新容器配置</td>
<td>docker update --restart=no nginx</td>
</tr>
<tr>
<td>docker stats</td>
<td>查看容器资源使用情况</td>
<td>docker stats nginx2</td>
</tr>
<tr>
<td>docker diff</td>
<td>对比容器文件变化		docker diff nginx nginx2</td>
<td></td>
</tr>
<tr>
...
<td>docker port</td>
<td>列出端口映射</td>
<td>docker port nginx2</td>
</tr>
<tr>
<td>docker container kill</td>
<td>杀死正在运行的容器</td>
<td>docker kill nginx2</td>
</tr>
<tr>
<td>docker export</td>
<td>容器文件导出为tar</td>
<td>docker export nginx.tar nginx</td>
</tr>
<tr>
<td>docker wait</td>
<td>阻塞容器</td>
...
<h4 id="docker运行容器命令" tabindex="-1"><a class="header-anchor" href="#docker运行容器命令"><span>docker运行容器命令</span></a></h4>
<blockquote>
<p>docker run命令是根据指定镜像创建一个容器并启动运行。如果本地没有该镜像，则从docker仓库中拉去镜像。所以<br>
docker run = docker image pull +  docker create + docker start<br>
命令格式：<code v-pre>docker run [选项] 镜像名称|镜像ID  [command]</code><br>
示例：<code v-pre>docker run -itd --name test --restart=always --network=host -v /etc/localtime/:/etc/localtime test:v1</code></p>
</blockquote>
...
<tr>
<td>- -restart</td>
<td>指定是否开机自启，always（开机自启）</td>
</tr>
<tr>
<td>- -network</td>
<td>指定docker网络模式(bridge/host/none/container)</td>
</tr>
<tr>
<td>-P</td>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">[root@docker ~]# docker container ls -a</span></span>
...
<span class="line"><span style="--shiki-light:#4078F2;--shiki-dark:#61AFEF">可以使用docker</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379"> container</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379"> start命令启动容器</span></span>
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">[root@docker ~]# docker container start centos-1 </span></span>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">[root@docker ~]# docker container run -d nginx:latest </span></span>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">[root@docker ~]# docker ps -a</span></span>
<span class="line"><span style="--shiki-light:#4078F2;--shiki-dark:#61AFEF">CONTAINER</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379"> ID</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379">   IMAGE</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379">          COMMAND</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379">                  CREATED</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379">         STATUS</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379">         PORTS</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379">     NAMES</span></span>
<span class="line"><span style="--shiki-light:#4078F2;--shiki-dark:#61AFEF">cef133be2d53</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379">   nginx:latest</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379">   "/docker-entrypoint.…"</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66">   6</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379"> seconds</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379"> ago</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379">   Up</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66"> 5</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379"> seconds</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379">   80/tcp</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379">    relaxed_lichterman</span></span>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="docker网络管理" tabindex="-1"><a class="header-anchor" href="#docker网络管理"><span>docker网络管理</span></a></h3>
<table>
<thead>
<tr>
<th>命令</th>
