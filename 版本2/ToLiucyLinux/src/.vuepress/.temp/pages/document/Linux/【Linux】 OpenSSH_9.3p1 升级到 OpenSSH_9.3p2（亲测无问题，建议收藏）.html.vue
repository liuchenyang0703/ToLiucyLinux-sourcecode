...
<h2 id="此文升级是基于9-3p1升级9-3p2-如是7-4升级9-3p2-可参考文章最后的参考文章" tabindex="-1"><a class="header-anchor" href="#此文升级是基于9-3p1升级9-3p2-如是7-4升级9-3p2-可参考文章最后的参考文章"><span>此文升级是基于9.3p1升级9.3p2（如是7.4升级9.3p2，可参考文章最后的参考文章）</span></a></h2>
<blockquote>
<p>9.3p1升级文档：<a href="https://liucy.blog.csdn.net/article/details/131398113" target="_blank" rel="noopener noreferrer">【Linux】 OpenSSH_7.4p1 升级到 OpenSSH_9.3p1（亲测无问题，建议收藏）</a></p>
</blockquote>
...
<h3 id="下载-openssh9-3p2-的安装包" tabindex="-1"><a class="header-anchor" href="#下载-openssh9-3p2-的安装包"><span>下载 openssh9.3p2 的安装包：</span></a></h3>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><h3 id="解压并编译安装openssh9-3p2" tabindex="-1"><a class="header-anchor" href="#解压并编译安装openssh9-3p2"><span>解压并编译安装OpenSSH9.3p2</span></a></h3>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="给sshd授3予权限" tabindex="-1"><a class="header-anchor" href="#给sshd授3予权限"><span>给sshd授3予权限</span></a></h3>
...
<div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>[root@localhost ~]# ssh -V</span></span>
<span class="line"><span>OpenSSH_9.3p2, OpenSSL 1.1.1t  7 Feb 2023</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://lcy-blog.oss-cn-beijing.aliyuncs.com/blog/6551fdeab07d4a31839ea5396b319e18.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>
