...
<span class="line"><span style="--shiki-light:#E45649;--shiki-dark:#C678DD">innodb_file_per_table</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">=</span><span style="--shiki-light:#383A42;--shiki-dark:#98C379">0 </span><span style="--shiki-light:#A0A1A7;--shiki-dark:#7F848E;--shiki-light-font-style:italic;--shiki-dark-font-style:italic"># 0：代表使用系统表空间； 1：代表使用独立表空间</span></span></code></pre>
